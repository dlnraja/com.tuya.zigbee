...
[![Version](https://img.shields.io/badge/version-v7.5.13-blue)]()
[![Drivers](https://img.shields.io/badge/drivers-221-brightgreen)]()
[![Fingerprints](https://img.shields.io/badge/fingerprints-10,844+-green)]()
[![Users Tracked](https://img.shields.io/badge/users%20tracked-33+-purple)]()
[![Last Updated](https://img.shields.io/badge/updated-2026-05-11-lightgrey)]()

> **v7.5.13** | **10,844+ fingerprints** | **221 drivers** | **2,427 flow cards** | Updated 2026-05-11

---

## Fingerprint Verification

**Verified**: 124 fingerprints from user reports found in drivers
**Missing** (9): `_TZ3000_an5jiwd`, `_TZ3000_qxqcxxs`, `_TZ3000_j6kfv0r`, `_TZ68_4h8bgm`, `_TZE284_aaeasoll`, `_TZ3040_o4mkahkc`, `_TZ3000_baeiitad`, `_TYST11_jeaxp72v`, `_TZ3000_enmfaave`
...
| **v5.11.211** | Tuya Unified Zigbee v5.11.211: Fixed DeviceIdentificationDatabase crash on startup (ReferenceEr... |
| **v5.11.210** | Tuya Unified Zigbee v5.11.210: Stability release - verified syntax integrity on all lib/ files,... |
| **v5.11.209** | Tuya Unified Zigbee app v5.11.208: Fixed app ID. |
| **v5.11.208** | Tuya Unified Zigbee app v5.11.208: Fixed app ID. |
...
- **False Battery Alert / Missing Battery** (36 reports, high priority): Set `get mainsPowered() { return true; }` and remove measure_battery in onNodeInit
- **Pairing Failure** (17 reports, high priority): Check driver.compose.json fingerprints, verify manufacturerName + productId
- **Device Not Responding** (9 reports, high priority): Check Zigbee mesh, device routing, and cluster bindings
- **Device Shows Unknown** (6 reports, high priority): Check settings keys: zb_model_id (not zb_modelId), zb_manufacturer_name (not zb_manufacturerName)
...
- **Total interviews recovered**: 210
- **Unique fingerprints**: 156
- **Sources**: {"github":172,"forum":38,"gmail":0,"forum-pm":0}
...
| **Flow cards not working** | Update app to v7.5.13, recreate flow, check driver flow cards |
...
*Auto-generated on 2026-05-11 from v7.5.13 — 10,844+ fingerprints across 221 drivers*
