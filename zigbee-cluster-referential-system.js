                ...
                updateReferential: {
                    ...
                    steps: [
                        ...
                        },
                        {
                            ...
                            run: "git config --local user.email 'action@github.com' && git config --local user.name 'GitHub Action' && git add . && git commit -m 'Monthly Zigbee Referential Update' && git push"
                        }
                    ]
                }
            }
