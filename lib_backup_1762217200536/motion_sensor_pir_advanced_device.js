...
/**
 * PirSensorAdvancedDevice - Unified Hybrid Driver
 * Auto-detects power source: AC/DC/Battery (CR2032/CR2450/AAA/AA)
 * Dynamically manages capabilities based on power source
 */
class PirSensorAdvancedDevice extends BaseHybridDevice {

  async onNodeInit({ zclNode }) {
    this.log('PirSensorAdvancedDevice initializing...');
    ...
    this.log('PirSensorAdvancedDevice initialized - Power source:', this.powerSource || 'unknown');
  }
  ...
  async onDeleted() {
    this.log('PirSensorAdvancedDevice deleted');
    await super.onDeleted().catch(err => this.error(err));
  }
}

module.exports = PirSensorAdvancedDevice;
