...
class SmartSocketIp3010sDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Smart Socket IP-3010S has been initialized');
    }
    ...
    onDeleted() {
        this.log('Smart Socket IP-3010S has been deleted');
    }
}

module.exports = SmartSocketIp3010sDevice;