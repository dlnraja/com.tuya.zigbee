...
// Device Type: zigbee
// Category: onoff
// Subcategory: smart_air_detection_box
// Enrichment Date: 2025-08-07T17:53:56.100Z
...
class Smartairdetectionbox extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Smartairdetectionbox SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Smartairdetectionbox Enhanced deleted');
  }
