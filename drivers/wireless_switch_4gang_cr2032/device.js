...
class WirelessSwitch_4gangBatteryDevice extends ZigBeeDevice {
    
    async onNodeInit() {
        this.log('wireless_switch_4gang_battery device initialized');
...
module.exports = WirelessSwitch_4gangBatteryDevice;