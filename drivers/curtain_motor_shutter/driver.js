...
class TuyaZigbeeDriver extends ZigBeeDriver {
  ...
  _registerFlowCards() {
    ...
    } catch (err) { if (this.developerDebugMode) { this.error(`Action curtain_motor_shutter_hybrid_curtain_motor_set_windowcoverings_set_curtain_motor_shutter_hybrid: ${err.message}`); }; }
    ...
    } catch (err) { if (this.developerDebugMode) { this.error(`Action curtain_motor_shutter_hybrid_curtain_motor_windowcoverings_open_curtain_motor_shutter_hybrid: ${err.message}`); }; }
    ...
    } catch (err) { if (this.developerDebugMode) { this.error(`Action curtain_motor_shutter_hybrid_curtain_motor_windowcoverings_close_curtain_motor_shutter_hybrid: ${err.message}`); }; }
    ...
    } catch (err) { if (this.developerDebugMode) { this.error(`Action curtain_motor_shutter_hybrid_curtain_motor_set_dim_curtain_motor_shutter_hybrid: ${err.message}`); }; }
    ...
    } catch (err) { if (this.developerDebugMode) { this.error(`Action curtain_motor_shutter_hybrid_curtain_motor_stop_curtain_motor_shutter_hybrid: ${err.message}`); }; }
    ...
    } catch (err) { if (this.developerDebugMode) { this.error(`Action curtain_motor_shutter_hybrid_curtain_motor_set_favorite_curtain_motor_shutter_hybrid: ${err.message}`); }; }
    ...
    } catch (err) { if (this.developerDebugMode) { this.error(`Action curtain_motor_shutter_hybrid_curtain_motor_set_brightness_curtain_motor_shutter_hybrid: ${err.message}`); }; }
    ...
    } catch (err) { if (this.developerDebugMode) { this.error(`Action curtain_motor_shutter_hybrid_curtain_motor_set_position_curtain_motor_shutter_hybrid: ${err.message}`); }; }
    ...
    } catch (err) { if (this.developerDebugMode) { this.error(`Action curtain_motor_shutter_hybrid_curtain_motor_open_curtain_motor_shutter_hybrid: ${err.message}`); }; }
    ...
    } catch (err) { if (this.developerDebugMode) { this.error(`Action curtain_motor_shutter_hybrid_curtain_motor_close_curtain_motor_shutter_hybrid: ${err.message}`); }; }
