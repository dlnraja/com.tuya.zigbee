...
class ZigbeeTemperatureAndHumiditySensorDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Zigbee Temperature and Humidity sensor has been initialized');
    }
    ...
    onDeleted() {
        this.log('Zigbee Temperature and Humidity sensor has been deleted');
    }
}

module.exports = ZigbeeTemperatureAndHumiditySensorDevice;