...
class PlugSmartDriver extends ZigBeeDriver {
  ...
  _registerFlowCards() {
    ...
    } catch (err) { if (this.developerDebugMode) { this.error(`Condition device_plug_energy_monitor_plug_smart_is_on: ${err.message}`); }; }
    ...
    } catch (err) { if (this.developerDebugMode) { this.error(`Action device_plug_energy_monitor_plug_smart_set_power_on: ${err.message}`); }; }
