...
class PlugSmartDriver extends ZigBeeDriver {
  ...
  _registerFlowCards() {
    ...
    } catch (err) { this.error(`Condition device_plug_energy_monitor_plug_smart_is_on: ${err.message}`); }
    ...
    } catch (err) { this.error(`Action device_plug_energy_monitor_plug_smart_turn_on: ${err.message}`); }
    ...
    } catch (err) { this.error(`Action device_plug_energy_monitor_plug_smart_turn_off: ${err.message}`); }
    ...
    } catch (err) { this.error(`Action device_plug_energy_monitor_plug_smart_toggle: ${err.message}`); }
    ...
    } catch (err) { this.error(`Action device_plug_energy_monitor_plug_smart_turn_on_delay: ${err.message}`); }
    ...
    } catch (err) { this.error(`Action device_plug_energy_monitor_plug_smart_turn_off_delay: ${err.message}`); }
    ...
    try {
      ...
      if (card) {
        card.registerRunListener(async (args) => {
          ...
          this.log('[FLOW] Action device_plug_energy_monitor_plug_smart_set_indicator triggered for', args.device.getName());
          return true;
        });
      }
    } catch (err) { this.error(`Action device_plug_energy_monitor_plug_smart_set_indicator: ${err.message}`); }
    ...
    } catch (err) { this.error(`Action device_plug_energy_monitor_plug_smart_set_power_on: ${err.message}`); }
