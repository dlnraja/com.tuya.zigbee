...
class PirSensorPir1ZbDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('PIR Sensor PIR1-ZB has been initialized');
    }
    ...
    onDeleted() {
        this.log('PIR Sensor PIR1-ZB has been deleted');
    }
}

module.exports = PirSensorPir1ZbDevice;