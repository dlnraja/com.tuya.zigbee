...
class OneGangSwitchMoesDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('One Gang Switch- MOES has been initialized');
    }
    ...
    onDeleted() {
        this.log('One Gang Switch- MOES has been deleted');
    }
}

module.exports = OneGangSwitchMoesDevice;