...
class FingerprintLockBatteryDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('fingerprint_lock_battery initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('fingerprint_lock_battery');
  ...
  async onDeleted() {
    this.log('fingerprint_lock_battery deleted');
  }
  // ========================================
...
module.exports = FingerprintLockBatteryDevice;
