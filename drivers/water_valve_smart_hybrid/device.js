...
class WaterValveSmartHybridDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('water_valve_smart_hybrid initialized');
  ...
  async onDeleted() {
    this.log('water_valve_smart_hybrid deleted');
  }
  // ========================================
...
module.exports = WaterValveSmartHybridDevice;
