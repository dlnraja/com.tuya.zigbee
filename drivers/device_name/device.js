...
class DeviceNameDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Device name has been initialized');
    }
    ...
    onDeleted() {
        this.log('Device name has been deleted');
    }
}

module.exports = DeviceNameDevice;