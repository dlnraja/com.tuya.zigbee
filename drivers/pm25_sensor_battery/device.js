...
class Pm25SensorBatteryDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('pm25_sensor_battery initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('pm25_sensor_battery');
  ...
  async onDeleted() {
    this.log('pm25_sensor_battery deleted');
  }

}

module.exports = Pm25SensorBatteryDevice;
