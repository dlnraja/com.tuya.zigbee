...
class 18w15wTuyaZigbeeSmartHomeLedLampDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('18W 15W Tuya zigbee Smart Home Led Lamp has been initialized');
    }
    ...
    onDeleted() {
        this.log('18W 15W Tuya zigbee Smart Home Led Lamp has been deleted');
    }
}

module.exports = 18w15wTuyaZigbeeSmartHomeLedLampDevice;