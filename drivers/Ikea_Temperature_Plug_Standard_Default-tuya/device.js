...
module.exports = class Ikea_Temperature_Plug_Standard_DefaulttuyaDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔌 Ikea_Temperature_Plug_Standard_Default-tuya initialisé');
