...
class DeviceRequestCeillingHumanPresenceSensorDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Device Request -Ceilling Human Presence Sensor has been initialized');
    }
    ...
    onDeleted() {
        this.log('Device Request -Ceilling Human Presence Sensor has been deleted');
    }
}

module.exports = DeviceRequestCeillingHumanPresenceSensorDevice;