...
class GenericTuyaDevice extends AutoAdaptiveDevice {
  ...
  async _autoMapDP(dp, value, type) {
    ...
    try {
      ...
      (() => { try { return (() => { try { return (() => { try { return (() => { try { return this.homey.flow.getTriggerCard(`generic_tuya_${capability}_changed`); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })()?.trigger(this, {
