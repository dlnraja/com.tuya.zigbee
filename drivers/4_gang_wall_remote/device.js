...
class 4GangWallRemoteDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('4 Gang Wall Remote has been initialized');
    }
    ...
    onDeleted() {
        this.log('4 Gang Wall Remote has been deleted');
    }
}

module.exports = 4GangWallRemoteDevice;