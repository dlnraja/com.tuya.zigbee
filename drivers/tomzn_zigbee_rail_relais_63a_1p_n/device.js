...
class TomznZigbeeRailRelais63a1pNDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('TOMZN Zigbee Rail relais 63A 1P + N has been initialized');
    }
    ...
    onDeleted() {
        this.log('TOMZN Zigbee Rail relais 63A 1P + N has been deleted');
    }
}

module.exports = TomznZigbeeRailRelais63a1pNDevice;