...
class CoDetectorProBatteryDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('co_detector_pro_battery initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('co_detector_pro_battery');
  ...
  async onDeleted() {
    this.log('co_detector_pro_battery deleted');
  }

}

module.exports = CoDetectorProBatteryDevice;
