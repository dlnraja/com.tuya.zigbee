...
class OutdoorLightControllerAcDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('outdoor_light_controller_ac initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('outdoor_light_controller_ac');
  ...
  async onDeleted() {
    this.log('outdoor_light_controller_ac deleted');
  }
  // ========================================
...
module.exports = OutdoorLightControllerAcDevice;
