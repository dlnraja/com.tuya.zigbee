...
class OnesmartTuyaWifiZigbeeCurtainMotorDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Onesmart Tuya Wifi Zigbee Curtain Motor has been initialized');
    }
    ...
    onDeleted() {
        this.log('Onesmart Tuya Wifi Zigbee Curtain Motor has been deleted');
    }
}

module.exports = OnesmartTuyaWifiZigbeeCurtainMotorDevice;