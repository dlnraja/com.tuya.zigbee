...
class SymfoniskRemoteDevice extends ZigBeeDevice {

    async onNodeInit() {
        this.log('symfonisk_remote device initialized');
    ...
    async onDeleted() {
        this.log('symfonisk_remote device deleted');
    }

}

module.exports = SymfoniskRemoteDevice;
