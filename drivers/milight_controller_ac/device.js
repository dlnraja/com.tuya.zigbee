...
class MilightControllerAcDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('milight_controller_ac initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('milight_controller_ac');
  ...
  async onDeleted() {
    this.log('milight_controller_ac deleted');
  }
  // ========================================
...
module.exports = MilightControllerAcDevice;
