...
class SmartHome3GangZigbeeDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Smart Home 3 gang Zigbee has been initialized');
    }
    ...
    onDeleted() {
        this.log('Smart Home 3 gang Zigbee has been deleted');
    }
}

module.exports = SmartHome3GangZigbeeDevice;