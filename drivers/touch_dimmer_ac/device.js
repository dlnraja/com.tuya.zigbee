...
class TouchDimmerAcDevice extends ZigBeeDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('touch_dimmer_ac initialized');
    ...
    const deviceType = TuyaClusterHandler.detectDeviceType('touch_dimmer_ac');
...
// TODO: Consider debouncing capability updates for better performance
  ...
  async onDeleted() {
    this.log('touch_dimmer_ac deleted');
  }
  // ========================================
...
module.exports = TouchDimmerAcDevice;
