...
class DoorbellCr2032Device extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('doorbell_cr2032 initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('doorbell_cr2032');
  ...
  async onDeleted() {
    this.log('doorbell_cr2032 deleted');
  }

}

module.exports = DoorbellCr2032Device;
