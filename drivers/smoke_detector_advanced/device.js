...
/**
 * SmartSmokeDetectorAdvancedDevice - v5.3.58 AUTO-ADAPTIVE VERSION
 *
 ...
 */
class SmartSmokeDetectorAdvancedDevice extends AutoAdaptiveDevice {
  ...
  /**
   * Setup IAS Zone for Smoke detection (SDK3 Compliant)
   *
