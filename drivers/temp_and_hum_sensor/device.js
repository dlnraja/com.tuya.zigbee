...
class TempAndHumSensorDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Temp and Hum Sensor has been initialized');
    }
    ...
    onDeleted() {
        this.log('Temp and Hum Sensor has been deleted');
    }
}

module.exports = TempAndHumSensorDevice;