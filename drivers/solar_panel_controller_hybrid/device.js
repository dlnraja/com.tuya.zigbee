...
class SolarPanelControllerHybridDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('solar_panel_controller_hybrid initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('solar_panel_controller_hybrid');
  ...
  async onDeleted() {
    this.log('solar_panel_controller_hybrid deleted');
  }
  // ========================================
...
module.exports = SolarPanelControllerHybridDevice;
