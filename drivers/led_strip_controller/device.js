...
class LedStripControllerDevice extends ZigBeeDevice {

    async onNodeInit() {
        this.log('led_strip_controller device initialized');
    ...
    async onDeleted() {
        this.log('led_strip_controller device deleted');
    }

}

module.exports = LedStripControllerDevice;
