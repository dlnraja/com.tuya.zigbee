...
class Tuya2In1ZigbeeMiniPirMotionDetectorBrightDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Tuya 2 in 1 Zigbee Mini PIR Motion Detector +Bright Lux has been initialized');
    }
    ...
    onDeleted() {
        this.log('Tuya 2 in 1 Zigbee Mini PIR Motion Detector +Bright Lux has been deleted');
    }
}

module.exports = Tuya2In1ZigbeeMiniPirMotionDetectorBrightDevice;