  ...
  async handleTuyaDataReport(data) {
    ...
    if (data.dp === DP.state) {
      ...
      if (this._lastPm25 !== pm) {
        ...
        try {
          const card = (() => { try { return (() => { try { return this.homey.flow.getTriggerCard('air_purifier_motion_hybrid_air_purifier_pm25_changed'); } catch(e) { return null; } })(); } catch(e) { return null; } })();
