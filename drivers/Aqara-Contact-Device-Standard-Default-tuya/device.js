...
use
strict;const { ZigBeeDevice } = require(homey-zigbeedriver);class AqaraContactDeviceStandardDefaultTuyaDevice extends ZigBeeDevice {async onNodeInit({ zclNode }) {this.log(🔌
...
configuration
des
rapports:, error);}}parseBattery(value) {return Math.round(value / 2);}}module.exports = AqaraContactDeviceStandardDefaultTuyaDevice;