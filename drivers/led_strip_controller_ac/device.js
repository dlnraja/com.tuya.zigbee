...
class LedStripControllerAcDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('led_strip_controller_ac initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('led_strip_controller_ac');
  ...
  async onDeleted() {
    this.log('led_strip_controller_ac deleted');
  }

}

module.exports = LedStripControllerAcDevice;
