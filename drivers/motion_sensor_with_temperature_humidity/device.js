...
class MotionSensorWithTemperatureHumidityDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Motion sensor with Temperature & Humidity has been initialized');
    }
    ...
    onDeleted() {
        this.log('Motion sensor with Temperature & Humidity has been deleted');
    }
}

module.exports = MotionSensorWithTemperatureHumidityDevice;