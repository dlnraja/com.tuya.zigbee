...
class LonsonhoContactSensorDriver extends ZigBeeDriver {
  ...
  _registerFlowCards() {
    // TRIGGERS
    try { this.homey.flow.getTriggerCard('contact_sensor_opened'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('contact_sensor_closed'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('contact_sensor_tamper_true'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('contact_sensor_battery_changed'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('contact_sensor_battery_low'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('contact_sensor_left_open'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('contact_sensor_contact_alarm'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('contact_sensor_tamper_alarm'); } catch (e) {}
