...
/**
 * wall_touch_8gang - Hybrid-Enhanced Driver
 *
 ...
 */
class WallTouch8GangDevice extends HybridDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('[COLOR] WallTouch8Gang initializing...');
    ...
    this.log('[OK] WallTouch8Gang ready (SDK3)');
  }
