...
class ZigbeePirSensorWithLuxDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Zigbee PIR Sensor with lux has been initialized');
    }
    ...
    onDeleted() {
        this.log('Zigbee PIR Sensor with lux has been deleted');
    }
}

module.exports = ZigbeePirSensorWithLuxDevice;