...
class ZbbridgeAcDevice extends ZigBeeDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('zbbridge_ac initialized');
    ...
    const deviceType = TuyaClusterHandler.detectDeviceType('zbbridge_ac');
...
module.exports = ZbbridgeAcDevice;
