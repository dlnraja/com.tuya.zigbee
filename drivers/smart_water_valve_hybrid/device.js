...
class SmartWaterValveHybridDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('smart_water_valve_hybrid initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('smart_water_valve_hybrid');
  ...
  async onDeleted() {
    this.log('smart_water_valve_hybrid deleted');
  }

}

module.exports = SmartWaterValveHybridDevice;
