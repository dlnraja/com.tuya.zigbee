...
class TuyaThermostatsDriver extends TuyaDevice {
  async onInit() {
    await super.onInit();
    
    this.log('TuyaThermostatsDriver initialized');
  ...
  async onSettings({ oldSettings, newSettings, changedKeys }) {
    this.log('TuyaThermostatsDriver settings changed');
  }
...
module.exports = TuyaThermostatsDriver;