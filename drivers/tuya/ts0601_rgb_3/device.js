...
class ts0601rgb3Device extends ZigbeeDevice {
    async onMeshInit() {
        try {
            await super.onMeshInit();
            this.log('TS0601_rgb_3 initialized');
            ...
            try { this.registerCapability('light_saturation', 'genOnOff'); } catch (error) { this.log('Error registering capability light_saturation:', error); }
            try { this.registerCapability('light_brightness', 'genOnOff'); } catch (error) { this.log('Error registering capability light_brightness:', error); }
            
            // Add metadata
            this.setStoreValue('modelId', 'TS0601_rgb_3');
            this.setStoreValue('source', 'database_analysis');
            this.setStoreValue('createdAt', '2025-07-31T20:27:53.849Z');
...
module.exports = ts0601rgb3Device;