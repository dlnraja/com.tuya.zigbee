...
class ts0122Device extends ZigbeeDevice {
    async onMeshInit() {
        try {
            await super.onMeshInit();
            this.log('TS0122 initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'TS0122');
            this.setStoreValue('source', 'generic_pattern_analysis');
            this.setStoreValue('createdAt', '2025-07-31T20:27:54.009Z');
