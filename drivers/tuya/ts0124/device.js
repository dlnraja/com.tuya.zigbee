...
class ts0124Device extends ZigbeeDevice {
    async onMeshInit() {
        try {
            await super.onMeshInit();
            this.log('TS0124 initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'TS0124');
            this.setStoreValue('source', 'generic_pattern_analysis');
            this.setStoreValue('createdAt', '2025-07-31T20:27:54.024Z');
