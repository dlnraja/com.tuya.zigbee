...
class ts0601curtainDevice extends ZigbeeDevice {
    async onMeshInit() {
        try {
            await super.onMeshInit();
            this.log('TS0601curtain initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'TS0601curtain');
            this.setStoreValue('source', 'generic_pattern_analysis');
            this.setStoreValue('createdAt', '2025-07-31T20:27:53.956Z');
