...
class ts0601plug2Device extends ZigbeeDevice {
    async onMeshInit() {
        try {
            await super.onMeshInit();
            this.log('TS0601_plug_2 initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'TS0601_plug_2');
            this.setStoreValue('source', 'database_analysis');
            this.setStoreValue('createdAt', '2025-07-31T20:27:53.760Z');
...
module.exports = ts0601plug2Device;