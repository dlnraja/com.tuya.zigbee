...
class ts011jDevice extends ZigbeeDevice {
    async onMeshInit() {
        try {
            await super.onMeshInit();
            this.log('TS011J initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'TS011J');
            this.setStoreValue('source', 'generic_pattern_analysis');
            this.setStoreValue('createdAt', '2025-07-31T20:27:54.007Z');
