...
class ts0601motion3Device extends ZigbeeDevice {
    async onMeshInit() {
        try {
            await super.onMeshInit();
            this.log('TS0601_motion_3 initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'TS0601_motion_3');
            this.setStoreValue('source', 'database_analysis');
            this.setStoreValue('createdAt', '2025-07-31T20:27:53.858Z');
...
module.exports = ts0601motion3Device;