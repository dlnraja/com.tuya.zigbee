...
class ts0601plugDevice extends ZigbeeDevice {
    async onMeshInit() {
        try {
            await super.onMeshInit();
            this.log('TS0601_plug initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'TS0601_plug');
            this.setStoreValue('source', 'database_analysis');
            this.setStoreValue('createdAt', '2025-07-31T20:27:53.752Z');
...
module.exports = ts0601plugDevice;