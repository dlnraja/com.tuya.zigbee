...
class ts0125Device extends ZigbeeDevice {
    async onMeshInit() {
        try {
            await super.onMeshInit();
            this.log('TS0125 initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'TS0125');
            this.setStoreValue('source', 'generic_pattern_analysis');
            this.setStoreValue('createdAt', '2025-07-31T20:27:54.034Z');
