...
class TuyaGenericDriver extends TuyaDevice {
  async onInit() {
    await super.onInit();
    
    this.log('TuyaGenericDriver initialized');
  ...
  async onSettings({ oldSettings, newSettings, changedKeys }) {
    this.log('TuyaGenericDriver settings changed');
  }
...
module.exports = TuyaGenericDriver;