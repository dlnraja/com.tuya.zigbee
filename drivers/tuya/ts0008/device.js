...
class ts0008Device extends ZigbeeDevice {
    async onMeshInit() {
        try {
            await super.onMeshInit();
            this.log('TS0008 initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'TS0008');
            this.setStoreValue('source', 'generic_pattern_analysis');
            this.setStoreValue('createdAt', '2025-07-31T20:27:53.886Z');
