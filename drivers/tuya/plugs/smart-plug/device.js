...
class SmartPlugDevice extends TuyaDevice {
    async onInit() {
        ...
        this.log('smart-plug device initializing (optimized)...');
        ...
        this.setupPolling();
        this.log('SmartPlug device is initializing...');
    ...
    async initializeCapabilities() {
        ...
        this.log('Initializing capabilities for smart-plug');
    }
    ...
    async pollDevice() {
        try {
            ...
            this.log('Polling smart-plug device...');
        } catch (error) {
...
module.exports = SmartPlugDevice;
    ...
    async initializeTuyaLightFeatures() {
        this.log('Initializing Tuya-Light features for smart-plug');
    ...
    async enhancedPollDevice() {
        try {
            this.log('Enhanced polling smart-plug...');
    ...
    setupAutoFingerprint() {
        ...
        this.log('Auto-fingerprint enabled for smart-plug');
    }
    
    setupFallbackParsing() {
        // Enhanced fallback parsing for tuya-light
        this.fallbackParsing = true;
        this.log('Fallback parsing enabled for smart-plug');
    }
    
    fallbackPolling() {
        // Basic fallback polling
        this.log('Using fallback polling for smart-plug');
    }
