...
class tz3600plugDevice extends ZigbeeDevice {
    async onMeshInit() {
        try {
            await super.onMeshInit();
            this.log('_TZ3600_plug initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', '_TZ3600_plug');
            this.setStoreValue('source', 'database_analysis');
            this.setStoreValue('createdAt', '2025-07-31T20:27:53.825Z');
...
module.exports = tz3600plugDevice;