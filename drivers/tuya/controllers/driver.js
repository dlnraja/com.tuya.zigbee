...
class TuyaControllersDriver extends TuyaDevice {
  async onInit() {
    await super.onInit();
    
    this.log('TuyaControllersDriver initialized');
  ...
  async onSettings({ oldSettings, newSettings, changedKeys }) {
    this.log('TuyaControllersDriver settings changed');
  }
...
module.exports = TuyaControllersDriver;