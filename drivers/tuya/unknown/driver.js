...
class TuyaUnknownDriver extends TuyaDevice {
  async onInit() {
    await super.onInit();
    
    this.log('TuyaUnknownDriver initialized');
  ...
  async onSettings({ oldSettings, newSettings, changedKeys }) {
    this.log('TuyaUnknownDriver settings changed');
  }
...
module.exports = TuyaUnknownDriver;