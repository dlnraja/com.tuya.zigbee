...
class ts011iDevice extends ZigbeeDevice {
    async onMeshInit() {
        try {
            await super.onMeshInit();
            this.log('TS011I initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'TS011I');
            this.setStoreValue('source', 'generic_pattern_analysis');
            this.setStoreValue('createdAt', '2025-07-31T20:27:54.004Z');
