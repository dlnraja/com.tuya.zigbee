...
class ts011gDevice extends ZigbeeDevice {
    async onMeshInit() {
        try {
            await super.onMeshInit();
            this.log('TS011G initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'TS011G');
            this.setStoreValue('source', 'generic_pattern_analysis');
            this.setStoreValue('createdAt', '2025-07-31T20:27:53.988Z');
