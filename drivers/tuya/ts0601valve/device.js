...
class ts0601valveDevice extends ZigbeeDevice {
    async onMeshInit() {
        try {
            await super.onMeshInit();
            this.log('TS0601valve initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'TS0601valve');
            this.setStoreValue('source', 'generic_pattern_analysis');
            this.setStoreValue('createdAt', '2025-07-31T20:27:53.952Z');
