...
/**
 * SmartBulbTunableWhiteDevice - SDK Compliant Light Driver
 *
 ...
 */
class SmartBulbTunableWhiteDevice extends AutoAdaptiveDevice {

  async onNodeInit({ zclNode }) {
    this.log('SmartBulbTunableWhiteDevice initializing...');
    ...
    this.log('SmartBulbTunableWhiteDevice initialized - Power source:', this.powerSource || 'unknown');
  }
  ...
  async onDeleted() {
    this.log('SmartBulbTunableWhiteDevice deleted');
    await super.onDeleted().catch(err => this.error(err));
  }
}

module.exports = SmartBulbTunableWhiteDevice;
