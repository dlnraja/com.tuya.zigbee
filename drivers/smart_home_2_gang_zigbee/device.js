...
class SmartHome2GangZigbeeDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Smart Home 2 gang Zigbee has been initialized');
    }
    ...
    onDeleted() {
        this.log('Smart Home 2 gang Zigbee has been deleted');
    }
}

module.exports = SmartHome2GangZigbeeDevice;