...
class SmartKnobRotaryDevice extends ZigBeeDevice {
  ...
  async _triggerRotateLeft() {
    ...
    // Trigger flow card
    const rotateLeftTrigger = this.homey.flow.getDeviceTriggerCard('remote_button_wireless_hybrid_rotate_left');
  ...
  async _triggerRotateRight() {
    ...
    // Trigger flow card
    const rotateRightTrigger = this.homey.flow.getDeviceTriggerCard('remote_button_wireless_hybrid_rotate_right');
