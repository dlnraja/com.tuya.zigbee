...
class SmartBulbRgbDriver extends ZigBeeDriver {
  ...
  _registerFlowCards() {
    ...
    try {
      ...
      this.log('[FLOW] ✅ Registered: bulb_rgb_smart_bulb_rgb_is_on');
    ...
    try {
      ...
      this.log('[FLOW] ✅ Registered: bulb_rgb_smart_bulb_rgb_turn_on');
    } catch (err) { this.log(`[FLOW] ⚠️ ${err.message}`); }
    ...
    try {
      ...
      this.log('[FLOW] ✅ Registered: bulb_rgb_smart_bulb_rgb_turn_off');
    } catch (err) { this.log(`[FLOW] ⚠️ ${err.message}`); }
    ...
    try {
      ...
      this.log('[FLOW] ✅ Registered: bulb_rgb_smart_bulb_rgb_toggle');
    } catch (err) { this.log(`[FLOW] ⚠️ ${err.message}`); }
    ...
    try {
      ...
      this.log('[FLOW] ✅ Registered: bulb_rgb_smart_bulb_rgb_set_dim');
    } catch (err) { this.log(`[FLOW] ⚠️ ${err.message}`); }
  }
