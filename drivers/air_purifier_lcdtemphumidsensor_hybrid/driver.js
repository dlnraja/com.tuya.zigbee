...
class AirPurifierDriver extends ZigBeeDriver {
  ...
  async onInit() {
    ...
    try {
      (() => { try { return this.homey.flow.getDeviceActionCard('air_purifier_set_fan_speed'); } catch(e) { return null; } })()
    ...
    try {
      (() => { try { return this.homey.flow.getDeviceActionCard('air_purifier_turn_on'); } catch(e) { return null; } })()
        .registerRunListener(async (args) => {
          if (!args.device) return false;
    ...
    try {
      (() => { try { return this.homey.flow.getDeviceActionCard('air_purifier_turn_off'); } catch(e) { return null; } })()
        .registerRunListener(async (args) => {
          if (!args.device) return false;
    ...
    try {
      (() => { try { return this.homey.flow.getDeviceActionCard('air_purifier_toggle'); } catch(e) { return null; } })()
        .registerRunListener(async (args) => {
          if (!args.device) return false;
    ...
    try {
      (() => { try { return this.homey.flow.getDeviceActionCard('air_purifier_set_brightness'); } catch(e) { return null; } })()
        .registerRunListener(async (args) => {
          if (!args.device) return false;
