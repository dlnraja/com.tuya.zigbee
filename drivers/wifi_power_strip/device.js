...
class WiFiPowerStripDevice extends VirtualButtonMixin(PhysicalButtonMixin(TuyaLocalDevice)) {
  ...
  get dpMappings() {
    return {
      ...
      '9':  { capability: null }, // countdown_1
      '14': { capability: null }, // power-on behavior
