...
class LockSmartDriver extends ZigBeeDriver {
  ...
  _registerFlowCards() {
    // CONDITION: Is locked
    try {
      (() => { try { return this.homey.flow.getConditionCard('lock_smart_is_locked'); } catch(e) { return null; } })()?.registerRunListener(async (args) => {
    ...
    // ACTION: Lock
    try {
      (() => { try { return this.homey.flow.getActionCard('lock_smart_lock'); } catch(e) { return null; } })()?.registerRunListener(async (args) => {
          if (!args.device) return false;
    ...
    // ACTION: Unlock
    try {
      (() => { try { return this.homey.flow.getActionCard('lock_smart_unlock'); } catch(e) { return null; } })()?.registerRunListener(async (args) => {
          if (!args.device) return false;
