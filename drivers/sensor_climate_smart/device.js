...
class SmartScenePanelDevice extends TuyaZigbeeDevice {
  ...
  _handleDP(dp, value) {
    if (dp >= 24 && dp <= 27) {
      ...
      this.homey.flow.getTriggerCard('sensor_climate_smart_hybrid_climate_sensor_smart_hybrid_smart_scene_panel_scene_activated').trigger(this, { scene: String(dp) }, { scene: String(dp) }).catch(() => {})
    } else if (dp === 38) {
