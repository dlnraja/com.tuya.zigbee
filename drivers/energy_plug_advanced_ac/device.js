...
class EnergyPlugAdvancedAcDevice extends ZigBeeDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('energy_plug_advanced_ac initialized');
    ...
    const deviceType = TuyaClusterHandler.detectDeviceType('energy_plug_advanced_ac');
  ...
  async onDeleted() {
    this.log('energy_plug_advanced_ac deleted');
  }
  // ========================================
...
module.exports = EnergyPlugAdvancedAcDevice;
