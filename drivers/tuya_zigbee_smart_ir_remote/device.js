...
class TuyaZigbeeSmartIrRemoteDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('tuya zigbee smart IR-remote has been initialized');
    }
    ...
    onDeleted() {
        this.log('tuya zigbee smart IR-remote has been deleted');
    }
}

module.exports = TuyaZigbeeSmartIrRemoteDevice;