...
class ThermoHygrometerDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Thermo-Hygrometer has been initialized');
    }
    ...
    onDeleted() {
        this.log('Thermo-Hygrometer has been deleted');
    }
}

module.exports = ThermoHygrometerDevice;