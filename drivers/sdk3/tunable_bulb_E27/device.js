...
class Tunablebulbe27 extends TuyaZigBeeLightDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Tunablebulbe27 RGB Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Tunablebulbe27 RGB Enhanced deleted');
  }
