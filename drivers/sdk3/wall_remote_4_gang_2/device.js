...
class Wallremote4gang2 extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Wallremote4gang2 SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Wallremote4gang2 Enhanced deleted');
  }
...
module.exports = Wallremote4gang2;
