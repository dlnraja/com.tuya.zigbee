...
class Wallremote2gang extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Wallremote2gang SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Wallremote2gang Enhanced deleted');
  }
...
module.exports = Wallremote2gang;
