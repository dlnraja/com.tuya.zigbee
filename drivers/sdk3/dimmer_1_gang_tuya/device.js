...
class Dimmer1gangtuya extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Dimmer1gangtuya SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Dimmer1gangtuya Enhanced deleted');
  }
...
module.exports = Dimmer1gangtuya;
