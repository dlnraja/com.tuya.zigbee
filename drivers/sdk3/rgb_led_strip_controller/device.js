...
class Rgbledstripcontroller extends TuyaZigBeeLightDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Rgbledstripcontroller RGB Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Rgbledstripcontroller RGB Enhanced deleted');
  }
