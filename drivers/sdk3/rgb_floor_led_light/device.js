...
class Rgbfloorledlight extends TuyaZigBeeLightDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Rgbfloorledlight RGB Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Rgbfloorledlight RGB Enhanced deleted');
  }
...
module.exports = Rgbfloorledlight;
