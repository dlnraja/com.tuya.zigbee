...
class Handheldremote4buttons extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Handheldremote4buttons SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Handheldremote4buttons Enhanced deleted');
  }
