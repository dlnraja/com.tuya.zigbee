...
class Wallremote1gang extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Wallremote1gang SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Wallremote1gang Enhanced deleted');
  }
...
module.exports = Wallremote1gang;
