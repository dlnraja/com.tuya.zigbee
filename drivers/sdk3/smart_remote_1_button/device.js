...
class Smartremote1button extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Smartremote1button SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Smartremote1button Enhanced deleted');
  }
...
module.exports = Smartremote1button;
