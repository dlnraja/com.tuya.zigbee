...
class Rgbwallledlight extends TuyaZigBeeLightDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Rgbwallledlight RGB Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Rgbwallledlight RGB Enhanced deleted');
  }
...
module.exports = Rgbwallledlight;
