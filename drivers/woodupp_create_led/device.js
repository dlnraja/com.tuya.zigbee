...
class WooduppCreateLedDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('WoodUpp CREATE LED has been initialized');
    }
    ...
    onDeleted() {
        this.log('WoodUpp CREATE LED has been deleted');
    }
}

module.exports = WooduppCreateLedDevice;