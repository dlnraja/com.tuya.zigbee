...
class SmartHeaterDriver extends ZigBeeDriver {
  ...
  async onInit() {
    ...
    // v5.13.3: Condition handler
      (() => { try { return (() => { try { return this.homey.flow.getConditionCard('smart_heater_is_on'); } catch(e) { return null; } })(); } catch(e) { return null; } })();
      (() => { try { return (() => { try { return this.homey.flow.getActionCard('smart_heater_set_temperature'); } catch(e) { return null; } })(); } catch(e) { return null; } })();
