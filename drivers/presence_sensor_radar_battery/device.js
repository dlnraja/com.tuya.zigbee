...
class PresenceSensorRadarBatteryDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('presence_sensor_radar_battery initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('presence_sensor_radar_battery');
  ...
  async onDeleted() {
    this.log('presence_sensor_radar_battery deleted');
  }
  // ========================================
...
module.exports = PresenceSensorRadarBatteryDevice;
