...
class ClimateMonitorCr2032Device extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('climate_monitor_cr2032 initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('climate_monitor_cr2032');
  ...
  async onDeleted() {
    this.log('climate_monitor_cr2032 deleted');
  }

}

module.exports = ClimateMonitorCr2032Device;
