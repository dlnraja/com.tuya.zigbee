...
class MiniCurtainSwitchModuleDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Mini Curtain Switch Module has been initialized');
    }
    ...
    onDeleted() {
        this.log('Mini Curtain Switch Module has been deleted');
    }
}

module.exports = MiniCurtainSwitchModuleDevice;