...
class SmartSmokeDetectorAdvancedBatteryDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('smart_smoke_detector_advanced_battery initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('smart_smoke_detector_advanced_battery');
  ...
  async onDeleted() {
    this.log('smart_smoke_detector_advanced_battery deleted');
  }
  // ========================================
...
module.exports = SmartSmokeDetectorAdvancedBatteryDevice;
