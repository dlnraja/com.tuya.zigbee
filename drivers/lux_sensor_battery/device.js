...
class LuxSensorBatteryDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('lux_sensor_battery initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('lux_sensor_battery');
  ...
  async onDeleted() {
    this.log('lux_sensor_battery deleted');
  }

}

module.exports = LuxSensorBatteryDevice;
