...
class StripLightControllerDevice extends ZigBeeDevice {

    async onNodeInit() {
        this.log('strip_light_controller device initialized');
    ...
    async onDeleted() {
        this.log('strip_light_controller device deleted');
    }

}

module.exports = StripLightControllerDevice;
