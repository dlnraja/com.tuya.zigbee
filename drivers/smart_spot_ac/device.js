...
class SmartSpotAcDevice extends ZigBeeDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('smart_spot_ac initialized');
    ...
    const deviceType = TuyaClusterHandler.detectDeviceType('smart_spot_ac');
...
// TODO: Consider debouncing capability updates for better performance
  ...
  async onDeleted() {
    this.log('smart_spot_ac deleted');
  }
  // ========================================
...
module.exports = SmartSpotAcDevice;
