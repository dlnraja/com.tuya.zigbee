...
class SceneSwitch6Driver extends ZigBeeDriver {
  ...
  async onInit() {
    ...
    this._buttonPressedTrigger = this.homey.flow.getTriggerCard('scene_switch_6_button_pressed');
    this._buttonDoubleTrigger = this.homey.flow.getTriggerCard('scene_switch_6_button_double_press');
    this._buttonLongTrigger = this.homey.flow.getTriggerCard('scene_switch_6_button_long_press');
