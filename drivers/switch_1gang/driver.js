...
class TuyaZigbeeDriver extends ZigBeeDriver {
  ...
  _registerFlowCards() {
    // TRIGGERS
    try { this.homey.flow.getTriggerCard('switch_1gang_turned_on'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('switch_1gang_turned_off'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('switch_1gang_physical_on'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('switch_1gang_physical_off'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('switch_1gang_physical_single'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('switch_1gang_physical_double'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('switch_1gang_physical_long_press'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('switch_1gang_physical_triple'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('switch_1gang_battery_low'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('switch_1gang_power_changed'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('switch_1gang_gang1_scene'); } catch (e) {}
    ...
    // ACTIONS
    try {
      const card = this.homey.flow.getActionCard('switch_1gang_turn_on');
      if (card) {
        card.registerRunListener(async (args) => {
          if (!args.device) return false;
