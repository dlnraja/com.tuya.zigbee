...
/**
 * wall_touch_6gang - Hybrid-Enhanced Driver
 *
 ...
 */
class WallTouch6GangDevice extends HybridDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('[COLOR] WallTouch6Gang initializing...');
    ...
    this.log('[OK] WallTouch6Gang ready (SDK3)');
  }
