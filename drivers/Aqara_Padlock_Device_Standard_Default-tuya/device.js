...
module.exports = class Aqara_Padlock_Device_Standard_DefaulttuyaDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔌 Aqara_Padlock_Device_Standard_Default-tuya initialisé');
