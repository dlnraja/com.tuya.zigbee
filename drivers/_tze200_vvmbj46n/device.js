...
class Tze200Vvmbj46nDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('_TZE200_vvmbj46n has been initialized');
    }
    ...
    onDeleted() {
        this.log('_TZE200_vvmbj46n has been deleted');
    }
}

module.exports = Tze200Vvmbj46nDevice;