...
class PressureSensorBatteryDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('pressure_sensor_battery initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('pressure_sensor_battery');
  ...
  async onDeleted() {
    this.log('pressure_sensor_battery deleted');
  }
  // ========================================
...
module.exports = PressureSensorBatteryDevice;
