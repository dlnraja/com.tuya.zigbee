...
class PoolPumpControllerAcDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('pool_pump_controller_ac initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('pool_pump_controller_ac');
  ...
  async onDeleted() {
    this.log('pool_pump_controller_ac deleted');
  }
  // ========================================
...
module.exports = PoolPumpControllerAcDevice;
