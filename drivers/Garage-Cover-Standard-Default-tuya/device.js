...
use
strict;const { ZigBeeDevice } = require(homey-zigbeedriver);class GarageCoverStandardDefaultTuyaDevice extends ZigBeeDevice {async onNodeInit({ zclNode }) {this.log(🔌
...
configuration
des
rapports:, error);}}parseBattery(value) {return Math.round(value / 2);}}module.exports = GarageCoverStandardDefaultTuyaDevice;