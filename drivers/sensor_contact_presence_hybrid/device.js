...
class PresenceSensorRadarDevice extends UnifiedSensorBase {
  ...
  async _triggerPresenceFlows(detected) {
    try {
      ...
      await
      this._getFlowCard('sensor_contact_presence_hybrid_presence_detected').trigger(this, {}).catch(() => { })
      ...
      await
      this._getFlowCard('sensor_contact_presence_hybrid_presence_cleared').trigger(this, {}).catch(() => { })
