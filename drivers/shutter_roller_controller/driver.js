...
class RollerShutterControllerDriver extends ZigBeeDriver {
  ...
  _registerFlowCards() {
    // CONDITION: Is open
    try {
      (() => { try { return (() => { try { return this.homey.flow.getConditionCard('shutter_roller_controller_is_open'); } catch(e) { return null; } })(); } catch(e) { return null; } })()
    ...
    try {
      (() => { try { return (() => { try { return this.homey.flow.getConditionCard('shutter_roller_controller_position_above'); } catch(e) { return null; } })(); } catch(e) { return null; } })()
        .registerRunListener(async (args) => {
          if (!args.device) return false;
          const pos = args.device.getCapabilityValue('windowcoverings_set') || 0;
    ...
    // CONDITION: Is moving
    try {
      (() => { try { return (() => { try { return this.homey.flow.getConditionCard('shutter_roller_controller_is_moving'); } catch(e) { return null; } })(); } catch(e) { return null; } })()
        .registerRunListener(async (args) => {
          if (!args.device) return false;
    ...
    // ACTION: Open
    try {
      (() => { try { return (() => { try { return this.homey.flow.getActionCard('shutter_roller_controller_open'); } catch(e) { return null; } })(); } catch(e) { return null; } })()
        .registerRunListener(async (args) => {
          if (!args.device) return false;
    ...
    // ACTION: Close
    try {
      (() => { try { return (() => { try { return this.homey.flow.getActionCard('shutter_roller_controller_close'); } catch(e) { return null; } })(); } catch(e) { return null; } })()
        .registerRunListener(async (args) => {
          if (!args.device) return false;
    ...
    // ACTION: Stop
    try {
      (() => { try { return (() => { try { return this.homey.flow.getActionCard('shutter_roller_controller_stop'); } catch(e) { return null; } })(); } catch(e) { return null; } })()
        .registerRunListener(async (args) => {
          if (!args.device) return false;
    ...
    // ACTION: Set position
    try {
      (() => { try { return (() => { try { return this.homey.flow.getActionCard('shutter_roller_controller_set_position'); } catch(e) { return null; } })(); } catch(e) { return null; } })()
        .registerRunListener(async (args) => {
          if (!args.device) return false;
