...
class FormaldehydeSensorBatteryDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('formaldehyde_sensor_battery initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('formaldehyde_sensor_battery');
  ...
  async onDeleted() {
    this.log('formaldehyde_sensor_battery deleted');
  }
  // ========================================
...
module.exports = FormaldehydeSensorBatteryDevice;
