...
class TemperatureControllerHybridDevice extends ZigBeeDevice {
  ...
  async onDeleted() {
    this.log('temperature_controller_hybrid deleted');
  }
  // ========================================
...
module.exports = TemperatureControllerHybridDevice;
