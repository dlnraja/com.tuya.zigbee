...
// Enrichment Date: 2025-08-07T17:53:55.678Z

'use strict';

const { ZigBeeDevice } = require('homey-meshdriver');

class Rgb_led_stripDevice extends ZigBeeDevice {
    ...
    this.printNode();
        ...
        this.log('🚀 rgb_led_strip - Initialisation MEGA enrichie...');
        ...
        this.log('✅ rgb_led_strip - Initialisation MEGA terminée');
    }
...
module.exports = Rgb_led_stripDevice;