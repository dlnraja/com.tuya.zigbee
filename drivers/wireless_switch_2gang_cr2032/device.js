...
class WirelessSwitch_2gangBatteryDevice extends ZigBeeDevice {
    
    async onNodeInit() {
        this.log('wireless_switch_2gang_battery device initialized');
...
module.exports = WirelessSwitch_2gangBatteryDevice;