...
class ZigbeeSmartDimmerSwitchModuleTimerDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Zigbee Smart Dimmer Switch Module Timer has been initialized');
    }
    ...
    onDeleted() {
        this.log('Zigbee Smart Dimmer Switch Module Timer has been deleted');
    }
}

module.exports = ZigbeeSmartDimmerSwitchModuleTimerDevice;