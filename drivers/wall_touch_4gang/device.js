...
/**
 * wall_touch_4gang - Hybrid-Enhanced Driver
 *
 ...
 */
class WallTouch4GangDevice extends HybridDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('[COLOR] WallTouch4Gang initializing...');
    ...
    this.log('[OK] WallTouch4Gang ready (SDK3)');
  }
