...
class OutdoorPowerPlugDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Outdoor power plug has been initialized');
    }
    ...
    onDeleted() {
        this.log('Outdoor power plug has been deleted');
    }
}

module.exports = OutdoorPowerPlugDevice;