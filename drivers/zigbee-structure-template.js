/**
 * Structure Template pour Drivers Zigbee Tuya
...
class TuyaZigbeeDevice extends ZigbeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        // Capacités pour Zigbee
        await this.registerCapabilities();
        
        // Listeners pour Zigbee
    ...
    async registerListeners() {
        // Listeners pour Zigbee selon Homey SDK
    ...
    async setupPolling() {
        ...
        this.pollTimer = this.homey.setInterval(async () => {
            try {
                await this.poll();
                this.log('Polling Zigbee réussi');
            } catch (error) {
    ...
    // Callbacks pour Zigbee selon Homey SDK
    ...
    // Méthodes pour Zigbee selon Homey SDK
    ...
    // Utilitaires pour Zigbee selon Homey SDK
    getCapabilities() {
