...
class SmartBulbTunableAcDevice extends ZigBeeDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('smart_bulb_tunable_ac initialized');
    ...
    const deviceType = TuyaClusterHandler.detectDeviceType('smart_bulb_tunable_ac');
  ...
  async onDeleted() {
    this.log('smart_bulb_tunable_ac deleted');
  }
  // ========================================
...
module.exports = SmartBulbTunableAcDevice;
