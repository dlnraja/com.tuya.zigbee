...
class SmartSwitchWithPowerMonitorDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('[Smart Switch with Power Monitor] has been initialized');
    }
    ...
    onDeleted() {
        this.log('[Smart Switch with Power Monitor] has been deleted');
    }
}

module.exports = SmartSwitchWithPowerMonitorDevice;