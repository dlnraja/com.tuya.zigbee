...
class ZigbeeIntelligentCurtainMotorDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('ZigBee Intelligent curtain motor has been initialized');
    }
    ...
    onDeleted() {
        this.log('ZigBee Intelligent curtain motor has been deleted');
    }
}

module.exports = ZigbeeIntelligentCurtainMotorDevice;