...
class HvacControllerAcDevice extends ZigBeeDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('hvac_controller_ac initialized');
    ...
    const deviceType = TuyaClusterHandler.detectDeviceType('hvac_controller_ac');
  ...
  async onDeleted() {
    this.log('hvac_controller_ac deleted');
  }
  // ========================================
...
module.exports = HvacControllerAcDevice;
