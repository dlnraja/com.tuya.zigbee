...
class GarageDoorOpenerCr2032Device extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('garage_door_opener_cr2032 initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('garage_door_opener_cr2032');
  ...
  async onDeleted() {
    this.log('garage_door_opener_cr2032 deleted');
  }

}

module.exports = GarageDoorOpenerCr2032Device;
