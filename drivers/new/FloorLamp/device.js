...
class FloorLampDevice extends ZigBeeDevice {
    async onNodeInit() {
        // FloorLamp Device initialization
        this.homey.log('🚀 FloorLamp Device initialized');
    ...
    enableLocalMode() {
        this.homey.log('✅ FloorLamp Local Mode enabled');
        this.isLocalMode = true;
        this.apiEnabled = false;
    }
    
    async onSettings(oldSettings, newSettings, changedKeysArr) {
        this.homey.log('⚙️ FloorLamp settings updated');
    }
    
    async onDeleted() {
        this.homey.log('🗑️ FloorLamp device deleted');
    }
}
