...
class GenericLightDevice extends ZigBeeDevice {
    async onNodeInit() {
        // GenericLight Device initialization
        this.homey.log('🚀 GenericLight Device initialized');
    ...
    enableLocalMode() {
        this.homey.log('✅ GenericLight Local Mode enabled');
        this.isLocalMode = true;
        this.apiEnabled = false;
    }
    
    async onSettings(oldSettings, newSettings, changedKeysArr) {
        this.homey.log('⚙️ GenericLight settings updated');
    }
    
    async onDeleted() {
        this.homey.log('🗑️ GenericLight device deleted');
    }
}
