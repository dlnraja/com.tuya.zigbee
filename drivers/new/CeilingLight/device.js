...
class CeilingLightDevice extends ZigBeeDevice {
    async onNodeInit() {
        // CeilingLight Device initialization
        this.homey.log('🚀 CeilingLight Device initialized');
    ...
    enableLocalMode() {
        this.homey.log('✅ CeilingLight Local Mode enabled');
        this.isLocalMode = true;
        this.apiEnabled = false;
    }
    
    async onSettings(oldSettings, newSettings, changedKeysArr) {
        this.homey.log('⚙️ CeilingLight settings updated');
    }
    
    async onDeleted() {
        this.homey.log('🗑️ CeilingLight device deleted');
    }
}
