...
class DoorSensorDevice extends ZigBeeDevice {
    async onNodeInit() {
        // DoorSensor Device initialization
        this.homey.log('🚀 DoorSensor Device initialized');
    ...
    enableLocalMode() {
        this.homey.log('✅ DoorSensor Local Mode enabled');
        this.isLocalMode = true;
        this.apiEnabled = false;
    }
    
    async onSettings(oldSettings, newSettings, changedKeysArr) {
        this.homey.log('⚙️ DoorSensor settings updated');
    }
    
    async onDeleted() {
        this.homey.log('🗑️ DoorSensor device deleted');
    }
}
