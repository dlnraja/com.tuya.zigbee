/**
 * Device Tuya Zigbee - WaterLeakSensor
 * Catégorie: sensor
...
class WaterLeakSensorDevice extends ZigBeeDevice {
    async onNodeInit() {
        // WaterLeakSensor Device initialization
        this.homey.log('🚀 WaterLeakSensor Device initialized');
    ...
    enableLocalMode() {
        this.homey.log('✅ WaterLeakSensor Local Mode enabled');
        this.isLocalMode = true;
        this.apiEnabled = false;
    }
    
    async onSettings(oldSettings, newSettings, changedKeysArr) {
        this.homey.log('⚙️ WaterLeakSensor settings updated');
    }
    
    async onDeleted() {
        this.homey.log('🗑️ WaterLeakSensor device deleted');
    }
}
