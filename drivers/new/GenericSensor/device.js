...
class GenericSensorDevice extends ZigBeeDevice {
    async onNodeInit() {
        ...
        this.homey.log('🚀 GenericSensor Device initialized');
    ...
    enableLocalMode() {
        this.homey.log('✅ GenericSensor Local Mode enabled');
        this.isLocalMode = true;
        this.apiEnabled = false;
    }
    
    async onSettings(oldSettings, newSettings, changedKeysArr) {
        this.homey.log('⚙️ GenericSensor settings updated');
    }
    
    async onDeleted() {
        this.homey.log('🗑️ GenericSensor device deleted');
    }
}
