...
class SmartPlugDevice extends ZigBeeDevice {
    async onNodeInit() {
        // SmartPlug Device initialization
        this.homey.log('🚀 SmartPlug Device initialized');
    ...
    enableLocalMode() {
        this.homey.log('✅ SmartPlug Local Mode enabled');
        this.isLocalMode = true;
        this.apiEnabled = false;
    }
    
    async onSettings(oldSettings, newSettings, changedKeysArr) {
        this.homey.log('⚙️ SmartPlug settings updated');
    }
    
    async onDeleted() {
        this.homey.log('🗑️ SmartPlug device deleted');
    }
}
