...
class GenericVacuumDevice extends ZigBeeDevice {
    async onNodeInit() {
        // GenericVacuum Device initialization
        this.homey.log('🚀 GenericVacuum Device initialized');
    ...
    async detectCapabilities() {
        const deviceType = this.getData().deviceType || 'vacuum';
    ...
    enableLocalMode() {
        this.homey.log('✅ GenericVacuum Local Mode enabled');
        this.isLocalMode = true;
        this.apiEnabled = false;
    }
    
    async onSettings(oldSettings, newSettings, changedKeysArr) {
        this.homey.log('⚙️ GenericVacuum settings updated');
    }
    
    async onDeleted() {
        this.homey.log('🗑️ GenericVacuum device deleted');
    }
}

module.exports = GenericVacuumDevice;
