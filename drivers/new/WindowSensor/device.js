...
class WindowSensorDevice extends ZigBeeDevice {
    async onNodeInit() {
        // WindowSensor Device initialization
        this.homey.log('🚀 WindowSensor Device initialized');
    ...
    enableLocalMode() {
        this.homey.log('✅ WindowSensor Local Mode enabled');
        this.isLocalMode = true;
        this.apiEnabled = false;
    }
    
    async onSettings(oldSettings, newSettings, changedKeysArr) {
        this.homey.log('⚙️ WindowSensor settings updated');
    }
    
    async onDeleted() {
        this.homey.log('🗑️ WindowSensor device deleted');
    }
}

module.exports = WindowSensorDevice;
