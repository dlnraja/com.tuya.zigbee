...
class GenericAlarmDevice extends ZigBeeDevice {
    async onNodeInit() {
        // GenericAlarm Device initialization
        this.homey.log('🚀 GenericAlarm Device initialized');
    ...
    enableLocalMode() {
        this.homey.log('✅ GenericAlarm Local Mode enabled');
        this.isLocalMode = true;
        this.apiEnabled = false;
    }
    
    async onSettings(oldSettings, newSettings, changedKeysArr) {
        this.homey.log('⚙️ GenericAlarm settings updated');
    }
    
    async onDeleted() {
        this.homey.log('🗑️ GenericAlarm device deleted');
    }
}
