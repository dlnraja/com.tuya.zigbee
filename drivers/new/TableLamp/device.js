...
class TableLampDevice extends ZigBeeDevice {
    async onNodeInit() {
        // TableLamp Device initialization
        this.homey.log('🚀 TableLamp Device initialized');
    ...
    enableLocalMode() {
        this.homey.log('✅ TableLamp Local Mode enabled');
        this.isLocalMode = true;
        this.apiEnabled = false;
    }
    
    async onSettings(oldSettings, newSettings, changedKeysArr) {
        this.homey.log('⚙️ TableLamp settings updated');
    }
    
    async onDeleted() {
        this.homey.log('🗑️ TableLamp device deleted');
    }
}
