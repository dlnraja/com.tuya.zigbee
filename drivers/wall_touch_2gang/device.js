...
/**
 * wall_touch_2gang - Hybrid-Enhanced Driver
 *
 ...
 */
class WallTouch2GangDevice extends HybridDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('[COLOR] WallTouch2Gang initializing...');
    ...
    this.log('[OK] WallTouch2Gang ready (SDK3)');
  }
