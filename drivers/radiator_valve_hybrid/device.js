...
class RadiatorValveHybridDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('radiator_valve_hybrid initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('radiator_valve_hybrid');
  ...
  async onDeleted() {
    this.log('radiator_valve_hybrid deleted');
  }

}

module.exports = RadiatorValveHybridDevice;
