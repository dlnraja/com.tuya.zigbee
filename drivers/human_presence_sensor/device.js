...
class HumanPresenceSensorDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Human Presence Sensor has been initialized');
    }
    ...
    onDeleted() {
        this.log('Human Presence Sensor has been deleted');
    }
}

module.exports = HumanPresenceSensorDevice;