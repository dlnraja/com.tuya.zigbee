...
class TuyaZigbee2GangSwitchDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Tuya Zigbee 2 gang switch has been initialized');
    }
    ...
    onDeleted() {
        this.log('Tuya Zigbee 2 gang switch has been deleted');
    }
}

module.exports = TuyaZigbee2GangSwitchDevice;