...
class 2GangZigbeeDimmerDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('2 Gang Zigbee Dimmer has been initialized');
    }
    ...
    onDeleted() {
        this.log('2 Gang Zigbee Dimmer has been deleted');
    }
}

module.exports = 2GangZigbeeDimmerDevice;