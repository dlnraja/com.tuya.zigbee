...
class GasDetectorBatteryDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('gas_detector_battery initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('gas_detector_battery');
  ...
  async onDeleted() {
    this.log('gas_detector_battery deleted');
  }

}

module.exports = GasDetectorBatteryDevice;
