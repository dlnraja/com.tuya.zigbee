...
class Zigbee1GangDimmerDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Zigbee 1 gang dimmer has been initialized');
    }
    ...
    onDeleted() {
        this.log('Zigbee 1 gang dimmer has been deleted');
    }
}

module.exports = Zigbee1GangDimmerDevice;