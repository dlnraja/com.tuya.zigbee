...
class TvocSensorAdvancedBatteryDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('tvoc_sensor_advanced_battery initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('tvoc_sensor_advanced_battery');
  ...
  async onDeleted() {
    this.log('tvoc_sensor_advanced_battery deleted');
  }
  // ========================================
...
module.exports = TvocSensorAdvancedBatteryDevice;
