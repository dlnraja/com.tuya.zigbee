...
class SmartBulbRgbDriver extends ZigBeeDriver {
  ...
  _registerFlowCards() {
    // CONDITION: Is on/off
    try {
      (() => { try { return this.homey.flow.getConditionCard('bulb_rgb_smart_bulb_rgb_is_on'); } catch(e) { return null; } })()?.registerRunListener(async (args) => {
    ...
    // ACTION: Turn on
    try {
      (() => { try { return this.homey.flow.getActionCard('bulb_rgb_smart_bulb_rgb_turn_on'); } catch(e) { return null; } })()?.registerRunListener(async (args) => {
          if (!args.device) return false;
    ...
    // ACTION: Turn off
    try {
      (() => { try { return this.homey.flow.getActionCard('bulb_rgb_smart_bulb_rgb_turn_off'); } catch(e) { return null; } })()?.registerRunListener(async (args) => {
          if (!args.device) return false;
    ...
    // ACTION: Toggle
    try {
      (() => { try { return this.homey.flow.getActionCard('bulb_rgb_smart_bulb_rgb_toggle'); } catch(e) { return null; } })()?.registerRunListener(async (args) => {
          if (!args.device) return false;
    ...
    try {
      (() => { try { return this.homey.flow.getActionCard('bulb_rgb_smart_bulb_rgb_set_dim'); } catch(e) { return null; } })()?.registerRunListener(async (args) => {
          if (!args.device) return false;
