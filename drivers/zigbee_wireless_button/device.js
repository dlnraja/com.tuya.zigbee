...
class ZigbeeWirelessButtonDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Zigbee Wireless Button has been initialized');
    }
    ...
    onDeleted() {
        this.log('Zigbee Wireless Button has been deleted');
    }
}

module.exports = ZigbeeWirelessButtonDevice;