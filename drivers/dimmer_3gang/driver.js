...
class Dimmer3GangDriver extends ZigBeeDriver {
  async onInit() {
    ...
    try{this.homey.flow.getDeviceConditionCard('dimmer_3gang_is_on').registerRunListener(async({device})=>device.getCapabilityValue('onoff')===true);}catch(e){this.log('[Flow]',e.message);}
