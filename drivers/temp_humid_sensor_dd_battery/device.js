...
class TempHumidSensorDdBatteryDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('temp_humid_sensor_dd_battery initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('temp_humid_sensor_dd_battery');
  ...
  async onDeleted() {
    this.log('temp_humid_sensor_dd_battery deleted');
  }
  // ========================================
...
module.exports = TempHumidSensorDdBatteryDevice;
