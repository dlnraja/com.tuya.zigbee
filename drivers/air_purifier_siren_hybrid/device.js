...
// A8: NaN Safety - use safeDivide/safeMultiply
  const require('../../lib/TuyaSpecificCluster');
...
class sensortemphumidsensor extends TuyaSpecificClusterDevice {
  ...
  reportHumidityCapacity(measuredValue) {
    ...
    this._safeSetCapability('measure_humidity', parsedValue + humidityOffset).catch(this.error);
  }
  ...
  reportTemperatureCapacity(measuredValue) {
    ...
    this._safeSetCapability('measure_temperature', parsedValue + temperatureOffset).catch(this.error);
  }
  ...
  /*   reportBatteryPercentageCapacity(measuredValue) {
    ...
    this._safeSetCapability('measure_battery', parsedValue).catch(this.error);
  } */
