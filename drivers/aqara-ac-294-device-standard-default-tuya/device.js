...
use
strict;const { ZigBeeDevice } = require(homey-zigbeedriver);class AqaraAc294DeviceStandardDefaultTuyaDevice extends ZigBeeDevice {async onNodeInit({ zclNode }) {this.log(🔌
...
configuration
des
rapports:, error);}}parseBattery(value) {return Math.round(value / 2);}}module.exports = AqaraAc294DeviceStandardDefaultTuyaDevice;