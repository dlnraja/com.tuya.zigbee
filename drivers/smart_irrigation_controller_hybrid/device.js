...
class SmartIrrigationControllerHybridDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('smart_irrigation_controller_hybrid initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('smart_irrigation_controller_hybrid');
  ...
  async onDeleted() {
    this.log('smart_irrigation_controller_hybrid deleted');
  }

}

module.exports = SmartIrrigationControllerHybridDevice;
