...
class Co2TempHumidityCr2032Device extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('co2_temp_humidity_cr2032 initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('co2_temp_humidity_cr2032');
  ...
  async onDeleted() {
    this.log('co2_temp_humidity_cr2032 deleted');
  }
  // ========================================
...
module.exports = Co2TempHumidityCr2032Device;
