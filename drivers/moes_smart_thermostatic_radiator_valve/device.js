...
class MoesSmartThermostaticRadiatorValveDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('MOES Smart Thermostatic Radiator Valve has been initialized');
    }
    ...
    onDeleted() {
        this.log('MOES Smart Thermostatic Radiator Valve has been deleted');
    }
}

module.exports = MoesSmartThermostaticRadiatorValveDevice;