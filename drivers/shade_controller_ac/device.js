...
class ShadeControllerAcDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('shade_controller_ac initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('shade_controller_ac');
  ...
  async onDeleted() {
    this.log('shade_controller_ac deleted');
  }
  // ========================================
...
module.exports = ShadeControllerAcDevice;
