...
class TuyaPlugUniversalDevice extends ZigBeeDevice {
  
  async onMeshInit() {
    await super.onMeshInit();
    
    // Log device initialization
    this.log('🔌 socket Tuya Universal initialisé');
  ...
  setupFlowCards() {
    try {
      ...
      this.registerFlowCard('energy_consumption');
      this.registerFlowCard('overload_alert');
...
module.exports = TuyaPlugUniversalDevice;