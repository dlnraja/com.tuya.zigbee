...
class AvattoTuyaZigbeeEInkScreenTemperatureAndHuDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('AVATTO Tuya ZigBee E-ink Screen Temperature And Humidity Sensor has been initialized');
    }
    ...
    onDeleted() {
        this.log('AVATTO Tuya ZigBee E-ink Screen Temperature And Humidity Sensor has been deleted');
    }
}

module.exports = AvattoTuyaZigbeeEInkScreenTemperatureAndHuDevice;