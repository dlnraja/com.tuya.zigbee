...
class 3GangWallSwitchDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('3 Gang Wall Switch has been initialized');
    }
    ...
    onDeleted() {
        this.log('3 Gang Wall Switch has been deleted');
    }
}

module.exports = 3GangWallSwitchDevice;