...
/**
 * SmartBulbRgbwDevice - SDK Compliant Light Driver
 *
 ...
 */
class SmartBulbRgbwDevice extends AutoAdaptiveDevice {

  async onNodeInit({ zclNode }) {
    this.log('SmartBulbRgbwDevice initializing...');
    ...
    this.log('SmartBulbRgbwDevice initialized - Power source:', this.powerSource || 'unknown');
  }
  ...
  async onDeleted() {
    this.log('SmartBulbRgbwDevice deleted');
    await super.onDeleted().catch(err => this.error(err));
  }
}

module.exports = SmartBulbRgbwDevice;
