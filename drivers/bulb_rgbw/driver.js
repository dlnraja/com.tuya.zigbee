...
class BulbRgbwDriver extends ZigBeeDriver {
  ...
  _registerFlowCards() {
    // CONDITION: Is on/off
    try {
      (() => { try { return this.homey.flow.getDeviceConditionCard('bulb_rgbw_bulb_rgbw_is_on'); } catch(e) { return null; } })()
    ...
    // ACTION: Turn on
    try {
      (() => { try { return this.homey.flow.getDeviceActionCard('bulb_rgbw_bulb_rgbw_turn_on'); } catch(e) { return null; } })()
        .registerRunListener(async (args) => {
          if (!args.device) return false;
    ...
    // ACTION: Turn off
    try {
      (() => { try { return this.homey.flow.getDeviceActionCard('bulb_rgbw_bulb_rgbw_turn_off'); } catch(e) { return null; } })()
        .registerRunListener(async (args) => {
          if (!args.device) return false;
    ...
    // ACTION: Toggle
    try {
      (() => { try { return this.homey.flow.getDeviceActionCard('bulb_rgbw_bulb_rgbw_toggle'); } catch(e) { return null; } })()
        .registerRunListener(async (args) => {
          if (!args.device) return false;
