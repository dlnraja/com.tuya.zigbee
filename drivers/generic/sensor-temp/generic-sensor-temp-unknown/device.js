...
class SoilSensorDevice extends TuyaDevice {
    async onInit() {
        ...
        this.log('soil-sensor device initializing (optimized)...');
        ...
        this.setupPolling();
        this.log('Soil Sensor device is initializing...');
    ...
    async initializeTuyaLightFeatures() {
        this.log('Initializing Tuya-Light features for soil-sensor');
    ...
    async enhancedPollDevice() {
        try {
            this.log('Enhanced polling soil-sensor...');
    ...
    setupAutoFingerprint() {
        ...
        this.log('Auto-fingerprint enabled for soil-sensor');
    }
    
    setupFallbackParsing() {
        // Enhanced fallback parsing for tuya-light
        this.fallbackParsing = true;
        this.log('Fallback parsing enabled for soil-sensor');
    }
    
    fallbackPolling() {
        // Basic fallback polling
        this.log('Using fallback polling for soil-sensor');
    }
    
    async initializeCapabilities() {
        // Initialize device-specific capabilities
        this.log('Initializing capabilities for soil-sensor');
    }
    ...
    async pollDevice() {
        try {
            ...
            this.log('Polling soil-sensor device...');
        } catch (error) {
