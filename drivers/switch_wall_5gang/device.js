...
/**
 * ╔══════════════════════════════════════════════════════════════════════════════╗
 * ║      5-GANG SWITCH - v9.7.2 UNIVERSAL                                        ║
 * ╠══════════════════════════════════════════════════════════════════════════════╣
 ...
 * ╚══════════════════════════════════════════════════════════════════════════════╝
 */
class Switch5GangDevice extends PhysicalButtonMixin(BatteryMixin(VirtualButtonMixin(UnifiedSwitchBase))) {
  ...
  async onNodeInit({ zclNode }) {
    await this._safeInvoke(async () => {
      ...
      this.log('[SWITCH-5G] ✅ Universal initialization complete');
    }, 'onNodeInit');
  }
}
