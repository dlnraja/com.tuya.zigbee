...
class LedControllerRgbDriver extends ZigBeeDriver {
  ...
  async onInit() {
    ...
    try{this.homey.flow.getConditionCard('led_controller_rgb_is_on').registerRunListener(async({device})=>device.getCapabilityValue('onoff')===true);}catch(e){this.log('[Flow]',e.message);}
