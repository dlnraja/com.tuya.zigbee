...
class LedControllerRgbDriver extends ZigBeeDriver {
  ...
  async onInit() {
    ...
    // v5.13.3: Condition handler
      (() => { try { return (() => { try { return this.homey.flow.getConditionCard('led_controller_rgb_is_on'); } catch(e) { return null; } })(); } catch(e) { return null; } })();
      (() => { try { return (() => { try { return this.homey.flow.getActionCard('led_controller_rgb_set_brightness'); } catch(e) { return null; } })(); } catch(e) { return null; } })();
