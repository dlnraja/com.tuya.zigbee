...
class LedControllerCctDriver extends ZigBeeDriver {
  ...
  async onInit() {
    ...
    // v5.13.3: Condition handler
      (() => { try { return this.homey.flow.getDeviceConditionCard('led_controller_cct_is_on'); } catch(e) { return null; } })();
      (() => { try { return this.homey.flow.getDeviceActionCard('led_controller_cct_set_brightness'); } catch(e) { return null; } })();
