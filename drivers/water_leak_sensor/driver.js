...
class WaterLeakSensorDriver extends ZigBeeDriver {
  ...
  _registerFlowCards() {
    ...
    try {
      (() => { try { return this.homey.flow.getConditionCard('water_leak_sensor_water_detected'); } catch(e) { return null; } })()?.registerRunListener(async (args) => {
    ...
    try {
      (() => { try { return this.homey.flow.getConditionCard('water_leak_sensor_battery_above'); } catch(e) { return null; } })()?.registerRunListener(async (args) => {
          if (!args.device) return false;
