...
class CeilingLightRgbAcDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('ceiling_light_rgb_ac initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('ceiling_light_rgb_ac');
  ...
  async onDeleted() {
    this.log('ceiling_light_rgb_ac deleted');
  }

}

module.exports = CeilingLightRgbAcDevice;
