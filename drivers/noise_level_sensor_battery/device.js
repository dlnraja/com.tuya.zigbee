...
class NoiseLevelSensorBatteryDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('noise_level_sensor_battery initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('noise_level_sensor_battery');
  ...
  async onDeleted() {
    this.log('noise_level_sensor_battery deleted');
  }
  // ========================================
...
module.exports = NoiseLevelSensorBatteryDevice;
