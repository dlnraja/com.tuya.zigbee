...
class AirQualityMonitorAcDevice extends ZigBeeDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('air_quality_monitor_ac initialized');
    ...
    const deviceType = TuyaClusterHandler.detectDeviceType('air_quality_monitor_ac');
...
// TODO: Consider debouncing capability updates for better performance
  ...
  async onDeleted() {
    this.log('air_quality_monitor_ac deleted');
  }
  // ========================================
...
module.exports = AirQualityMonitorAcDevice;
