...
class MultisensorBatteryDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('multisensor_battery initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('multisensor_battery');
  ...
  async onDeleted() {
    this.log('multisensor_battery deleted');
  }

}

module.exports = MultisensorBatteryDevice;
