...
class FanTuyaUniversalDevice extends ZigBeeDevice {
  
  async onMeshInit() {
    await super.onMeshInit();
    
    // Log device initialization
    this.log('🔌 fan Tuya Universal initialisé');
  ...
  setupFlowCards() {
    try {
      ...
      this.registerFlowCard('fan_speed_up');
      this.registerFlowCard('fan_speed_down');
...
module.exports = FanTuyaUniversalDevice;