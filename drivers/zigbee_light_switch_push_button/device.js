...
class ZigbeeLightSwitchPushButtonDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Zigbee Light Switch Push Button has been initialized');
    }
    ...
    onDeleted() {
        this.log('Zigbee Light Switch Push Button has been deleted');
    }
}

module.exports = ZigbeeLightSwitchPushButtonDevice;