...
class IkeaGas-418PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaGas-418PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaGas-418PlugDevice supprimé');
    }
}

module.exports = IkeaGas-418PlugDevice;