...
class IkeaHumidity-288PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaHumidity-288PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaHumidity-288PlugDevice supprimé');
    }
}

module.exports = IkeaHumidity-288PlugDevice;