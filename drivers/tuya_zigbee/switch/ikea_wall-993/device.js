...
class IkeaWall-993Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaWall-993Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaWall-993Device supprimé');
    }
}

module.exports = IkeaWall-993Device;