...
class TuyaWall-10Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaWall-10Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaWall-10Device supprimé');
    }
}

module.exports = TuyaWall-10Device;