...
class AqaraSwitch-883PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraSwitch-883PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraSwitch-883PlugDevice supprimé');
    }
}

module.exports = AqaraSwitch-883PlugDevice;