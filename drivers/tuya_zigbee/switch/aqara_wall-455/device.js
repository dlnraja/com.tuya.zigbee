...
class AqaraWall-455Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraWall-455Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraWall-455Device supprimé');
    }
}

module.exports = AqaraWall-455Device;