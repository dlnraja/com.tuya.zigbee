...
class TuyaAcAcPlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaAcAcPlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaAcAcPlugDevice supprimé');
    }
}

module.exports = TuyaAcAcPlugDevice;