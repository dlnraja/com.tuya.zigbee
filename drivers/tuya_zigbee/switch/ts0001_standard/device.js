...
class Ts0001StandardDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts0001StandardDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts0001StandardDevice supprimé');
    }
}

module.exports = Ts0001StandardDevice;