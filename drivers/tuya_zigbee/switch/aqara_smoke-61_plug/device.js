...
class AqaraSmoke-61PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraSmoke-61PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraSmoke-61PlugDevice supprimé');
    }
}

module.exports = AqaraSmoke-61PlugDevice;