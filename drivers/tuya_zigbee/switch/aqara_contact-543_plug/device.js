...
class AqaraContact-543PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraContact-543PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraContact-543PlugDevice supprimé');
    }
}

module.exports = AqaraContact-543PlugDevice;