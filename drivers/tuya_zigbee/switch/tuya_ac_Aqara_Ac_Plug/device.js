...
class TuyaAcAqaraAcPlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaAcAqaraAcPlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaAcAqaraAcPlugDevice supprimé');
    }
}

module.exports = TuyaAcAqaraAcPlugDevice;