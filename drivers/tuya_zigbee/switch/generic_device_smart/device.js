...
class GenericDeviceSmartDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 GenericDeviceSmartDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  GenericDeviceSmartDevice supprimé');
    }
}

module.exports = GenericDeviceSmartDevice;