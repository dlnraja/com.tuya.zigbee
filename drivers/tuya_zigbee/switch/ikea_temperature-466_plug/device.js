...
class IkeaTemperature-466PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaTemperature-466PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaTemperature-466PlugDevice supprimé');
    }
}

module.exports = IkeaTemperature-466PlugDevice;