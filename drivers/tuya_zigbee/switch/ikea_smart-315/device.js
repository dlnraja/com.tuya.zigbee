...
class IkeaSmart-315Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaSmart-315Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaSmart-315Device supprimé');
    }
}

module.exports = IkeaSmart-315Device;