...
class AqaraMotion-800PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraMotion-800PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraMotion-800PlugDevice supprimé');
    }
}

module.exports = AqaraMotion-800PlugDevice;