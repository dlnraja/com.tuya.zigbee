...
class TuyaOutlet-791Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaOutlet-791Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaOutlet-791Device supprimé');
    }
}

module.exports = TuyaOutlet-791Device;