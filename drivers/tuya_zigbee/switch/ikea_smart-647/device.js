...
class IkeaSmart-647Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaSmart-647Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaSmart-647Device supprimé');
    }
}

module.exports = IkeaSmart-647Device;