...
class AqaraTemperature-666PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraTemperature-666PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraTemperature-666PlugDevice supprimé');
    }
}

module.exports = AqaraTemperature-666PlugDevice;