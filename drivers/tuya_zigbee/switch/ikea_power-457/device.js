...
class IkeaPower-457Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaPower-457Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaPower-457Device supprimé');
    }
}

module.exports = IkeaPower-457Device;