...
class TuyaAcIkeaAcPlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaAcIkeaAcPlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaAcIkeaAcPlugDevice supprimé');
    }
}

module.exports = TuyaAcIkeaAcPlugDevice;