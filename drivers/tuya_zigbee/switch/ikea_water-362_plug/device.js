...
class IkeaWater-362PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaWater-362PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaWater-362PlugDevice supprimé');
    }
}

module.exports = IkeaWater-362PlugDevice;