...
class TuyaPower-50Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaPower-50Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaPower-50Device supprimé');
    }
}

module.exports = TuyaPower-50Device;