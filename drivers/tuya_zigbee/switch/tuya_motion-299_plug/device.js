...
class TuyaMotion-299PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaMotion-299PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaMotion-299PlugDevice supprimé');
    }
}

module.exports = TuyaMotion-299PlugDevice;