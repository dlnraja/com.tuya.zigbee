...
class Ts011fStandardDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts011fStandardDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts011fStandardDevice supprimé');
    }
}

module.exports = Ts011fStandardDevice;