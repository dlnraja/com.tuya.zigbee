...
class TuyaGas-320PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaGas-320PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaGas-320PlugDevice supprimé');
    }
}

module.exports = TuyaGas-320PlugDevice;