...
class TuyaAc-322PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaAc-322PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaAc-322PlugDevice supprimé');
    }
}

module.exports = TuyaAc-322PlugDevice;