...
class Ts0003StandardDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts0003StandardDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts0003StandardDevice supprimé');
    }
}

module.exports = Ts0003StandardDevice;