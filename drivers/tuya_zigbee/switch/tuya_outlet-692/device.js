...
class TuyaOutlet-692Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaOutlet-692Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaOutlet-692Device supprimé');
    }
}

module.exports = TuyaOutlet-692Device;