...
class TuyaHeater-0PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaHeater-0PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaHeater-0PlugDevice supprimé');
    }
}

module.exports = TuyaHeater-0PlugDevice;