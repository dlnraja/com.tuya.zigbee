...
class Ts0601PresencePlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts0601PresencePlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts0601PresencePlugDevice supprimé');
    }
}

module.exports = Ts0601PresencePlugDevice;