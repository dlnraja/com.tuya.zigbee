...
class TuyaAcAcPlugStandardDefaultDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaAcAcPlugStandardDefaultDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaAcAcPlugStandardDefaultDevice supprimé');
    }
}

module.exports = TuyaAcAcPlugStandardDefaultDevice;