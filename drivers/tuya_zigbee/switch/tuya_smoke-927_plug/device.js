...
class TuyaSmoke-927PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaSmoke-927PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaSmoke-927PlugDevice supprimé');
    }
}

module.exports = TuyaSmoke-927PlugDevice;