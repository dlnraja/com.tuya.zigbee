...
class IkeaMotion-927PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaMotion-927PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaMotion-927PlugDevice supprimé');
    }
}

module.exports = IkeaMotion-927PlugDevice;