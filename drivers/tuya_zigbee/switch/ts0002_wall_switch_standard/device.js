...
class Ts0002WallSwitchStandardDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts0002WallSwitchStandardDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts0002WallSwitchStandardDevice supprimé');
    }
}

module.exports = Ts0002WallSwitchStandardDevice;