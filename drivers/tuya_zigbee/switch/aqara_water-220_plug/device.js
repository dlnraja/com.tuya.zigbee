...
class AqaraWater-220PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraWater-220PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraWater-220PlugDevice supprimé');
    }
}

module.exports = AqaraWater-220PlugDevice;