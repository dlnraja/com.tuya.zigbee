...
class TuyaWall-287Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaWall-287Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaWall-287Device supprimé');
    }
}

module.exports = TuyaWall-287Device;