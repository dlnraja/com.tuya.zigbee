...
class TuyaWater-581PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaWater-581PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaWater-581PlugDevice supprimé');
    }
}

module.exports = TuyaWater-581PlugDevice;