...
class AqaraHumidity-794PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraHumidity-794PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraHumidity-794PlugDevice supprimé');
    }
}

module.exports = AqaraHumidity-794PlugDevice;