...
class TuyaSmart-181Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaSmart-181Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaSmart-181Device supprimé');
    }
}

module.exports = TuyaSmart-181Device;