...
class TuyaFan-730PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaFan-730PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaFan-730PlugDevice supprimé');
    }
}

module.exports = TuyaFan-730PlugDevice;