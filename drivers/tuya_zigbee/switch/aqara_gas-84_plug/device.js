...
class AqaraGas-84PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraGas-84PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraGas-84PlugDevice supprimé');
    }
}

module.exports = AqaraGas-84PlugDevice;