...
class IkeaContact-348PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaContact-348PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaContact-348PlugDevice supprimé');
    }
}

module.exports = IkeaContact-348PlugDevice;