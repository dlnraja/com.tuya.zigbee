...
class TuyaPower-890Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaPower-890Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaPower-890Device supprimé');
    }
}

module.exports = TuyaPower-890Device;