...
class AqaraSwitch-457PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraSwitch-457PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraSwitch-457PlugDevice supprimé');
    }
}

module.exports = AqaraSwitch-457PlugDevice;