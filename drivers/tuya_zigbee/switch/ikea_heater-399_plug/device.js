...
class IkeaHeater-399PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaHeater-399PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaHeater-399PlugDevice supprimé');
    }
}

module.exports = IkeaHeater-399PlugDevice;