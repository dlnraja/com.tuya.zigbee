...
class AqaraGas-474PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraGas-474PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraGas-474PlugDevice supprimé');
    }
}

module.exports = AqaraGas-474PlugDevice;