...
class IkeaWall-697Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaWall-697Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaWall-697Device supprimé');
    }
}

module.exports = IkeaWall-697Device;