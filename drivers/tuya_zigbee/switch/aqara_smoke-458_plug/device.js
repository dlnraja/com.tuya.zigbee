...
class AqaraSmoke-458PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraSmoke-458PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraSmoke-458PlugDevice supprimé');
    }
}

module.exports = AqaraSmoke-458PlugDevice;