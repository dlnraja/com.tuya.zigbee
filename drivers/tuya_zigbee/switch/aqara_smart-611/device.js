...
class AqaraSmart-611Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraSmart-611Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraSmart-611Device supprimé');
    }
}

module.exports = AqaraSmart-611Device;