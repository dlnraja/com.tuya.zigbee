...
class IkeaPower-769Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaPower-769Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaPower-769Device supprimé');
    }
}

module.exports = IkeaPower-769Device;