...
class AqaraFan-459PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraFan-459PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraFan-459PlugDevice supprimé');
    }
}

module.exports = AqaraFan-459PlugDevice;