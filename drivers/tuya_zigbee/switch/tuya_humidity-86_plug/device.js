...
class TuyaHumidity-86PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaHumidity-86PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaHumidity-86PlugDevice supprimé');
    }
}

module.exports = TuyaHumidity-86PlugDevice;