...
class IkeaOutlet-132Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaOutlet-132Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaOutlet-132Device supprimé');
    }
}

module.exports = IkeaOutlet-132Device;