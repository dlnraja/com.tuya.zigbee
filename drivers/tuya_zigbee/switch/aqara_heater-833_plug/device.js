...
class AqaraHeater-833PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraHeater-833PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraHeater-833PlugDevice supprimé');
    }
}

module.exports = AqaraHeater-833PlugDevice;