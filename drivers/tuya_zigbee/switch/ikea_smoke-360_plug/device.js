...
class IkeaSmoke-360PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaSmoke-360PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaSmoke-360PlugDevice supprimé');
    }
}

module.exports = IkeaSmoke-360PlugDevice;