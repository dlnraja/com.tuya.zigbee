...
class AqaraOutlet-425Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraOutlet-425Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraOutlet-425Device supprimé');
    }
}

module.exports = AqaraOutlet-425Device;