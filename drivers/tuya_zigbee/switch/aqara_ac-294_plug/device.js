...
class AqaraAc-294PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraAc-294PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraAc-294PlugDevice supprimé');
    }
}

module.exports = AqaraAc-294PlugDevice;