...
class AqaraFan-281PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraFan-281PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraFan-281PlugDevice supprimé');
    }
}

module.exports = AqaraFan-281PlugDevice;