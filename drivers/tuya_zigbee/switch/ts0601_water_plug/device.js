...
class Ts0601WaterPlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts0601WaterPlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts0601WaterPlugDevice supprimé');
    }
}

module.exports = Ts0601WaterPlugDevice;