...
class IkeaSwitch-612PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaSwitch-612PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaSwitch-612PlugDevice supprimé');
    }
}

module.exports = IkeaSwitch-612PlugDevice;