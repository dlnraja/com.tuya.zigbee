...
class AqaraOutlet-197Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraOutlet-197Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraOutlet-197Device supprimé');
    }
}

module.exports = AqaraOutlet-197Device;