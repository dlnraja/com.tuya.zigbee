...
class TuyaWater-264PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaWater-264PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaWater-264PlugDevice supprimé');
    }
}

module.exports = TuyaWater-264PlugDevice;