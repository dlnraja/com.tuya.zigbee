...
class IkeaFan-208PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaFan-208PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaFan-208PlugDevice supprimé');
    }
}

module.exports = IkeaFan-208PlugDevice;