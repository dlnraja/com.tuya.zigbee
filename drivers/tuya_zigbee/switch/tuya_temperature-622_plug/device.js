...
class TuyaTemperature-622PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaTemperature-622PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaTemperature-622PlugDevice supprimé');
    }
}

module.exports = TuyaTemperature-622PlugDevice;