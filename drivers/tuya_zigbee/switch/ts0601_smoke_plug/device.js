...
class Ts0601SmokePlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts0601SmokePlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts0601SmokePlugDevice supprimé');
    }
}

module.exports = Ts0601SmokePlugDevice;