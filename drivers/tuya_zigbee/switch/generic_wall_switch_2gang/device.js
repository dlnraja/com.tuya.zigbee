...
class GenericWallSwitch2gangDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 GenericWallSwitch2gangDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  GenericWallSwitch2gangDevice supprimé');
    }
}

module.exports = GenericWallSwitch2gangDevice;