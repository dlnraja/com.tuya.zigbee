...
class TuyaContact-202PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaContact-202PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaContact-202PlugDevice supprimé');
    }
}

module.exports = TuyaContact-202PlugDevice;