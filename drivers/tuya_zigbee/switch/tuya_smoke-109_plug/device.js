...
class TuyaSmoke-109PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaSmoke-109PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaSmoke-109PlugDevice supprimé');
    }
}

module.exports = TuyaSmoke-109PlugDevice;