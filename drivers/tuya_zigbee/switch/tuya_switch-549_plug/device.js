...
class TuyaSwitch-549PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaSwitch-549PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaSwitch-549PlugDevice supprimé');
    }
}

module.exports = TuyaSwitch-549PlugDevice;