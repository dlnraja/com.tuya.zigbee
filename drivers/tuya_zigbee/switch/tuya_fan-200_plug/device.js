...
class TuyaFan-200PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaFan-200PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaFan-200PlugDevice supprimé');
    }
}

module.exports = TuyaFan-200PlugDevice;