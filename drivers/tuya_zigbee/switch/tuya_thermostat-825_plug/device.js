...
class TuyaThermostat-825PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaThermostat-825PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaThermostat-825PlugDevice supprimé');
    }
}

module.exports = TuyaThermostat-825PlugDevice;