...
class IkeaHeater-896PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaHeater-896PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaHeater-896PlugDevice supprimé');
    }
}

module.exports = IkeaHeater-896PlugDevice;