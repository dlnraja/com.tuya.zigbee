...
class AqaraWater-237PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraWater-237PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraWater-237PlugDevice supprimé');
    }
}

module.exports = AqaraWater-237PlugDevice;