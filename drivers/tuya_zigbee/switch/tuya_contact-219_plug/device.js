...
class TuyaContact-219PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaContact-219PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaContact-219PlugDevice supprimé');
    }
}

module.exports = TuyaContact-219PlugDevice;