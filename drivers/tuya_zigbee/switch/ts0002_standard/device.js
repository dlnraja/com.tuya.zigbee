...
class Ts0002StandardDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts0002StandardDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts0002StandardDevice supprimé');
    }
}

module.exports = Ts0002StandardDevice;