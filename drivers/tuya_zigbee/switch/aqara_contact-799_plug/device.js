...
class AqaraContact-799PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraContact-799PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraContact-799PlugDevice supprimé');
    }
}

module.exports = AqaraContact-799PlugDevice;