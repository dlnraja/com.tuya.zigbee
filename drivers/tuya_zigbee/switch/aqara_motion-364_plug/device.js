...
class AqaraMotion-364PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraMotion-364PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraMotion-364PlugDevice supprimé');
    }
}

module.exports = AqaraMotion-364PlugDevice;