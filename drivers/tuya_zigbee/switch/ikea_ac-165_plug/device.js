...
class IkeaAc-165PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaAc-165PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaAc-165PlugDevice supprimé');
    }
}

module.exports = IkeaAc-165PlugDevice;