...
class TuyaMotion-362PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaMotion-362PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaMotion-362PlugDevice supprimé');
    }
}

module.exports = TuyaMotion-362PlugDevice;