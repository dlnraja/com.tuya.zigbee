...
class IkeaSwitch-783PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaSwitch-783PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaSwitch-783PlugDevice supprimé');
    }
}

module.exports = IkeaSwitch-783PlugDevice;