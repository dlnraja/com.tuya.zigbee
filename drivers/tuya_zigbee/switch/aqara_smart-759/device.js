...
class AqaraSmart-759Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraSmart-759Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraSmart-759Device supprimé');
    }
}

module.exports = AqaraSmart-759Device;