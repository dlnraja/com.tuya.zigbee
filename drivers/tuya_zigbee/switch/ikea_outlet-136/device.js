...
class IkeaOutlet-136Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaOutlet-136Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaOutlet-136Device supprimé');
    }
}

module.exports = IkeaOutlet-136Device;