...
class GenericWallSwitch1gangDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 GenericWallSwitch1gangDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  GenericWallSwitch1gangDevice supprimé');
    }
}

module.exports = GenericWallSwitch1gangDevice;