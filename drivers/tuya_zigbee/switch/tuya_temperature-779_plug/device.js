...
class TuyaTemperature-779PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaTemperature-779PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaTemperature-779PlugDevice supprimé');
    }
}

module.exports = TuyaTemperature-779PlugDevice;