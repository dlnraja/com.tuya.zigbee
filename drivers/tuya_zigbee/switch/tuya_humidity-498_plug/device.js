...
class TuyaHumidity-498PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaHumidity-498PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaHumidity-498PlugDevice supprimé');
    }
}

module.exports = TuyaHumidity-498PlugDevice;