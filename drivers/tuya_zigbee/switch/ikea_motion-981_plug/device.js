...
class IkeaMotion-981PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaMotion-981PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaMotion-981PlugDevice supprimé');
    }
}

module.exports = IkeaMotion-981PlugDevice;