...
class TuyaThermostat-435PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaThermostat-435PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaThermostat-435PlugDevice supprimé');
    }
}

module.exports = TuyaThermostat-435PlugDevice;