...
class IkeaWater-667PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaWater-667PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaWater-667PlugDevice supprimé');
    }
}

module.exports = IkeaWater-667PlugDevice;