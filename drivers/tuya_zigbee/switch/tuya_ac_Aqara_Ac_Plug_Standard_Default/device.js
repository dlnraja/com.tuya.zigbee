...
class TuyaAcAqaraAcPlugStandardDefaultDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaAcAqaraAcPlugStandardDefaultDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaAcAqaraAcPlugStandardDefaultDevice supprimé');
    }
}

module.exports = TuyaAcAqaraAcPlugStandardDefaultDevice;