...
class TuyaGas-695PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaGas-695PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaGas-695PlugDevice supprimé');
    }
}

module.exports = TuyaGas-695PlugDevice;