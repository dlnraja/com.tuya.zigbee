...
class AqaraHumidity-617PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraHumidity-617PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraHumidity-617PlugDevice supprimé');
    }
}

module.exports = AqaraHumidity-617PlugDevice;