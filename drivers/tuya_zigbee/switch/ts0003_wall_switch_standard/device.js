...
class Ts0003WallSwitchStandardDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts0003WallSwitchStandardDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts0003WallSwitchStandardDevice supprimé');
    }
}

module.exports = Ts0003WallSwitchStandardDevice;