...
class IkeaThermostat-128PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaThermostat-128PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaThermostat-128PlugDevice supprimé');
    }
}

module.exports = IkeaThermostat-128PlugDevice;