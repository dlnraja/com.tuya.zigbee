...
class IkeaGas-317PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaGas-317PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaGas-317PlugDevice supprimé');
    }
}

module.exports = IkeaGas-317PlugDevice;