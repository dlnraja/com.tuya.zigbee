...
class AqaraThermostat-831PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraThermostat-831PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraThermostat-831PlugDevice supprimé');
    }
}

module.exports = AqaraThermostat-831PlugDevice;