...
class AqaraThermostat-115PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraThermostat-115PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraThermostat-115PlugDevice supprimé');
    }
}

module.exports = AqaraThermostat-115PlugDevice;