...
class TuyaHeater-387PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaHeater-387PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaHeater-387PlugDevice supprimé');
    }
}

module.exports = TuyaHeater-387PlugDevice;