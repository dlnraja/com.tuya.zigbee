...
class GenericSmartPlugEmDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 GenericSmartPlugEmDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  GenericSmartPlugEmDevice supprimé');
    }
}

module.exports = GenericSmartPlugEmDevice;