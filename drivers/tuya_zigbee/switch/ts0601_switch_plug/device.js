...
class Ts0601SwitchPlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts0601SwitchPlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts0601SwitchPlugDevice supprimé');
    }
}

module.exports = Ts0601SwitchPlugDevice;