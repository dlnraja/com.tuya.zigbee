...
class TuyaSwitch-225PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaSwitch-225PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaSwitch-225PlugDevice supprimé');
    }
}

module.exports = TuyaSwitch-225PlugDevice;