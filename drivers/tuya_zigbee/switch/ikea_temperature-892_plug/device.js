...
class IkeaTemperature-892PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaTemperature-892PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaTemperature-892PlugDevice supprimé');
    }
}

module.exports = IkeaTemperature-892PlugDevice;