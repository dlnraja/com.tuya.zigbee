...
class Ts011fSmartPlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts011fSmartPlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts011fSmartPlugDevice supprimé');
    }
}

module.exports = Ts011fSmartPlugDevice;