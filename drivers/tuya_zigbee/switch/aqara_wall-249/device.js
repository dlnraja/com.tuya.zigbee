...
class AqaraWall-249Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraWall-249Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraWall-249Device supprimé');
    }
}

module.exports = AqaraWall-249Device;