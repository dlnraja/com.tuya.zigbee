...
class IkeaSmoke-94PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaSmoke-94PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaSmoke-94PlugDevice supprimé');
    }
}

module.exports = IkeaSmoke-94PlugDevice;