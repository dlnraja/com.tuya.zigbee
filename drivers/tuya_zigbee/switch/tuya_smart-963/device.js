...
class TuyaSmart-963Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaSmart-963Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaSmart-963Device supprimé');
    }
}

module.exports = TuyaSmart-963Device;