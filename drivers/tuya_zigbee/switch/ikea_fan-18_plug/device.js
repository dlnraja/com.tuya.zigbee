...
class IkeaFan-18PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaFan-18PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaFan-18PlugDevice supprimé');
    }
}

module.exports = IkeaFan-18PlugDevice;