...
class AqaraPower-317Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraPower-317Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraPower-317Device supprimé');
    }
}

module.exports = AqaraPower-317Device;