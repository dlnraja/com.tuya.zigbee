...
class Ts0601GasPlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts0601GasPlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts0601GasPlugDevice supprimé');
    }
}

module.exports = Ts0601GasPlugDevice;