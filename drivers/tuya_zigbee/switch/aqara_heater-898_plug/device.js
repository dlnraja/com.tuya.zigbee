...
class AqaraHeater-898PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraHeater-898PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraHeater-898PlugDevice supprimé');
    }
}

module.exports = AqaraHeater-898PlugDevice;