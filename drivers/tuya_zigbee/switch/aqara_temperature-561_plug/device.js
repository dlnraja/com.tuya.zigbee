...
class AqaraTemperature-561PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraTemperature-561PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraTemperature-561PlugDevice supprimé');
    }
}

module.exports = AqaraTemperature-561PlugDevice;