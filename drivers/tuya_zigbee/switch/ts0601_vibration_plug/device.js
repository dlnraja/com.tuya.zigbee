...
class Ts0601VibrationPlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts0601VibrationPlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts0601VibrationPlugDevice supprimé');
    }
}

module.exports = Ts0601VibrationPlugDevice;