...
class IkeaThermostat-39PlugDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaThermostat-39PlugDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaThermostat-39PlugDevice supprimé');
    }
}

module.exports = IkeaThermostat-39PlugDevice;