...
class AqaraPower-551Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraPower-551Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraPower-551Device supprimé');
    }
}

module.exports = AqaraPower-551Device;