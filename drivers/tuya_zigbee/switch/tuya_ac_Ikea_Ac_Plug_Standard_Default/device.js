...
class TuyaAcIkeaAcPlugStandardDefaultDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaAcIkeaAcPlugStandardDefaultDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaAcIkeaAcPlugStandardDefaultDevice supprimé');
    }
}

module.exports = TuyaAcIkeaAcPlugStandardDefaultDevice;