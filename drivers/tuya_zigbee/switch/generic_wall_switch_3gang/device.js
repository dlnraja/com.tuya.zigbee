...
class GenericWallSwitch3gangDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 GenericWallSwitch3gangDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  GenericWallSwitch3gangDevice supprimé');
    }
}

module.exports = GenericWallSwitch3gangDevice;