...
class TuyaFloor269Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaFloor269Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaFloor269Device supprimé');
    }
}

module.exports = TuyaFloor269Device;