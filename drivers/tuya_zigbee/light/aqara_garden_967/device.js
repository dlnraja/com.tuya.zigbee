...
class AqaraGarden967Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraGarden967Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraGarden967Device supprimé');
    }
}

module.exports = AqaraGarden967Device;