...
class TuyaStrip423Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaStrip423Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaStrip423Device supprimé');
    }
}

module.exports = TuyaStrip423Device;