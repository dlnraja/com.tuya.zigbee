...
class IkeaCeiling940Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaCeiling940Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaCeiling940Device supprimé');
    }
}

module.exports = IkeaCeiling940Device;