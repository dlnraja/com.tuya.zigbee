...
class AqaraBulb130Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraBulb130Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraBulb130Device supprimé');
    }
}

module.exports = AqaraBulb130Device;