...
class IkeaBulb793Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaBulb793Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaBulb793Device supprimé');
    }
}

module.exports = IkeaBulb793Device;