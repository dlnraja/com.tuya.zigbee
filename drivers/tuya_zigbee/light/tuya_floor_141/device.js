...
class TuyaFloor141Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaFloor141Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaFloor141Device supprimé');
    }
}

module.exports = TuyaFloor141Device;