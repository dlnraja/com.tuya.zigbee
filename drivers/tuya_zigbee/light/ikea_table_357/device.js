...
class IkeaTable357Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaTable357Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaTable357Device supprimé');
    }
}

module.exports = IkeaTable357Device;