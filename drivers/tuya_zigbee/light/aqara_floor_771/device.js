...
class AqaraFloor771Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraFloor771Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraFloor771Device supprimé');
    }
}

module.exports = AqaraFloor771Device;