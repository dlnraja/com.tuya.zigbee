...
class Ts130fBulbE27Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts130fBulbE27Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts130fBulbE27Device supprimé');
    }
}

module.exports = Ts130fBulbE27Device;