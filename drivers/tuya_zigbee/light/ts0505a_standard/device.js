...
class Ts0505aStandardDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts0505aStandardDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts0505aStandardDevice supprimé');
    }
}

module.exports = Ts0505aStandardDevice;