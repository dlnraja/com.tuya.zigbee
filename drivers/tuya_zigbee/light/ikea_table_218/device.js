...
class IkeaTable218Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaTable218Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaTable218Device supprimé');
    }
}

module.exports = IkeaTable218Device;