...
class IkeaFloor238Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaFloor238Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaFloor238Device supprimé');
    }
}

module.exports = IkeaFloor238Device;