...
class Ts0505cBulbE27Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts0505cBulbE27Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts0505cBulbE27Device supprimé');
    }
}

module.exports = Ts0505cBulbE27Device;