...
class TuyaCeiling282Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaCeiling282Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaCeiling282Device supprimé');
    }
}

module.exports = TuyaCeiling282Device;