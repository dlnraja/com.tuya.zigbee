...
class Ts0505bBulbE27Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts0505bBulbE27Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts0505bBulbE27Device supprimé');
    }
}

module.exports = Ts0505bBulbE27Device;