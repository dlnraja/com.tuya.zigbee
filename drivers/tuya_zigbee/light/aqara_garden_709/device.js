...
class AqaraGarden709Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraGarden709Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraGarden709Device supprimé');
    }
}

module.exports = AqaraGarden709Device;