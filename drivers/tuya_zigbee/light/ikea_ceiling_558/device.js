...
class IkeaCeiling558Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaCeiling558Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaCeiling558Device supprimé');
    }
}

module.exports = IkeaCeiling558Device;