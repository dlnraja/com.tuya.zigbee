...
class Ts0505cStandardDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts0505cStandardDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts0505cStandardDevice supprimé');
    }
}

module.exports = Ts0505cStandardDevice;