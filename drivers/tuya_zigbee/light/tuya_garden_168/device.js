...
class TuyaGarden168Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaGarden168Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaGarden168Device supprimé');
    }
}

module.exports = TuyaGarden168Device;