...
class AqaraCeiling372Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraCeiling372Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraCeiling372Device supprimé');
    }
}

module.exports = AqaraCeiling372Device;