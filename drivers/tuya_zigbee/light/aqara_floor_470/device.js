...
class AqaraFloor470Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraFloor470Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraFloor470Device supprimé');
    }
}

module.exports = AqaraFloor470Device;