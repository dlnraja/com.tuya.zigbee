...
class AqaraCeiling655Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraCeiling655Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraCeiling655Device supprimé');
    }
}

module.exports = AqaraCeiling655Device;