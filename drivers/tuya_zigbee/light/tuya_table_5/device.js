...
class TuyaTable5Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaTable5Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaTable5Device supprimé');
    }
}

module.exports = TuyaTable5Device;