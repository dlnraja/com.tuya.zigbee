...
class TuyaBulb211Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaBulb211Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaBulb211Device supprimé');
    }
}

module.exports = TuyaBulb211Device;