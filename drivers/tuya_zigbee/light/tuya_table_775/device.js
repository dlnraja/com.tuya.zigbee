...
class TuyaTable775Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaTable775Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaTable775Device supprimé');
    }
}

module.exports = TuyaTable775Device;