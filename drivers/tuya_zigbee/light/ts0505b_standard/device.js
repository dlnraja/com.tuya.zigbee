...
class Ts0505bStandardDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts0505bStandardDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts0505bStandardDevice supprimé');
    }
}

module.exports = Ts0505bStandardDevice;