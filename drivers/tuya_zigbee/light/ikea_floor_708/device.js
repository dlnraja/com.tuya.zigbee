...
class IkeaFloor708Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaFloor708Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaFloor708Device supprimé');
    }
}

module.exports = IkeaFloor708Device;