...
class Ts0505aBulbE27Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts0505aBulbE27Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts0505aBulbE27Device supprimé');
    }
}

module.exports = Ts0505aBulbE27Device;