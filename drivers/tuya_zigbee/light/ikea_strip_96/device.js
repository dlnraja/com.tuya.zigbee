...
class IkeaStrip96Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaStrip96Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaStrip96Device supprimé');
    }
}

module.exports = IkeaStrip96Device;