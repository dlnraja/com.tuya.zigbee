...
class TuyaGarden409Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaGarden409Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaGarden409Device supprimé');
    }
}

module.exports = TuyaGarden409Device;