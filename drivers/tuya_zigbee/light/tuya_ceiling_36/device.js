...
class TuyaCeiling36Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaCeiling36Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaCeiling36Device supprimé');
    }
}

module.exports = TuyaCeiling36Device;