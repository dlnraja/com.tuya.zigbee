...
class Ts0505aDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts0505aDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts0505aDevice supprimé');
    }
}

module.exports = Ts0505aDevice;