...
class GenericDeviceBulbStandardDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 GenericDeviceBulbStandardDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  GenericDeviceBulbStandardDevice supprimé');
    }
}

module.exports = GenericDeviceBulbStandardDevice;