...
class Ts0505bDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts0505bDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts0505bDevice supprimé');
    }
}

module.exports = Ts0505bDevice;