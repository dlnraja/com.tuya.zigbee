...
class AqaraDeadbolt-642Lock extends ZigBeeDevice {
    ...
    async registerCapabilitiesIntelligently(zclNode) {
        try {
            ...
            const fallback = this.genericFallbacks.get('lock') || this.genericFallbacks.get('light');
...
module.exports = AqaraDeadbolt-642Lock;
