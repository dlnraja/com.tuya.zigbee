...
class AqaraSmoke-458 extends ZigBeeDevice {
    ...
    async registerCapabilitiesIntelligently(zclNode) {
        try {
            ...
            const fallback = this.genericFallbacks.get('sensor-smoke') || this.genericFallbacks.get('light');
