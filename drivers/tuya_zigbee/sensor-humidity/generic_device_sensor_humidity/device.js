...
class GenericDeviceSensorHumidity extends ZigBeeDevice {
    ...
    async registerCapabilitiesIntelligently(zclNode) {
        try {
            ...
            const fallback = this.genericFallbacks.get('sensor-humidity') || this.genericFallbacks.get('light');
...
module.exports = GenericDeviceSensorHumidity;
