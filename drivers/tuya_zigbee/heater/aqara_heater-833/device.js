...
class AqaraHeater-833 extends ZigBeeDevice {
    ...
    async registerCapabilitiesIntelligently(zclNode) {
        try {
            ...
            const fallback = this.genericFallbacks.get('heater') || this.genericFallbacks.get('light');
...
module.exports = AqaraHeater-833;
