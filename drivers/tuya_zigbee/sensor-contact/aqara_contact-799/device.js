...
class AqaraContact-799 extends ZigBeeDevice {
    ...
    async registerCapabilitiesIntelligently(zclNode) {
        try {
            ...
            const fallback = this.genericFallbacks.get('sensor-contact') || this.genericFallbacks.get('light');
...
module.exports = AqaraContact-799;
