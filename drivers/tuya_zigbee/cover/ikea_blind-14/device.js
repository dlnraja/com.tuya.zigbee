...
class IkeaBlind-14Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaBlind-14Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaBlind-14Device supprimé');
    }
}

module.exports = IkeaBlind-14Device;