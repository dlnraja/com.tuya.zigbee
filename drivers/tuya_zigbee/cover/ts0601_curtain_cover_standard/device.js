...
class Ts0601CurtainCoverStandardDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts0601CurtainCoverStandardDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts0601CurtainCoverStandardDevice supprimé');
    }
}

module.exports = Ts0601CurtainCoverStandardDevice;