...
class IkeaShade-837Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaShade-837Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaShade-837Device supprimé');
    }
}

module.exports = IkeaShade-837Device;