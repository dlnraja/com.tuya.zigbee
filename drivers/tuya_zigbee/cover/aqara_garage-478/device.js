...
class AqaraGarage-478Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraGarage-478Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraGarage-478Device supprimé');
    }
}

module.exports = AqaraGarage-478Device;