...
class TuyaBlind-531CoverDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaBlind-531CoverDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaBlind-531CoverDevice supprimé');
    }
}

module.exports = TuyaBlind-531CoverDevice;