...
class IkeaGarage-4Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaGarage-4Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaGarage-4Device supprimé');
    }
}

module.exports = IkeaGarage-4Device;