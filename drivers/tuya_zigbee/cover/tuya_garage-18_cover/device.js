...
class TuyaGarage-18CoverDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaGarage-18CoverDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaGarage-18CoverDevice supprimé');
    }
}

module.exports = TuyaGarage-18CoverDevice;