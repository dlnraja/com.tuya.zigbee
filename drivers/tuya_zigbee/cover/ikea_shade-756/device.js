...
class IkeaShade-756Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaShade-756Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaShade-756Device supprimé');
    }
}

module.exports = IkeaShade-756Device;