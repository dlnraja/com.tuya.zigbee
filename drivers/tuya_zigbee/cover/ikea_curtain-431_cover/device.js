...
class IkeaCurtain-431CoverDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaCurtain-431CoverDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaCurtain-431CoverDevice supprimé');
    }
}

module.exports = IkeaCurtain-431CoverDevice;