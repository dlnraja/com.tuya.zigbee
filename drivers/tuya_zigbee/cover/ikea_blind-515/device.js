...
class IkeaBlind-515Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaBlind-515Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaBlind-515Device supprimé');
    }
}

module.exports = IkeaBlind-515Device;