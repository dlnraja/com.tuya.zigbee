...
class Ts130fStandardDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts130fStandardDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts130fStandardDevice supprimé');
    }
}

module.exports = Ts130fStandardDevice;