...
class TuyaShade-647CoverDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaShade-647CoverDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaShade-647CoverDevice supprimé');
    }
}

module.exports = TuyaShade-647CoverDevice;