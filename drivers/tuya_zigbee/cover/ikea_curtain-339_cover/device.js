...
class IkeaCurtain-339CoverDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaCurtain-339CoverDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaCurtain-339CoverDevice supprimé');
    }
}

module.exports = IkeaCurtain-339CoverDevice;