...
class Ts130fCoverDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts130fCoverDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts130fCoverDevice supprimé');
    }
}

module.exports = Ts130fCoverDevice;