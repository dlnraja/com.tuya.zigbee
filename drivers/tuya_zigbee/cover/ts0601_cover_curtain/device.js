...
class Ts0601CoverCurtainDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts0601CoverCurtainDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts0601CoverCurtainDevice supprimé');
    }
}

module.exports = Ts0601CoverCurtainDevice;