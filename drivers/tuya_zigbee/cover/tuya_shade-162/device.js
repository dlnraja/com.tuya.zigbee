...
class TuyaShade-162Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaShade-162Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaShade-162Device supprimé');
    }
}

module.exports = TuyaShade-162Device;