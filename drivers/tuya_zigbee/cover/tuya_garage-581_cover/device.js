...
class TuyaGarage-581CoverDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaGarage-581CoverDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaGarage-581CoverDevice supprimé');
    }
}

module.exports = TuyaGarage-581CoverDevice;