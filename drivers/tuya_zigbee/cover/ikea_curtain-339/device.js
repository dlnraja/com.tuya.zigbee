...
class IkeaCurtain-339Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaCurtain-339Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaCurtain-339Device supprimé');
    }
}

module.exports = IkeaCurtain-339Device;