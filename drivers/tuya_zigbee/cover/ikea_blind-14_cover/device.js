...
class IkeaBlind-14CoverDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaBlind-14CoverDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaBlind-14CoverDevice supprimé');
    }
}

module.exports = IkeaBlind-14CoverDevice;