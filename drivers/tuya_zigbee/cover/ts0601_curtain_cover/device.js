...
class Ts0601CurtainCoverDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts0601CurtainCoverDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts0601CurtainCoverDevice supprimé');
    }
}

module.exports = Ts0601CurtainCoverDevice;