...
class TuyaCurtain-601CoverDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaCurtain-601CoverDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaCurtain-601CoverDevice supprimé');
    }
}

module.exports = TuyaCurtain-601CoverDevice;