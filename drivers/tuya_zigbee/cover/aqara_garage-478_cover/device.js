...
class AqaraGarage-478CoverDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraGarage-478CoverDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraGarage-478CoverDevice supprimé');
    }
}

module.exports = AqaraGarage-478CoverDevice;