...
class AqaraCurtain-550Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraCurtain-550Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraCurtain-550Device supprimé');
    }
}

module.exports = AqaraCurtain-550Device;