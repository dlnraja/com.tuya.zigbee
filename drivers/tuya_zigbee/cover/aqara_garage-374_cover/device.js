...
class AqaraGarage-374CoverDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraGarage-374CoverDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraGarage-374CoverDevice supprimé');
    }
}

module.exports = AqaraGarage-374CoverDevice;