...
class IkeaShade-756CoverDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaShade-756CoverDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaShade-756CoverDevice supprimé');
    }
}

module.exports = IkeaShade-756CoverDevice;