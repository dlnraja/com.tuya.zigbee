...
class TuyaBlind-205Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaBlind-205Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaBlind-205Device supprimé');
    }
}

module.exports = TuyaBlind-205Device;