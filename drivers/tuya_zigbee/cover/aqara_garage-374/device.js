...
class AqaraGarage-374Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraGarage-374Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraGarage-374Device supprimé');
    }
}

module.exports = AqaraGarage-374Device;