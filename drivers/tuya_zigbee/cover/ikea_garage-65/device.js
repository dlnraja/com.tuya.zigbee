...
class IkeaGarage-65Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaGarage-65Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaGarage-65Device supprimé');
    }
}

module.exports = IkeaGarage-65Device;