...
class AqaraCurtain-550CoverDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraCurtain-550CoverDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraCurtain-550CoverDevice supprimé');
    }
}

module.exports = AqaraCurtain-550CoverDevice;