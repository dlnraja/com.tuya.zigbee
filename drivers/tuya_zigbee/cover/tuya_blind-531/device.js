...
class TuyaBlind-531Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaBlind-531Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaBlind-531Device supprimé');
    }
}

module.exports = TuyaBlind-531Device;