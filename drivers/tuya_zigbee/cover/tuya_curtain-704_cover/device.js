...
class TuyaCurtain-704CoverDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaCurtain-704CoverDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaCurtain-704CoverDevice supprimé');
    }
}

module.exports = TuyaCurtain-704CoverDevice;