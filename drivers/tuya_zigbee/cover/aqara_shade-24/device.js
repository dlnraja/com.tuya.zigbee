...
class AqaraShade-24Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraShade-24Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraShade-24Device supprimé');
    }
}

module.exports = AqaraShade-24Device;