...
class AqaraShade-549Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraShade-549Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraShade-549Device supprimé');
    }
}

module.exports = AqaraShade-549Device;