...
class AqaraBlind-824Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraBlind-824Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraBlind-824Device supprimé');
    }
}

module.exports = AqaraBlind-824Device;