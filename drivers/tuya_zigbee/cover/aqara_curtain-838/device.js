...
class AqaraCurtain-838Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraCurtain-838Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraCurtain-838Device supprimé');
    }
}

module.exports = AqaraCurtain-838Device;