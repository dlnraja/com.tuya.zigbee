...
class IkeaShade-837CoverDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaShade-837CoverDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaShade-837CoverDevice supprimé');
    }
}

module.exports = IkeaShade-837CoverDevice;