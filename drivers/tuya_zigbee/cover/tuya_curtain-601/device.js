...
class TuyaCurtain-601Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaCurtain-601Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaCurtain-601Device supprimé');
    }
}

module.exports = TuyaCurtain-601Device;