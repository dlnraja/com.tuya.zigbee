...
class IkeaBlind-515CoverDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaBlind-515CoverDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaBlind-515CoverDevice supprimé');
    }
}

module.exports = IkeaBlind-515CoverDevice;