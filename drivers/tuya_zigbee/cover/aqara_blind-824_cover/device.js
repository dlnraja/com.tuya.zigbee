...
class AqaraBlind-824CoverDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraBlind-824CoverDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraBlind-824CoverDevice supprimé');
    }
}

module.exports = AqaraBlind-824CoverDevice;