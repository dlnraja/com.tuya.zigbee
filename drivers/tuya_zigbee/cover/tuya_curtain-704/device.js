...
class TuyaCurtain-704Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaCurtain-704Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaCurtain-704Device supprimé');
    }
}

module.exports = TuyaCurtain-704Device;