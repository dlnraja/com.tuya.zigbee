...
class TuyaGarage-18Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaGarage-18Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaGarage-18Device supprimé');
    }
}

module.exports = TuyaGarage-18Device;