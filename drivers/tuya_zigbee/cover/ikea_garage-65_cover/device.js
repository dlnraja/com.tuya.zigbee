...
class IkeaGarage-65CoverDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaGarage-65CoverDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaGarage-65CoverDevice supprimé');
    }
}

module.exports = IkeaGarage-65CoverDevice;