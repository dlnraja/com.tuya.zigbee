...
class AqaraShade-24CoverDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraShade-24CoverDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraShade-24CoverDevice supprimé');
    }
}

module.exports = AqaraShade-24CoverDevice;