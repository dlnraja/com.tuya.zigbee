...
class TuyaGarage-581Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaGarage-581Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaGarage-581Device supprimé');
    }
}

module.exports = TuyaGarage-581Device;