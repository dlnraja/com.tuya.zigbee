...
class AqaraShade-549CoverDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraShade-549CoverDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraShade-549CoverDevice supprimé');
    }
}

module.exports = AqaraShade-549CoverDevice;