...
class TuyaAcAqaraAcDeviceStandardDefault extends ZigBeeDevice {
    ...
    async registerCapabilitiesIntelligently(zclNode) {
        try {
            ...
            const fallback = this.genericFallbacks.get('ac') || this.genericFallbacks.get('light');
...
module.exports = TuyaAcAqaraAcDeviceStandardDefault;
