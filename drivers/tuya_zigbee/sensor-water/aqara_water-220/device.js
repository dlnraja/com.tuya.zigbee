...
class AqaraWater-220 extends ZigBeeDevice {
    ...
    async registerCapabilitiesIntelligently(zclNode) {
        try {
            ...
            const fallback = this.genericFallbacks.get('sensor-water') || this.genericFallbacks.get('light');
