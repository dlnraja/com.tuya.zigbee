...
class TuyaZigbeeDoorwindowSensorAliexpressDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Tuya Zigbee Door/Window Sensor - AliExpress has been initialized');
    }
    ...
    async registerCapabilitiesAndReporting() {
        try {
            ...
            if (this.hasCapability('alarm_contact')) {
                await this.registerCapability('alarm_contact', 1280, {
                    reportOpts: {
    ...
    onDeleted() {
        this.log('Tuya Zigbee Door/Window Sensor - AliExpress has been deleted');
    }
}

module.exports = TuyaZigbeeDoorwindowSensorAliexpressDevice;