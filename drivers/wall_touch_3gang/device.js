...
/**
 * wall_touch_3gang - Hybrid-Enhanced Driver
 *
 ...
 */
class WallTouch3GangDevice extends HybridDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('[COLOR] WallTouch3Gang initializing...');
    ...
    this.log('[OK] WallTouch3Gang ready (SDK3)');
  }
