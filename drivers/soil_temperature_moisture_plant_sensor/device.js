...
class SoilTemperatureMoisturePlantSensorDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('[Soil Temperature Moisture Plant Sensor] has been initialized');
    }
    ...
    onDeleted() {
        this.log('[Soil Temperature Moisture Plant Sensor] has been deleted');
    }
}

module.exports = SoilTemperatureMoisturePlantSensorDevice;