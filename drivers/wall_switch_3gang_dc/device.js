...
class WallSwitch_3gangDcDevice extends ZigBeeDevice {
    
    async onNodeInit() {
        this.log('wall_switch_3gang_dc device initialized - 3 button(s), dc powered');
...
module.exports = WallSwitch_3gangDcDevice;