...
class SmartBulbDimmerAcDevice extends ZigBeeDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('smart_bulb_dimmer_ac initialized');
    ...
    const deviceType = TuyaClusterHandler.detectDeviceType('smart_bulb_dimmer_ac');
  ...
  async onDeleted() {
    this.log('smart_bulb_dimmer_ac deleted');
  }
  // ========================================
...
module.exports = SmartBulbDimmerAcDevice;
