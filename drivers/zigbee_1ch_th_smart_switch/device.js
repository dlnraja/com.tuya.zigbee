...
class Zigbee1chThSmartSwitchDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Zigbee 1CH TH Smart Switch has been initialized');
    }
    ...
    onDeleted() {
        this.log('Zigbee 1CH TH Smart Switch has been deleted');
    }
}

module.exports = Zigbee1chThSmartSwitchDevice;