...
// Device Type: zigbee
// Category: switches
// Subcategory: switch_3_gang
// Enrichment Date: 2025-08-07T17:53:57.113Z
...
class Switch3gang extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Switch3gang SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Switch3gang Enhanced deleted');
  }
