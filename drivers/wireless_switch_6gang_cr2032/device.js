...
class WirelessSwitch_6gangBatteryDevice extends ZigBeeDevice {
    
    async onNodeInit() {
        this.log('wireless_switch_6gang_battery device initialized - 6 button(s), battery powered');
...
module.exports = WirelessSwitch_6gangBatteryDevice;