...
class EwelinkGu10ZigbeeLedLampenDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Ewelink GU10 Zigbee LED-lampen has been initialized');
    }
    ...
    onDeleted() {
        this.log('Ewelink GU10 Zigbee LED-lampen has been deleted');
    }
}

module.exports = EwelinkGu10ZigbeeLedLampenDevice;