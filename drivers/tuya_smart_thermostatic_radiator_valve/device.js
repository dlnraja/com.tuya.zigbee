...
class TuyaSmartThermostaticRadiatorValveDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Tuya Smart Thermostatic Radiator Valve has been initialized');
    }
    ...
    onDeleted() {
        this.log('Tuya Smart Thermostatic Radiator Valve has been deleted');
    }
}

module.exports = TuyaSmartThermostaticRadiatorValveDevice;