...
class TemperatureHumidityTz3000Akqdg6g7Device extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Temperature-Humidity- TZ3000_akqdg6g7 has been initialized');
    }
    ...
    onDeleted() {
        this.log('Temperature-Humidity- TZ3000_akqdg6g7 has been deleted');
    }
}

module.exports = TemperatureHumidityTz3000Akqdg6g7Device;