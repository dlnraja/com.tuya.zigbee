...
class ThermostatHybridDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('thermostat_hybrid initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('thermostat_hybrid');
  ...
  async onDeleted() {
    this.log('thermostat_hybrid deleted');
  }

}

module.exports = ThermostatHybridDevice;
