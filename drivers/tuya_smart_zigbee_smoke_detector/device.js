...
class TuyaSmartZigbeeSmokeDetectorDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Tuya Smart Zigbee Smoke Detector has been initialized');
    }
    ...
    onDeleted() {
        this.log('Tuya Smart Zigbee Smoke Detector has been deleted');
    }
}

module.exports = TuyaSmartZigbeeSmokeDetectorDevice;