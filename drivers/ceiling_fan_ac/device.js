...
class CeilingFanAcDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('ceiling_fan_ac initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('ceiling_fan_ac');
  ...
  async onDeleted() {
    this.log('ceiling_fan_ac deleted');
  }

}

module.exports = CeilingFanAcDevice;
