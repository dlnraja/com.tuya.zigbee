...
class ContactPresenceHybridDevice extends UnifiedSensorBase {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('[CONTACT-HYBRID] ✅ Contact presence sensor ready');
  }
...
module.exports = ContactPresenceHybridDevice;
