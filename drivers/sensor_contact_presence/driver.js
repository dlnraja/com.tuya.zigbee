...
class PresenceSensorRadarDriver extends ZigBeeDriver {
  ...
  _registerFlowCards() {
    ...
    } catch (err) { if (this.developerDebugMode) { this.error(`Condition sensor_contact_presence_hybrid_is_present: ${err.message}`); }; }
    ...
    } catch (err) { if (this.developerDebugMode) { this.error(`Condition sensor_contact_presence_hybrid_illuminance_above: ${err.message}`); }; }
    ...
    } catch (err) { if (this.developerDebugMode) { this.error(`Condition sensor_contact_presence_hybrid_distance_within: ${err.message}`); }; }
    ...
    } catch (err) { if (this.developerDebugMode) { this.error(`Condition sensor_contact_presence_hybrid_motion_active: ${err.message}`); }; }
