...
/**
 * P126 — TuyaZigbeeDevice + safe-timers + mainsPowered
 */
            ...
            CLUSTER.WINDOW_COVERING,
            {
                setParser: async (value) => {
                    ...
                    if (this._reportPercentageDebounce) {
                      ...
                      // if refresh unsupported, reset timeout
                      if (typeof this._reportPercentageDebounce.refresh !== 'function') {
                        safeClearTimeout(this, this._reportPercentageDebounce);
                        this._reportPercentageDebounce = safeSetTimeout(this, () => {
