...
class RgbLedControllerAcDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('rgb_led_controller_ac initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('rgb_led_controller_ac');
  ...
  async onDeleted() {
    this.log('rgb_led_controller_ac deleted');
  }

}

module.exports = RgbLedControllerAcDevice;
