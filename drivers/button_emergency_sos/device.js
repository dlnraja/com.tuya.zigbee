...
class SosEmergencyButtonDevice extends BaseHybridDevice {
  ...
  _handleTuyaDP(dp, value) {
    ...
    if (dp === 4 || dp === 15) {
      ...
      if (!isNaN(battery) && battery >= 0 && battery <= 100) {
        ...
        if (this.hasCapability('measure_battery')) {
          this._safeSetCapability('measure_battery', parseFloat(battery)).catch(() => { });
        }
    ...
    if (dp === 13) {
      ...
      if (value === 1) {
      (() => { try { return (() => { try { return this.homey.flow.getTriggerCard('button_emergency_sos_double_pressed'); } catch(e) { return null; } })(); } catch(e) { return null; } })();
      } else if (value === 2) {
      (() => { try { return (() => { try { return this.homey.flow.getTriggerCard('button_emergency_sos_long_pressed'); } catch(e) { return null; } })(); } catch(e) { return null; } })();
      }
  ...
  _triggerFlow() {
    ...
    if (this.driver?.triggerSOS) {
      ...
      try {
      const card = (() => { try { return (() => { try { return this.homey.flow.getTriggerCard('button_emergency_sos_pressed'); } catch(e) { return null; } })(); } catch(e) { return null; } })();
        if (card) {
          card.trigger(this, {}, {}).catch(e => this.log('[SOS] trigger error:', e.message));
  ...
  async _setupBattery() {
    ...
    const updateBattery = (value, source) => {
      ...
      this._safeSetCapability('measure_battery', parseFloat(percent)).catch(() => { });
      this._updateActivity();
      return true;
    };
