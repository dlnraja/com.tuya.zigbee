...
module.exports = class Aqara_Temperature_Plug_Standard_DefaulttuyaDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔌 Aqara_Temperature_Plug_Standard_Default-tuya initialisé');
