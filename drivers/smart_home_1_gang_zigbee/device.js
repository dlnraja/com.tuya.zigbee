...
class SmartHome1GangZigbeeDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Smart Home 1 gang Zigbee has been initialized');
    }
    ...
    onDeleted() {
        this.log('Smart Home 1 gang Zigbee has been deleted');
    }
}

module.exports = SmartHome1GangZigbeeDevice;