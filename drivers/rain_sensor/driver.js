...
class RainSensorDriver extends ZigBeeDriver {
  ...
  _registerFlowCards() {
    ...
    try {
      (() => { try { return this.homey.flow.getConditionCard('rain_sensor_is_raining'); } catch(e) { return null; } })()?.registerRunListener(async (args) => {
    ...
    try {
      (() => { try { return this.homey.flow.getConditionCard('rain_sensor_rain_intensity_above'); } catch(e) { return null; } })()?.registerRunListener(async (args) => {
          if (!args.device) return false;
