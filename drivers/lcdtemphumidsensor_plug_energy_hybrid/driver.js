...
class PlugEnergyMonitorDriver extends ZigBeeDriver {
  ...
  _registerFlowCards() {
    // TRIGGERS
    try { this.homey.flow.getTriggerCard('lcdtemphumidsensor_plug_energy_hybrid_plug_energy_monitor_turned_on'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('lcdtemphumidsensor_plug_energy_hybrid_plug_energy_monitor_turned_off'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('lcdtemphumidsensor_plug_energy_hybrid_plug_energy_monitor_measure_power_changed'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('lcdtemphumidsensor_plug_energy_hybrid_plug_energy_monitor_measure_voltage_changed'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('lcdtemphumidsensor_plug_energy_hybrid_plug_energy_monitor_measure_current_changed'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('lcdtemphumidsensor_plug_energy_hybrid_plug_energy_monitor_meter_power_changed'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('lcdtemphumidsensor_plug_energy_hybrid_plug_energy_monitor_power_changed'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('lcdtemphumidsensor_plug_energy_hybrid_plug_energy_monitor_battery_low'); } catch (e) {}
