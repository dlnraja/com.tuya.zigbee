...
/**
 * wall_touch_5gang - Hybrid-Enhanced Driver
 *
 ...
 */
class WallTouch5GangDevice extends HybridDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('[COLOR] WallTouch5Gang initializing...');
    ...
    this.log('[OK] WallTouch5Gang ready (SDK3)');
  }
