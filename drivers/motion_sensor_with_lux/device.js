...
class MotionSensorWithLuxDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Motion sensor with Lux has been initialized');
    }
    ...
    onDeleted() {
        this.log('Motion sensor with Lux has been deleted');
    }
}

module.exports = MotionSensorWithLuxDevice;