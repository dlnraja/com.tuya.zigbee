...
class DeviceRequest3ButtonSwitchDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Device Request -3 button switch has been initialized');
    }
    ...
    onDeleted() {
        this.log('Device Request -3 button switch has been deleted');
    }
}

module.exports = DeviceRequest3ButtonSwitchDevice;