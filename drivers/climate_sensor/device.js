...
class ClimateSensorDevice extends UnifiedSensorBase {
  ...
  isLCDClimateDevice() {
    ...
    if (CI.includesCI(lcdManufacturers, mfr)) return true;
  ...
  _isSoilSensor() {
    const mfr = getManufacturer(this);
    const soilManufacturers = [
      '_tze284_oitavov2', '_tze200_myd45weu', '_tze200_ga1maeof',
      '_tze200_9cqcpkgb', '_tze204_myd45weu', '_tze284_myd45weu',
      '_tze200_2se8efxh'
    ];
    return CI.includesCI(soilManufacturers, mfr);
  }
