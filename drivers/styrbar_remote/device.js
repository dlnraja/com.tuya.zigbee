...
class StyrbarRemoteDevice extends ZigBeeDevice {

    async onNodeInit() {
        this.log('styrbar_remote device initialized');
    ...
    async onDeleted() {
        this.log('styrbar_remote device deleted');
    }

}

module.exports = StyrbarRemoteDevice;
