...
class SmartScenePanelDevice extends TuyaZigbeeDevice {
  ...
  _handleDP(dp, value) {
    if (dp >= 24 && dp <= 27) {
      ...
      (() => { try { return this.homey.flow.getTriggerCard('climate_sensor_smart_smart_scene_panel_scene_activated'); } catch(e) { return null; } })()?.trigger(this, { scene: String(dp) }, { scene: String(dp) }).catch(() => {})
    } else if (dp === 38) {
