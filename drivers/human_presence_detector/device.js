...
class HumanPresenceDetectorDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Human Presence Detector has been initialized');
    }
    ...
    onDeleted() {
        this.log('Human Presence Detector has been deleted');
    }
}

module.exports = HumanPresenceDetectorDevice;