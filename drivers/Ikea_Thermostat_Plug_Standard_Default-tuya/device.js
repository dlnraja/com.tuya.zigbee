...
module.exports = class Ikea_Thermostat_Plug_Standard_DefaulttuyaDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔌 Ikea_Thermostat_Plug_Standard_Default-tuya initialisé');
