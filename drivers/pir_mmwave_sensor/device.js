...
class pir_mmwave_sensor extends ZigBeeDevice {
    ...
    onZoneStatusAttributeReport(status) {
        ...
        await this.setCapabilityValue('alarm_motion', status.alarm1).catch(this.error);
    }
        ...
        switch (dp) {
            case 1:
                ...
                if (typeof measuredValue === 'boolean') {
                    await this.setCapabilityValue('alarm_motion', measuredValue).catch(this.error);
            ...
            case 110:
                ...
                if (typeof measuredValue === 'number') {
                    ...
                    await this.setCapabilityValue('measure_battery', measuredValue).catch(this.error);
                    const batteryThreshold = this.getSetting('batteryThreshold') || 20;
                    await this.setCapabilityValue('alarm_battery', measuredValue < batteryThreshold).catch(this.error);
                }
                break;
