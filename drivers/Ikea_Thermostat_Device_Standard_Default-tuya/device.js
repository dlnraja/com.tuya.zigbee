...
module.exports = class Ikea_Thermostat_Device_Standard_DefaulttuyaDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔌 Ikea_Thermostat_Device_Standard_Default-tuya initialisé');
