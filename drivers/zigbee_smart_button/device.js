...
class ZigbeeSmartButtonDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Zigbee Smart Button has been initialized');
    }
    ...
    onDeleted() {
        this.log('Zigbee Smart Button has been deleted');
    }
}

module.exports = ZigbeeSmartButtonDevice;