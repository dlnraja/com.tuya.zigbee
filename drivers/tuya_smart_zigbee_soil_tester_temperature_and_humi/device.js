...
class TuyaSmartZigbeeSoilTesterTemperatureAndHumiDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('[Tuya Smart Zigbee Soil Tester Temperature and Humidity Meter] has been initialized');
    }
    ...
    onDeleted() {
        this.log('[Tuya Smart Zigbee Soil Tester Temperature and Humidity Meter] has been deleted');
    }
}

module.exports = TuyaSmartZigbeeSoilTesterTemperatureAndHumiDevice;