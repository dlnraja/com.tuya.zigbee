...
class SceneController_4buttonDevice extends ZigBeeDevice {
    
    async onNodeInit() {
        this.log('scene_controller_4button device initialized - 4 button(s), battery powered');
...
module.exports = SceneController_4buttonDevice;