...
class SonoffTX2ChDevice extends EweLinkLocalDevice {
  get stateMappings() {
    return {
  ...
  async onInit() {
    if (!this.hasCapability('onoff.2')) await this.addCapability('onoff.2').catch(() => {});
    await super.onInit();
  }
...
module.exports = SonoffTX2ChDevice;
