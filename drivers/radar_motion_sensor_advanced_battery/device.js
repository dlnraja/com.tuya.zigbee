...
class RadarMotionSensorAdvancedBatteryDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('radar_motion_sensor_advanced_battery initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('radar_motion_sensor_advanced_battery');
  ...
  async onDeleted() {
    this.log('radar_motion_sensor_advanced_battery deleted');
  }

}

module.exports = RadarMotionSensorAdvancedBatteryDevice;
