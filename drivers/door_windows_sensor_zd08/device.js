...
class DoorWindowsSensorZd08Device extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Door & Windows Sensor ZD08 has been initialized');
    }
    ...
    onDeleted() {
        this.log('Door & Windows Sensor ZD08 has been deleted');
    }
}

module.exports = DoorWindowsSensorZd08Device;