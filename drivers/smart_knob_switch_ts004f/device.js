...
class SmartKnobSwitchTs004fDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Smart Knob Switch TS004F has been initialized');
    }
    ...
    onDeleted() {
        this.log('Smart Knob Switch TS004F has been deleted');
    }
}

module.exports = SmartKnobSwitchTs004fDevice;