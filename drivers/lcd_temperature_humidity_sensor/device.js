...
class LcdTemperatureHumiditySensorDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('LCD temperature & humidity sensor has been initialized');
    }
    ...
    onDeleted() {
        this.log('LCD temperature & humidity sensor has been deleted');
    }
}

module.exports = LcdTemperatureHumiditySensorDevice;