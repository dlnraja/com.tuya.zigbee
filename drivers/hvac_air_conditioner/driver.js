...
class HvacAirConditionerDriver extends ZigBeeDriver {
  ...
  _registerFlowCards() {
    // CONDITION: Is on
    try {
      (() => { try { return (() => { try { return this.homey.flow.getConditionCard('hvac_air_conditioner_air_conditioner_hybrid_is_on'); } catch(e) { return null; } })(); } catch(e) { return null; } })()
    ...
    // ACTION: Turn on
    try {
      (() => { try { return (() => { try { return this.homey.flow.getActionCard('hvac_air_conditioner_air_conditioner_hybrid_turn_on'); } catch(e) { return null; } })(); } catch(e) { return null; } })()
        .registerRunListener(async (args) => {
          if (!args.device) return false;
    ...
    // ACTION: Turn off
    try {
      (() => { try { return (() => { try { return this.homey.flow.getActionCard('hvac_air_conditioner_air_conditioner_hybrid_turn_off'); } catch(e) { return null; } })(); } catch(e) { return null; } })()
        .registerRunListener(async (args) => {
          if (!args.device) return false;
    ...
    // ACTION: Toggle
    try {
      (() => { try { return (() => { try { return this.homey.flow.getActionCard('hvac_air_conditioner_air_conditioner_hybrid_toggle'); } catch(e) { return null; } })(); } catch(e) { return null; } })()
        .registerRunListener(async (args) => {
          if (!args.device) return false;
    ...
    try {
      (() => { try { return (() => { try { return this.homey.flow.getActionCard('hvac_air_conditioner_air_conditioner_hybrid_set_target_temperature'); } catch(e) { return null; } })(); } catch(e) { return null; } })()
        .registerRunListener(async (args) => {
          if (!args.device) return false;
