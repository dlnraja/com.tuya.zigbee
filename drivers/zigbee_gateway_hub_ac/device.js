...
class ZigbeeGatewayHubAcDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('zigbee_gateway_hub_ac initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('zigbee_gateway_hub_ac');
  ...
  async onDeleted() {
    this.log('zigbee_gateway_hub_ac deleted');
  }
  // ========================================
...
module.exports = ZigbeeGatewayHubAcDevice;
