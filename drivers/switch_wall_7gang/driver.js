...
class SwitchWall7gangDriver extends ZigBeeDriver {
  ...
  _registerFlowCards() {
    ...
    gangs.forEach(gang => {
      try {
        (() => { try { return this.homey.flow.getConditionCard(`switch_wall_7gang_gang${gang}_is_on`); } catch(e) { return null; } })()?.registerRunListener(async (args) => {
      ...
      try {
        (() => { try { return this.homey.flow.getActionCard(`switch_wall_7gang_turn_on_gang${gang}`); } catch(e) { return null; } })()?.registerRunListener(async (args) => {
            if (!args.device) return false;
      ...
      try {
        (() => { try { return this.homey.flow.getActionCard(`switch_wall_7gang_turn_off_gang${gang}`); } catch(e) { return null; } })()?.registerRunListener(async (args) => {
            if (!args.device) return false;
      ...
      try {
        (() => { try { return this.homey.flow.getActionCard(`switch_wall_7gang_toggle_gang${gang}`); } catch(e) { return null; } })()?.registerRunListener(async (args) => {
            if (!args.device) return false;
    ...
    try {
      (() => { try { return this.homey.flow.getActionCard('switch_wall_7gang_set_backlight'); } catch(e) { return null; } })()?.registerRunListener(async (args) => {
    ...
    try {
      (() => { try { return this.homey.flow.getActionCard('switch_wall_7gang_set_backlight_color'); } catch(e) { return null; } })()?.registerRunListener(async (args) => {
    ...
    try {
      (() => { try { return this.homey.flow.getActionCard('switch_wall_7gang_set_backlight_brightness'); } catch(e) { return null; } })()?.registerRunListener(async (args) => {
    ...
    try {
      (() => { try { return this.homey.flow.getActionCard('switch_wall_7gang_turn_on_all'); } catch(e) { return null; } })()?.registerRunListener(async (args) => {
          if (!args.device) return false;
          for (const [gi, cap] of Object.entries(capMap)) {
            const gangNum = Number(gi);
            if (args.device.hasCapability(cap)) await args.device._setGangOnOff(gangNum, true).catch(() => {});
    ...
    try {
      (() => { try { return this.homey.flow.getActionCard('switch_wall_7gang_turn_off_all'); } catch(e) { return null; } })()?.registerRunListener(async (args) => {
          if (!args.device) return false;
          for (const [gi, cap] of Object.entries(capMap)) {
            const gangNum = Number(gi);
            if (args.device.hasCapability(cap)) await args.device._setGangOnOff(gangNum, false).catch(() => {});
    ...
    try {
      (() => { try { return this.homey.flow.getActionCard('switch_wall_7gang_set_scene_mode'); } catch(e) { return null; } })()?.registerRunListener(async (args) => {
          if (!args.device) return false;
