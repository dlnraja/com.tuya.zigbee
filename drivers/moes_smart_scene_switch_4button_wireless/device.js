...
class MoesSmartSceneSwitch4buttonWirelessDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('MOES Smart Scene Switch 4Button Wireless has been initialized');
    }
    ...
    onDeleted() {
        this.log('MOES Smart Scene Switch 4Button Wireless has been deleted');
    }
}

module.exports = MoesSmartSceneSwitch4buttonWirelessDevice;