...
use
strict;const { ZigBeeDevice } = require(homey-zigbeedriver);class SmartDeviceStandardDefaultTuyaDevice extends ZigBeeDevice {async onNodeInit({ zclNode }) {this.log(🔌
...
configuration
des
rapports:, error);}}parseBattery(value) {return Math.round(value / 2);}}module.exports = SmartDeviceStandardDefaultTuyaDevice;