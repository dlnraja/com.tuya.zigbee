...
class SceneSwitch1Driver extends ZigBeeDriver {
  ...
  async onInit() {
    ...
    this._buttonPressedTrigger = this.homey.flow.getTriggerCard('scene_switch_1_button_pressed');
    this._buttonDoubleTrigger = this.homey.flow.getTriggerCard('scene_switch_1_button_double_press');
    this._buttonLongTrigger = this.homey.flow.getTriggerCard('scene_switch_1_button_long_press');
    this._batteryChangedTrigger = this.homey.flow.getTriggerCard('scene_switch_1_battery_changed');
