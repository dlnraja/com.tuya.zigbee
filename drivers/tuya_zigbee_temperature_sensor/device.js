...
class TuyaZigbeeTemperatureSensorDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Tuya Zigbee Temperature Sensor has been initialized');
    }
    ...
    onDeleted() {
        this.log('Tuya Zigbee Temperature Sensor has been deleted');
    }
}

module.exports = TuyaZigbeeTemperatureSensorDevice;