...
class DoorWindowsSensorDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Door-Windows sensor has been initialized');
    }
    ...
    onDeleted() {
        this.log('Door-Windows sensor has been deleted');
    }
}

module.exports = DoorWindowsSensorDevice;