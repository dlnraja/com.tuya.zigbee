...
class MiniSwitchDriver extends ZigBeeDriver {
  ...
  _registerFlowCards() {
    // CONDITION: Is on
    try {
      (() => { try { return this.homey.flow.getDeviceConditionCard('module_mini_switch_is_on'); } catch(e) { return null; } })()
    ...
    // ACTION: Turn on
    try {
      (() => { try { return this.homey.flow.getDeviceActionCard('module_mini_switch_turn_on'); } catch(e) { return null; } })()
        .registerRunListener(async (args) => {
          if (!args.device) return false;
    ...
    // ACTION: Turn off
    try {
      (() => { try { return this.homey.flow.getDeviceActionCard('module_mini_switch_turn_off'); } catch(e) { return null; } })()
        .registerRunListener(async (args) => {
          if (!args.device) return false;
    ...
    // ACTION: Toggle
    try {
      (() => { try { return this.homey.flow.getDeviceActionCard('module_mini_switch_toggle'); } catch(e) { return null; } })()
        .registerRunListener(async (args) => {
          if (!args.device) return false;
