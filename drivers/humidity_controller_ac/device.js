...
class HumidityControllerAcDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('humidity_controller_ac initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('humidity_controller_ac');
  ...
  async onDeleted() {
    this.log('humidity_controller_ac deleted');
  }

}

module.exports = HumidityControllerAcDevice;
