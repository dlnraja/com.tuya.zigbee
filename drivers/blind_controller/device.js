...
class BlindControllerDevice extends ZigBeeDevice {

    async onNodeInit() {
        this.log('blind_controller device initialized');
    ...
    async onDeleted() {
        this.log('blind_controller device deleted');
    }

}

module.exports = BlindControllerDevice;
