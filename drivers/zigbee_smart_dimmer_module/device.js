...
class ZigbeeSmartDimmerModuleDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Zigbee Smart Dimmer Module has been initialized');
    }
    ...
    onDeleted() {
        this.log('Zigbee Smart Dimmer Module has been deleted');
    }
}

module.exports = ZigbeeSmartDimmerModuleDevice;