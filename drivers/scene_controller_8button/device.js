...
class SceneController_8buttonDevice extends ZigBeeDevice {
    
    async onNodeInit() {
        this.log('scene_controller_8button device initialized - 8 button(s), battery powered');
...
module.exports = SceneController_8buttonDevice;