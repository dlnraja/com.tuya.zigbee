...
class SmartRotaryDimmerDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Smart Rotary Dimmer has been initialized');
    }
    ...
    onDeleted() {
        this.log('Smart Rotary Dimmer has been deleted');
    }
}

module.exports = SmartRotaryDimmerDevice;