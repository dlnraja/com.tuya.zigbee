...
class TuyaSmartTemperatureAndHumiditySensorTuyaDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Tuya Smart Temperature And Humidity Sensor- Tuya has been initialized');
    }
    ...
    onDeleted() {
        this.log('Tuya Smart Temperature And Humidity Sensor- Tuya has been deleted');
    }
}

module.exports = TuyaSmartTemperatureAndHumiditySensorTuyaDevice;