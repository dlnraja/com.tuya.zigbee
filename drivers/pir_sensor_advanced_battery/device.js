...
class PirSensorAdvancedBatteryDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('pir_sensor_advanced_battery initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('pir_sensor_advanced_battery');
  ...
  async onDeleted() {
    this.log('pir_sensor_advanced_battery deleted');
  }
  // ========================================
...
module.exports = PirSensorAdvancedBatteryDevice;
