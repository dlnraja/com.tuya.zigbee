...
class TouchSwitch_4gangDevice extends ZigBeeDevice {
    
    async onNodeInit() {
        this.log('touch_switch_4gang device initialized - 4 button(s), ac powered');
...
module.exports = TouchSwitch_4gangDevice;