...
class TuyaZigbeeSoilMoistureSensorDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Tuya Zigbee Soil Moisture Sensor has been initialized');
    }
    ...
    onDeleted() {
        this.log('Tuya Zigbee Soil Moisture Sensor has been deleted');
    }
}

module.exports = TuyaZigbeeSoilMoistureSensorDevice;