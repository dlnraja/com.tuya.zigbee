...
class Switch4GangDriver extends ZigBeeDriver {
  ...
  async onInit() {
    ...
    try {
      ...
      this.gang1OnTrigger = this.homey.flow.getTriggerCard('switch_4gang_gang1_turned_on');
      this.gang1OffTrigger = this.homey.flow.getTriggerCard('switch_4gang_gang1_turned_off');
      this.gang2OnTrigger = this.homey.flow.getTriggerCard('switch_4gang_gang2_turned_on');
      this.gang2OffTrigger = this.homey.flow.getTriggerCard('switch_4gang_gang2_turned_off');
      this.gang3OnTrigger = this.homey.flow.getTriggerCard('switch_4gang_gang3_turned_on');
      this.gang3OffTrigger = this.homey.flow.getTriggerCard('switch_4gang_gang3_turned_off');
      this.gang4OnTrigger = this.homey.flow.getTriggerCard('switch_4gang_gang4_turned_on');
      this.gang4OffTrigger = this.homey.flow.getTriggerCard('switch_4gang_gang4_turned_off');
      ...
      for (const g of [1, 2, 3, 4]) {
        try { this.homey.flow.getTriggerCard(`switch_4gang_gang${g}_scene`); } catch (e) { this.log(`[FLOW] scene G${g}: ${e.message}`); }
      }
