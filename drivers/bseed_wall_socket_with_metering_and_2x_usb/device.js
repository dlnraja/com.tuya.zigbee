...
class BseedWallSocketWithMeteringAnd2xUsbDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('BSEED Wall Socket with metering and 2x usb has been initialized');
    }
    ...
    onDeleted() {
        this.log('BSEED Wall Socket with metering and 2x usb has been deleted');
    }
}

module.exports = BseedWallSocketWithMeteringAnd2xUsbDevice;