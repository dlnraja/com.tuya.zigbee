  ...
  async _triggerPresenceFlows(detected) {
    try {
      if (detected) {
        ...
        try {
      (() => { try { return (() => { try { return this.homey.flow.getTriggerCard('sensor_gas_presence_hybrid_presence_sensor_radar_presence_detected'); } catch(e) { return null; } })(); } catch(e) { return null; } })();
        ...
        try {
      (() => { try { return (() => { try { return this.homey.flow.getTriggerCard('sensor_gas_presence_hybrid_presence_sensor_radar_presence_cleared'); } catch(e) { return null; } })(); } catch(e) { return null; } })();
        } catch (e) { /* card missing */ }
