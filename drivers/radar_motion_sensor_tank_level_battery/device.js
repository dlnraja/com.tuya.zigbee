...
class RadarMotionSensorTankLevelBatteryDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('radar_motion_sensor_tank_level_battery initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('radar_motion_sensor_tank_level_battery');
  ...
  async onDeleted() {
    this.log('radar_motion_sensor_tank_level_battery deleted');
  }
  // ========================================
...
module.exports = RadarMotionSensorTankLevelBatteryDevice;
