...
class SmokeDetectorTempHumidityAdvancedBatteryDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('smoke_detector_temp_humidity_advanced_battery initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('smoke_detector_temp_humidity_advanced_battery');
  ...
  async onDeleted() {
    this.log('smoke_detector_temp_humidity_advanced_battery deleted');
  }

}

module.exports = SmokeDetectorTempHumidityAdvancedBatteryDevice;
