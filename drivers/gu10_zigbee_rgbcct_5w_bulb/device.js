...
class Gu10ZigbeeRgbcct5wBulbDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('GU10 Zigbee RGBCCT 5W bulb has been initialized');
    }
    ...
    onDeleted() {
        this.log('GU10 Zigbee RGBCCT 5W bulb has been deleted');
    }
}

module.exports = Gu10ZigbeeRgbcct5wBulbDevice;