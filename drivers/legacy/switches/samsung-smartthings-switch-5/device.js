 ...
 * Chemin: drivers/legacy/switches/samsung-smartthings-switch-5
 * Enrichi le: 2025-08-02T14:11:17.952Z
...
class samsungSmartthingsSwitch_5Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('samsung-smartthings-switch-5 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'samsung-smartthings-switch-5');
...
module.exports = samsungSmartthingsSwitch_5Device;
