 ...
 * Chemin: drivers/legacy/switches/bticino-bulb-20
 * Enrichi le: 2025-08-02T14:11:17.843Z
...
class bticinoBulb_20Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('bticino-bulb-20 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'bticino-bulb-20');
...
module.exports = bticinoBulb_20Device;
