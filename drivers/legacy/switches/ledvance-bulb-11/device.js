 ...
 * Chemin: drivers/legacy/switches/ledvance-bulb-11
 * Enrichi le: 2025-08-02T14:11:17.889Z
...
class ledvanceBulb_11Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('ledvance-bulb-11 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'ledvance-bulb-11');
...
module.exports = ledvanceBulb_11Device;
