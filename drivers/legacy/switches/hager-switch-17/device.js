 ...
 * Chemin: drivers/legacy/switches/hager-switch-17
 * Enrichi le: 2025-08-02T14:11:17.871Z
...
class hagerSwitch_17Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('hager-switch-17 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'hager-switch-17');
...
module.exports = hagerSwitch_17Device;
