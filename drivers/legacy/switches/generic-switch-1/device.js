 ...
 * Chemin: drivers/legacy/switches/generic-switch-1
 * Enrichi le: 2025-08-02T14:11:17.865Z
...
class genericSwitch_1Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('generic-switch-1 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'generic-switch-1');
...
module.exports = genericSwitch_1Device;
