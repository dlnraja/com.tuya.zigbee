 ...
 * Chemin: drivers/legacy/switches/legrand-switch-16
 * Enrichi le: 2025-08-02T14:11:17.918Z
...
class legrandSwitch_16Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('legrand-switch-16 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'legrand-switch-16');
...
module.exports = legrandSwitch_16Device;
