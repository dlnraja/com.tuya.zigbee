 ...
 * Chemin: drivers/legacy/switches/legrand-switch-11
 * Enrichi le: 2025-08-02T14:11:17.914Z
...
class legrandSwitch_11Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('legrand-switch-11 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'legrand-switch-11');
...
module.exports = legrandSwitch_11Device;
