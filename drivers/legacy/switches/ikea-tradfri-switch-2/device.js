 ...
 * Chemin: drivers/legacy/switches/ikea-tradfri-switch-2
 * Enrichi le: 2025-08-02T14:11:17.882Z
...
class ikeaTradfriSwitch_2Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('ikea-tradfri-switch-2 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'ikea-tradfri-switch-2');
...
module.exports = ikeaTradfriSwitch_2Device;
