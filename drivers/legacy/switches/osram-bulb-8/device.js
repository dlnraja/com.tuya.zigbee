 ...
 * Chemin: drivers/legacy/switches/osram-bulb-8
 * Enrichi le: 2025-08-02T14:11:17.934Z
...
class osramBulb_8Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('osram-bulb-8 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'osram-bulb-8');
...
module.exports = osramBulb_8Device;
