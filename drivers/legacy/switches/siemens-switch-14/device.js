 ...
 * Chemin: drivers/legacy/switches/siemens-switch-14
 * Enrichi le: 2025-08-02T14:11:17.980Z
...
class siemensSwitch_14Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('siemens-switch-14 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'siemens-switch-14');
...
module.exports = siemensSwitch_14Device;
