 ...
 * Chemin: drivers/legacy/switches/schneider-bulb-12
 * Enrichi le: 2025-08-02T14:11:17.955Z
...
class schneiderBulb_12Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('schneider-bulb-12 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'schneider-bulb-12');
...
module.exports = schneiderBulb_12Device;
