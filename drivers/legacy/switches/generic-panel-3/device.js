 ...
 * Chemin: drivers/legacy/switches/generic-panel-3
 * Enrichi le: 2025-08-02T14:11:17.854Z
...
class genericPanel_3Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('generic-panel-3 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'generic-panel-3');
...
module.exports = genericPanel_3Device;
