 ...
 * Chemin: drivers/legacy/switches/ikea-tradfri-bulb-4
 * Enrichi le: 2025-08-02T14:11:17.877Z
...
class ikeaTradfriBulb_4Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('ikea-tradfri-bulb-4 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'ikea-tradfri-bulb-4');
...
module.exports = ikeaTradfriBulb_4Device;
