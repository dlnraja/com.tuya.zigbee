 ...
 * Chemin: drivers/legacy/switches/hager-bulb-19
 * Enrichi le: 2025-08-02T14:11:17.869Z
...
class hagerBulb_19Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('hager-bulb-19 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'hager-bulb-19');
...
module.exports = hagerBulb_19Device;
