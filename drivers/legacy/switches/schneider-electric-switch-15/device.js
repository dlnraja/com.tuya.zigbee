 ...
 * Chemin: drivers/legacy/switches/schneider-electric-switch-15
 * Enrichi le: 2025-08-02T14:11:17.966Z
...
class schneiderElectricSwitch_15Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('schneider-electric-switch-15 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'schneider-electric-switch-15');
...
module.exports = schneiderElectricSwitch_15Device;
