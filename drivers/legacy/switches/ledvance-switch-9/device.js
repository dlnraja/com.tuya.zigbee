 ...
 * Chemin: drivers/legacy/switches/ledvance-switch-9
 * Enrichi le: 2025-08-02T14:11:17.899Z
...
class ledvanceSwitch_9Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('ledvance-switch-9 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'ledvance-switch-9');
...
module.exports = ledvanceSwitch_9Device;
