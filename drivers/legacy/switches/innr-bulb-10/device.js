 ...
 * Chemin: drivers/legacy/switches/innr-bulb-10
 * Enrichi le: 2025-08-02T14:11:17.884Z
...
class innrBulb_10Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('innr-bulb-10 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'innr-bulb-10');
...
module.exports = innrBulb_10Device;
