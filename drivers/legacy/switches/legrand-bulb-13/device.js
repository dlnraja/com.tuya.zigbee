 ...
 * Chemin: drivers/legacy/switches/legrand-bulb-13
 * Enrichi le: 2025-08-02T14:11:17.903Z
...
class legrandBulb_13Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('legrand-bulb-13 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'legrand-bulb-13');
...
module.exports = legrandBulb_13Device;
