 ...
 * Chemin: drivers/legacy/switches/generic-bulb-1
 * Enrichi le: 2025-08-02T14:11:17.852Z
...
class genericBulb_1Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('generic-bulb-1 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'generic-bulb-1');
...
module.exports = genericBulb_1Device;
