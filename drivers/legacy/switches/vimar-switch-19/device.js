 ...
 * Chemin: drivers/legacy/switches/vimar-switch-19
 * Enrichi le: 2025-08-02T14:11:31.671Z
...
class vimarSwitch_19Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('vimar-switch-19 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'vimar-switch-19');
...
module.exports = vimarSwitch_19Device;
