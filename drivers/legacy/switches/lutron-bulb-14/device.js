 ...
 * Chemin: drivers/legacy/switches/lutron-bulb-14
 * Enrichi le: 2025-08-02T14:11:17.920Z
...
class lutronBulb_14Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('lutron-bulb-14 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'lutron-bulb-14');
...
module.exports = lutronBulb_14Device;
