 ...
 * Chemin: drivers/legacy/switches/bosch-switch-13
 * Enrichi le: 2025-08-02T14:11:17.837Z
...
class boschSwitch_13Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('bosch-switch-13 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'bosch-switch-13');
...
module.exports = boschSwitch_13Device;
