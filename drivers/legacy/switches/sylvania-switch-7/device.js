 ...
 * Chemin: drivers/legacy/switches/sylvania-switch-7
 * Enrichi le: 2025-08-02T14:11:17.986Z
...
class sylvaniaSwitch_7Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('sylvania-switch-7 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'sylvania-switch-7');
...
module.exports = sylvaniaSwitch_7Device;
