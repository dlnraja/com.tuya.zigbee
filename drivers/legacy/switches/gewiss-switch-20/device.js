 ...
 * Chemin: drivers/legacy/switches/gewiss-switch-20
 * Enrichi le: 2025-08-02T14:11:17.867Z
...
class gewissSwitch_20Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('gewiss-switch-20 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'gewiss-switch-20');
...
module.exports = gewissSwitch_20Device;
