 ...
 * Chemin: drivers/legacy/switches/xiaomi-aqara-bulb-6
 * Enrichi le: 2025-08-02T14:11:31.689Z
...
class xiaomiAqaraBulb_6Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('xiaomi-aqara-bulb-6 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'xiaomi-aqara-bulb-6');
...
module.exports = xiaomiAqaraBulb_6Device;
