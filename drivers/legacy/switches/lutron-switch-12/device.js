 ...
 * Chemin: drivers/legacy/switches/lutron-switch-12
 * Enrichi le: 2025-08-02T14:11:17.931Z
...
class lutronSwitch_12Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('lutron-switch-12 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'lutron-switch-12');
...
module.exports = lutronSwitch_12Device;
