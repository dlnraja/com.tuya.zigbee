 ...
 * Chemin: drivers/legacy/switches/legrand-bulb-18
 * Enrichi le: 2025-08-02T14:11:17.905Z
...
class legrandBulb_18Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('legrand-bulb-18 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'legrand-bulb-18');
...
module.exports = legrandBulb_18Device;
