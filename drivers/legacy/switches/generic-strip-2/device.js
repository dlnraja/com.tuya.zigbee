 ...
 * Chemin: drivers/legacy/switches/generic-strip-2
 * Enrichi le: 2025-08-02T14:11:17.856Z
...
class genericStrip_2Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('generic-strip-2 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'generic-strip-2');
...
module.exports = genericStrip_2Device;
