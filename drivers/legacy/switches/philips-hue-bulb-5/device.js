 ...
 * Chemin: drivers/legacy/switches/philips-hue-bulb-5
 * Enrichi le: 2025-08-02T14:11:17.939Z
...
class philipsHueBulb_5Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('philips-hue-bulb-5 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'philips-hue-bulb-5');
...
module.exports = philipsHueBulb_5Device;
