 ...
 * Chemin: drivers/legacy/switches/bticino-switch-18
 * Enrichi le: 2025-08-02T14:11:17.850Z
...
class bticinoSwitch_18Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('bticino-switch-18 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'bticino-switch-18');
...
module.exports = bticinoSwitch_18Device;
