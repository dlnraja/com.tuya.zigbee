 ...
 * Chemin: drivers/legacy/switches/xiaomi-aqara-switch-4
 * Enrichi le: 2025-08-02T14:11:31.701Z
...
class xiaomiAqaraSwitch_4Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('xiaomi-aqara-switch-4 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'xiaomi-aqara-switch-4');
...
module.exports = xiaomiAqaraSwitch_4Device;
