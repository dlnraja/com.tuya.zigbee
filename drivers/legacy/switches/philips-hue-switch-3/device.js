 ...
 * Chemin: drivers/legacy/switches/philips-hue-switch-3
 * Enrichi le: 2025-08-02T14:11:17.948Z
...
class philipsHueSwitch_3Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('philips-hue-switch-3 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'philips-hue-switch-3');
...
module.exports = philipsHueSwitch_3Device;
