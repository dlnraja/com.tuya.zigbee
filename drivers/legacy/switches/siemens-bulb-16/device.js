 ...
 * Chemin: drivers/legacy/switches/siemens-bulb-16
 * Enrichi le: 2025-08-02T14:11:17.971Z
...
class siemensBulb_16Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('siemens-bulb-16 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'siemens-bulb-16');
...
module.exports = siemensBulb_16Device;
