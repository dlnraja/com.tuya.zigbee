 ...
 * Chemin: drivers/legacy/switches/schneider-switch-10
 * Enrichi le: 2025-08-02T14:11:17.968Z
...
class schneiderSwitch_10Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('schneider-switch-10 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'schneider-switch-10');
...
module.exports = schneiderSwitch_10Device;
