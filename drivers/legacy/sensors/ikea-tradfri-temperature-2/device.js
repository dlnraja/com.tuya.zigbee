 ...
 * Chemin: drivers/legacy/sensors/ikea-tradfri-temperature-2
 * Enrichi le: 2025-08-02T14:11:17.234Z
...
class ikeaTradfriTemperature_2Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('ikea-tradfri-temperature-2 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'ikea-tradfri-temperature-2');
...
module.exports = ikeaTradfriTemperature_2Device;
