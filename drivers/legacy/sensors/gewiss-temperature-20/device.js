 ...
 * Chemin: drivers/legacy/sensors/gewiss-temperature-20
 * Enrichi le: 2025-08-02T14:11:17.222Z
...
class gewissTemperature_20Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('gewiss-temperature-20 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'gewiss-temperature-20');
...
module.exports = gewissTemperature_20Device;
