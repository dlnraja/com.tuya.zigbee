 ...
 * Chemin: drivers/legacy/sensors/sylvania-temperature-7
 * Enrichi le: 2025-08-02T14:11:17.675Z
...
class sylvaniaTemperature_7Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('sylvania-temperature-7 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'sylvania-temperature-7');
...
module.exports = sylvaniaTemperature_7Device;
