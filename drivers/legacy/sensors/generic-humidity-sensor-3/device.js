 ...
 * Chemin: drivers/legacy/sensors/generic-humidity-sensor-3
 * Enrichi le: 2025-08-02T14:11:17.214Z
...
class genericHumiditySensor_3Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('generic-humidity-sensor-3 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'generic-humidity-sensor-3');
...
module.exports = genericHumiditySensor_3Device;
