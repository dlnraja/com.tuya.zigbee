 ...
 * Chemin: drivers/legacy/sensors/schneider-electric-temperature-15
 * Enrichi le: 2025-08-02T14:11:17.659Z
...
class schneiderElectricTemperature_15Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('schneider-electric-temperature-15 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'schneider-electric-temperature-15');
...
module.exports = schneiderElectricTemperature_15Device;
