 ...
 * Chemin: drivers/legacy/sensors/bticino-temperature-18
 * Enrichi le: 2025-08-02T14:11:17.205Z
...
class bticinoTemperature_18Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('bticino-temperature-18 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'bticino-temperature-18');
...
module.exports = bticinoTemperature_18Device;
