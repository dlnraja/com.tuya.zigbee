 ...
 * Chemin: drivers/legacy/sensors/philips-hue-temperature-3
 * Enrichi le: 2025-08-02T14:11:17.326Z
...
class philipsHueTemperature_3Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('philips-hue-temperature-3 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'philips-hue-temperature-3');
...
module.exports = philipsHueTemperature_3Device;
