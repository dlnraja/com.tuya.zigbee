 ...
 * Chemin: drivers/legacy/sensors/bosch-temperature-13
 * Enrichi le: 2025-08-02T14:11:17.202Z
...
class boschTemperature_13Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('bosch-temperature-13 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'bosch-temperature-13');
...
module.exports = boschTemperature_13Device;
