 ...
 * Chemin: drivers/legacy/sensors/ledvance-temperature-9
 * Enrichi le: 2025-08-02T14:11:17.266Z
...
class ledvanceTemperature_9Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('ledvance-temperature-9 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'ledvance-temperature-9');
...
module.exports = ledvanceTemperature_9Device;
