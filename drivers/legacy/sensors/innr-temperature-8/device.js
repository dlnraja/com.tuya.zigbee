 ...
 * Chemin: drivers/legacy/sensors/innr-temperature-8
 * Enrichi le: 2025-08-02T14:11:17.248Z
...
class innrTemperature_8Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('innr-temperature-8 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'innr-temperature-8');
...
module.exports = innrTemperature_8Device;
