 ...
 * Chemin: drivers/legacy/sensors/vimar-temperature-19
 * Enrichi le: 2025-08-02T14:11:17.697Z
...
class vimarTemperature_19Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('vimar-temperature-19 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'vimar-temperature-19');
...
module.exports = vimarTemperature_19Device;
