 ...
 * Chemin: drivers/legacy/sensors/osram-temperature-6
 * Enrichi le: 2025-08-02T14:11:17.317Z
...
class osramTemperature_6Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('osram-temperature-6 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'osram-temperature-6');
...
module.exports = osramTemperature_6Device;
