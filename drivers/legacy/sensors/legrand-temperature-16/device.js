 ...
 * Chemin: drivers/legacy/sensors/legrand-temperature-16
 * Enrichi le: 2025-08-02T14:11:17.295Z
...
class legrandTemperature_16Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('legrand-temperature-16 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'legrand-temperature-16');
...
module.exports = legrandTemperature_16Device;
