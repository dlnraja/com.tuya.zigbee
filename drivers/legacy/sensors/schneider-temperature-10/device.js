 ...
 * Chemin: drivers/legacy/sensors/schneider-temperature-10
 * Enrichi le: 2025-08-02T14:11:17.667Z
...
class schneiderTemperature_10Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('schneider-temperature-10 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'schneider-temperature-10');
...
module.exports = schneiderTemperature_10Device;
