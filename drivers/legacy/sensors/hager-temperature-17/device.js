 ...
 * Chemin: drivers/legacy/sensors/hager-temperature-17
 * Enrichi le: 2025-08-02T14:11:17.230Z
...
class hagerTemperature_17Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('hager-temperature-17 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'hager-temperature-17');
...
module.exports = hagerTemperature_17Device;
