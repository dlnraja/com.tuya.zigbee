 ...
 * Chemin: drivers/legacy/sensors/legrand-temperature-11
 * Enrichi le: 2025-08-02T14:11:17.283Z
...
class legrandTemperature_11Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('legrand-temperature-11 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'legrand-temperature-11');
...
module.exports = legrandTemperature_11Device;
