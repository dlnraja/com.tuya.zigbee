 ...
 * Chemin: drivers/legacy/sensors/samsung-smartthings-temperature-5
 * Enrichi le: 2025-08-02T14:11:17.537Z
...
class samsungSmartthingsTemperature_5Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('samsung-smartthings-temperature-5 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'samsung-smartthings-temperature-5');
...
module.exports = samsungSmartthingsTemperature_5Device;
