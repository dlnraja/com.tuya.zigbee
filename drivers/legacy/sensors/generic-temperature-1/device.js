 ...
 * Chemin: drivers/legacy/sensors/generic-temperature-1
 * Enrichi le: 2025-08-02T14:11:17.219Z
...
class genericTemperature_1Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('generic-temperature-1 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'generic-temperature-1');
...
module.exports = genericTemperature_1Device;
