 ...
 * Chemin: drivers/legacy/sensors/lutron-temperature-12
 * Enrichi le: 2025-08-02T14:11:17.302Z
...
class lutronTemperature_12Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('lutron-temperature-12 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'lutron-temperature-12');
...
module.exports = lutronTemperature_12Device;
