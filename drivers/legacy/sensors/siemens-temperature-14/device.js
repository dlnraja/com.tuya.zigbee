 ...
 * Chemin: drivers/legacy/sensors/siemens-temperature-14
 * Enrichi le: 2025-08-02T14:11:17.670Z
...
class siemensTemperature_14Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('siemens-temperature-14 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'siemens-temperature-14');
...
module.exports = siemensTemperature_14Device;
