 ...
 * Chemin: drivers/legacy/sensors/samsung-smartthings-temperature-41
 * Enrichi le: 2025-08-02T14:11:17.514Z
...
class samsungsmartthingstemperature41Device extends ZigbeeDevice {
    async onMeshInit() {
        try {
            ...
            this.log('samsung-smartthings-temperature-41 initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'samsung-smartthings-temperature-41');
            this.setStoreValue('source', 'historical_recovery');
            this.setStoreValue('category', 'temperature');
            this.setStoreValue('createdAt', '2025-07-31T21:10:00.558Z');
