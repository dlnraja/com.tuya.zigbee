 ...
 * Chemin: drivers/legacy/sensors/xiaomi-aqara-temperature-32
 * Enrichi le: 2025-08-02T14:11:17.788Z
...
class xiaomiaqaratemperature32Device extends ZigbeeDevice {
    async onMeshInit() {
        try {
            ...
            this.log('xiaomi-aqara-temperature-32 initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'xiaomi-aqara-temperature-32');
            this.setStoreValue('source', 'historical_recovery');
            this.setStoreValue('category', 'temperature');
            this.setStoreValue('createdAt', '2025-07-31T21:10:00.863Z');
