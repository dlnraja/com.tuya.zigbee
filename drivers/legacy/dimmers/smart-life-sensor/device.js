 ...
 * Chemin: drivers/legacy/dimmers/smart-life-sensor
 * Enrichi le: 2025-08-02T14:11:16.574Z
...
class smartlifesensorDevice extends ZigbeeDevice {
    async onMeshInit() {
        try {
            ...
            this.log('smart-life-sensor initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'smart-life-sensor');
            this.setStoreValue('source', 'historical_recovery');
            this.setStoreValue('category', 'switches');
            this.setStoreValue('createdAt', '2025-07-31T21:10:01.377Z');
