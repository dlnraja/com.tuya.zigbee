 ...
 * Chemin: drivers/legacy/dimmers/ts0601blind
 * Enrichi le: 2025-08-02T14:11:16.870Z
...
class ts0601blindDevice extends Device {
    async onInit() {
        this.log('ts0601blind device initialized (enriched version)');
