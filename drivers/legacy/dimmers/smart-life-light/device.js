 ...
 * Chemin: drivers/legacy/dimmers/smart-life-light
 * Enrichi le: 2025-08-02T14:11:16.563Z
...
class smartlifelightDevice extends ZigbeeDevice {
    async onMeshInit() {
        try {
            ...
            this.log('smart-life-light initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'smart-life-light');
            this.setStoreValue('source', 'historical_recovery');
            this.setStoreValue('category', 'switches');
            this.setStoreValue('createdAt', '2025-07-31T21:10:01.357Z');
