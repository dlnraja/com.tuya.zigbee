 ...
 * Chemin: drivers/legacy/dimmers/ts0001
 * Enrichi le: 2025-08-02T14:11:16.669Z
...
class ts0001Device extends Device {
    async onInit() {
        this.log('ts0001 device initialized (enriched version)');
