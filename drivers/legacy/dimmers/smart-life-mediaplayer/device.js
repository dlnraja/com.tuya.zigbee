 ...
 * Chemin: drivers/legacy/dimmers/smart-life-mediaplayer
 * Enrichi le: 2025-08-02T14:11:16.571Z
...
class smartlifemediaplayerDevice extends ZigbeeDevice {
    async onMeshInit() {
        try {
            ...
            this.log('smart-life-mediaplayer initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'smart-life-mediaplayer');
            this.setStoreValue('source', 'historical_recovery');
            this.setStoreValue('category', 'switches');
            this.setStoreValue('createdAt', '2025-07-31T21:10:02.062Z');
