 ...
 * Chemin: drivers/legacy/dimmers/ts0601rgb
 * Enrichi le: 2025-08-02T14:11:16.904Z
...
class ts0601rgbDevice extends Device {
    async onInit() {
        this.log('ts0601rgb device initialized (enriched version)');
