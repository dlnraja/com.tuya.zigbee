 ...
 * Chemin: drivers/legacy/dimmers/tuya-light-rgbww
 * Enrichi le: 2025-08-02T14:11:17.032Z
...
class tuyalightrgbwwDevice extends ZigbeeDevice {
    async onMeshInit() {
        try {
            await super.onMeshInit();
            this.log('tuya-light-rgbww initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'tuya-light-rgbww');
            this.setStoreValue('source', 'tuya_light_recovery');
            this.setStoreValue('category', 'lights');
            this.setStoreValue('createdAt', '2025-07-31T21:24:23.521Z');
...
module.exports = tuyalightrgbwwDevice;