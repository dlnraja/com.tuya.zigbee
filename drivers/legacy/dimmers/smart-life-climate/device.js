 ...
 * Chemin: drivers/legacy/dimmers/smart-life-climate
 * Enrichi le: 2025-08-02T14:11:16.539Z
...
class smartlifeclimateDevice extends ZigbeeDevice {
    async onMeshInit() {
        try {
            ...
            this.log('smart-life-climate initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'smart-life-climate');
            this.setStoreValue('source', 'historical_recovery');
            this.setStoreValue('category', 'switches');
            this.setStoreValue('createdAt', '2025-07-31T21:10:01.410Z');
