 ...
 * Chemin: drivers/legacy/dimmers/ts0008
 * Enrichi le: 2025-08-02T14:11:16.765Z
...
class ts0008Device extends Device {
    async onInit() {
        this.log('ts0008 device initialized (enriched version)');
