 ...
 * Chemin: drivers/legacy/dimmers/smart-life-vacuum
 * Enrichi le: 2025-08-02T14:11:16.584Z
...
class smartlifevacuumDevice extends ZigbeeDevice {
    async onMeshInit() {
        try {
            ...
            this.log('smart-life-vacuum initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'smart-life-vacuum');
            this.setStoreValue('source', 'historical_recovery');
            this.setStoreValue('category', 'switches');
            this.setStoreValue('createdAt', '2025-07-31T21:10:02.129Z');
