 ...
 * Chemin: drivers/legacy/dimmers/osram-strips-22
 * Enrichi le: 2025-08-02T14:11:16.252Z
...
class osramstrips22Device extends ZigbeeDevice {
    async onMeshInit() {
        try {
            await super.onMeshInit();
            this.log('osram-strips-22 initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'osram-strips-22');
            this.setStoreValue('source', 'historical_recovery');
            this.setStoreValue('category', 'lights');
            this.setStoreValue('createdAt', '2025-07-31T21:09:59.888Z');
...
module.exports = osramstrips22Device;