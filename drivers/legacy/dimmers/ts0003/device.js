 ...
 * Chemin: drivers/legacy/dimmers/ts0003
 * Enrichi le: 2025-08-02T14:11:16.735Z
...
class ts0003Device extends Device {
    async onInit() {
        this.log('ts0003 device initialized (enriched version)');
