 ...
 * Chemin: drivers/legacy/dimmers/ts011i
 * Enrichi le: 2025-08-02T14:11:16.782Z
...
class ts011iDevice extends Device {
    async onInit() {
        this.log('ts011i device initialized (enriched version)');
