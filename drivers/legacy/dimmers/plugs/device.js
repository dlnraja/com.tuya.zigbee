 ...
 * Chemin: drivers/legacy/dimmers/plugs
 * Enrichi le: 2025-08-02T14:11:16.528Z
...
class plugsDevice extends Device {
    async onInit() {
        this.log('plugs device initialized (enriched version)');
