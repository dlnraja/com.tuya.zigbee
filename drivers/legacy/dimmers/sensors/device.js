 ...
 * Chemin: drivers/legacy/dimmers/sensors
 * Enrichi le: 2025-08-02T14:11:16.531Z
...
class sensorsDevice extends Device {
    async onInit() {
        this.log('sensors device initialized (enriched version)');
