 ...
 * Chemin: drivers/legacy/dimmers/ts0601vibration
 * Enrichi le: 2025-08-02T14:11:16.926Z
...
class ts0601vibrationDevice extends Device {
    async onInit() {
        this.log('ts0601vibration device initialized (enriched version)');
