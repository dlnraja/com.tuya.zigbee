 ...
 * Chemin: drivers/legacy/dimmers/ts0123
 * Enrichi le: 2025-08-02T14:11:16.801Z
...
class ts0123Device extends Device {
    async onInit() {
        this.log('ts0123 device initialized (enriched version)');
