 ...
 * Chemin: drivers/legacy/dimmers/_tz3600
 * Enrichi le: 2025-08-02T14:11:17.086Z
...
class _tz3600Device extends Device {
    async onInit() {
        this.log('_tz3600 device initialized (enriched version)');
