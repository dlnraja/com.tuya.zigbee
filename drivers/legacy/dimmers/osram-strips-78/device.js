 ...
 * Chemin: drivers/legacy/dimmers/osram-strips-78
 * Enrichi le: 2025-08-02T14:11:16.354Z
...
class osramstrips78Device extends ZigbeeDevice {
    async onMeshInit() {
        try {
            ...
            this.log('osram-strips-78 initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'osram-strips-78');
            this.setStoreValue('source', 'historical_recovery');
            this.setStoreValue('category', 'lights');
            this.setStoreValue('createdAt', '2025-07-31T21:09:59.999Z');
