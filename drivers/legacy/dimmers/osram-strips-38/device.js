 ...
 * Chemin: drivers/legacy/dimmers/osram-strips-38
 * Enrichi le: 2025-08-02T14:11:16.270Z
...
class osramstrips38Device extends ZigbeeDevice {
    async onMeshInit() {
        try {
            await super.onMeshInit();
            this.log('osram-strips-38 initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'osram-strips-38');
            this.setStoreValue('source', 'historical_recovery');
            this.setStoreValue('category', 'lights');
            this.setStoreValue('createdAt', '2025-07-31T21:09:59.926Z');
...
module.exports = osramstrips38Device;