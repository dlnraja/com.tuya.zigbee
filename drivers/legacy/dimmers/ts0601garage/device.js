 ...
 * Chemin: drivers/legacy/dimmers/ts0601garage
 * Enrichi le: 2025-08-02T14:11:16.888Z
...
class ts0601garageDevice extends Device {
    async onInit() {
        this.log('ts0601garage device initialized (enriched version)');
