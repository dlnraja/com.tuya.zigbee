 ...
 * Chemin: drivers/legacy/dimmers/ts0007
 * Enrichi le: 2025-08-02T14:11:16.755Z
...
class ts0007Device extends Device {
    async onInit() {
        this.log('ts0007 device initialized (enriched version)');
