 ...
 * Chemin: drivers/legacy/dimmers/smart-life-lock
 * Enrichi le: 2025-08-02T14:11:16.568Z
...
class smartlifelockDevice extends ZigbeeDevice {
    async onMeshInit() {
        try {
            ...
            this.log('smart-life-lock initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'smart-life-lock');
            this.setStoreValue('source', 'historical_recovery');
            this.setStoreValue('category', 'switches');
            this.setStoreValue('createdAt', '2025-07-31T21:10:02.009Z');
