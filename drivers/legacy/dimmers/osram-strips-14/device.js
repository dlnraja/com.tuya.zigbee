 ...
 * Chemin: drivers/legacy/dimmers/osram-strips-14
 * Enrichi le: 2025-08-02T14:11:16.221Z
...
class osramstrips14Device extends ZigbeeDevice {
    async onMeshInit() {
        try {
            await super.onMeshInit();
            this.log('osram-strips-14 initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'osram-strips-14');
            this.setStoreValue('source', 'historical_recovery');
            this.setStoreValue('category', 'lights');
            this.setStoreValue('createdAt', '2025-07-31T21:09:59.874Z');
...
module.exports = osramstrips14Device;