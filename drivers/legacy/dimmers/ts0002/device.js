 ...
 * Chemin: drivers/legacy/dimmers/ts0002
 * Enrichi le: 2025-08-02T14:11:16.726Z
...
class ts0002Device extends Device {
    async onInit() {
        this.log('ts0002 device initialized (enriched version)');
