 ...
 * Chemin: drivers/legacy/dimmers/tuya-light-rgbw
 * Enrichi le: 2025-08-02T14:11:17.027Z
...
class tuyalightrgbwDevice extends ZigbeeDevice {
    async onMeshInit() {
        try {
            await super.onMeshInit();
            this.log('tuya-light-rgbw initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'tuya-light-rgbw');
            this.setStoreValue('source', 'tuya_light_recovery');
            this.setStoreValue('category', 'lights');
            this.setStoreValue('createdAt', '2025-07-31T21:24:23.515Z');
...
module.exports = tuyalightrgbwDevice;