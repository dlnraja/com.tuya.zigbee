 ...
 * Chemin: drivers/legacy/dimmers/ts0601thermostat
 * Enrichi le: 2025-08-02T14:11:16.920Z
...
class ts0601thermostatDevice extends Device {
    async onInit() {
        this.log('ts0601thermostat device initialized (enriched version)');
