 ...
 * Chemin: drivers/legacy/dimmers/ts0601dimmer
 * Enrichi le: 2025-08-02T14:11:16.884Z
...
class ts0601dimmerDevice extends Device {
    async onInit() {
        this.log('ts0601dimmer device initialized (enriched version)');
