 ...
 * Chemin: drivers/legacy/dimmers/ts0601lock
 * Enrichi le: 2025-08-02T14:11:16.897Z
...
class ts0601lockDevice extends Device {
    async onInit() {
        this.log('ts0601lock device initialized (enriched version)');
