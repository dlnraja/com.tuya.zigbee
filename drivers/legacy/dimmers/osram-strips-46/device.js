 ...
 * Chemin: drivers/legacy/dimmers/osram-strips-46
 * Enrichi le: 2025-08-02T14:11:16.280Z
...
class osramstrips46Device extends ZigbeeDevice {
    async onMeshInit() {
        try {
            await super.onMeshInit();
            this.log('osram-strips-46 initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'osram-strips-46');
            this.setStoreValue('source', 'historical_recovery');
            this.setStoreValue('category', 'lights');
            this.setStoreValue('createdAt', '2025-07-31T21:09:59.949Z');
...
module.exports = osramstrips46Device;