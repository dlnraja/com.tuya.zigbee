 ...
 * Chemin: drivers/legacy/dimmers/ts0601water
 * Enrichi le: 2025-08-02T14:11:16.932Z
...
class ts0601waterDevice extends Device {
    async onInit() {
        this.log('ts0601water device initialized (enriched version)');
