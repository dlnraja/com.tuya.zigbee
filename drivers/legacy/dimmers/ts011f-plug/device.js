 ...
 * Chemin: drivers/legacy/dimmers/ts011f-plug
 * Enrichi le: 2025-08-02T14:11:16.768Z
...
class ts011f-plugDevice extends Device {
    async onInit() {
        this.log('ts011f-plug device initialized (enriched version)');
