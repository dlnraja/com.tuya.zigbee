 ...
 * Chemin: drivers/legacy/dimmers/ts0601gas
 * Enrichi le: 2025-08-02T14:11:16.892Z
...
class ts0601gasDevice extends Device {
    async onInit() {
        this.log('ts0601gas device initialized (enriched version)');
