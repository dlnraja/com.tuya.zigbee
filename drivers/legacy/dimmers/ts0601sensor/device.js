 ...
 * Chemin: drivers/legacy/dimmers/ts0601sensor
 * Enrichi le: 2025-08-02T14:11:16.909Z
...
class ts0601sensorDevice extends Device {
    async onInit() {
        this.log('ts0601sensor device initialized (enriched version)');
