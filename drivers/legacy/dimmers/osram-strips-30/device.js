 ...
 * Chemin: drivers/legacy/dimmers/osram-strips-30
 * Enrichi le: 2025-08-02T14:11:16.258Z
...
class osramstrips30Device extends ZigbeeDevice {
    async onMeshInit() {
        try {
            await super.onMeshInit();
            this.log('osram-strips-30 initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'osram-strips-30');
            this.setStoreValue('source', 'historical_recovery');
            this.setStoreValue('category', 'lights');
            this.setStoreValue('createdAt', '2025-07-31T21:09:59.907Z');
...
module.exports = osramstrips30Device;