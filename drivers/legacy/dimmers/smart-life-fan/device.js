 ...
 * Chemin: drivers/legacy/dimmers/smart-life-fan
 * Enrichi le: 2025-08-02T14:11:16.554Z
...
class smartlifefanDevice extends ZigbeeDevice {
    async onMeshInit() {
        try {
            ...
            this.log('smart-life-fan initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'smart-life-fan');
            this.setStoreValue('source', 'historical_recovery');
            this.setStoreValue('category', 'switches');
            this.setStoreValue('createdAt', '2025-07-31T21:10:01.759Z');
