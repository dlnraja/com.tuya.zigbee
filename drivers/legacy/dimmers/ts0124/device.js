 ...
 * Chemin: drivers/legacy/dimmers/ts0124
 * Enrichi le: 2025-08-02T14:11:16.804Z
...
class ts0124Device extends Device {
    async onInit() {
        this.log('ts0124 device initialized (enriched version)');
