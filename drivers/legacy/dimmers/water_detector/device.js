 ...
 * Chemin: drivers/legacy/dimmers/water_detector
 * Enrichi le: 2025-08-02T14:11:17.049Z
...
class waterdetectorDevice extends ZigbeeDevice {
    async onMeshInit() {
        try {
            await super.onMeshInit();
            this.log('water_detector initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'water_detector');
            this.setStoreValue('source', 'historical_recovery');
            this.setStoreValue('category', 'switches');
            this.setStoreValue('createdAt', '2025-07-31T21:10:01.294Z');
