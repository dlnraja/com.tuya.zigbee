 ...
 * Chemin: drivers/legacy/dimmers/lights
 * Enrichi le: 2025-08-02T14:11:16.209Z
...
class lightsDevice extends Device {
    async onInit() {
        this.log('lights device initialized (enriched version)');
