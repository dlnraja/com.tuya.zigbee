 ...
 * Chemin: drivers/legacy/dimmers/ts0601switch
 * Enrichi le: 2025-08-02T14:11:16.918Z
...
class ts0601switchDevice extends Device {
    async onInit() {
        this.log('ts0601switch device initialized (enriched version)');
