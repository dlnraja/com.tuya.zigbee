 ...
 * Chemin: drivers/legacy/dimmers/controls
 * Enrichi le: 2025-08-02T14:11:16.204Z
...
class controlsDevice extends Device {
    async onInit() {
        this.log('controls device initialized (enriched version)');
