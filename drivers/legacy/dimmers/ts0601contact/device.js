 ...
 * Chemin: drivers/legacy/dimmers/ts0601contact
 * Enrichi le: 2025-08-02T14:11:16.872Z
...
class ts0601contactDevice extends Device {
    async onInit() {
        this.log('ts0601contact device initialized (enriched version)');
