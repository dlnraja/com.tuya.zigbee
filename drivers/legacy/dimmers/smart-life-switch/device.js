 ...
 * Chemin: drivers/legacy/dimmers/smart-life-switch
 * Enrichi le: 2025-08-02T14:11:16.579Z
...
class smartlifeswitchDevice extends ZigbeeDevice {
    async onMeshInit() {
        try {
            ...
            this.log('smart-life-switch initialized');
            ...
            // Add metadata
            this.setStoreValue('modelId', 'smart-life-switch');
            this.setStoreValue('source', 'historical_recovery');
            this.setStoreValue('category', 'switches');
            this.setStoreValue('createdAt', '2025-07-31T21:10:01.346Z');
