 ...
 * Chemin: drivers/legacy/generic/innr-motion-14
 * Enrichi le: 2025-08-02T14:11:17.138Z
...
class innrMotion_14Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('innr-motion-14 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'innr-motion-14');
...
module.exports = innrMotion_14Device;
