 ...
 * Chemin: drivers/legacy/generic/lutron-motion-18
 * Enrichi le: 2025-08-02T14:11:17.152Z
...
class lutronMotion_18Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('lutron-motion-18 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'lutron-motion-18');
...
module.exports = lutronMotion_18Device;
