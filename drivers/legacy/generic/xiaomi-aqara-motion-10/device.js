 ...
 * Chemin: drivers/legacy/generic/xiaomi-aqara-motion-10
 * Enrichi le: 2025-08-02T14:11:17.198Z
...
class xiaomiAqaraMotion_10Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('xiaomi-aqara-motion-10 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'xiaomi-aqara-motion-10');
...
module.exports = xiaomiAqaraMotion_10Device;
