 ...
 * Chemin: drivers/legacy/generic/generic-gas-sensor-5
 * Enrichi le: 2025-08-02T14:11:17.118Z
...
class genericGasSensor_5Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('generic-gas-sensor-5 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'generic-gas-sensor-5');
...
module.exports = genericGasSensor_5Device;
