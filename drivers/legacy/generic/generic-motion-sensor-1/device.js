 ...
 * Chemin: drivers/legacy/generic/generic-motion-sensor-1
 * Enrichi le: 2025-08-02T14:11:17.120Z
...
class genericMotionSensor_1Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('generic-motion-sensor-1 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'generic-motion-sensor-1');
...
module.exports = genericMotionSensor_1Device;
