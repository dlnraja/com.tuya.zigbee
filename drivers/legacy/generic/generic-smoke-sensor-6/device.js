 ...
 * Chemin: drivers/legacy/generic/generic-smoke-sensor-6
 * Enrichi le: 2025-08-02T14:11:17.127Z
...
class genericSmokeSensor_6Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('generic-smoke-sensor-6 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'generic-smoke-sensor-6');
...
module.exports = genericSmokeSensor_6Device;
