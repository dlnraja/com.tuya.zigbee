 ...
 * Chemin: drivers/legacy/generic/ledvance-motion-15
 * Enrichi le: 2025-08-02T14:11:17.143Z
...
class ledvanceMotion_15Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('ledvance-motion-15 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'ledvance-motion-15');
...
module.exports = ledvanceMotion_15Device;
