 ...
 * Chemin: drivers/legacy/generic/sylvania-motion-13
 * Enrichi le: 2025-08-02T14:11:17.184Z
...
class sylvaniaMotion_13Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('sylvania-motion-13 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'sylvania-motion-13');
...
module.exports = sylvaniaMotion_13Device;
