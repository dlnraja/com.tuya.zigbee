 ...
 * Chemin: drivers/legacy/generic/generic-contact-sensor-2
 * Enrichi le: 2025-08-02T14:11:17.115Z
...
class genericContactSensor_2Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('generic-contact-sensor-2 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'generic-contact-sensor-2');
...
module.exports = genericContactSensor_2Device;
