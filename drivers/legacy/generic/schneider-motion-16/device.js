 ...
 * Chemin: drivers/legacy/generic/schneider-motion-16
 * Enrichi le: 2025-08-02T14:11:17.170Z
...
class schneiderMotion_16Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('schneider-motion-16 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'schneider-motion-16');
...
module.exports = schneiderMotion_16Device;
