 ...
 * Chemin: drivers/legacy/generic/generic-pressure-sensor-4
 * Enrichi le: 2025-08-02T14:11:17.122Z
...
class genericPressureSensor_4Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('generic-pressure-sensor-4 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'generic-pressure-sensor-4');
...
module.exports = genericPressureSensor_4Device;
