 ...
 * Chemin: drivers/legacy/generic/osram-motion-12
 * Enrichi le: 2025-08-02T14:11:17.154Z
...
class osramMotion_12Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('osram-motion-12 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'osram-motion-12');
...
module.exports = osramMotion_12Device;
