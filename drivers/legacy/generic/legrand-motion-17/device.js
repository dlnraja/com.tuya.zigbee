 ...
 * Chemin: drivers/legacy/generic/legrand-motion-17
 * Enrichi le: 2025-08-02T14:11:17.148Z
...
class legrandMotion_17Device extends ZigbeeDevice {
    async onMeshInit() {
        this.log('legrand-motion-17 initialized');
        
        // Enable debugging
        this.enableDebug();
        
        // Set device info
        this.setStoreValue('modelId', 'legrand-motion-17');
...
module.exports = legrandMotion_17Device;
