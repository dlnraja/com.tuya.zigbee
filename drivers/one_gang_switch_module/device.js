...
class OneGangSwitchModuleDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('One gang switch module has been initialized');
    }
    ...
    onDeleted() {
        this.log('One gang switch module has been deleted');
    }
}

module.exports = OneGangSwitchModuleDevice;