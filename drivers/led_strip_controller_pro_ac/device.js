...
class LedStripControllerProAcDevice extends ZigBeeDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('led_strip_controller_pro_ac initialized');
    ...
    const deviceType = TuyaClusterHandler.detectDeviceType('led_strip_controller_pro_ac');
  ...
  async onDeleted() {
    this.log('led_strip_controller_pro_ac deleted');
  }
  // ========================================
...
module.exports = LedStripControllerProAcDevice;
