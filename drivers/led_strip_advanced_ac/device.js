...
class LedStripAdvancedAcDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('led_strip_advanced_ac initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('led_strip_advanced_ac');
  ...
  async onDeleted() {
    this.log('led_strip_advanced_ac deleted');
  }
  // ========================================
...
module.exports = LedStripAdvancedAcDevice;
