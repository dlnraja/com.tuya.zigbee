...
class TemperatureAndHumiditySensorDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Temperature and humidity sensor has been initialized');
    }
    ...
    onDeleted() {
        this.log('Temperature and humidity sensor has been deleted');
    }
}

module.exports = TemperatureAndHumiditySensorDevice;