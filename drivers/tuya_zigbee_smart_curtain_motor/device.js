...
class TuyaZigbeeSmartCurtainMotorDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Tuya zigbee smart curtain motor has been initialized');
    }
    ...
    onDeleted() {
        this.log('Tuya zigbee smart curtain motor has been deleted');
    }
}

module.exports = TuyaZigbeeSmartCurtainMotorDevice;