...
class MoesStarRingSmartKnobThermostatDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Moes Star Ring Smart Knob Thermostat has been initialized');
    }
    ...
    onDeleted() {
        this.log('Moes Star Ring Smart Knob Thermostat has been deleted');
    }
}

module.exports = MoesStarRingSmartKnobThermostatDevice;