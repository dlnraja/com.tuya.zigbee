...
// Device Type: zigbee
// Category: switches
// Subcategory: wall_switch_2_gang
// Enrichment Date: 2025-08-07T17:53:57.227Z
...
class Wallswitch2gang extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Wallswitch2gang SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Wallswitch2gang Enhanced deleted');
  }
...
module.exports = Wallswitch2gang;
