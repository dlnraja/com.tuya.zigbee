...
// Device Type: zigbee
// Category: switches
// Subcategory: switch_1_gang_metering
// Enrichment Date: 2025-08-07T17:53:57.074Z
...
class Switch1gangmetering extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Switch1gangmetering SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Switch1gangmetering Enhanced deleted');
  }
...
module.exports = Switch1gangmetering;
