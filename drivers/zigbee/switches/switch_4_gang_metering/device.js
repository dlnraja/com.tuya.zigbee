...
// Device Type: zigbee
// Category: switches
// Subcategory: switch_4_gang_metering
// Enrichment Date: 2025-08-07T17:53:57.125Z
...
class Switch4gangmetering extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Switch4gangmetering SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Switch4gangmetering Enhanced deleted');
  }
...
module.exports = Switch4gangmetering;
