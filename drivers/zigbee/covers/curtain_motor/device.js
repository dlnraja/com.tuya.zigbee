...
// Device Type: zigbee
// Category: covers
// Subcategory: curtain_motor
// Enrichment Date: 2025-08-07T17:53:55.404Z
...
class Curtainmotor extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Curtainmotor SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Curtainmotor Enhanced deleted');
  }
