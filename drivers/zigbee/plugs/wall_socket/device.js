...
// Enrichment Date: 2025-08-07T17:53:56.463Z
...
class Wallsocket extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Wallsocket SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Wallsocket Enhanced deleted');
  }
