...
// Subcategory: thermostatic_radiator_valve
// Enrichment Date: 2025-08-07T17:53:57.371Z

'use strict';

const { ZigBeeDriver } = require('homey-meshdriver');

class Thermostatic_radiator_valveDriver extends ZigBeeDriver {
    ...
    this.printNode();
        ...
        this.log('🚀 thermostatic_radiator_valve Driver - Initialisation MEGA enrichie...');
        ...
        this.log('✅ thermostatic_radiator_valve Driver - Initialisation MEGA terminée');
    }
...
module.exports = Thermostatic_radiator_valveDriver;