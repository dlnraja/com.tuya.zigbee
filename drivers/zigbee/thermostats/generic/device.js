...
class GenericDevice extends TuyaDevice {
    async onInit() {
        ...
        this.log('generic device initializing (optimized)...');
        
        // Optimisations de performance
        this.setupOptimizedPolling();
        this.setupMemoryManagement();
        this.setupErrorHandling();
        this.log('generic device initializing...');
        await this.initializeCapabilities();
        this.setupPolling();
    }

    async initializeCapabilities() {
        this.log('Initializing capabilities for generic');
    ...
    async pollDevice() {
        try {
            this.log('Polling generic device...');
