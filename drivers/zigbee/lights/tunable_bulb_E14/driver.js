...
// Driver Type: zigbee
// Category: lights
// Subcategory: tunable_bulb_E14
// Enrichment Date: 2025-08-07T17:53:55.786Z

'use strict';

const { ZigBeeDriver } = require('homey-meshdriver');

class Tunable_bulb_E14Driver extends ZigBeeDriver {
    ...
    this.printNode();
        ...
        this.log('🚀 tunable_bulb_E14 Driver - Initialisation MEGA enrichie...');
        ...
        this.log('✅ tunable_bulb_E14 Driver - Initialisation MEGA terminée');
    }
...
module.exports = Tunable_bulb_E14Driver;