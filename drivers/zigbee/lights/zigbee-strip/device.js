...
class ZigbeestripDevice extends TuyaDevice {
    async onInit() {
        // OPTIMIZED VERSION 3.5.4
        this.log('zigbee-strip device initializing (optimized)...');
        
        // Optimisations de performance
        this.setupOptimizedPolling();
        this.setupMemoryManagement();
        this.setupErrorHandling();
        this.log('zigbee-strip device initializing...');
        await this.initializeCapabilities();
        this.setupPolling();
    }

    async initializeCapabilities() {
        this.log('Initializing capabilities for zigbee-strip');
    ...
    async pollDevice() {
        try {
            this.log('Polling zigbee-strip device...');
...
module.exports = ZigbeestripDevice;
