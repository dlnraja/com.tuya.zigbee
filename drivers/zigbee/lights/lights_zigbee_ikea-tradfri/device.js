...
class Ikea-tradfriDevice extends ZigbeeDevice {
    async onInit() {
        await super.onInit();
        
        this.log('🚀 ikea-tradfri device initialized');
        this.log('📅 Enriched: 2025-08-05T08:40:39.365Z');
...
module.exports = Ikea-tradfriDevice;
