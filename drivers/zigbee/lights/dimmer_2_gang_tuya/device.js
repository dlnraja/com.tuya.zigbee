...
class Dimmer2gangtuya extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Dimmer2gangtuya SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Dimmer2gangtuya Enhanced deleted');
  }
...
module.exports = Dimmer2gangtuya;
