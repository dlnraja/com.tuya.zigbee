...
// Enrichment Date: 2025-08-07T17:53:55.617Z

'use strict';

const { ZigBeeDevice } = require('homey-meshdriver');

class Rgb_floor_led_lightDevice extends ZigBeeDevice {
    ...
    this.printNode();
        ...
        this.log('🚀 rgb_floor_led_light - Initialisation MEGA enrichie...');
        ...
        this.log('✅ rgb_floor_led_light - Initialisation MEGA terminée');
    }
...
module.exports = Rgb_floor_led_lightDevice;