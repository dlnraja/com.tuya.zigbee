...
class Smartgardenirrigationcontrol extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Smartgardenirrigationcontrol SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Smartgardenirrigationcontrol Enhanced deleted');
  }
