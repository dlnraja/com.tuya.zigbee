...
// Device Type: zigbee
// Category: onoff
// Subcategory: double_power_point
// Enrichment Date: 2025-08-07T17:53:55.961Z
...
class Doublepowerpoint extends ZigBeeDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('Doublepowerpoint SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Doublepowerpoint Enhanced deleted');
  }
