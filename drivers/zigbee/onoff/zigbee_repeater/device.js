...
// Device Type: zigbee
// Category: onoff
// Subcategory: zigbee_repeater
// Enrichment Date: 2025-08-07T17:53:56.217Z
...
class Zigbeerepeater extends ZigBeeDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('Zigbeerepeater SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Zigbeerepeater Enhanced deleted');
  }
