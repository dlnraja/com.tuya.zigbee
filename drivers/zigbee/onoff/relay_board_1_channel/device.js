...
// Device Type: zigbee
// Category: onoff
// Subcategory: relay_board_1_channel
// Enrichment Date: 2025-08-07T17:53:56.025Z
...
class Relayboard1channel extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Relayboard1channel SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Relayboard1channel Enhanced deleted');
  }
...
module.exports = Relayboard1channel;
