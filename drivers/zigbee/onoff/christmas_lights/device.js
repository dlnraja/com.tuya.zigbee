...
// Device Type: zigbee
// Category: onoff
// Subcategory: christmas_lights
// Enrichment Date: 2025-08-07T17:53:55.890Z

'use strict';

const TuyaZigBeeLightDevice = require('../../lib/TuyaZigBeeLightDevice');

class Christmaslights extends TuyaZigBeeLightDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Christmaslights RGB Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Christmaslights RGB Enhanced deleted');
  }
