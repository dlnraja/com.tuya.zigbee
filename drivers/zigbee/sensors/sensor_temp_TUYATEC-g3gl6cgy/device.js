...
// Device Type: zigbee
// Category: sensors
// Subcategory: sensor_temp_TUYATEC-g3gl6cgy
// Enrichment Date: 2025-08-07T17:53:56.788Z
...
class Sensortemptuyatecg3gl6cgy extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Sensortemptuyatecg3gl6cgy SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Sensortemptuyatecg3gl6cgy Enhanced deleted');
  }
