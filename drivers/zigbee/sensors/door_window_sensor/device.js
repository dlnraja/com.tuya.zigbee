...
// Device Type: zigbee
// Category: sensors
// Subcategory: door_window_sensor
// Enrichment Date: 2025-08-07T17:53:56.561Z
...
class Doorwindowsensor extends ZigBeeDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('Doorwindowsensor SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Doorwindowsensor Enhanced deleted');
  }
