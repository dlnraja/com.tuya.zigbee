...
class Samsungsmartthingstemperature76Device extends ZigbeeDevice {
    ...
    async onInit() {
        ...
        // Initialize device
        this.log('samsung-smartthings-temperature-76 device initialized');
    ...
    async onUninit() {
        ...
        this.log('samsung-smartthings-temperature-76 device uninitialized');
    }
    ...
    async onSettings({ oldSettings, newSettings, changedKeys }) {
        ...
        this.log('samsung-smartthings-temperature-76 settings updated');
    }
}
