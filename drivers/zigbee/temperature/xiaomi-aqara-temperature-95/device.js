...
class Xiaomiaqaratemperature95Device extends ZigbeeDevice {
    ...
    async onInit() {
        ...
        // Initialize device
        this.log('xiaomi-aqara-temperature-95 device initialized');
    ...
    async onUninit() {
        ...
        this.log('xiaomi-aqara-temperature-95 device uninitialized');
    }
    ...
    async onSettings({ oldSettings, newSettings, changedKeys }) {
        ...
        this.log('xiaomi-aqara-temperature-95 settings updated');
    }
}
