...
class Xiaomiaqaratemperature137Device extends ZigbeeDevice {
    ...
    async onInit() {
        ...
        // Initialize device
        this.log('xiaomi-aqara-temperature-137 device initialized');
    ...
    async onUninit() {
        ...
        this.log('xiaomi-aqara-temperature-137 device uninitialized');
    }
    ...
    async onSettings({ oldSettings, newSettings, changedKeys }) {
        ...
        this.log('xiaomi-aqara-temperature-137 settings updated');
    }
}
