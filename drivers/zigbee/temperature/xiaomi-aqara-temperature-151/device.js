...
class Xiaomiaqaratemperature151Device extends ZigbeeDevice {
    ...
    async onInit() {
        ...
        // Initialize device
        this.log('xiaomi-aqara-temperature-151 device initialized');
    ...
    async onUninit() {
        ...
        this.log('xiaomi-aqara-temperature-151 device uninitialized');
    }
    ...
    async onSettings({ oldSettings, newSettings, changedKeys }) {
        ...
        this.log('xiaomi-aqara-temperature-151 settings updated');
    }
}
