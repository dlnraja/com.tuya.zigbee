...
class Samsungsmartthingstemperature62Device extends ZigbeeDevice {
    ...
    async onInit() {
        ...
        // Initialize device
        this.log('samsung-smartthings-temperature-62 device initialized');
    ...
    async onUninit() {
        ...
        this.log('samsung-smartthings-temperature-62 device uninitialized');
    }
    ...
    async onSettings({ oldSettings, newSettings, changedKeys }) {
        ...
        this.log('samsung-smartthings-temperature-62 settings updated');
    }
}
