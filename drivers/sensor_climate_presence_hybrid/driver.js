...
class PresenceSensorRadarDriver extends ZigBeeDriver {
  ...
  _registerFlowCards() {
    ...
    try {
      (() => { try { return (() => { try { return this.homey.flow.getConditionCard('presence_sensor_radar_is_present'); } catch(e) { return null; } })(); } catch(e) { return null; } })()
    ...
    try {
      (() => { try { return (() => { try { return this.homey.flow.getConditionCard('presence_sensor_radar_illuminance_above'); } catch(e) { return null; } })(); } catch(e) { return null; } })()
        .registerRunListener(async (args) => {
          if (!args.device) return false;
    ...
    try {
      (() => { try { return (() => { try { return this.homey.flow.getConditionCard('presence_sensor_radar_distance_within'); } catch(e) { return null; } })(); } catch(e) { return null; } })()
        .registerRunListener(async (args) => {
          if (!args.device) return false;
