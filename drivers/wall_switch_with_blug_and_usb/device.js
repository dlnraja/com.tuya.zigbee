...
class WallSwitchWithBlugAndUsbDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Wall switch with blug and USB has been initialized');
    }
    ...
    onDeleted() {
        this.log('Wall switch with blug and USB has been deleted');
    }
}

module.exports = WallSwitchWithBlugAndUsbDevice;