...
class DeviceRequestAlreadyFixedGirierTuyaSmartZigDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Device Request / already fixed- GIRIER Tuya Smart ZigBee has been initialized');
    }
    ...
    onDeleted() {
        this.log('Device Request / already fixed- GIRIER Tuya Smart ZigBee has been deleted');
    }
}

module.exports = DeviceRequestAlreadyFixedGirierTuyaSmartZigDevice;