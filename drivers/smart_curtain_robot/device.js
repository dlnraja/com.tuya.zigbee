...
class SmartCurtainRobotDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('smart curtain robot has been initialized');
    }
    ...
    onDeleted() {
        this.log('smart curtain robot has been deleted');
    }
}

module.exports = SmartCurtainRobotDevice;