  ...
  async _triggerPresenceFlows(detected) {
    try {
      if (detected) {
        ...
        this._getFlowCard('sensor_motion_presence_hybrid_presence_detected')?.trigger(this, {}, {}).catch(this.error || console.error)
        ...
        this._getFlowCard('sensor_motion_presence_hybrid_presence_cleared')?.trigger(this, {}, {}).catch(this.error || console.error)
