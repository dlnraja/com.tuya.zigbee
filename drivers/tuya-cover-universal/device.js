...
class TuyaCoverUniversalDevice extends ZigBeeDevice {
  
  async onMeshInit() {
    await super.onMeshInit();
    
    // Log device initialization
    this.log('🔌 cover Tuya Universal initialisé');
  ...
  setupFlowCards() {
    try {
      ...
      this.registerFlowCard('open');
      this.registerFlowCard('close');
      this.registerFlowCard('stop');
      this.registerFlowCard('position_set');
...
module.exports = TuyaCoverUniversalDevice;