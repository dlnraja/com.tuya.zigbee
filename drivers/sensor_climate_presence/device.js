...
class ClimatePresenceHybridDevice extends UnifiedSensorBase {
  ...
  async _triggerPresenceFlows(detected) {
    ...
    try { await (() => { try { return this.homey.flow.getTriggerCard(cardId); } catch(e) { return null; } })()?.trigger(this, {}).catch(() => {}); } catch (e) {}
    if (detected) {
      try { await (() => { try { return this.homey.flow.getTriggerCard(prefix + 'presence_sensor_radar_motion_detected_sensor_presence_radar_hybrid'); } catch(e) { return null; } })()?.trigger(this, {}).catch(() => {}); } catch (e) {}
    }
  }
