...
class TempSensorProBatteryDevice extends ZigBeeDevice {

  async onNodeInit({ zclNode }) {
    this.log('temp_sensor_pro_battery initialized');

    // Call parent
    await super.onNodeInit({ zclNode });

    // Auto-detect device type and initialize Tuya cluster handler
    const deviceType = TuyaClusterHandler.detectDeviceType('temp_sensor_pro_battery');
  ...
  async onDeleted() {
    this.log('temp_sensor_pro_battery deleted');
  }

}

module.exports = TempSensorProBatteryDevice;
