...
// The device also reports acPowerMultiplier/acPowerDivisor and metering multiplier/divisor attributes
// (see commented-out block below), but fixed divisors are used here to match the original behavior.
