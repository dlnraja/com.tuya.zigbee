...
class WirelessSwitch_3gangBatteryDevice extends ZigBeeDevice {
    
    async onNodeInit() {
        this.log('wireless_switch_3gang_battery device initialized');
...
module.exports = WirelessSwitch_3gangBatteryDevice;