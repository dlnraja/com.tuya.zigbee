...
class IRRemoteDriver extends Driver {
  ...
  async onInit() {
    ...
    // Action: Send IR code
    (() => { try { return this.homey.flow.getActionCard('ir_remote_send_code'); } catch(e) { return null; } })()
    ...
    (() => { try { return this.homey.flow.getActionCard('ir_remote_start_learning'); } catch(e) { return null; } })()
      .registerRunListener(async (args) => {
        const device = args.device;
        if (!device) throw new Error('No device');
