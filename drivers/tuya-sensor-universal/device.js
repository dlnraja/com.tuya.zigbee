...
class TuyaSensorUniversalDevice extends ZigBeeDevice {
  
  async onMeshInit() {
    await super.onMeshInit();
    
    // Log device initialization
    this.log('🔌 sensor Tuya Universal initialisé');
  ...
  setupFlowCards() {
    try {
      ...
      this.registerFlowCard('presence_detected');
      this.registerFlowCard('contact_alert');
...
module.exports = TuyaSensorUniversalDevice;