 ...
 */
class GasDetectorDevice extends AutoAdaptiveDevice {
  ...
  /**
   * Setup IAS Zone for Gas detection (SDK3 Compliant)
   * v5.2.71: Fixed - was incorrectly using alarm_generic instead of alarm_generic
   *
   * Cluster 1280 (IASZone) - Gas Alarm detection
   */
  async setupIASZone() {
