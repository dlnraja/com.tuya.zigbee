...
class 2GangZigbeeSwitchesDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('2 Gang Zigbee Switches has been initialized');
    }
    ...
    onDeleted() {
        this.log('2 Gang Zigbee Switches has been deleted');
    }
}

module.exports = 2GangZigbeeSwitchesDevice;