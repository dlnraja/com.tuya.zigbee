...
class InsomaWaterTimerDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('Insoma Water Timer has been initialized');
    }
    ...
    onDeleted() {
        this.log('Insoma Water Timer has been deleted');
    }
}

module.exports = InsomaWaterTimerDevice;