...
class SmartBulbRgbAcDevice extends ZigBeeDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('smart_bulb_rgb_ac initialized');
    ...
    const deviceType = TuyaClusterHandler.detectDeviceType('smart_bulb_rgb_ac');
...
// TODO: Consider debouncing capability updates for better performance
  ...
  async onDeleted() {
    this.log('smart_bulb_rgb_ac deleted');
  }
  // ========================================
...
module.exports = SmartBulbRgbAcDevice;
