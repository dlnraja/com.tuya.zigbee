...
class MoesBliendMotorDevice extends ZigBeeDevice {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log('MOES Bliend Motor has been initialized');
    }
    ...
    onDeleted() {
        this.log('MOES Bliend Motor has been deleted');
    }
}

module.exports = MoesBliendMotorDevice;