...
class MotionSensorDriver extends ZigBeeDriver {
  ...
  async onInit() {
    ...
    try {
      ...
      // ═══════════════════════════════════════════════════════════════
      this.motionDetectedTrigger = this.homey.flow.getTriggerCard('motion_sensor_motion_detected');
      this.motionClearedTrigger = this.homey.flow.getTriggerCard('motion_sensor_motion_cleared');
      this.batteryLowTrigger = this.homey.flow.getTriggerCard('motion_sensor_battery_low');
      this.batteryChangedTrigger = this.homey.flow.getTriggerCard('motion_sensor_battery_changed');
      this.luxChangedTrigger = this.homey.flow.getTriggerCard('motion_sensor_lux_changed');
