...
class LedStripDriver extends ZigBeeDriver {
  ...
  _registerFlowCards() {
    // TRIGGERS
    try { this.homey.flow.getTriggerCard('led_strip_led_strip_turned_on'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('led_strip_led_strip_turned_off'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('led_strip_turned_on'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('led_strip_turned_off'); } catch (e) {}
    try { this.homey.flow.getTriggerCard('led_strip_battery_low'); } catch (e) {}
    ...
    } catch (err) { this.error(`Condition led_strip_is_on: ${err.message}`); }
    ...
    } catch (err) { this.error(`Action led_strip_set_brightness: ${err.message}`); }
