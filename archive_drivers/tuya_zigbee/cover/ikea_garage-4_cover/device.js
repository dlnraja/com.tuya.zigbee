...
class IkeaGarage-4CoverDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaGarage-4CoverDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaGarage-4CoverDevice supprimé');
    }
}

module.exports = IkeaGarage-4CoverDevice;