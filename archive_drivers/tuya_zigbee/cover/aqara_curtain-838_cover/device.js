...
class AqaraCurtain-838CoverDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraCurtain-838CoverDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraCurtain-838CoverDevice supprimé');
    }
}

module.exports = AqaraCurtain-838CoverDevice;