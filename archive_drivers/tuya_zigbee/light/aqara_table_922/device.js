...
class AqaraTable922Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraTable922Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraTable922Device supprimé');
    }
}

module.exports = AqaraTable922Device;