...
class IkeaStrip461Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaStrip461Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaStrip461Device supprimé');
    }
}

module.exports = IkeaStrip461Device;