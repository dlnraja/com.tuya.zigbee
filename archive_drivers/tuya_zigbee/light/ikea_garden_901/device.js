...
class IkeaGarden901Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaGarden901Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaGarden901Device supprimé');
    }
}

module.exports = IkeaGarden901Device;