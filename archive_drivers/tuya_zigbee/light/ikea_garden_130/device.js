...
class IkeaGarden130Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaGarden130Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaGarden130Device supprimé');
    }
}

module.exports = IkeaGarden130Device;