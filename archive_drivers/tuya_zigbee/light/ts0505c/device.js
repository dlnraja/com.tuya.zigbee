...
class Ts0505cDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 Ts0505cDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  Ts0505cDevice supprimé');
    }
}

module.exports = Ts0505cDevice;