...
class AqaraStrip219Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraStrip219Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraStrip219Device supprimé');
    }
}

module.exports = AqaraStrip219Device;