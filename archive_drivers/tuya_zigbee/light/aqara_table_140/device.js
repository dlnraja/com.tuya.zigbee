...
class AqaraTable140Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraTable140Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraTable140Device supprimé');
    }
}

module.exports = AqaraTable140Device;