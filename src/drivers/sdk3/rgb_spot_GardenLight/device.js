...
class Rgbspotgardenlight extends TuyaZigBeeLightDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Rgbspotgardenlight RGB Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Rgbspotgardenlight RGB Enhanced deleted');
  }
