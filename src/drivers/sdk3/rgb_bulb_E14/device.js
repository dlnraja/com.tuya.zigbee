...
class Rgbbulbe14 extends TuyaZigBeeLightDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Rgbbulbe14 RGB Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Rgbbulbe14 RGB Enhanced deleted');
  }
