...
class Dimmableledstrip extends TuyaZigBeeLightDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Dimmableledstrip RGB Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Dimmableledstrip RGB Enhanced deleted');
  }
...
module.exports = Dimmableledstrip;
