...
class Wallremote6gang extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Wallremote6gang SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Wallremote6gang Enhanced deleted');
  }
...
module.exports = Wallremote6gang;
