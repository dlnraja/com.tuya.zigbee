...
class GenericFanDevice extends ZigBeeDevice {
    async onNodeInit() {
        // GenericFan Device initialization
        this.homey.log('🚀 GenericFan Device initialized');
    ...
    enableLocalMode() {
        this.homey.log('✅ GenericFan Local Mode enabled');
        this.isLocalMode = true;
        this.apiEnabled = false;
    }
    
    async onSettings(oldSettings, newSettings, changedKeysArr) {
        this.homey.log('⚙️ GenericFan settings updated');
    }
    
    async onDeleted() {
        this.homey.log('🗑️ GenericFan device deleted');
    }
}

module.exports = GenericFanDevice;
