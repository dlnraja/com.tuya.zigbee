...
class VacuumCleanerDevice extends ZigBeeDevice {
    async onNodeInit() {
        // VacuumCleaner Device initialization
        this.homey.log('🚀 VacuumCleaner Device initialized');
    ...
    enableLocalMode() {
        this.homey.log('✅ VacuumCleaner Local Mode enabled');
        this.isLocalMode = true;
        this.apiEnabled = false;
    }
    
    async onSettings(oldSettings, newSettings, changedKeysArr) {
        this.homey.log('⚙️ VacuumCleaner settings updated');
    }
    
    async onDeleted() {
        this.homey.log('🗑️ VacuumCleaner device deleted');
    }
}
