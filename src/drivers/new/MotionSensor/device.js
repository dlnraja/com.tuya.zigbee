/**
 * Device Tuya Zigbee - MotionSensor
 * Catégorie: sensor
...
class MotionSensorDevice extends ZigBeeDevice {
    async onNodeInit() {
        // MotionSensor Device initialization
        this.homey.log('🚀 MotionSensor Device initialized');
    ...
    enableLocalMode() {
        this.homey.log('✅ MotionSensor Local Mode enabled');
        this.isLocalMode = true;
        this.apiEnabled = false;
    }
    
    async onSettings(oldSettings, newSettings, changedKeysArr) {
        this.homey.log('⚙️ MotionSensor settings updated');
    }
    
    async onDeleted() {
        this.homey.log('🗑️ MotionSensor device deleted');
    }
}
