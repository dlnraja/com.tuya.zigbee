...
class TemperatureSensorDevice extends ZigBeeDevice {
    async onNodeInit() {
        // TemperatureSensor Device initialization
        this.homey.log('🚀 TemperatureSensor Device initialized');
    ...
    enableLocalMode() {
        this.homey.log('✅ TemperatureSensor Local Mode enabled');
        this.isLocalMode = true;
        this.apiEnabled = false;
    }
    
    async onSettings(oldSettings, newSettings, changedKeysArr) {
        this.homey.log('⚙️ TemperatureSensor settings updated');
    }
    
    async onDeleted() {
        this.homey.log('🗑️ TemperatureSensor device deleted');
    }
}
