...
class GenericCoverDevice extends ZigBeeDevice {
    async onNodeInit() {
        ...
        this.homey.log('🚀 GenericCover Device initialized');
    ...
    enableLocalMode() {
        this.homey.log('✅ GenericCover Local Mode enabled');
        this.isLocalMode = true;
        this.apiEnabled = false;
    }
    
    async onSettings(oldSettings, newSettings, changedKeysArr) {
        this.homey.log('⚙️ GenericCover settings updated');
    }
    
    async onDeleted() {
        this.homey.log('🗑️ GenericCover device deleted');
    }
}
