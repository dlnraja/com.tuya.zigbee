...
class GenericMediaPlayerDevice extends ZigBeeDevice {
    async onNodeInit() {
        // GenericMediaPlayer Device initialization
        this.homey.log('🚀 GenericMediaPlayer Device initialized');
    ...
    enableLocalMode() {
        this.homey.log('✅ GenericMediaPlayer Local Mode enabled');
        this.isLocalMode = true;
        this.apiEnabled = false;
    }
    
    async onSettings(oldSettings, newSettings, changedKeysArr) {
        this.homey.log('⚙️ GenericMediaPlayer settings updated');
    }
    
    async onDeleted() {
        this.homey.log('🗑️ GenericMediaPlayer device deleted');
    }
}
