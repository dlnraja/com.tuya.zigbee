/**
 * Device Tuya Zigbee - SmokeDetector
 * Catégorie: alarm
...
class SmokeDetectorDevice extends ZigBeeDevice {
    async onNodeInit() {
        // SmokeDetector Device initialization
        this.homey.log('🚀 SmokeDetector Device initialized');
    ...
    enableLocalMode() {
        this.homey.log('✅ SmokeDetector Local Mode enabled');
        this.isLocalMode = true;
        this.apiEnabled = false;
    }
    
    async onSettings(oldSettings, newSettings, changedKeysArr) {
        this.homey.log('⚙️ SmokeDetector settings updated');
    }
    
    async onDeleted() {
        this.homey.log('🗑️ SmokeDetector device deleted');
    }
}
