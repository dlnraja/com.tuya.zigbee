...
class FanDevice extends ZigBeeDevice {
    async onNodeInit() {
        // Fan Device initialization
        this.homey.log('🚀 Fan Device initialized');
    ...
    enableLocalMode() {
        this.homey.log('✅ Fan Local Mode enabled');
        this.isLocalMode = true;
        this.apiEnabled = false;
    }
    
    async onSettings(oldSettings, newSettings, changedKeysArr) {
        this.homey.log('⚙️ Fan settings updated');
    }
    
    async onDeleted() {
        this.homey.log('🗑️ Fan device deleted');
    }
}
