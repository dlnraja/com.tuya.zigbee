/**
 * Device Tuya Zigbee - GardenLight
 * Catégorie: light
...
class GardenLightDevice extends ZigBeeDevice {
    async onNodeInit() {
        // GardenLight Device initialization
        this.homey.log('🚀 GardenLight Device initialized');
    ...
    enableLocalMode() {
        this.homey.log('✅ GardenLight Local Mode enabled');
        this.isLocalMode = true;
        this.apiEnabled = false;
    }
    
    async onSettings(oldSettings, newSettings, changedKeysArr) {
        this.homey.log('⚙️ GardenLight settings updated');
    }
    
    async onDeleted() {
        this.homey.log('🗑️ GardenLight device deleted');
    }
}

module.exports = GardenLightDevice;
