...
class RGBBulbDevice extends ZigBeeDevice {
    async onNodeInit() {
        // RGBBulb Device initialization
        this.homey.log('🚀 RGBBulb Device initialized');
    ...
    enableLocalMode() {
        this.homey.log('✅ RGBBulb Local Mode enabled');
        this.isLocalMode = true;
        this.apiEnabled = false;
    }
    
    async onSettings(oldSettings, newSettings, changedKeysArr) {
        this.homey.log('⚙️ RGBBulb settings updated');
    }
    
    async onDeleted() {
        this.homey.log('🗑️ RGBBulb device deleted');
    }
}
