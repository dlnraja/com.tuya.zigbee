...
class TuyaZigbeeTuyaUniversalDevice extends ZigBeeDevice {

  async onNodeInit() {
    this.log('tuya_zigbee-tuya-universal device initialized');
...
module.exports = TuyaZigbeeTuyaUniversalDevice;
