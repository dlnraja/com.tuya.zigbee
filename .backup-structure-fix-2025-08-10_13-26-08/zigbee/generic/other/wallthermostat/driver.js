...
// Subcategory: wall_thermostat
// Enrichment Date: 2025-08-07T17:53:57.387Z

'use strict';

const { ZigBeeDriver } = require('homey-meshdriver');

class Wall_thermostatDriver extends ZigBeeDriver {
    ...
    this.printNode();
        ...
        this.log('🚀 wall_thermostat Driver - Initialisation MEGA enrichie...');
        ...
        this.log('✅ wall_thermostat Driver - Initialisation MEGA terminée');
    }
...
module.exports = Wall_thermostatDriver;