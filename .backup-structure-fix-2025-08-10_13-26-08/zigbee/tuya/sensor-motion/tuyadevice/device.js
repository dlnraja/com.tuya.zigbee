...
// Device Type: zigbee
// Category: sensors
// Subcategory: water_leak_sensor_tuya
// Enrichment Date: 2025-08-07T17:53:56.981Z
...
class Waterleaksensortuya extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Waterleaksensortuya SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Waterleaksensortuya Enhanced deleted');
  }
