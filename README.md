...
[![Fingerprints](https://img.shields.io/badge/fingerprints-16,787+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **412 drivers** and **16,787+ device fingerprints**.
...
| 2 | `sensor_climate_smart` | 2,036 |
| 3 | `sensor_climate_temphumidsensor` | 2,036 |
| 4 | `switch_1gang` | 1,231 |
| 5 | `bulb_dimmable` | 628 |
| 6 | `presence_sensor_radar` | 502 |
| 7 | `radiator_valve` | 478 |
| 8 | `wall_dimmer_tuya` | 377 |
| 9 | `curtain_motor` | 365 |
| 10 | `generic_tuya` | 357 |
| 11 | `motion_sensor` | 264 |
| 12 | `bulb_rgbw` | 235 |
| 13 | `plug_energy_monitor` | 220 |
| 14 | `sensor_contact_zigbee` | 219 |
| 15 | `diy_custom_zigbee` | 206 |
| 16 | `generic_diy` | 202 |
| 17 | `switch_4gang` | 199 |
| 18 | `thermostat_tuya_dp` | 195 |
| 19 | `switch_2gang` | 191 |
| 20 | `usb_dongle_triple` | 182 |
...
| **v8.5.46** | v8.5.45: CRITICAL, CRITICAL, CRITICAL, CRITICAL, CRITICAL |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 412 Drivers ─ 16,787+ fingerprints
```
