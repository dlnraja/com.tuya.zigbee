...
[![Fingerprints](https://img.shields.io/badge/fingerprints-5,038+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **429 drivers** and **5,038+ device fingerprints**.
...
| Metric | Value |
|--------|-------|
| **App Version** | v9.0.130 |
| **Device Fingerprints** | 5,038+ |
...
| **v9.0.130** | yyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy... |
| **v9.0.129** | v9.0.128: |
...
| **v9.0.125** | v9.0.125: automated publish, manifest sync, and Homey test promotion. |
| **v9.0.124** | v9.0.123: |
| **v9.0.123** | v9.0.123: automated publish, manifest sync, and Homey test promotion. |
| **v9.0.122** | v9.0.121: |
| **v9.0.121** | v9.0.121: stabilized post-publish manifest sync, changelog cleanup, and fingerprint collision baseline. |
| **v9.0.120** | v9.0.120: automated publish and fingerprint synchronization. |
| **v9.0.119** | v9.0.119: hardened CI lifecycle gates, normalized Homey manifest output, and refreshed fingerprint collision baseline. |
| **v9.0.118** | v9.0.118: automated fingerprint refresh and manifest synchronization. |
| **v9.0.117** | v9.0.116: |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 429 Drivers ─ 5,038+ fingerprints
```
