...
[![Fingerprints](https://img.shields.io/badge/fingerprints-26,616+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **320 drivers** and **26,616+ device fingerprints**.
...
| Metric | Value |
|--------|-------|
| **App Version** | v8.1.194 |
| **Device Fingerprints** | 26,616+ |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 320 Drivers ─ 26,616+ fingerprints
```
