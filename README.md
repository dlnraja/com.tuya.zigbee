...
[![Fingerprints](https://img.shields.io/badge/fingerprints-5,213+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **429 drivers** and **5,213+ device fingerprints**.
...
| Metric | Value |
|--------|-------|
| **App Version** | v9.0.116 |
| **Device Fingerprints** | 5,213+ |
...
| # | Driver | Fingerprints |
|---|--------|-------------|
| 1 | `climate_sensor` | 752 |
| 2 | `switch_1gang` | 440 |
| 3 | `generic_tuya` | 339 |
| 4 | `button_wireless_2` | 226 |
| 5 | `diy_custom_zigbee` | 205 |
| 6 | `presence_sensor_radar` | 168 |
| 7 | `radiator_valve` | 151 |
...
| 18 | `remote_button_wireless_plug` | 52 |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 429 Drivers ─ 5,213+ fingerprints
```
