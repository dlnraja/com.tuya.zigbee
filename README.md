...
[![Fingerprints](https://img.shields.io/badge/fingerprints-12,027+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **413 drivers** and **12,027+ device fingerprints**.
...
| 3 | `bulb_dimmable` | 628 |
| 4 | `radiator_valve` | 515 |
| 5 | `presence_sensor_radar` | 500 |
| 6 | `curtain_motor` | 388 |
| 7 | `dimmer_wall_1gang` | 361 |
| 8 | `generic_tuya` | 358 |
| 9 | `motion_sensor` | 268 |
| 10 | `plug_energy_monitor` | 247 |
| 11 | `bulb_rgbw` | 235 |
| 12 | `generic_diy` | 207 |
| 13 | `diy_custom_zigbee` | 206 |
| 14 | `switch_4gang` | 200 |
| 15 | `switch_2gang` | 192 |
| 16 | `thermostat_tuya_dp` | 189 |
| 17 | `contact_sensor` | 188 |
| 18 | `plug_smart` | 186 |
| 19 | `water_leak_sensor` | 150 |
| 20 | `switch_3gang` | 127 |
...
| Version | Changes |
|---------|---------|
| **v8.5.20** | v8.5.17: Added support for soil sensor `_TZE284_0ints6wl` / `TS0601` (requested by user), Updated app metadata and bu... |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 413 Drivers ─ 12,027+ fingerprints
```
