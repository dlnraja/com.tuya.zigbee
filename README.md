...
[![Fingerprints](https://img.shields.io/badge/fingerprints-4,329+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
[![Drivers](https://img.shields.io/badge/drivers-193-brightgreen)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
[![Flow Cards](https://img.shields.io/badge/flow%20cards-2,219-blue)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **193 drivers** and **4,329+ device fingerprints**.
...
- **2,219+ flow cards** — triggers, conditions & actions in EN, FR, NL, DE
...
| Version | Changes |
|---------|---------|
| **v5.11.168** | v5.11.166: Added missing `button.push` capability to FingerBot, resolving issue #162., Synchronized energy scaling UI... |
| **v5.11.167** | v5.11.166: Added missing `button.push` capability to FingerBot, resolving issue #162., Synchronized energy scaling UI... |
| **v5.11.166** | Universal Tuya Zigbee app v5.11.166 adds new capabilities and fixes issues for better device compatibility. |
...
| **v5.11.161** | Universal Tuya Zigbee app v5.11.161 adds new device capabilities and fixes critical bugs. |
| **v5.11.160** | Universal Tuya Zigbee app v5.11.160 adds new device capabilities and fixes critical bugs for improved performance. |
| **v5.11.159** | Universal Tuya Zigbee app v5.11.159 adds new device support and fixes UI issues for energy scaling. |
| **v5.11.158** | Universal Tuya Zigbee app v5.11.158 adds new driver support and fixes energy scaling UI components. |
| **v5.11.157** | Universal Tuya Zigbee app v5.11.157 adds new device capabilities and fixes driver issues. |
| **v5.11.156** | Universal Tuya Zigbee app v5.11.156 adds missing button.push capability for Fingerbot and fixes energy scale issues. |
| **v5.11.155** | Universal Tuya Zigbee app v5.11.155 adds missing button.push capability for Fingerbot and improves device support. |
...
Homey Pro
  └─ Universal Tuya Zigbee App (SDK3)
       ...
       └─ 193 Drivers ─ 4,329+ fingerprints
```
