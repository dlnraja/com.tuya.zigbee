...
[![Fingerprints](https://img.shields.io/badge/fingerprints-5,184+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **431 drivers** and **5,184+ device fingerprints**.
...
| Metric | Value |
|--------|-------|
| **App Version** | v9.0.193 |
| **Device Fingerprints** | 5,184+ |
...
| 6 | `presence_sensor_radar` | 161 |
| 7 | `radiator_valve` | 143 |
| 8 | `sensor_contact_zigbee` | 115 |
| 9 | `wall_dimmer_tuya` | 106 |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 431 Drivers ─ 5,184+ fingerprints
```
