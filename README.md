...
[![Fingerprints](https://img.shields.io/badge/fingerprints-26,219+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **365 drivers** and **26,219+ device fingerprints**.
...
| Metric | Value |
|--------|-------|
| **App Version** | v8.1.146 |
| **Device Fingerprints** | 26,219+ |
...
| # | Driver | Fingerprints |
|---|--------|-------------|
| 1 | `climate_sensor` | 1,907 |
| 2 | `sensor_climate_temphumidsensor` | 1,851 |
| 3 | `switch_1gang` | 1,504 |
| 4 | `wall_switch_5_gang_tuya` | 1,182 |
| 5 | `wall_switch_1_gang_tuya` | 1,148 |
| 6 | `lcdtemphumidsensor` | 638 |
| 7 | `lcdtemphumidluxsensor` | 631 |
| 8 | `lcdtemphumidsensor_2` | 630 |
| 9 | `lcdtemphumidsensor_3` | 625 |
| 10 | `climate_sensor_energy` | 624 |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 365 Drivers ─ 26,219+ fingerprints
```
