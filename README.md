...
[![Fingerprints](https://img.shields.io/badge/fingerprints-12,686+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
[![Drivers](https://img.shields.io/badge/drivers-412-brightgreen)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
[![Flow Cards](https://img.shields.io/badge/flow%20cards-4,038-blue)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **412 drivers** and **12,686+ device fingerprints**.
...
- **4,038+ flow cards** — triggers, conditions & actions in EN, FR, NL, DE
...
| 2 | `switch_1gang` | 1,195 |
| 3 | `bulb_dimmable` | 629 |
| 4 | `radiator_valve` | 415 |
...
| 14 | `switch_4gang` | 197 |
| 15 | `generic_diy` | 194 |
| 16 | `thermostat_tuya_dp` | 193 |
| 17 | `switch_2gang` | 189 |
| 18 | `usb_dongle_triple` | 176 |
| 19 | `plug_energy_monitor` | 157 |
| 20 | `thermostat_4ch` | 156 |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 412 Drivers ─ 12,686+ fingerprints
```
