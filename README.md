...
Local Zigbee support for Tuya (and white-label) devices on Homey Pro. Switches, sensors, lights, thermostats, covers, valves — **431 drivers**, **4,368 unique fingerprints**. No cloud required.
...
| Metric | Value |
|--------|-------|
| **App Version** | v9.0.659 |
| **Drivers** | 431 (381 Zigbee + 50 WiFi) |
| **Unique Fingerprints** | 4,368 |
| **Pairing Variants** | 16,540 (4 case combos per fingerprint) |
