...
[![Fingerprints](https://img.shields.io/badge/fingerprints-40,191+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **411 drivers** and **40,191+ device fingerprints**.
...
| # | Driver | Fingerprints |
|---|--------|-------------|
| 1 | `climate_sensor` | 18,868 |
| 2 | `curtain_motor` | 2,672 |
| 3 | `contact_sensor` | 2,508 |
| 4 | `bulb_dimmable` | 1,430 |
| 5 | `bulb_rgbw` | 1,353 |
| 6 | `switch_1gang` | 1,293 |
| 7 | `dimmer_wall_1gang` | 1,137 |
| 8 | `bulb_tunable_white` | 932 |
| 9 | `button_wireless_1` | 795 |
| 10 | `bulb_rgb` | 444 |
| 11 | `presence_sensor_radar` | 432 |
| 12 | `radiator_valve` | 416 |
| 13 | `generic_tuya` | 398 |
| 14 | `motion_sensor` | 290 |
| 15 | `wall_dimmer_tuya` | 285 |
| 16 | `button_emergency_sos` | 252 |
| 17 | `dimmer_ts110e` | 207 |
| 18 | `switch_4gang` | 198 |
| 19 | `generic_diy` | 195 |
| 20 | `thermostat_tuya_dp` | 195 |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 411 Drivers ─ 40,191+ fingerprints
```
