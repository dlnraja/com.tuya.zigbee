...
[![Fingerprints](https://img.shields.io/badge/fingerprints-10,815+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **221 drivers** and **10,815+ device fingerprints**.
...
| 9 | `switch_2gang` | 268 |
| 10 | `contact_sensor` | 262 |
| 11 | `bulb_rgbw` | 256 |
| 12 | `motion_sensor` | 239 |
| 13 | `switch_4gang` | 235 |
...
| Version | Changes |
|---------|---------|
| **v7.5.13** | v7.5.12: Fixed sensor fallback check for unknown model IDs to prevent incorrect capability assignments, Cleaned up Hy... |
