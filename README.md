...
[![Fingerprints](https://img.shields.io/badge/fingerprints-23,677+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **412 drivers** and **23,677+ device fingerprints**.
...
| Version | Feature |
|---------|---------|
| **v8.5.43** | v8.5.43: HOMEY_PAT updated — publish re-triggered with valid Athom token. Use... |
| **vv8_5_30** |  |
...
| 2 | `climate_sensor_switch` | 2,036 |
| 3 | `sensor_climate_lcdtemphumidsensor` | 2,036 |
| 4 | `sensor_climate_presence` | 2,036 |
| 5 | `sensor_climate_smart` | 2,036 |
| 6 | `sensor_climate_temphumidsensor` | 2,036 |
| 7 | `switch_1gang` | 1,231 |
| 8 | `bulb_dimmable` | 628 |
| 9 | `presence_sensor_radar` | 502 |
| 10 | `radiator_valve` | 479 |
| 11 | `wall_dimmer_tuya` | 377 |
| 12 | `curtain_motor` | 366 |
| 13 | `generic_tuya` | 357 |
| 14 | `motion_sensor` | 264 |
| 15 | `bulb_rgbw` | 235 |
| 16 | `sensor_contact_motion` | 228 |
| 17 | `sensor_contact_rain` | 228 |
| 18 | `sensor_contact_zigbee` | 228 |
| 19 | `plug_energy_monitor` | 225 |
| 20 | `diy_custom_zigbee` | 206 |
...
| **v8.5.43** | v8.5.42: Fixed manufacturer fingerprint for button_wireless_4 driver, Fixed manufacturer fingerprint for illuminance_... |
| **v8.5.42** | v8.5.42: Fixed button_wireless_4 and illuminance_sensor manufacturer fingerprints. Added 114 new device fingerprints ... |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 412 Drivers ─ 23,677+ fingerprints
```
