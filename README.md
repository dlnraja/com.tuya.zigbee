...
[![Fingerprints](https://img.shields.io/badge/fingerprints-18,404+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **365 drivers** and **18,404+ device fingerprints**.
...
| Version | Feature |
|---------|---------|
| **v8.1.129** | Fixed soil sensor DP mappings. |
| **v8.1.128** | Fixed bed sensor DP1 inversion and removed bogus capabilities. |
...
| Metric | Value |
|--------|-------|
| **App Version** | v8.1.125 |
| **Device Fingerprints** | 18,404+ |
...
| # | Driver | Fingerprints |
|---|--------|-------------|
| 1 | `climate_sensor` | 1,900 |
| 2 | `sensor_climate_temphumidsensor` | 1,854 |
| 3 | `switch_1gang` | 1,432 |
| 4 | `wall_switch_5_gang_tuya` | 1,182 |
| 5 | `wall_switch_1_gang_tuya` | 1,148 |
| 6 | `bulb_dimmable_dimmer` | 534 |
| 7 | `curtain_motor` | 512 |
| 8 | `presence_sensor_radar` | 503 |
| 9 | `radiator_valve` | 483 |
| 10 | `generic_tuya` | 358 |
| 11 | `switch_1_gang` | 340 |
| 12 | `doorwindowsensor_2` | 321 |
| 13 | `radar_sensor_ceiling` | 300 |
| 14 | `dimmer_wall_1gang` | 264 |
| 15 | `bulb_rgbw` | 250 |
| 16 | `power_meter` | 210 |
| 17 | `soil_sensor` | 196 |
| 18 | `generic_diy` | 195 |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 365 Drivers ─ 18,404+ fingerprints
```
