...
[![Fingerprints](https://img.shields.io/badge/fingerprints-4,346%20unique-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
[![Fingerprints](https://img.shields.io/badge/fingerprints-4,345%20unique-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings **local control** to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks and more across **430 drivers** and **4,346 unique device fingerprints** (17,057 including case variants for bulletproof pairing).
A community-driven Homey app that brings **local control** to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks and more across **430 drivers** and **4,345 unique device fingerprints** (17,055 including case variants for bulletproof pairing).
...
| Metric | Value |
|--------|-------|
| **App Version** | v9.0.444 |
| **Drivers** | 430 (380 Zigbee + 50 WiFi) |
| **Unique Fingerprints** | 4,346 |
| **Pairing Variants** | 17,057 (4 case combos per fingerprint) |
| **Unique Fingerprints** | 4,345 |
| **Pairing Variants** | 17,055 (4 case combos per fingerprint) |
