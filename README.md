...
[![Fingerprints](https://img.shields.io/badge/fingerprints-4,752+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **429 drivers** and **4,752+ device fingerprints**.
...
| Metric | Value |
|--------|-------|
| **App Version** | v9.0.112 |
| **Device Fingerprints** | 4,752+ |
...
| # | Driver | Fingerprints |
|---|--------|-------------|
| 1 | `climate_sensor` | 702 |
| 2 | `switch_1gang` | 446 |
| 3 | `generic_tuya` | 337 |
| 4 | `button_wireless_2` | 224 |
| 5 | `presence_sensor_radar` | 155 |
| 6 | `radiator_valve` | 136 |
| 7 | `wall_dimmer_tuya` | 130 |
| 8 | `sensor_contact_zigbee` | 108 |
| 9 | `diy_custom_zigbee` | 103 |
| 10 | `universal_zigbee` | 97 |
| 11 | `generic_diy` | 85 |
| 12 | `wall_thermostat` | 73 |
| 13 | `switch_4gang` | 68 |
| 14 | `light_bulb_rgb_rgbw` | 66 |
| 15 | `dimmer_wall_1gang` | 65 |
| 16 | `curtain_motor` | 55 |
| 17 | `switch_2gang` | 55 |
| 18 | `water_leak_sensor_tuya` | 53 |
| 19 | `thermostat_tuya_dp` | 51 |
| 20 | `switch_3gang` | 48 |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 429 Drivers ─ 4,752+ fingerprints
```
