...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **431 drivers** and **5,363+ device fingerprints**.
...
| **v9.0.275** | v9.0.220: automated publish, manifest sync, and Homey test promotion. |
| **v9.0.274** | v9.0.220: automated publish, manifest sync, and Homey test promotion. |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 431 Drivers ─ 5,363+ fingerprints
```
