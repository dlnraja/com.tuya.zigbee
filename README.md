...
[![Fingerprints](https://img.shields.io/badge/fingerprints-5,621+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **430 drivers** and **5,621+ device fingerprints**.
...
| Metric | Value |
|--------|-------|
| **App Version** | v9.0.148 |
| **Device Fingerprints** | 5,621+ |
...
| **v9.0.148** | v9.0.144: automated publish, manifest sync, and Homey test promotion. |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 430 Drivers ─ 5,621+ fingerprints
```
