...
[![Fingerprints](https://img.shields.io/badge/fingerprints-5,047+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **429 drivers** and **5,047+ device fingerprints**.
...
| Metric | Value |
|--------|-------|
| **App Version** | v9.0.119 |
| **Device Fingerprints** | 5,047+ |
...
| **v9.0.119** | yyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy... |
| **v9.0.118** | v9.0.117: |
| **v9.0.117** | v9.0.116: |
| **v9.0.116** | v9.0.115: |
| **v9.0.115** | v9.0.114: |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 429 Drivers ─ 5,047+ fingerprints
```
