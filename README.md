...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **212 drivers** and **7,591+ device fingerprints**.
...
- **2,448+ flow cards** — triggers, conditions & actions in EN, FR, NL, DE
...
| Version | Changes |
|---------|---------|
| **v5.11.198** | v5.11.197: Added 3 new device fingerprints to driver mappings, enabling direct support for recently released Tuya har... |
...
Homey Pro
  └─ Universal Tuya Zigbee App (SDK3)
       ...
       └─ 212 Drivers ─ 7,591+ fingerprints
```
