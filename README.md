...
[![Fingerprints](https://img.shields.io/badge/fingerprints-21,108+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **320 drivers** and **21,108+ device fingerprints**.
...
| Metric | Value |
|--------|-------|
| **App Version** | v8.1.178 |
| **Device Fingerprints** | 21,108+ |
...
| 14 | `presence_sensor_radar` | 473 |
| 15 | `generic_tuya` | 392 |
| 16 | `radar_sensor_ceiling` | 292 |
| 17 | `doorwindowsensor_2` | 279 |
| 18 | `dimmer_wall_1gang` | 266 |
| 19 | `bulb_rgbw` | 250 |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 320 Drivers ─ 21,108+ fingerprints
```
