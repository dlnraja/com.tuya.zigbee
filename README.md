...
| Version | Changes |
|---------|---------|
| **v9.0.729** | Fixed wall dimmer brightness misread as humidity; fixed AC thermostat valve DP poisoning target temperature from diagnostics. |
