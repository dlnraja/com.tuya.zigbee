...
[![Fingerprints](https://img.shields.io/badge/fingerprints-14,715+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **412 drivers** and **14,715+ device fingerprints**.
...
| 2 | `sensor_climate_temphumidsensor` | 2,036 |
| 3 | `switch_1gang` | 1,231 |
| 4 | `bulb_dimmable` | 628 |
| 5 | `presence_sensor_radar` | 502 |
| 6 | `radiator_valve` | 478 |
| 7 | `wall_dimmer_tuya` | 377 |
| 8 | `curtain_motor` | 365 |
| 9 | `generic_tuya` | 357 |
| 10 | `motion_sensor` | 264 |
| 11 | `bulb_rgbw` | 235 |
| 12 | `plug_energy_monitor` | 220 |
| 13 | `sensor_contact_zigbee` | 219 |
| 14 | `diy_custom_zigbee` | 206 |
| 15 | `generic_diy` | 202 |
| 16 | `switch_4gang` | 199 |
| 17 | `thermostat_tuya_dp` | 195 |
| 18 | `switch_2gang` | 191 |
| 19 | `usb_dongle_triple` | 182 |
| 20 | `water_leak_sensor_tuya` | 153 |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 412 Drivers ─ 14,715+ fingerprints
```
