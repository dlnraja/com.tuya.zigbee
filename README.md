...
[![Fingerprints](https://img.shields.io/badge/fingerprints-38,432+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **412 drivers** and **38,432+ device fingerprints**.
...
| 2 | `climate_sensor_energy` | 2,036 |
| 3 | `climate_sensor_gas` | 2,036 |
| 4 | `climate_sensor_plug` | 2,036 |
| 5 | `climate_sensor_smart` | 2,036 |
| 6 | `climate_sensor_switch` | 2,036 |
| 7 | `sensor_climate_lcdtemphumidsensor` | 2,036 |
| 8 | `sensor_climate_presence` | 2,036 |
| 9 | `sensor_climate_smart` | 2,036 |
| 10 | `sensor_climate_temphumidsensor` | 2,036 |
| 11 | `switch_1gang` | 1,233 |
| 12 | `wall_switch_1_gang_tuya` | 1,233 |
| 13 | `wall_switch_5_gang_tuya` | 1,233 |
| 14 | `bulb_dimmable` | 628 |
| 15 | `radiator_valve` | 523 |
| 16 | `presence_sensor_radar` | 502 |
| 17 | `radar_sensor_ceiling` | 502 |
| 18 | `dimmer_wall_plug` | 380 |
| 19 | `dimmer_wall_switch` | 380 |
| 20 | `dimmer_wall_water` | 380 |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 412 Drivers ─ 38,432+ fingerprints
```
