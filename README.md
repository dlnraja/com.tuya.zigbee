...
[![Fingerprints](https://img.shields.io/badge/fingerprints-5,337+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
[![Drivers](https://img.shields.io/badge/drivers-431-brightgreen)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
[![Flow Cards](https://img.shields.io/badge/flow%20cards-4,842-blue)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **431 drivers** and **5,337+ device fingerprints**.
...
- **4,842+ flow cards** — triggers, conditions & actions in EN, FR, NL, DE
...
| Metric | Value |
|--------|-------|
| **App Version** | v9.0.261 |
| **Device Fingerprints** | 5,337+ |
...
| # | Driver | Fingerprints |
|---|--------|-------------|
| 1 | `climate_sensor` | 805 |
| 2 | `switch_1gang` | 555 |
| 3 | `generic_tuya` | 451 |
| 4 | `button_wireless_2` | 225 |
| 5 | `presence_sensor_radar` | 213 |
...
| **v9.0.261** | v9.0.220: automated publish, manifest sync, and Homey test promotion. |
| **v9.0.260** | v9.0.220: automated publish, manifest sync, and Homey test promotion. |
| **v9.0.259** | v9.0.220: automated publish, manifest sync, and Homey test promotion. |
| **v9.0.258** | v9.0.220: automated publish, manifest sync, and Homey test promotion. |
| **v9.0.257** | v9.0.220: automated publish, manifest sync, and Homey test promotion. |
| **v9.0.256** | v9.0.220: automated publish, manifest sync, and Homey test promotion. |
| **v9.0.255** | v9.0.220: automated publish, manifest sync, and Homey test promotion. |
| **v9.0.254** | v9.0.220: automated publish, manifest sync, and Homey test promotion. |
| **v9.0.253** | v9.0.220: automated publish, manifest sync, and Homey test promotion. |
| **v9.0.252** | v9.0.220: automated publish, manifest sync, and Homey test promotion. |
| **v9.0.251** | v9.0.220: automated publish, manifest sync, and Homey test promotion. |
| **v9.0.250** | v9.0.220: automated publish, manifest sync, and Homey test promotion. |
| **v9.0.249** | v9.0.220: automated publish, manifest sync, and Homey test promotion. |
| **v9.0.248** | v9.0.220: automated publish, manifest sync, and Homey test promotion. |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 431 Drivers ─ 5,337+ fingerprints
```
