...
[![Fingerprints](https://img.shields.io/badge/fingerprints-21,545+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **320 drivers** and **21,545+ device fingerprints**.
...
| Metric | Value |
|--------|-------|
| **App Version** | v8.1.191 |
| **Device Fingerprints** | 21,545+ |
...
| # | Driver | Fingerprints |
|---|--------|-------------|
| 1 | `climate_sensor` | 1,588 |
| 2 | `sensor_climate_temphumidsensor` | 1,536 |
| 3 | `switch_1gang` | 1,136 |
| 4 | `wall_switch_5_gang_tuya` | 993 |
| 5 | `wall_switch_1_gang_tuya` | 965 |
| 6 | `curtain_motor` | 578 |
| 7 | `lcdtemphumidluxsensor` | 546 |
| 8 | `lcdtemphumidsensor_2` | 541 |
| 9 | `lcdtemphumidsensor_3` | 540 |
| 10 | `climate_sensor_energy` | 539 |
| 11 | `lcdtemphumidsensor` | 527 |
| 12 | `presence_sensor_radar` | 503 |
| 13 | `radiator_valve` | 493 |
| 14 | `bulb_dimmable_dimmer` | 453 |
| 15 | `generic_tuya` | 360 |
| 16 | `doorwindowsensor_2` | 287 |
| 17 | `radar_sensor_ceiling` | 271 |
| 18 | `bulb_rgbw` | 250 |
| 19 | `bulb_dimmable` | 249 |
| 20 | `dimmer_wall_1gang` | 248 |
...
| **ventries** | [object Object],[object Object],[object Object] |
| **v9.0.1** | v9.0.0: |
| **v9.0.0** | v8.5.54: |
| **v8.5.54** | v8.5.53: |
| **v8.5.53** | v8.5.52: |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 320 Drivers ─ 21,545+ fingerprints
```
