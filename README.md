...
[![Fingerprints](https://img.shields.io/badge/fingerprints-31,419+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
[![Drivers](https://img.shields.io/badge/drivers-365-brightgreen)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
[![Flow Cards](https://img.shields.io/badge/flow%20cards-3,831-blue)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **365 drivers** and **31,419+ device fingerprints**.
...
- **3,831+ flow cards** — triggers, conditions & actions in EN, FR, NL, DE
...
|--------|-------|
| **App Version** | v8.1.94 |
| **Device Fingerprints** | 31,419+ |
| **Unique Product IDs** | 503 |
...
| # | Driver | Fingerprints |
|---|--------|-------------|
| 1 | `climate_sensor` | 1,890 |
| 2 | `lcdtemphumidsensor_2` | 1,880 |
| 3 | `climate_sensor_energy` | 1,872 |
| 4 | `sensor_climate_temphumidsensor` | 1,872 |
| 5 | `switch_1_gang` | 1,559 |
| 6 | `switch_1gang` | 1,448 |
| 7 | `sr_zs_switch` | 1,197 |
| 8 | `relay_board_1_channel` | 1,194 |
| 9 | `wall_switch_1_gang_tuya` | 1,194 |
| 10 | `wall_switch_5_gang_tuya` | 1,194 |
| 11 | `smart_switch` | 1,188 |
| 12 | `curtain_motor` | 644 |
| 13 | `bulb_dimmable` | 643 |
| 14 | `bulb_dimmable_dimmer` | 543 |
| 15 | `presence_sensor_radar` | 506 |
| 16 | `dimmer_wall_1gang` | 485 |
| 17 | `curtain_module` | 462 |
| 18 | `radiator_valve` | 413 |
| 19 | `dimmer_1_gang` | 383 |
| 20 | `contact_sensor` | 381 |
...
| **ventries** | [object Object],[object Object] |
| **v9.0.1** | v9.0.0: |
| **v9.0.0** | v8.5.54: |
| **v8.5.54** | v8.5.53: |
| **v8.5.53** | v8.5.52: |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 365 Drivers ─ 31,419+ fingerprints
```
