...
- **1,863+ flow cards** — triggers, conditions & actions in EN, FR, NL, DE
...
| Version | Changes |
|---------|---------|
| **v5.11.113** | v5.11.110: Implemented batch close/respond state update for improved performance., None, None, None |
