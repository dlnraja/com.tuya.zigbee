...
[![Fingerprints](https://img.shields.io/badge/fingerprints-21,246+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
[![Drivers](https://img.shields.io/badge/drivers-365-brightgreen)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
[![Flow Cards](https://img.shields.io/badge/flow%20cards-3,834-blue)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **365 drivers** and **21,246+ device fingerprints**.
...
- **3,834+ flow cards** — triggers, conditions & actions in EN, FR, NL, DE
...
| Metric | Value |
|--------|-------|
| **App Version** | v8.1.156 |
| **Device Fingerprints** | 21,246+ |
| **Unique Product IDs** | 504 |
| **Drivers** | 365 (361 Zigbee + 4 WiFi) |
| **Flow Cards** | 3,834 |
| **Unique Capabilities** | 114 |
| **SVG Icons** | 663 |
...
| # | Driver | Fingerprints |
|---|--------|-------------|
| 1 | `climate_sensor` | 1,776 |
| 2 | `sensor_climate_temphumidsensor` | 1,367 |
| 3 | `switch_1gang` | 1,288 |
| 4 | `wall_switch_5_gang_tuya` | 834 |
| 5 | `wall_switch_1_gang_tuya` | 813 |
| 6 | `curtain_motor` | 578 |
| 7 | `lcdtemphumidsensor` | 530 |
| 8 | `lcdtemphumidluxsensor` | 515 |
| 9 | `lcdtemphumidsensor_2` | 512 |
| 10 | `lcdtemphumidsensor_3` | 510 |
| 11 | `climate_sensor_energy` | 509 |
| 12 | `bulb_dimmable_dimmer` | 507 |
| 13 | `radiator_valve` | 495 |
| 14 | `presence_sensor_radar` | 470 |
| 15 | `generic_tuya` | 392 |
| 16 | `radar_sensor_ceiling` | 292 |
| 17 | `doorwindowsensor_2` | 279 |
| 18 | `dimmer_wall_1gang` | 275 |
| 19 | `bulb_rgbw` | 250 |
| 20 | `bulb_dimmable` | 249 |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 365 Drivers ─ 21,246+ fingerprints
```
