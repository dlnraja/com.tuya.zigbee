...
[![Fingerprints](https://img.shields.io/badge/fingerprints-26,624+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **320 drivers** and **26,624+ device fingerprints**.
...
|---------|---------|
| **vv8_5_30** |  |
| **v8.1.192** | Documentation update: changelog reading protocol, button anti-patterns, valid... |
| **ventries** |  |
| **v9.0.1** | v9.0.0: |
| **v9.0.0** | v8.5.54: |
| **v8.5.54** | v8.5.53: |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 320 Drivers ─ 26,624+ fingerprints
```
