...
[![Fingerprints](https://img.shields.io/badge/fingerprints-12,661+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
[![Drivers](https://img.shields.io/badge/drivers-412-brightgreen)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
[![Flow Cards](https://img.shields.io/badge/flow%20cards-4,072-blue)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **412 drivers** and **12,661+ device fingerprints**.
...
- **4,072+ flow cards** — triggers, conditions & actions in EN, FR, NL, DE
...
| Version | Feature |
|---------|---------|
| **v8.1.8** | v8.1.8: fix: resolve server-side AggregateError by defining GENERIC_MANUFACTU... |
| **v8.1.7** | v8.1.6: fix: generate all missing and correct driver images to fix processing... |
| **vv8_5_30** |  |
| **v9.0.1** | v9.0.0: |
| **v9.0.0** | v8.5.54: |
| **v8.5.54** | v8.5.53: |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 412 Drivers ─ 12,661+ fingerprints
```
