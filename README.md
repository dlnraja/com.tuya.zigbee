...
[![Fingerprints](https://img.shields.io/badge/fingerprints-6,945+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **429 drivers** and **6,945+ device fingerprints**.
...
| # | Driver | Fingerprints |
|---|--------|-------------|
| 1 | `climate_sensor` | 1,316 |
| 2 | `switch_1gang` | 858 |
| 3 | `button_wireless_2` | 370 |
| 4 | `generic_tuya` | 342 |
| 5 | `presence_sensor_radar` | 291 |
| 6 | `radiator_valve` | 271 |
| 7 | `wall_thermostat` | 138 |
| 8 | `wall_dimmer_tuya` | 133 |
| 9 | `switch_4gang` | 132 |
| 10 | `dimmer_wall_1gang` | 120 |
| 11 | `curtain_motor` | 110 |
| 12 | `switch_2gang` | 110 |
| 13 | `diy_custom_zigbee` | 103 |
| 14 | `light_bulb_rgb_rgbw` | 102 |
| 15 | `sensor_contact_zigbee` | 99 |
| 16 | `motion_sensor` | 88 |
| 17 | `universal_zigbee` | 81 |
| 18 | `vibration_sensor` | 78 |
| 19 | `sensor_motion_presence` | 67 |
| 20 | `curtain_motor_shutter` | 66 |
...
| **v9.0.56** | v9.0.55: |
| **v9.0.55** | v9.0.54: |
| **v9.0.54** | v9.0.53: v9.0.53: app.json + docs + scripts + tests + , v9.0.53: drivers+docs+scripts+tests (30+ root causes), v9.0.5... |
| **v9.0.53** | v9.0.53: v9.0.53: app.json + docs + scripts + tests + |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 429 Drivers ─ 6,945+ fingerprints
```
