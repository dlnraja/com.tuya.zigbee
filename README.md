...
[![Fingerprints](https://img.shields.io/badge/fingerprints-4,325+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
[![Drivers](https://img.shields.io/badge/drivers-191-brightgreen)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
[![Flow Cards](https://img.shields.io/badge/flow%20cards-2,238-blue)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **191 drivers** and **4,325+ device fingerprints**.
...
- **2,238+ flow cards** — triggers, conditions & actions in EN, FR, NL, DE
...
| Version | Feature |
|---------|---------|
| **v5.11.154** | Universal Tuya Zigbee app v5.11.154: No new drivers or fingerprints added. |
| **v5.11.152** | Universal Tuya Zigbee app v5.11.152 adds new device support and fixes several... |
...
| Metric | Value |
|--------|-------|
| **App Version** | v5.11.154 |
| **Device Fingerprints** | 4,325+ |
| **Unique Product IDs** | 559 |
| **Drivers** | 191 (142 Zigbee + 49 WiFi) |
| **Flow Cards** | 2,238 |
| **Unique Capabilities** | 124 |
| **SVG Icons** | 318 |
...
| 11 | `presence_sensor_radar` | 103 |
| 12 | `motion_sensor` | 102 |
| 13 | `switch_2gang` | 92 |
| 14 | `switch_4gang` | 80 |
...
| Version | Changes |
|---------|---------|
| **v5.11.154** | v5.11.152: Fixed rain sensor pairing by removing strict endpoints., Removed emoji characters from all driver.js files... |
...
Homey Pro
  └─ Universal Tuya Zigbee App (SDK3)
       ...
       └─ 191 Drivers ─ 4,325+ fingerprints
```
