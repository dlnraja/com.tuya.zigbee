...
[![Fingerprints](https://img.shields.io/badge/fingerprints-7,915+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **412 drivers** and **7,915+ device fingerprints**.
...
| 4 | `button_wireless_2` | 228 |
| 5 | `dimmer_wall_1gang` | 216 |
| 6 | `presence_sensor_radar` | 178 |
| 7 | `dimmer_ts110e` | 177 |
| 8 | `generic_tuya` | 170 |
| 9 | `thermostat_tuya_dp` | 162 |
| 10 | `radiator_valve` | 158 |
| 11 | `sensor_contact_zigbee` | 132 |
| 12 | `wall_dimmer_tuya` | 130 |
| 13 | `curtain_motor_shutter` | 122 |
| 14 | `motion_sensor` | 121 |
| 15 | `smart_lcd_thermostat` | 112 |
| 16 | `wall_thermostat` | 112 |
| 17 | `thermostat_4ch` | 110 |
| 18 | `presence_sensor_ceiling` | 107 |
| 19 | `diy_custom_zigbee` | 103 |
| 20 | `radar_sensor_2` | 102 |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 412 Drivers ─ 7,915+ fingerprints
```
