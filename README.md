...
[![Fingerprints](https://img.shields.io/badge/fingerprints-5,039+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **429 drivers** and **5,039+ device fingerprints**.
...
| Metric | Value |
|--------|-------|
| **App Version** | v9.0.123 |
| **Device Fingerprints** | 5,039+ |
...
| **v9.0.123** | yyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy... |
| **v9.0.122** | v9.0.121: |
...
| **v9.0.112** | v9.0.111: |
| **v9.0.111** | v9.0.110: |
| **v9.0.110** | v9.0.110: automated maintenance, fingerprint refresh, and manifest synchronization. |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 429 Drivers ─ 5,039+ fingerprints
```
