...
[![Fingerprints](https://img.shields.io/badge/fingerprints-12,852+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **221 drivers** and **12,852+ device fingerprints**.
...
| Version | Changes |
|---------|---------|
| **v7.2.5** | 🚀 Nexus Awakening: Stable Release of Premium Features (Adaptive Lighting, TP... |
...
| **v7.0.22** | 🚀 [Nexus Autonomous] Universal Zigbee Hardening: Expanded brand fallbacks, d... |
...
| 4 | `button_wireless_2` | 523 |
| 5 | `air_purifier` | 490 |
| 6 | `plug_energy_monitor` | 471 |
| 7 | `curtain_motor` | 439 |
| 8 | `dimmer_wall_1gang` | 424 |
| 9 | `contact_sensor` | 413 |
| 10 | `generic_tuya` | 350 |
| 11 | `presence_sensor_radar` | 292 |
| 12 | `motion_sensor` | 272 |
| 13 | `switch_2gang` | 270 |
| 14 | `bulb_rgb` | 263 |
| 15 | `bulb_rgbw` | 248 |
| 16 | `switch_4gang` | 233 |
| 17 | `diy_custom_zigbee` | 206 |
| 18 | `thermostat_tuya_dp` | 201 |
| 19 | `switch_3gang` | 192 |
| 20 | `button_wireless_4` | 178 |
