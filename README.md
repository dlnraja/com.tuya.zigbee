...
[![Fingerprints](https://img.shields.io/badge/fingerprints-26,480+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **365 drivers** and **26,480+ device fingerprints**.
...
| Metric | Value |
|--------|-------|
| **App Version** | v8.1.141 |
| **Device Fingerprints** | 26,480+ |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 365 Drivers ─ 26,480+ fingerprints
```
