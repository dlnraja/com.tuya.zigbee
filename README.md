...
[![Fingerprints](https://img.shields.io/badge/fingerprints-5,214+-green)](https://homey.app/a/com.dlnraja.tuya.zigbee/)
...
A community-driven Homey app that brings local control to Tuya Zigbee devices — no cloud, no internet needed. Covers switches, sensors, lights, thermostats, covers, locks, and more across **429 drivers** and **5,214+ device fingerprints**.
...
| 6 | `presence_sensor_radar` | 172 |
| 7 | `radiator_valve` | 150 |
| 8 | `wall_dimmer_tuya` | 130 |
| 9 | `sensor_contact_zigbee` | 104 |
...
Homey Pro
  └─ Tuya Unified Zigbee App (SDK3)
       ...
       └─ 429 Drivers ─ 5,214+ fingerprints
```
