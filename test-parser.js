...
try {
  ...
  fs.mkdirSync(path.join(__dirname, 'scripts/temp'), { recursive: true });
  fs.writeFileSync(path.join(__dirname, 'scripts/temp/mock-diag.json'), JSON.stringify({ pseudo, crashData }, null, 2));
} catch (e) {
