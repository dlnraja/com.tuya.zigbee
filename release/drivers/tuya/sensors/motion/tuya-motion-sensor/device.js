...
class TuyamotionsensorDevice extends TuyaDevice {
    ...
    async onInit() {
        ...
        // Initialize device
        this.log('tuya-motion-sensor device initialized (Historical)');
    ...
    async onUninit() {
        ...
        this.log('tuya-motion-sensor device uninitialized');
    }
    ...
    async onSettings({ oldSettings, newSettings, changedKeys }) {
        ...
        this.log('tuya-motion-sensor settings updated');
    }
}
