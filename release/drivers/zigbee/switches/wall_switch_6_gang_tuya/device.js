...
// Enrichment Date: 2025-08-07T17:53:57.324Z
...
class Wallswitch6gangtuya extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Wallswitch6gangtuya SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Wallswitch6gangtuya Enhanced deleted');
  }
...
module.exports = Wallswitch6gangtuya;
