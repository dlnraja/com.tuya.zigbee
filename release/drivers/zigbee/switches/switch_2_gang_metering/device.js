...
class Switch2gangmetering extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Switch2gangmetering SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Switch2gangmetering Enhanced deleted');
  }
...
module.exports = Switch2gangmetering;
