...
// Device Type: zigbee
// Category: switches
// Subcategory: wall_curtain_switch
// Enrichment Date: 2025-08-07T17:53:57.199Z
...
class Wallcurtainswitch extends ZigBeeDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('Wallcurtainswitch SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Wallcurtainswitch Enhanced deleted');
  }
