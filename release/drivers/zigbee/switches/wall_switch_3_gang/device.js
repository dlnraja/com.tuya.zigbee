...
// Device Type: zigbee
// Category: switches
// Subcategory: wall_switch_3_gang
// Enrichment Date: 2025-08-07T17:53:57.295Z
...
class Wallswitch3gang extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Wallswitch3gang SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Wallswitch3gang Enhanced deleted');
  }
...
module.exports = Wallswitch3gang;
