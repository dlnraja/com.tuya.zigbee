...
// Device Type: zigbee
// Category: switches
// Subcategory: switch_1_gang
// Enrichment Date: 2025-08-07T17:53:57.067Z
...
class Switch1gang extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Switch1gang SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Switch1gang Enhanced deleted');
  }
