...
// Device Type: zigbee
// Category: switches
// Subcategory: button_switch
// Enrichment Date: 2025-08-07T17:53:57.028Z
...
class Buttonswitch extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Buttonswitch SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Buttonswitch Enhanced deleted');
  }
