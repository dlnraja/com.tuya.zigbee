...
// Device Type: zigbee
// Category: switches
// Subcategory: wall_switch_4_gang
// Enrichment Date: 2025-08-07T17:53:57.301Z
...
class Wallswitch4gang extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Wallswitch4gang SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Wallswitch4gang Enhanced deleted');
  }
