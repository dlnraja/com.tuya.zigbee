...
// Device Type: zigbee
// Category: switches
// Subcategory: smart_button_switch
// Enrichment Date: 2025-08-07T17:53:57.042Z
...
class Smartbuttonswitch extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Smartbuttonswitch SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Smartbuttonswitch Enhanced deleted');
  }
