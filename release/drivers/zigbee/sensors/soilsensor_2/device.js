...
// Device Type: zigbee
// Category: sensors
// Subcategory: soilsensor_2
// Enrichment Date: 2025-08-07T17:53:56.898Z
...
class Soilsensor2 extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Soilsensor2 SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Soilsensor2 Enhanced deleted');
  }
