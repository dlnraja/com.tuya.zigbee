...
// Device Type: zigbee
// Category: sensors
// Subcategory: doorwindowsensor_4
// Enrichment Date: 2025-08-07T17:53:56.553Z
...
class Doorwindowsensor4 extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Doorwindowsensor4 SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Doorwindowsensor4 Enhanced deleted');
  }
