...
// Device Type: zigbee
// Category: sensors
// Subcategory: radar_sensor
// Enrichment Date: 2025-08-07T17:53:56.724Z
...
class Radarsensor extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Radarsensor SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Radarsensor Enhanced deleted');
  }
