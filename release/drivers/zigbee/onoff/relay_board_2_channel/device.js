...
// Device Type: zigbee
// Category: onoff
// Subcategory: relay_board_2_channel
// Enrichment Date: 2025-08-07T17:53:56.031Z
...
class Relayboard2channel extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Relayboard2channel SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Relayboard2channel Enhanced deleted');
  }
...
module.exports = Relayboard2channel;
