...
// Device Type: zigbee
// Category: onoff
// Subcategory: blind_motor
// Enrichment Date: 2025-08-07T17:53:55.878Z
...
class Blindmotor extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Blindmotor SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Blindmotor Enhanced deleted');
  }
