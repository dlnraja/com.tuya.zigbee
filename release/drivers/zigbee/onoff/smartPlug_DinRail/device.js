...
// Device Type: zigbee
// Category: onoff
// Subcategory: smartPlug_DinRail
// Enrichment Date: 2025-08-07T17:53:56.093Z
...
class Smartplugdinrail extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Smartplugdinrail SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Smartplugdinrail Enhanced deleted');
  }
