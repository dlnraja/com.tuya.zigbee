...
// Device Type: zigbee
// Category: plugs
// Subcategory: smart_plug_2_socket
// Enrichment Date: 2025-08-07T17:53:56.327Z
...
class Smartplug2socket extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Smartplug2socket SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Smartplug2socket Enhanced deleted');
  }
...
module.exports = Smartplug2socket;
