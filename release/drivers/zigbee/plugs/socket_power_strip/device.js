...
// Device Type: zigbee
// Category: plugs
// Subcategory: socket_power_strip
// Enrichment Date: 2025-08-07T17:53:56.347Z
...
class Socketpowerstrip extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Socketpowerstrip SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Socketpowerstrip Enhanced deleted');
  }
...
module.exports = Socketpowerstrip;
