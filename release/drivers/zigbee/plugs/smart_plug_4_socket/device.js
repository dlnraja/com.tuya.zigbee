...
// Device Type: zigbee
// Category: plugs
// Subcategory: smart_plug_4_socket
// Enrichment Date: 2025-08-07T17:53:56.335Z
...
class Smartplug4socket extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Smartplug4socket SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Smartplug4socket Enhanced deleted');
  }
