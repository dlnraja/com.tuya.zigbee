...
// Device Type: zigbee
// Category: plugs
// Subcategory: example_smartplug
// Enrichment Date: 2025-08-07T17:53:56.234Z
...
class Examplesmartplug extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Examplesmartplug SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Examplesmartplug Enhanced deleted');
  }
