...
// Device Type: zigbee
// Category: plugs
// Subcategory: outdoor_2_socket
// Enrichment Date: 2025-08-07T17:53:56.241Z
...
class Outdoor2socket extends ZigBeeDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('Outdoor2socket SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Outdoor2socket Enhanced deleted');
  }
