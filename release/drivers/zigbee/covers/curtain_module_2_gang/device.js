...
// Enrichment Date: 2025-08-07T17:53:55.282Z
...
class Curtainmodule2gang extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Curtainmodule2gang SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Curtainmodule2gang Enhanced deleted');
  }
...
module.exports = Curtainmodule2gang;
