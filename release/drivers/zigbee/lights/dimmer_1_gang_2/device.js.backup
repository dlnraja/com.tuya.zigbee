...
class Dimmer1gang2 extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Dimmer1gang2 SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Dimmer1gang2 Enhanced deleted');
  }
