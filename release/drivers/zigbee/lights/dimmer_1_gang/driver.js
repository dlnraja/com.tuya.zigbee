...
// Driver Type: zigbee
// Category: lights
// Subcategory: dimmer_1_gang
// Enrichment Date: 2025-08-07T17:53:55.421Z

'use strict';

const { ZigBeeDriver } = require('homey-meshdriver');

class Dimmer_1_gangDriver extends ZigBeeDriver {
    ...
    this.printNode();
        ...
        this.log('🚀 dimmer_1_gang Driver - Initialisation MEGA enrichie...');
        ...
        this.log('✅ dimmer_1_gang Driver - Initialisation MEGA terminée');
    }
...
module.exports = Dimmer_1_gangDriver;