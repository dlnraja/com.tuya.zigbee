...
// Driver Type: zigbee
// Category: lights
// Subcategory: dimmer_2_gang
// Enrichment Date: 2025-08-07T17:53:55.502Z

'use strict';

const { ZigBeeDriver } = require('homey-meshdriver');

class Dimmer_2_gangDriver extends ZigBeeDriver {
    ...
    this.printNode();
        ...
        this.log('🚀 dimmer_2_gang Driver - Initialisation MEGA enrichie...');
        ...
        this.log('✅ dimmer_2_gang Driver - Initialisation MEGA terminée');
    }
...
module.exports = Dimmer_2_gangDriver;