...
class Smartremote4buttons extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Smartremote4buttons SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Smartremote4buttons Enhanced deleted');
  }
...
module.exports = Smartremote4buttons;
