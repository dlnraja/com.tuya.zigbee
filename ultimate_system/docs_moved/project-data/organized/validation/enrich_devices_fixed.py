    ...
    for source_file in data_sources:
        if os.path.exists(source_file):
            try:
                ...
                print(f"Source {source_file}: {len(unique_ids)} IDs trouves")
                
            except Exception as e:
                print(f"Erreur lecture {source_file}: {e}")
    
    print(f"\nTOTAL: {len(all_ids)} manufacturer IDs uniques trouves")
...
def get_comprehensive_manufacturer_database():
    ...
    return {
        'motion_sensor': [
            ...
            '_TZ3000_nss8amz9', '_TZ3000_lqrfnfkq', '_TZ3000_6flvjxz8'
        ],
        'contact_sensor': [
            ...
            '_TZ3000_gdvxyasq', '_TZ3000_xrgxkyvz', '_TZ3000_zlrrr7z3'
        ],
        'temperature_humidity_sensor': [
            ...
            '_TZ3000_b28wrpvx', '_TZ3000_itnrsufe', '_TZ3000_qb3zqzdy'
        ],
        'smart_plug': [
            ...
            '_TZ3000_rdtmvrpu', '_TZ3210_r5afgmkl', '_TZ3000_upjrsxh1'
        ],
        'energy_plug': [
            ...
            '_TZ3000_gjg3iav8', '_TZ3000_air9m6af', '_TZ3000_8fdayfch'
        ],
        'smart_light': [
            ...
            '_TZ3000_evag0pvn', '_TZ3000_lumyztas', '_TZ3000_9cpuaca6'
        ],
        'rgb_light': [
            '_TZ3000_dbou1ap4', '_TZ3000_keabpigv', '_TZ3000_wamqdr3f',
            '_TZ3000_gek6snaj', '_TZ3000_49qchf10', '_TZ3000_ygaeb6gb',
        ...
        'light_switch': [
            ...
            '_TZ3000_odzoiova', '_TZ3000_cfnprab5', '_TZ3000_nnwehhst'
        ],
        'dimmer_switch': [
        ...
        'scene_switch': [
            ...
            '_TZ3000_wyhuocal', '_TZ3000_oj7gjqme', '_TZ3000_a7ouggvs'
        ],
        'scene_remote_2gang': [
        ...
        'scene_remote_4gang': [
            ...
            '_TZ3000_tk3s5tyg', '_TZ3000_wyhuocal', '_TZ3000_oj7gjqme'
        ],
        'air_quality_sensor': [
            ...
            '_TZE200_ogkdpgy2', '_TZE200_3ejwq3mg', '_TZE200_lsanae15'
        ],
        'smoke_detector': [
...
def enrich_all_drivers():
    ...
    print(f"\nENRICHISSEMENT TERMINE: {enriched_count} drivers mis a jour")
...
def add_missing_product_ids():
    ...
    print(f"\nPRODUCT IDS AJOUTES: {updated_count} drivers mis a jour")
...
def main():
    ...
    print("Compatibilite Johan Bendz: Complete")
    print("Pret pour publication automatique!")
