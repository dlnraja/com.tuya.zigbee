...
class TuyaLightTS0505A extends ZigBeeDevice {
  async onNodeInit({ zclNode }) {
    this.log('Tuya Light TS0505A initialized');
    ...
    this.setEnergyApproximation({"usageConstant":9});
  }
...
module.exports = TuyaLightTS0505A;