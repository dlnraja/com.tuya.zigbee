...
class AqaraBlind-772CoverDevice extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraBlind-772CoverDevice initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraBlind-772CoverDevice supprimé');
    }
}

module.exports = AqaraBlind-772CoverDevice;