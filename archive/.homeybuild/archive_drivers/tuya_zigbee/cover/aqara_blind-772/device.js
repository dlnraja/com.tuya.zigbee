...
class AqaraBlind-772Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraBlind-772Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraBlind-772Device supprimé');
    }
}

module.exports = AqaraBlind-772Device;