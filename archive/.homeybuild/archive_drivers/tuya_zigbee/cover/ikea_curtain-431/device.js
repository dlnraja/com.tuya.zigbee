...
class IkeaCurtain-431Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaCurtain-431Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaCurtain-431Device supprimé');
    }
}

module.exports = IkeaCurtain-431Device;