// Driver plug-aqara-aqara-contact-543

#// Description
Driver pour appareil plug aqara aqara-contact-543
...
#// Installation
1. Copier ce dossier dans `drivers/zigbee/plug/aqara/aqara-contact-543/`
