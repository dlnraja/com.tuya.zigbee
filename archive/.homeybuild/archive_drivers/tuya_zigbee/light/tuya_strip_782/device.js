...
class TuyaStrip782Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaStrip782Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaStrip782Device supprimé');
    }
}

module.exports = TuyaStrip782Device;