...
class IkeaBulb320Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 IkeaBulb320Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  IkeaBulb320Device supprimé');
    }
}

module.exports = IkeaBulb320Device;