...
class TuyaBulb305Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 TuyaBulb305Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  TuyaBulb305Device supprimé');
    }
}

module.exports = TuyaBulb305Device;