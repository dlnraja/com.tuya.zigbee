...
class AqaraStrip599Device extends ZigBeeDevice {
    async onNodeInit({ zclNode }) {
        this.log('🔧 AqaraStrip599Device initialisé (mode intelligent)');
    ...
    async onDeleted() {
        this.log('🗑️  AqaraStrip599Device supprimé');
    }
}

module.exports = AqaraStrip599Device;