...
// Device Type: zigbee
// Category: covers
// Subcategory: curtain_module
// Enrichment Date: 2025-08-07T17:53:55.271Z
...
class Curtainmodule extends ZigBeeDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('Curtainmodule SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Curtainmodule Enhanced deleted');
  }
