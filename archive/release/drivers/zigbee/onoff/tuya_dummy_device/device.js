...
// Enrichment Date: 2025-08-07T17:53:56.201Z
...
class Tuyadummydevice extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Tuyadummydevice SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Tuyadummydevice Enhanced deleted');
  }
