...
// Device Type: zigbee
// Category: onoff
// Subcategory: power_strip
// Enrichment Date: 2025-08-07T17:53:56.012Z
...
class Powerstrip extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Powerstrip SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Powerstrip Enhanced deleted');
  }
