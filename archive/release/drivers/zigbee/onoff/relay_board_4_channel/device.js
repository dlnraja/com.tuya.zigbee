...
// Device Type: zigbee
// Category: onoff
// Subcategory: relay_board_4_channel
// Enrichment Date: 2025-08-07T17:53:56.039Z
...
class Relayboard4channel extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Relayboard4channel SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Relayboard4channel Enhanced deleted');
  }
