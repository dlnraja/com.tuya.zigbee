...
class Wallremote4gang extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Wallremote4gang SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Wallremote4gang Enhanced deleted');
  }
...
module.exports = Wallremote4gang;
