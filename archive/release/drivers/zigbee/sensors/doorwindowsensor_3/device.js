...
// Device Type: zigbee
// Category: sensors
// Subcategory: doorwindowsensor_3
// Enrichment Date: 2025-08-07T17:53:56.547Z
...
class Doorwindowsensor3 extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Doorwindowsensor3 SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Doorwindowsensor3 Enhanced deleted');
  }
...
module.exports = Doorwindowsensor3;
