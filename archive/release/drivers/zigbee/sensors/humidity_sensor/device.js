...
// Device Type: zigbee
// Category: sensors
// Subcategory: humidity_sensor
// Enrichment Date: 2025-08-07T17:53:56.606Z
...
class Humiditysensor extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Humiditysensor SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Humiditysensor Enhanced deleted');
  }
