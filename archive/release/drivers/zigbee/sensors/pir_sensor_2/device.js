...
// Device Type: zigbee
// Category: sensors
// Subcategory: pir_sensor_2
// Enrichment Date: 2025-08-07T17:53:56.716Z
...
class Pirsensor2 extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Pirsensor2 SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Pirsensor2 Enhanced deleted');
  }
