...
// Enrichment Date: 2025-08-07T17:53:56.849Z
...
class Smokesensor2 extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Smokesensor2 SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Smokesensor2 Enhanced deleted');
  }
