...
// Device Type: zigbee
// Category: sensors
// Subcategory: rain_sensor
// Enrichment Date: 2025-08-07T17:53:56.769Z
...
class Rainsensor extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Rainsensor SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Rainsensor Enhanced deleted');
  }
