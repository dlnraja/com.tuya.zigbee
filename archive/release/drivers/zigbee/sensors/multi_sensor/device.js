...
// Enrichment Date: 2025-08-07T17:53:56.684Z
...
class Multisensor extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Multisensor SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Multisensor Enhanced deleted');
  }
