...
// Device Type: zigbee
// Category: sensors
// Subcategory: temphumidsensor5
// Enrichment Date: 2025-08-07T17:53:56.975Z
...
class Temphumidsensor5 extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Temphumidsensor5 SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Temphumidsensor5 Enhanced deleted');
  }
