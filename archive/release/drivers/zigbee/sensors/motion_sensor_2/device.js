...
// Device Type: zigbee
// Category: sensors
// Subcategory: motion_sensor_2
// Enrichment Date: 2025-08-07T17:53:56.679Z
...
class Motionsensor2 extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Motionsensor2 SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Motionsensor2 Enhanced deleted');
  }
