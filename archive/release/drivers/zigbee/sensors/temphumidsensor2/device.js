...
// Device Type: zigbee
// Category: sensors
// Subcategory: temphumidsensor2
// Enrichment Date: 2025-08-07T17:53:56.917Z
...
class Temphumidsensor2 extends ZigBeeDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('Temphumidsensor2 SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Temphumidsensor2 Enhanced deleted');
  }
