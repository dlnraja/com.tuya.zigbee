...
// Device Type: zigbee
// Category: sensors
// Subcategory: slim_motion_sensor
// Enrichment Date: 2025-08-07T17:53:56.801Z
...
class Slimmotionsensor extends ZigBeeDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('Slimmotionsensor SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Slimmotionsensor Enhanced deleted');
  }
