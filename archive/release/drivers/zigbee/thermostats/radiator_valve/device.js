...
// Enrichment Date: 2025-08-07T17:53:57.362Z

'use strict';

const { ZigBeeDevice } = require('homey-meshdriver');

class Radiator_valveDevice extends ZigBeeDevice {
    ...
    this.printNode();
        ...
        this.log('🚀 radiator_valve - Initialisation MEGA enrichie...');
        ...
        this.log('✅ radiator_valve - Initialisation MEGA terminée');
    }
...
module.exports = Radiator_valveDevice;