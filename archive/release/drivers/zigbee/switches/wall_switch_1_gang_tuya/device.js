...
// Enrichment Date: 2025-08-07T17:53:57.219Z
...
class Wallswitch1gangtuya extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Wallswitch1gangtuya SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Wallswitch1gangtuya Enhanced deleted');
  }
...
module.exports = Wallswitch1gangtuya;
