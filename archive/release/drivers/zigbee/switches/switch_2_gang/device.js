...
// Device Type: zigbee
// Category: switches
// Subcategory: switch_2_gang
// Enrichment Date: 2025-08-07T17:53:57.080Z
...
class Switch2gang extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Switch2gang SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Switch2gang Enhanced deleted');
  }
