...
// Device Type: zigbee
// Category: switches
// Subcategory: switch_4_gang
// Enrichment Date: 2025-08-07T17:53:57.119Z
...
class Switch4gang extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Switch4gang SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Switch4gang Enhanced deleted');
  }
