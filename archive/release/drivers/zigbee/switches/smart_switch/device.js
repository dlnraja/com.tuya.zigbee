...
// Enrichment Date: 2025-08-07T17:53:57.062Z
...
class Smartswitch extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Smartswitch SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Smartswitch Enhanced deleted');
  }
