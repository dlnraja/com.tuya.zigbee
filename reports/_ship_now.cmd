...
git status -sb
git commit --trailer "Co-authored-by: Cursor <cursoragent@cursor.com>" -m "fix(P2521f): BSEED zcl_only P214 Syntax harden tip 5.12.195"
if errorlevel 1 exit /b 1
git pull --rebase origin stable-v5
git push origin stable-v5
echo STABLE_EXIT=%ERRORLEVEL%
