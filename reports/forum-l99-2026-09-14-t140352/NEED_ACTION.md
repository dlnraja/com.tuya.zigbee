...
- **#2246/#2247** VicHY @ **9.0.1016**: presence stalls / curtain flip / relay onoff gone / sticky true — **P2575** trust DP1 + lock onoff + soft-clear. Tip ≥**9.0.1027** → update + restart app (re-pair only if class still curtain).
