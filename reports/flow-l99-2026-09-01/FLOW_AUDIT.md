...
```
Flow card ID uniqueness OK (5243 compose ids)
...
```
# DP × Cluster × Flow coverage — 2026-09-01
...
- Without: none
- Flow card entries (compose): 5110
...
- Registry couples (Tuya EF00-eligible): 136
- Covered: 120 (88.2%)
...
rs": 0,
  ...
  "topByTriggers": [
    ...
    {
      "driverId": "smart_remote_4_buttons",
      "triggers": 20
    }
  ]
}
