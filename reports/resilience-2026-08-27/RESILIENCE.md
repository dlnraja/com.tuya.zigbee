# Project resilience audit — 2026-08-27

SHADOW forum. Methodology: Homey-native gaps → parallel complementary stacks (P2221→P2225).
Mode: full fleet

Domains: **16/22** gates green | Bug classes: fixed=10 partial=41 open=3
...
|--------|------|--------|-------|-----------|
| sacred_couple_fp | 1 | partial | 2/3 ⚠ | No hot-swap; mfr-only pairing ambiguous |
...
| ef00_dp | 1 | partial | 0/1 ⚠ | Opaque 0xEF00; type0 misread |
...
| dimmer_brightness | 2 | hardened | 0/1 ⚠ | dim 0–1 vs MCU 0–1000 |
