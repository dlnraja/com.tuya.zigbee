# Sacred couple DP audit — 2026-09-18

Cases: **238** | Issues: **1233** | RAW unparsed: **0**
...
|------|--------|----|-----|--------|--------|-------|
| p2485-hewlydpz-7ytnacie-4gang | wall_switch_4_gang_tuya | 1 | state_l1 | — | missing_in_driver | Z2M defines state_l1 — no driver dpMapping |
| p2485-hewlydpz-7ytnacie-4gang | wall_switch_4_gang_tuya | 2 | state_l2 | — | missing_in_driver | Z2M defines state_l2 — no driver dpMapping |
| p2485-hewlydpz-7ytnacie-4gang | wall_switch_4_gang_tuya | 3 | state_l3 | — | missing_in_driver | Z2M defines state_l3 — no driver dpMapping |
| p2485-hewlydpz-7ytnacie-4gang | wall_switch_4_gang_tuya | 4 | state_l4 | — | missing_in_driver | Z2M defines state_l4 — no driver dpMapping |
| p2485-hewlydpz-7ytnacie-4gang | wall_switch_4_gang_tuya | 7 | countdown_l1 | — | missing_in_driver | Z2M defines countdown_l1 — no driver dpMapping |
| p2485-hewlydpz-7ytnacie-4gang | wall_switch_4_gang_tuya | 8 | countdown_l2 | — | missing_in_driver | Z2M defines countdown_l2 — no driver dpMapping |
| p2485-hewlydpz-7ytnacie-4gang | wall_switch_4_gang_tuya | 9 | countdown_l3 | — | missing_in_driver | Z2M defines countdown_l3 — no driver dpMapping |
| p2485-hewlydpz-7ytnacie-4gang | wall_switch_4_gang_tuya | 10 | countdown_l4 | — | missing_in_driver | Z2M defines countdown_l4 — no driver dpMapping |
| p2485-hewlydpz-7ytnacie-4gang | wall_switch_4_gang_tuya | 13 | state | — | missing_in_driver | Z2M defines state — no driver dpMapping |
| p2485-hewlydpz-7ytnacie-4gang | wall_switch_4_gang_tuya | 14 | power_on_behavior | — | missing_in_driver | Z2M defines power_on_behavior — no driver dpMapping |
| p2485-hewlydpz-7ytnacie-4gang | wall_switch_4_gang_tuya | 15 | indicator_mode | — | missing_in_driver | Z2M defines indicator_mode — no driver dpMapping |
| p2485-hewlydpz-7ytnacie-4gang | wall_switch_4_gang_tuya | 16 | backlight_switch | — | missing_in_driver | Z2M defines backlight_switch — no driver dpMapping |
| p2485-hewlydpz-7ytnacie-4gang | wall_switch_4_gang_tuya | 101 | child_lock | — | missing_in_driver | Z2M defines child_lock — no driver dpMapping |
| p2485-hewlydpz-7ytnacie-4gang | wall_switch_4_gang_tuya | 102 | backlight | — | missing_in_driver | Z2M defines backlight — no driver dpMapping |
| p2485-hewlydpz-7ytnacie-4gang | wall_switch_4_gang_tuya | 103 | on_color | — | missing_in_driver | Z2M defines on_color — no driver dpMapping |
| p2485-hewlydpz-7ytnacie-4gang | wall_switch_4_gang_tuya | 104 | off_color | — | missing_in_driver | Z2M defines off_color — no driver dpMapping |
| p2485-hewlydpz-7ytnacie-4gang | wall_switch_4_gang_tuya | 1 | state_l1 | — | missing_in_driver | Z2M defines state_l1 — no driver dpMapping |
| p2485-hewlydpz-7ytnacie-4gang | wall_switch_4_gang_tuya | 2 | state_l2 | — | missing_in_driver | Z2M defines state_l2 — no driver dpMapping |
| p2485-hewlydpz-7ytnacie-4gang | wall_switch_4_gang_tuya | 3 | state_l3 | — | missing_in_driver | Z2M defines state_l3 — no driver dpMapping |
| p2485-hewlydpz-7ytnacie-4gang | wall_switch_4_gang_tuya | 4 | state_l4 | — | missing_in_driver | Z2M defines state_l4 — no driver dpMapping |
...
| p2485-hewlydpz-7ytnacie-4gang | wall_switch_4_gang_tuya | 103 | on_color | — | missing_in_driver | Z2M defines on_color — no driver dpMapping |
| p2485-hewlydpz-7ytnacie-4gang | wall_switch_4_gang_tuya | 104 | off_color | — | missing_in_driver | Z2M defines off_color — no driver dpMapping |
| p2441-miamo-icka1clh-am43-curtain | curtain_motor | 2 | position | — | missing_in_driver | Z2M defines position — no driver dpMapping |
| p2441-miamo-icka1clh-am43-curtain | curtain_motor | 3 | position | — | missing_in_driver | Z2M defines position — no driver dpMapping |
| p2441-miamo-icka1clh-am43-curtain | curtain_motor | 5 | motor_direction | — | missing_in_driver | Z2M defines motor_direction — no driver dpMapping |
| p2441-miamo-icka1clh-am43-curtain | curtain_motor | 101 | opening_mode | — | missing_in_driver | Z2M defines opening_mode — no driver dpMapping |
| p2441-miamo-icka1clh-am43-curtain | curtain_motor | 102 | factory_reset | — | missing_in_driver | Z2M defines factory_reset — no driver dpMapping |
| p2441-miamo-icka1clh-am43-curtain | curtain_motor | 103 | set_upper_limit | — | missing_in_driver | Z2M defines set_upper_limit — no driver dpMapping |
| p2441-miamo-icka1clh-am43-curtain | curtain_motor | 104 | set_bottom_limit | — | missing_in_driver | Z2M defines set_bottom_limit — no driver dpMapping |
| p2441-miamo-icka1clh-am43-curtain | curtain_motor | 105 | motor_speed | — | missing_in_driver | Z2M defines motor_speed — no driver dpMapping |
| p2441-miamo-icka1clh-am43-curtain | curtain_motor | 2 | position | — | missing_in_driver | Z2M defines position — no driver dpMapping |
| p2441-miamo-icka1clh-am43-curtain | curtain_motor | 3 | position | — | missing_in_driver | Z2M defines position — no driver dpMapping |
| p2441-miamo-icka1clh-am43-curtain | curtain_motor | 5 | motor_direction | — | missing_in_driver | Z2M defines motor_direction — no driver dpMapping |
| p2441-miamo-icka1clh-am43-curtain | curtain_motor | 101 | opening_mode | — | missing_in_driver | Z2M defines opening_mode — no driver dpMapping |
...
| p2441-miamo-icka1clh-am43-curtain | curtain_motor | 104 | set_bottom_limit | — | missing_in_driver | Z2M defines set_bottom_limit — no driver dpMapping |
| p2441-miamo-icka1clh-am43-curtain | curtain_motor | 105 | motor_speed | — | missing_in_driver | Z2M defines motor_speed — no driver dpMapping |
| eduard-martirosyan-tze284-fodv6bkr-curtain | curtain_motor | 2 | position | — | missing_in_driver | Z2M defines position — no driver dpMapping |
| eduard-martirosyan-tze284-fodv6bkr-curtain | curtain_motor | 3 | position | — | missing_in_driver | Z2M defines position — no driver dpMapping |
| eduard-martirosyan-tze284-fodv6bkr-curtain | curtain_motor | 4 | opening_mode | — | missing_in_driver | Z2M defines opening_mode — no driver dpMapping |
| eduard-martirosyan-tze284-fodv6bkr-curtain | curtain_motor | 7 | work_state | — | missing_in_driver | Z2M defines work_state — no driver dpMapping |
| eduard-martirosyan-tze284-fodv6bkr-curtain | curtain_motor | 13 | battery | — | missing_in_driver | Z2M defines battery — no driver dpMapping |
| eduard-martirosyan-tze284-fodv6bkr-curtain | curtain_motor | 101 | motor_direction | — | missing_in_driver | Z2M defines motor_direction — no driver dpMapping |
| eduard-martirosyan-tze284-fodv6bkr-curtain | curtain_motor | 102 | set_upper_limit | — | missing_in_driver | Z2M defines set_upper_limit — no driver dpMapping |
| eduard-martirosyan-tze284-fodv6bkr-curtain | curtain_motor | 104 | illuminance | — | missing_in_driver | Z2M defines illuminance — no driver dpMapping |
| eduard-martirosyan-tze284-fodv6bkr-curtain | curtain_motor | 107 | factory_reset | — | missing_in_driver | Z2M defines factory_reset — no driver dpMapping |
| vichy-clrdrnya-presence | presence_sensor_radar | 1 | presence | — | missing_in_driver | Z2M defines presence — no driver dpMapping |
| vichy-clrdrnya-presence | presence_sensor_radar | 2 | radar_sensitivity | — | missing_in_driver | Z2M defines radar_sensitivity — no driver dpMapping |
| vichy-clrdrnya-presence | presence_sensor_radar | 3 | shield_range | — | missing_in_driver | Z2M defines shield_range — no driver dpMapping |
| vichy-clrdrnya-presence | presence_sensor_radar | 4 | detection_range | — | missing_in_driver | Z2M defines detection_range — no driver dpMapping |
| vichy-clrdrnya-presence | presence_sensor_radar | 6 | equipment_status | — | missing_in_driver | Z2M defines equipment_status — no driver dpMapping |
| vichy-clrdrnya-presence | presence_sensor_radar | 9 | target_distance | — | missing_in_driver | Z2M defines target_distance — no driver dpMapping |
| vichy-clrdrnya-presence | presence_sensor_radar | 101 | entry_filter_time | — | missing_in_driver | Z2M defines entry_filter_time — no driver dpMapping |
| vichy-clrdrnya-presence | presence_sensor_radar | 102 | departure_delay | — | missing_in_driver | Z2M defines departure_delay — no driver dpMapping |
| vichy-clrdrnya-presence | presence_sensor_radar | 103 | cline | — | missing_in_driver | Z2M defines cline — no driver dpMapping |
| vichy-clrdrnya-presence | presence_sensor_radar | 104 | illuminance | — | missing_in_driver | Z2M defines illuminance — no driver dpMapping |
| vichy-clrdrnya-presence | presence_sensor_radar | 105 | entry_sensitivity | — | missing_in_driver | Z2M defines entry_sensitivity — no driver dpMapping |
| vichy-clrdrnya-presence | presence_sensor_radar | 106 | entry_distance_indentation | — | missing_in_driver | Z2M defines entry_distance_indentation — no driver dpMapping |
| vichy-clrdrnya-presence | presence_sensor_radar | 107 | breaker_mode | — | missing_in_driver | Z2M defines breaker_mode — no driver dpMapping |
| vichy-clrdrnya-presence | presence_sensor_radar | 108 | breaker_status | — | missing_in_driver | Z2M defines breaker_status — no driver dpMapping |
| vichy-clrdrnya-presence | presence_sensor_radar | 109 | status_indication | — | missing_in_driver | Z2M defines status_indication — no driver dpMapping |
| vichy-clrdrnya-presence | presence_sensor_radar | 110 | illuminance_threshold | — | missing_in_driver | Z2M defines illuminance_threshold — no driver dpMapping |
| vichy-clrdrnya-presence | presence_sensor_radar | 111 | breaker_polarity | — | missing_in_driver | Z2M defines breaker_polarity — no driver dpMapping |
| vichy-clrdrnya-presence | presence_sensor_radar | 112 | block_time | — | missing_in_driver | Z2M defines block_time — no driver dpMapping |
| vichy-clrdrnya-presence | presence_sensor_radar | 113 | parameter_setting_result | — | missing_in_driver | Z2M defines parameter_setting_result — no driver dpMapping |
| vichy-clrdrnya-presence | presence_sensor_radar | 114 | factory_parameters | — | missing_in_driver | Z2M defines factory_parameters — no driver dpMapping |
| vichy-clrdrnya-presence | presence_sensor_radar | 115 | sensor | — | missing_in_driver | Z2M defines sensor — no driver dpMapping |
...
| wqashyqo-ts0601-soil | soil_sensor | 102 | soil_calibration | — | missing_in_driver | Z2M defines soil_calibration — no driver dpMapping |
| wqashyqo-ts0601-soil | soil_sensor | 103 | temperature | — | missing_in_driver | Z2M defines temperature — no driver dpMapping |
| wqashyqo-ts0601-soil | soil_sensor | 104 | temperature_calibration | — | missing_in_driver | Z2M defines temperature_calibration — no driver dpMapping |
| wqashyqo-ts0601-soil | soil_sensor | 105 | humidity_calibration | — | missing_in_driver | Z2M defines humidity_calibration — no driver dpMapping |
| wqashyqo-ts0601-soil | soil_sensor | 106 | temperature_unit | — | missing_in_driver | Z2M defines temperature_unit — no driver dpMapping |
| wqashyqo-ts0601-soil | soil_sensor | 107 | soil_moisture | — | missing_in_driver | Z2M defines soil_moisture — no driver dpMapping |
| wqashyqo-ts0601-soil | soil_sensor | 108 | battery | — | missing_in_driver | Z2M defines battery — no driver dpMapping |
| wqashyqo-ts0601-soil | soil_sensor | 109 | humidity | — | missing_in_driver | Z2M defines humidity — no driver dpMapping |
| wqashyqo-ts0601-soil | soil_sensor | 110 | soil_warning | — | missing_in_driver | Z2M defines soil_warning — no driver dpMapping |
| wqashyqo-ts0601-soil | soil_sensor | 111 | temperature_sampling | — | missing_in_driver | Z2M defines temperature_sampling — no driver dpMapping |
| wqashyqo-ts0601-soil | soil_sensor | 112 | soil_sampling | — | missing_in_driver | Z2M defines soil_sampling — no driver dpMapping |
...
| p2268-a14rjslz-3phase-not-climate | energy_meter_3phase | 1 | energy | — | missing_in_driver | knowledge documents DP — not in driver compose/device |
| p2268-a14rjslz-3phase-not-climate | energy_meter_3phase | 23 | produced_energy | — | missing_in_driver | knowledge documents DP — not in driver compose/device |
| p2268-a14rjslz-3phase-not-climate | energy_meter_3phase | 24 | total_energy | — | missing_in_driver | knowledge documents DP — not in driver compose/device |
| p2268-a14rjslz-3phase-not-climate | energy_meter_3phase | 29 | power | — | missing_in_driver | knowledge documents DP — not in driver compose/device |
| p2268-cf4b5ktf-moes-3phase-soft | energy_meter_3phase | 23 | — | — | missing_in_driver | knowledge documents DP — not in driver compose/device |
| p2268-cf4b5ktf-moes-3phase-soft | energy_meter_3phase | 29 | — | — | missing_in_driver | knowledge documents DP — not in driver compose/device |
...
| p2276-dikb3dp6-3phase-not-climate | energy_meter_3phase | 23 | produced_energy | — | missing_in_driver | knowledge documents DP — not in driver compose/device |
| p2276-dikb3dp6-3phase-not-climate | energy_meter_3phase | 29 | power | — | missing_in_driver | knowledge documents DP — not in driver compose/device |
| p2276-dikb3dp6-3phase-not-climate | energy_meter_3phase | 1 | energy | — | missing_in_driver | Z2M defines energy — no driver dpMapping |
| p2276-dikb3dp6-3phase-not-climate | energy_meter_3phase | 23 | produced_energy | — | missing_in_driver | Z2M defines produced_energy — no driver dpMapping |
| p2276-dikb3dp6-3phase-not-climate | energy_meter_3phase | 29 | power | — | missing_in_driver | Z2M defines power — no driver dpMapping |
...
| p2514-zm16b-3mzb0sdz-curtain | curtain_motor | 8 | — | — | missing_in_driver | knowledge documents DP — not in driver compose/device |
| p2514-zm16b-3mzb0sdz-curtain | curtain_motor | 9 | — | — | missing_in_driver | knowledge documents DP — not in driver compose/device; TX path undocumented in driver |
| p2514-zm16b-3mzb0sdz-curtain | curtain_motor | 11 | — | — | missing_in_driver | knowledge documents DP — not in driver compose/device; TX path undocumented in driver |
| p2514-zm16b-3mzb0sdz-curtain | curtain_motor | 13 | — | — | missing_in_driver | knowledge documents DP — not in driver compose/device |
| p2514-zm16b-3mzb0sdz-curtain | curtain_motor | 16 | — | — | missing_in_driver | knowledge documents DP — not in driver compose/device; TX path undocumented in driver |
...
| hobeian-zg103z-vibration-tilt | vibration_sensor | 104 | sensitivity | — | missing_in_driver | Z2M defines sensitivity — no driver dpMapping |
| hobeian-zg103z-vibration-tilt | vibration_sensor | 105 | battery | — | missing_in_driver | Z2M defines battery — no driver dpMapping |
| p2432-dze200-mja3fuja-air-quality | air_quality_co2 | 18 | — | — | missing_in_driver | knowledge documents DP — not in driver compose/device |
| p2432-dze200-mja3fuja-air-quality | air_quality_co2 | 19 | — | — | missing_in_driver | knowledge documents DP — not in driver compose/device |
| p2432-dze200-mja3fuja-air-quality | air_quality_co2 | 21 | — | — | missing_in_driver | knowledge documents DP — not in driver compose/device |
| p2432-dze200-mja3fuja-air-quality | air_quality_co2 | 22 | — | — | missing_in_driver | knowledge documents DP — not in driver compose/device |
| p2516-a14rjslz-3phase-meter | energy_meter_3phase | 1 | energy | — | missing_in_driver | knowledge documents DP — not in driver compose/device |
| p2516-a14rjslz-3phase-meter | energy_meter_3phase | 23 | produced_energy | — | missing_in_driver | knowledge documents DP — not in driver compose/device |
| p2516-a14rjslz-3phase-meter | energy_meter_3phase | 24 | total_energy | — | missing_in_driver | knowledge documents DP — not in driver compose/device |
| p2516-a14rjslz-3phase-meter | energy_meter_3phase | 29 | power | — | missing_in_driver | knowledge documents DP — not in driver compose/device |
| p2519-8eazvzo6-not-climate | switch_wall_6gang | 1 | state_l1 | — | missing_in_driver | Z2M defines state_l1 — no driver dpMapping |
| p2519-8eazvzo6-not-climate | switch_wall_6gang | 2 | state_l2 | — | missing_in_driver | Z2M defines state_l2 — no driver dpMapping |
| p2519-8eazvzo6-not-climate | switch_wall_6gang | 3 | state_l3 | — | missing_in_driver | Z2M defines state_l3 — no driver dpMapping |
| p2519-8eazvzo6-not-climate | switch_wall_6gang | 4 | state_l4 | — | missing_in_driver | Z2M defines state_l4 — no driver dpMapping |
| p2519-8eazvzo6-not-climate | switch_wall_6gang | 5 | state_l5 | — | missing_in_driver | Z2M defines state_l5 — no driver dpMapping |
| p2519-8eazvzo6-not-climate | switch_wall_6gang | 6 | state_l6 | — | missing_in_driver | Z2M defines state_l6 — no driver dpMapping |
| p2519-8eazvzo6-not-climate | switch_wall_6gang | 21 | current | — | missing_in_driver | Z2M defines current — no driver dpMapping |
| p2519-8eazvzo6-not-climate | switch_wall_6gang | 22 | power | — | missing_in_driver | Z2M defines power — no driver dpMapping |
| p2519-8eazvzo6-not-climate | switch_wall_6gang | 23 | voltage | — | missing_in_driver | Z2M defines voltage — no driver dpMapping |
| p2538-tze284-8b9zpaav-airbox | air_quality_co2 | 18 | temperature | — | missing_in_driver | Z2M defines temperature — no driver dpMapping |
| p2538-tze284-8b9zpaav-airbox | air_quality_co2 | 19 | humidity | — | missing_in_driver | Z2M defines humidity — no driver dpMapping |
| p2538-tze284-8b9zpaav-airbox | air_quality_co2 | 21 | voc | — | missing_in_driver | Z2M defines voc — no driver dpMapping |
| p2538-tze284-8b9zpaav-airbox | air_quality_co2 | 22 | formaldehyd | — | missing_in_driver | Z2M defines formaldehyd — no driver dpMapping |
| p2538-tze284-it9utkro-pm25-airbox | air_quality_co2 | 18 | temperature | — | missing_in_driver | Z2M defines temperature — no driver dpMapping |
| p2538-tze284-it9utkro-pm25-airbox | air_quality_co2 | 19 | humidity | — | missing_in_driver | Z2M defines humidity — no driver dpMapping |
| p2538-tze284-it9utkro-pm25-airbox | air_quality_co2 | 20 | co2 | — | missing_in_driver | Z2M defines co2 — no driver dpMapping |
| p2538-tze284-it9utkro-pm25-airbox | air_quality_co2 | 21 | voc | — | missing_in_driver | Z2M defines voc — no driver dpMapping |
| p2538-tze284-it9utkro-pm25-airbox | air_quality_co2 | 22 | formaldehyd | — | missing_in_driver | Z2M defines formaldehyd — no driver dpMapping |
| p2541-tze200-yvx5lh6k-air-quality-reinstate | air_quality_co2 | 18 | — | — | missing_in_driver | knowledge documents DP — not in driver compose/device |
| p2541-tze200-yvx5lh6k-air-quality-reinstate | air_quality_co2 | 19 | — | — | missing_in_driver | knowledge documents DP — not in driver compose/device |
| p2541-tze200-yvx5lh6k-air-quality-reinstate | air_quality_co2 | 21 | — | — | missing_in_driver | knowledge documents DP — not in driver compose/device |
| p2541-tze200-yvx5lh6k-air-quality-reinstate | air_quality_co2 | 22 | — | — | missing_in_driver | knowledge documents DP — not in driver compose/device |
| p2571-tgeqdjgk-knob-dimmer | wall_dimmer_tuya | 102 | state | — | missing_in_driver | Z2M defines state — no driver dpMapping |
| p2571-tgeqdjgk-knob-dimmer | wall_dimmer_tuya | 103 | brightness | — | missing_in_driver | Z2M defines brightness — no driver dpMapping |
| p2571-tgeqdjgk-knob-dimmer | wall_dimmer_tuya | 105 | adjustment_mode | — | missing_in_driver | Z2M defines adjustment_mode — no driver dpMapping |
| p2571-tgeqdjgk-knob-dimmer | wall_dimmer_tuya | 106 | power_on_behavior | — | missing_in_driver | Z2M defines power_on_behavior — no driver dpMapping |
| p2571-tgeqdjgk-knob-dimmer | wall_dimmer_tuya | 107 | color_temp | — | missing_in_driver | Z2M defines color_temp — no driver dpMapping |
| p2571-tgeqdjgk-knob-dimmer | wall_dimmer_tuya | 111 | action | — | missing_in_driver | Z2M defines action — no driver dpMapping |
| p2571-tgeqdjgk-knob-dimmer | wall_dimmer_tuya | 112 | action | — | missing_in_driver | Z2M defines action — no driver dpMapping |
| p2571-tgeqdjgk-knob-dimmer | wall_dimmer_tuya | 121 | state_l1 | — | missing_in_driver | Z2M defines state_l1 — no driver dpMapping |
| p2571-tgeqdjgk-knob-dimmer | wall_dimmer_tuya | 122 | state_l2 | — | missing_in_driver | Z2M defines state_l2 — no driver dpMapping |
| p2571-tgeqdjgk-knob-dimmer | wall_dimmer_tuya | 131 | switch_mode_l1 | — | missing_in_driver | Z2M defines switch_mode_l1 — no driver dpMapping |
| p2571-tgeqdjgk-knob-dimmer | wall_dimmer_tuya | 132 | switch_mode_l2 | — | missing_in_driver | Z2M defines switch_mode_l2 — no driver dpMapping |
| p2571-tgeqdjgk-knob-dimmer | wall_dimmer_tuya | 141 | mode | — | missing_in_driver | Z2M defines mode — no driver dpMapping |
| p2571-tgeqdjgk-knob-dimmer | wall_dimmer_tuya | 102 | state | — | missing_in_driver | Z2M defines state — no driver dpMapping |
| p2571-tgeqdjgk-knob-dimmer | wall_dimmer_tuya | 103 | brightness | — | missing_in_driver | Z2M defines brightness — no driver dpMapping |
| p2571-tgeqdjgk-knob-dimmer | wall_dimmer_tuya | 105 | adjustment_mode | — | missing_in_driver | Z2M defines adjustment_mode — no driver dpMapping |
| p2571-tgeqdjgk-knob-dimmer | wall_dimmer_tuya | 106 | power_on_behavior | — | missing_in_driver | Z2M defines power_on_behavior — no driver dpMapping |
...
| p2571-tgeqdjgk-knob-dimmer | wall_dimmer_tuya | 132 | switch_mode_l2 | — | missing_in_driver | Z2M defines switch_mode_l2 — no driver dpMapping |
| p2571-tgeqdjgk-knob-dimmer | wall_dimmer_tuya | 141 | mode | — | missing_in_driver | Z2M defines mode — no driver dpMapping |
| p2571-vvmbj46n-lcd-th | lcdtemphumidsensor | 9 | temperature_unit | — | missing_in_driver | Z2M defines temperature_unit — no driver dpMapping |
| p2571-vvmbj46n-lcd-th | lcdtemphumidsensor | 10 | max_temperature_alarm | — | missing_in_driver | Z2M defines max_temperature_alarm — no driver dpMapping |
| p2571-vvmbj46n-lcd-th | lcdtemphumidsensor | 11 | min_temperature_alarm | — | missing_in_driver | Z2M defines min_temperature_alarm — no driver dpMapping |
| p2571-vvmbj46n-lcd-th | lcdtemphumidsensor | 12 | max_humidity_alarm | — | missing_in_driver | Z2M defines max_humidity_alarm — no driver dpMapping |
| p2571-vvmbj46n-lcd-th | lcdtemphumidsensor | 13 | min_humidity_alarm | — | missing_in_driver | Z2M defines min_humidity_alarm — no driver dpMapping |
| p2571-vvmbj46n-lcd-th | lcdtemphumidsensor | 14 | temperature_alarm | — | missing_in_driver | Z2M defines temperature_alarm — no driver dpMapping |
| p2571-vvmbj46n-lcd-th | lcdtemphumidsensor | 17 | temperature_periodic_report | — | missing_in_driver | Z2M defines temperature_periodic_report — no driver dpMapping |
| p2571-vvmbj46n-lcd-th | lcdtemphumidsensor | 19 | temperature_sensitivity | — | missing_in_driver | Z2M defines temperature_sensitivity — no driver dpMapping |
| p2571-vvmbj46n-lcd-th | lcdtemphumidsensor | 20 | humidity_sensitivity | — | missing_in_driver | Z2M defines humidity_sensitivity — no driver dpMapping |
| p2571-vvmbj46n-lcd-th | lcdtemphumidsensor | 9 | temperature_unit | — | missing_in_driver | Z2M defines temperature_unit — no driver dpMapping |
| p2571-vvmbj46n-lcd-th | lcdtemphumidsensor | 10 | max_temperature_alarm | — | missing_in_driver | Z2M defines max_temperature_alarm — no driver dpMapping |
| p2571-vvmbj46n-lcd-th | lcdtemphumidsensor | 11 | min_temperature_alarm | — | missing_in_driver | Z2M defines min_temperature_alarm — no driver dpMapping |
| p2571-vvmbj46n-lcd-th | lcdtemphumidsensor | 12 | max_humidity_alarm | — | missing_in_driver | Z2M defines max_humidity_alarm — no driver dpMapping |
...
| _TZ3000_vdfwjopk|TS0219 | dp_6 |
| _TZE200_jfw0a4aa|TS0601 | sensitivity |
| _TZE200_dfxkcots|TS0601 | countdown |
| _TZE200_3p5ydos3|TS0601 | countdown |
| _TZ3210_0zabbfax|TS0503B | dp_6 |
