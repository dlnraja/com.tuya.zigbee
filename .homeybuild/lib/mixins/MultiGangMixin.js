...
module.exports = (BaseClass) => class extends BaseClass {
    ...
    /**
     * 🛡️ THE SYNCHRONIZATION SHIELD (Multi-Gang Guard)
    ...
    async _onMultipleGangAction(valueObj, customOpts) {
        ...
        for (const [capability, value] of Object.entries(valueObj)) {
            ...
            if (dp) {
                ...
                // Route to the specific sender (BaseHybridDevice or TuyaLocalDevice)
    ...
    _buildGangMapFromCapabilities() {
        ...
        this.log(`[MultiGang] 🗺️ Auto-Mapped DPs:`, JSON.stringify(map));
        return map;
    }
