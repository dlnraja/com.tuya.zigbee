  ...
  return class extends superclass {
    ...
    collectArchitectureContext() {
      return {
        appArchitecture: {
          baseClasses: {
            BaseHybridDevice: 'Ultimate base - handles both Tuya DP (0xEF00) and ZCL protocols with auto-detection',
            HybridSwitchBase: 'Multi-gang switches with physical button detection and power-on/backlight settings',
            HybridSensorBase: 'All sensors - motion, contact, temp/humidity, air quality, soil, rain, smoke',
            HybridPlugBase: 'Smart plugs, water valves, energy monitoring with metering clusters',
            HybridCoverBase: 'Curtain motors, blinds, shutters with position/tilt control',
            HybridLightBase: 'Bulbs, LED strips, dimmers with color temp and RGB support',
            HybridThermostatBase: 'TRVs, thermostats with schedule and temperature control',
