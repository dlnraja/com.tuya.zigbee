...
class RemoteButtonWirelessHybridDriver extends Homey.Driver {
  ...
  _registerFlowCards() {
    ...
    this.homey.flow.getTriggerCard('remote_button_wireless_hybrid_single_press')
      .registerRunListener(async (args, state) => true);

    // Double press trigger
    this.homey.flow.getTriggerCard('remote_button_wireless_hybrid_double_press')
      .registerRunListener(async (args, state) => true);

    // Long press trigger
    this.homey.flow.getTriggerCard('remote_button_wireless_hybrid_long_press')
      .registerRunListener(async (args, state) => true);

    // Brightness condition
    this.homey.flow.getConditionCard('remote_button_wireless_hybrid_brightness_above')
