...
// Enrichment Date: 2025-08-07T17:53:55.141Z

'use strict';

const { ZigBeeDriver } = require('homey-meshdriver');

class Irrigation_controllerDriver extends ZigBeeDriver {
    ...
    this.printNode();
        ...
        this.log('🚀 irrigation_controller Driver - Initialisation MEGA enrichie...');
        ...
        this.log('✅ irrigation_controller Driver - Initialisation MEGA terminée');
    }
...
module.exports = Irrigation_controllerDriver;