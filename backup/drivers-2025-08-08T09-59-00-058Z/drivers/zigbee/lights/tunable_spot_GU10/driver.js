...
// Driver Type: zigbee
// Category: lights
// Subcategory: tunable_spot_GU10
// Enrichment Date: 2025-08-07T17:53:55.798Z

'use strict';

const { ZigBeeDriver } = require('homey-meshdriver');

class Tunable_spot_GU10Driver extends ZigBeeDriver {
    ...
    this.printNode();
        ...
        this.log('🚀 tunable_spot_GU10 Driver - Initialisation MEGA enrichie...');
        ...
        this.log('✅ tunable_spot_GU10 Driver - Initialisation MEGA terminée');
    }
...
module.exports = Tunable_spot_GU10Driver;