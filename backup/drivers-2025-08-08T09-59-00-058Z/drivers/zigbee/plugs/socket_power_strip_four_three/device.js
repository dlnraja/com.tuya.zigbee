...
// Enrichment Date: 2025-08-07T17:53:56.364Z
...
class Socketpowerstripfourthree extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Socketpowerstripfourthree SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Socketpowerstripfourthree Enhanced deleted');
  }
...
module.exports = Socketpowerstripfourthree;
