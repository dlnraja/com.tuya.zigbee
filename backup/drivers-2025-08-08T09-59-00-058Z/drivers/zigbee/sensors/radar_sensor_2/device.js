...
// Device Type: zigbee
// Category: sensors
// Subcategory: radar_sensor_2
// Enrichment Date: 2025-08-07T17:53:56.731Z
...
class Radarsensor2 extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Radarsensor2 SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Radarsensor2 Enhanced deleted');
  }
