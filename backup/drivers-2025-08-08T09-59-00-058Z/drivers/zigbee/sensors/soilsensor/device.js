...
// Device Type: zigbee
// Category: sensors
// Subcategory: soilsensor
// Enrichment Date: 2025-08-07T17:53:56.863Z
...
class Soilsensor extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Soilsensor SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Soilsensor Enhanced deleted');
  }
