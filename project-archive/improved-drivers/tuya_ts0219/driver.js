...
class TuyaTs0219Driver extends Homey.Driver {
   ...
   */
  onUninit() {
    this.log('TuyaTs0219Driver is unloading...');
  }
  ...
  _registerFlowCards() {
    // Action cards
    this.flowActionTurnOn = this.homey.flow.getActionCard('tuya_ts0219_turn_on');
    this.flowActionTurnOn.registerRun(this._actionTurnOn.bind(this));
    
    this.flowActionTurnOff = this.homey.flow.getActionCard('tuya_ts0219_turn_off');
    this.flowActionTurnOff.registerRun(this._actionTurnOff.bind(this));
    
    this.flowActionToggle = this.homey.flow.getActionCard('tuya_ts0219_toggle');
    this.flowActionToggle.registerRun(this._actionToggle.bind(this));
    
    // Condition cards
    this.flowConditionIsOn = this.homey.flow.getConditionCard('tuya_ts0219_is_on');
    ...
    return [
      {
        name: 'Tuya TS0219',
        data: {
          id: '74c52686-1465-4ddc-97e0-8642480ca25b'
        },
        store: {
          // Add store data here
        },
