 ...
 * Tuya TS0202 Driver
 * 
 * @class TuyaTs0202Driver
 * @extends {Homey.Driver}
 */
class TuyaTs0202Driver extends Homey.Driver {
  /**
   * onInit is called when the driver is initialized.
   */
  async onInit() {
    this.log('TuyaTs0202Driver has been initialized');
   ...
   */
  onUninit() {
    this.log('TuyaTs0202Driver is unloading...');
  }
  ...
  _registerFlowCards() {
    // Action cards
    this.flowActionTurnOn = this.homey.flow.getActionCard('tuya_ts0202_turn_on');
    this.flowActionTurnOn.registerRun(this._actionTurnOn.bind(this));
    
    this.flowActionTurnOff = this.homey.flow.getActionCard('tuya_ts0202_turn_off');
    this.flowActionTurnOff.registerRun(this._actionTurnOff.bind(this));
    
    this.flowActionToggle = this.homey.flow.getActionCard('tuya_ts0202_toggle');
    this.flowActionToggle.registerRun(this._actionToggle.bind(this));
    
    // Condition cards
    this.flowConditionIsOn = this.homey.flow.getConditionCard('tuya_ts0202_is_on');
    ...
    return [
      {
        name: 'Tuya TS0202',
        data: {
          id: '077df26d-c897-4db7-9c88-3a219755cb35'
        },
        store: {
          // Add store data here
        },
...
module.exports = TuyaTs0202Driver;