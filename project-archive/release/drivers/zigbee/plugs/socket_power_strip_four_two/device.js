...
// Device Type: zigbee
// Category: plugs
// Subcategory: socket_power_strip_four_two
// Enrichment Date: 2025-08-07T17:53:56.400Z
...
class Socketpowerstripfourtwo extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Socketpowerstripfourtwo SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Socketpowerstripfourtwo Enhanced deleted');
  }
