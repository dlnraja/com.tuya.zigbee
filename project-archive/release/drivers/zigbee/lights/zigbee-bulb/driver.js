...
// Driver Type: zigbee
// Category: lights
// Subcategory: zigbee-bulb
// Enrichment Date: 2025-08-07T17:53:55.859Z

'use strict';

const { ZigBeeDriver } = require('homey-meshdriver');

class Zigbee-bulbDriver extends ZigBeeDriver {
    ...
    this.printNode();
        ...
        this.log('🚀 zigbee-bulb Driver - Initialisation MEGA enrichie...');
        ...
        this.log('✅ zigbee-bulb Driver - Initialisation MEGA terminée');
    }
...
module.exports = Zigbee-bulbDriver;