...
// Device Type: zigbee
// Category: sensors
// Subcategory: radar_sensor_ceiling
// Enrichment Date: 2025-08-07T17:53:56.737Z
...
class Radarsensorceiling extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Radarsensorceiling SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Radarsensorceiling Enhanced deleted');
  }
