...
// Device Type: zigbee
// Category: sensors
// Subcategory: lcdtemphumidsensor_3
// Enrichment Date: 2025-08-07T17:53:56.664Z
...
class Lcdtemphumidsensor3 extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Lcdtemphumidsensor3 SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Lcdtemphumidsensor3 Enhanced deleted');
  }
