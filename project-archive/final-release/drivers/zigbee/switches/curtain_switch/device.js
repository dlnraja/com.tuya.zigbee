...
// Device Type: zigbee
// Category: switches
// Subcategory: curtain_switch
// Enrichment Date: 2025-08-07T17:53:57.033Z
...
class Curtainswitch extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Curtainswitch SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Curtainswitch Enhanced deleted');
  }
