...
// Device Type: zigbee
// Category: sensors
// Subcategory: temphumidsensor4
// Enrichment Date: 2025-08-07T17:53:56.968Z
...
class Temphumidsensor4 extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Temphumidsensor4 SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Temphumidsensor4 Enhanced deleted');
  }
