...
// Driver Type: zigbee
// Category: lights
// Subcategory: rgb_floor_led_light
// Enrichment Date: 2025-08-07T17:53:55.614Z

'use strict';

const { ZigBeeDriver } = require('homey-meshdriver');

class Rgb_floor_led_lightDriver extends ZigBeeDriver {
    ...
    this.printNode();
        ...
        this.log('🚀 rgb_floor_led_light Driver - Initialisation MEGA enrichie...');
        ...
        this.log('✅ rgb_floor_led_light Driver - Initialisation MEGA terminée');
    }
...
module.exports = Rgb_floor_led_lightDriver;