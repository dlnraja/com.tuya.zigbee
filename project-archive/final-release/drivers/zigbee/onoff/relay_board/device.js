...
// Device Type: zigbee
// Category: onoff
// Subcategory: relay_board
// Enrichment Date: 2025-08-07T17:53:56.018Z
...
class Relayboard extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Relayboard SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Relayboard Enhanced deleted');
  }
