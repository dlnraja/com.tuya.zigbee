...
class TuyatemperaturesensorDevice extends TuyaDevice {
    ...
    async onInit() {
        ...
        // Initialize device
        this.log('tuya-temperature-sensor device initialized (Historical)');
    ...
    async onUninit() {
        ...
        this.log('tuya-temperature-sensor device uninitialized');
    }
    ...
    async onSettings({ oldSettings, newSettings, changedKeys }) {
        ...
        this.log('tuya-temperature-sensor settings updated');
    }
}
