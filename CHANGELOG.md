...
### Bug Fixes
- Fixed bed sensor: DP12 now reports illuminance correctly.
- Removed obsolete data point DP103 from bed sensor driver.

### New Features
- Monthly enrichment: 365 drivers and 3428 fingerprints validated.
---
...
### Bug Fixes
- Fixed a bug in UnifiedSensorBase by adding a forceActiveTuyaMode check to _handleDP.
...
### New Features
- Added 4 new fingerprints from Z2M/ZHA/community.

### Improvements
- Updated fingerprints.json to sync with new data.
---
...
### Bug Fixes
- Fixed auto-heal for fingerprints after radiator valve collision cleanup.
- Resolved radiator valve collision issue #381 and improved issue responses.
---

 v8.1.141 (2026-06-06)

v8.1.140: Fixed auto-heal for 5 missing fingerprints from radiator valve collision issue., No new features added in this release., No improvements made in this release.
...
### Bug Fixes
- Fixed auto-heal for 5 missing fingerprints from radiator valve collision issue.
...
v8.1.134: Fixed illuminance sensor: removed ZCL reporting for Tuya DP devices.
---
...
### Bug Fixes
- Fixed illuminance sensor: removed ZCL reporting for Tuya DP devices.
---
...
### New Features
- Added 116 new fingerprints from Z2M/ZHA/community/JohanBendz.
