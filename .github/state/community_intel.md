...
**Author:** haadeess | **State:** open | **Created:** 2026-06-07T07:54:17Z | **Updated:** 2026-06-09T14:25:49Z
...
---
**Comment by haadeess**:
<img width="1243" height="864" alt="Image" src="https://github.com/user-attachments/assets/6cc8561b-d40e-4b85-8894-c8a38f6bb29d" />

========================================================================

## [dlnraja/com.tuya.zigbee] Issue #410: _TZ3000_yj6k7vfo [button_wireless_smart] Bug: No button press detected again. #334
**Author:** haadeess | **State:** open | **Created:** 2026-06-09T14:12:56Z | **Updated:** 2026-06-09T14:12:56Z
**URL:** https://github.com/dlnraja/com.tuya.zigbee/issues/410

### Body:
No keystroke detected

fe2b7beb-c5ca-4835-b7e2-cf418ef8a2ed

<img width="1979" height="1251" alt="Image" src="https://github.com/user-attachments/assets/44639ef3-b499-4378-a91d-bdcd1c916487" />
...
> 8463f923-c8fe-48b9-b9c4-d4d9adba1512 

 _Originally posted by @haadeess in [#334](https://github.com/dlnraja/com.tuya.zigbee/issues/334#issuecomment-4629336437)_
...
**Author:** haadeess | **State:** open | **Created:** 2026-06-07T07:25:47Z | **Updated:** 2026-06-09T08:06:33Z
...
---
**Comment by dlnraja**:
@haadeess Thank you for the detailed diagnostic! I've analyzed the Zigbee interview data and found important technical details:

### Diagnostic Analysis — `_TZE200_u6x1zyv2` TS0601

**Your device is a HYBRID device** that uses BOTH protocols:
1. **IAS Zone (cluster 1280)** — zoneType: `waterSensor`, zoneState: `enrolled`
2. **Illuminance Measurement (cluster 1024)** — measuredValue: 34982
3. **Tuya DP (cluster 61184)** — Additional data via Tuya protocol
4. **Power Configuration (cluster 1)** — batteryVoltage: 30, batteryPercentageRemaining: 200

**Key insight:** This device uses IAS Zone as the PRIMARY detection method (water sensor), not Tuya DP. The IAS Zone cluster handles rain detection, while Tuya DP provides additional data (sensitivity, illuminance, battery settings).

### What was fixed

1. `_TZE200_u6x1zyv2` correctly routes to `rain_sensor` (not `water_leak_sensor`)
2. 5 secondary fingerprint databases synchronized
3. `batteryThreshold` → `battery_threshold` (snake_case)
4. DP104 alarm_battery removed (Rule AO)

### What to test

1. Update to **v8.1.189+**
2. Remove and re-pair the device
3. Check the log for `[RAIN-IAS]` messages (IAS Zone setup)
4. Verify: rain detection (alarm_water) triggers when water touches sensor
5. Verify: illuminance values appear
6. Share a new diagnostic report

### Technical note

The IAS Zone enrollment shows `enrolled: true` which means the device successfully enrolled with the coordinator. The issue might be that the IAS Zone status change notifications are not being received. The rain_sensor driver listens for `zoneStatusChangeNotification` and `attr.zoneStatus` events — if these events are not being received, the rain detection won't trigger.
...
---
**Comment by haadeess**:
4bccd47a-acc4-4417-8fcd-531ba9f9afff

v8.1.193

<img width="1267" height="925" alt="Image" src="https://github.com/user-attachments/assets/a893b5fc-f1ac-4241-8f23-b61a0726e9dc" />

========================================================================

## [dlnraja/com.tuya.zigbee] Issue #409: [Auto] 3 new fingerprints from community (2026-06)
**Author:** github-actions[bot] | **State:** open | **Created:** 2026-06-09T06:31:42Z | **Updated:** 2026-06-09T06:31:42Z
**URL:** https://github.com/dlnraja/com.tuya.zigbee/issues/409

### Body:
## 🌐 Monthly Community Sync Found 3 New Fingerprints
...
## [dlnraja/com.tuya.zigbee] Issue #408: [Auto] 37 new fingerprints from community (2026-06)
**Author:** github-actions[bot] | **State:** open | **Created:** 2026-06-09T02:15:06Z | **Updated:** 2026-06-09T02:15:06Z
**URL:** https://github.com/dlnraja/com.tuya.zigbee/issues/408

### Body:
## 🌐 Monthly Community Sync Found 37 New Fingerprints

| Manufacturer ID | Product ID | Device Type | Source | Vendor | Capabilities |
|---|---|---|---|---|---|
| `_TZ3210_ncw88jfq` | TS0201,TY0201 | lcdtemphumidsensor | Johan | - | measure_temperature, measure_humidity, measure_battery |
...
| `_TZ3000_8nkb7mof` | TS0121,TSO121,TS011F | smartplug | Johan | - | onoff, measure_power, meter_power |
...
| `_TZ3000_fkp5zyho` | TS0041 | wall_remote_1_gang | Johan | - | - |
| `_TZ3000_axpdxqgu` | TS0041 | wall_remote_1_gang | Johan | - | - |
| `_TZ3000_f97vq5mn` | TS0041 | wall_remote_1_gang | Johan | - | - |
| `_TZ3000_owgcnkrh` | TS0042 | wall_remote_2_gang | Johan | - | - |
...
| `_TYZB01_xiuox57i` | TS0003,TS0013,TS0043 | wall_switch_3_gang | Johan | - | onoff |
| `_TYZB01_b8cr31hp` | TS0003,TS0013,TS0043 | wall_switch_3_gang | Johan | - | onoff |
| `_TYZB01_mqel1whf` | TS0003,TS0013,TS0043 | wall_switch_3_gang | Johan | - | onoff |
| `_TYZB01_bagt1e4o` | TS0014,TS0044 | wall_switch_4_gang | Johan | - | onoff |
| `_TZ3210_ncw88jfq` | - | - | Z2M | - | - |
| `_TZE204_7bztmfm1` | - | - | Z2M | - | - |
| `_TZ3000_nwidmc4n` | - | - | Z2M | - | - |
| `_TZ3000_pfc7i3kt` | - | - | Z2M | - | - |
| `_TZ3000_iv4eq7eh` | - | - | Z2M | - | - |
| `_TZ3000_mzcp0of6` | - | - | Z2M | - | - |
| `_TZE204_guvc7pdy` | - | - | Z2M | - | - |
| `_TZ3000_avotanj3` | - | - | Z2M | - | - |
| `_TZE284_sdvbnmj5` | - | - | Z2M | - | - |
...
**Author:** DaPicardos | **State:** open | **Created:** 2026-06-06T11:33:46Z | **Updated:** 2026-06-08T18:27:53Z
...
---
**Comment by dlnraja**:
## 📊 Analyse Cross-Project Complète — Z2M / ZHA / Homey

J'ai comparé nos implémentations avec **3 projets** (Z2M, ZHA, Homey) pour chaque device. Voici les découvertes clés :

### 🔍 Bed Sensor (_TZE200_seq9cm6u)

| Projet | DP1 | DP4 | DP12 | Battery |
|--------|-----|-----|------|---------|
| **Z2M** | presence (bool, trueFalse) | battery (%) | presence_distance | DP4 direct % |
| **ZHA** | Pas de quirk enregistré | Pas de quirk | N/A | N/A |
| **Homey** | alarm_contact (inverted: 0=occupied) | CR2032 direct % | measure_pressure | DP4 special 0→10%, 1→100% |

**Découverte**: Z2M utilise `trueFalse` (non-inverted) mais notre code inverse avec `(v === 0)`. Le Z2M confirme que DP1=0 signifie "occupied" — notre inversion est CORRECTE.

### 🔍 Rain Sensor (_TZE200_u6x1zyv2)

| Projet | Détection pluie | Battery | Protocole |
|--------|----------------|---------|-----------|
| **Z2M** | DP1 (rainwater bool) | DP4 | Tuya DP uniquement |
| **ZHA** | DP105 (IAS Zone, threshold >100) | DP4 (TS0207) | IAS Zone uniquement |
| **Homey** | DP1 (alarm_water) + IAS Zone | DP4 + DP15 fallback | **LES DEUX** protocoles |

**Découverte**: Seul Homey gère les DEUX protocoles (Tuya DP + IAS Zone) dans le même driver. Z2M ne gère que Tuya DP. ZHA ne gère que IAS Zone.

### 🔍 4-Button Remote (_TZ3000_u3nv1jwk)

| Projet | Détection boutons | Battery | Scene Mode |
|--------|------------------|---------|------------|
| **Z2M** | Per-endpoint ZCL OnOff | ZCL genPowerCfg | Pas nécessaire |
| **ZHA** | TuyaSmartRemoteOnOffCluster + Tuya4ButtonTriggers | TuyaNoBindPowerCfg | Pas dans le quirk |
| **Homey** | ButtonDevice (scenes + OnOff + Tuya DP) | ZCL genPowerCfg | Attribute 0x8004 |

**Découverte**: ZHA utilise `TuyaNoBindPowerConfigurationCluster` pour éviter le drain batterie. Notre driver ne le fait pas.

### 🔍 Soil Sensor (_TZE284_aao3yzhs)

| Projet | Humidité | Température | Battery | EC |
|--------|----------|-------------|---------|-----|
| **Z2M** | DP3 | DP5 (/10) | DP15 + DP14 | Non exposé |
| **ZHA** | DP3 | DP5 (/10) | DP15 seulement | Non exposé |
| **Homey** | DP3 + DP105 + DP109 | DP5 (auto-scale) | DP15 + DP14 (enum→%) | DP4 + DP106 + DP112 |

**Découverte**: Homey a la couverture la plus large — 3 DPs d'humidité vs 1 pour Z2M/ZHA.

### 🔍 Presence Radar (_TZE200_ka8l86iu)

| Projet | Présence | Battery | Illuminance |
|--------|----------|---------|-------------|
| **Z2M** | DP1 (enum) | DP110 (%) | DP106 |
| **ZHA** | Pas de quirk | N/A | N/A |
| **Homey** | DP1 (enum→bool) | DP110 (%) | DP106 |

**Découverte**: Z2M et Homey ont les mêmes DPs. ZHA n'a pas de quirk pour ce MFR.

### 🎯 Améliorations suggérées

1. **Bed Sensor**: Vérifier si le battery DP4 envoie bien un pourcentage ou un voltage
2. **Rain Sensor**: Vérifier le mapping DP4 (Z2M dit battery_low bool, pas percentage)
3. **Soil Sensor**: Ajouter le support DP14 (battery_state enum) dans EnrichedDPMappings
4. **Presence Radar**: Vérifier le battery DP110 (non-standard)

Sources: Z2M (zigbee-herdsman-converters), ZHA (zha-device-handlers), Homey SDK3 docs
