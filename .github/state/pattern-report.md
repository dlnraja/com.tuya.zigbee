...
| Pairing Failure | 17 | **high** | `vision` (13x), `_TZE` (5x), `TS0601` (5x) |
| Device Not Responding | 9 | **high** | `test` (5x), `TS0601` (5x), `vision` (4x) |
| Device Shows Unknown | 6 | **high** | `_TZE` (3x), `TS0601` (3x), `vision` (3x) |
...
### Pairing Failure (17 reports)
**Fix:** Check driver.compose.json fingerprints, verify manufacturerName + productId
**Files:** `drivers/{driver}/driver.compose.json`
**Most affected:** `vision` (13x), `_TZE` (5x), `TS0601` (5x), `router` (5x), `example` (3x), `generic` (3x), `_TZ3000_o4mkahkc` (2x), `test` (2x), `_TZ3000_o4mkahk` (2x), `TS0202` (2x)
...
### Device Shows Unknown (6 reports)
**Fix:** Check settings keys: zb_model_id (not zb_modelId), zb_manufacturer_name (not zb_manufacturerName)
**Files:** `drivers/{driver}/device.js`
**Most affected:** `_TZE` (3x), `TS0601` (3x), `vision` (3x), `_TZE284_aa03yzhs` (2x), `tuya` (2x), `test` (2x), `generic` (2x), `dlnraja` (1x), `example` (1x), `_TZ3000_wpueorev` (1x)
