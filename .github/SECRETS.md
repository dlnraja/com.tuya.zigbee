...
| nightly-auto-process.yml | GOOGLE_API_KEY, OPENAI_API_KEY, HF_TOKEN, APIFREELLM_KEY, HOMEY_PAT, HOMEY_EMAIL, HOMEY_PASSWORD, GH_PAT |
| sunday-master.yml | GH_PAT, GOOGLE_API_KEY, OPENAI_API_KEY, HF_TOKEN, APIFREELLM_KEY, HOMEY_EMAIL, HOMEY_PASSWORD |
...
| monthly-comprehensive-sync.yml | GOOGLE_API_KEY, OPENAI_API_KEY, HF_TOKEN, APIFREELLM_KEY, HOMEY_PAT, GH_PAT |
