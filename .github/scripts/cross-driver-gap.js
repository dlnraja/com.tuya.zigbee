...
const G=[
{n:'Sensors',d:['climate_sensor','motion_sensor','contact_sensor'],m:2,p:['_TZ3000_','SNZB-']},
{n:'Switches',d:['switch_1gang','switch_2gang','switch_3gang','switch_4gang'],m:2,p:['_TZ3000_','_TZ3002_','ZBMINI']},
];
...
all[d]=new Set([...(txt.match(/"_T[A-Za-z0-9_]+"/g)||[]),...(txt.match(/"(SNZB-\d{2}\w*|ZBMINI\w*|S\d{2}ZB\w*|BASICZBR\d*|SONOFF|eWeLink)"/g)||[])].map(s=>s.replace(/"/g,'')));
}
