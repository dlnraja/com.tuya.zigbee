...
This device is **already supported** in [dlnraja/com.tuya.zigbee](https://github.com/dlnraja/com.tuya.zigbee) (Universal Tuya Zigbee fork) — **v{{VERSION}}** with {{DRIVERS}} drivers and {{FP_COUNT}}+ fingerprints.
