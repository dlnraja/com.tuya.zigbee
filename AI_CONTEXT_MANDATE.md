...
>
> **P2269 ANTI-SPAGHETTI SSOT**: Prefer [SPAGHETTI_MAP.md](docs/architecture/SPAGHETTI_MAP.md), [PROTOCOL_TX_RX_SSOT.md](docs/architecture/PROTOCOL_TX_RX_SSOT.md), [BATTERY_SSOT.md](docs/architecture/BATTERY_SSOT.md), [TIME_SYNC_SSOT.md](docs/architecture/TIME_SYNC_SSOT.md), [PARSER_SSOT.md](docs/architecture/PARSER_SSOT.md), [PUBLISH_SSOT.md](docs/architecture/PUBLISH_SSOT.md), [COMM_PATHFINDING.md](docs/architecture/COMM_PATHFINDING.md). Machine publish SSOT: [config/architecture/publish-ssot.json](config/architecture/publish-ssot.json). Harvest ≥50: `reports/discussion-harvest-2026-08-26/`. Gates: `npm run check:p2269` · `npm run check:p2270` · `npm run check:p2278` · `npm run check:p2279` · `npm run check:p2284`–`p2288`. Dual track SSOT: [config/architecture/dual-app-tracks.json](config/architecture/dual-app-tracks.json). L99 apply log: `reports/l99-reco-apply-2026-08-26/`.
>
