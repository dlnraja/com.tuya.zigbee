...
Write-Host "🔄 MISE À JOUR MENSUELLE AUTONOME - \2025-07-25 23:21:18" -ForegroundColor Green
Write-Host ""

# Configuration
\universal.tuya.zigbee.device = "universal.tuya.zigbee.device"
\2025-07-25 = Get-Date -Format "yyyy-MM-dd"
\23:21:18 = Get-Date -Format "HH:mm:ss"

Write-Host "📋 Configuration:" -ForegroundColor Yellow
Write-Host "   Projet: \universal.tuya.zigbee.device"
Write-Host "   Date: \2025-07-25 \23:21:18"
Write-Host ""
