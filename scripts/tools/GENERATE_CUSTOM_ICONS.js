...
console.log('­ƒÄ¿ G├ëN├ëRATION IC├öNES SP├ëCIFIQUES PAR TYPE DE DEVICE\n');
...
function processAllDrivers() {
    ...
    for (const driver of drivers) {
        ...
        try {
            ...
            console.log(`   ÔÜá´©Å ${driver}: ${error.message}`);
        }
    }
    
    console.log(`\nÔ£à ${processed} drivers trait├®s\n`);
    console.log('­ƒôè Types d├®tect├®s:');
...
// Ex├®cution
console.log('================================================');
console.log('  G├ëN├ëRATION IC├öNES SP├ëCIFIQUES PAR TYPE DEVICE');
console.log('================================================\n');
