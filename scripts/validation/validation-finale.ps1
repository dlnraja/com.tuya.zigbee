    ...
    if ($validationOK) {
        ...
        if (-not $DryRun) {
            ...
            try {
                ...
                Invoke-GitWithTimeout -GitCommand "commit -m 'VALIDATION FINALE: Projet validé et optimisé - Mode Automatique Intelligent activé'" -TimeoutSeconds 30 -OperationName "Git Commit"
