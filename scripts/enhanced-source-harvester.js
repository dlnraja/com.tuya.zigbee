...
class EnhancedSourceHarvester {
  ...
  async harvestAllSources() {
    console.log('🚀 Enhanced Source Harvesting - Comprehensive Community Analysis...\n');
  ...
  async harvestZigbee2MQTT() {
    console.log('📡 Enhanced Zigbee2MQTT harvesting...');
    ...
    console.log(`✅ Enhanced Z2M data: ${enhancedZ2MData.length} devices with community feedback`);
  }

  async harvestBlakadder() {
    console.log('📋 Enhanced Blakadder harvesting...');
    ...
    console.log(`✅ Enhanced Blakadder data: ${enhancedBlakadderData.length} devices with ratings`);
  }

  async analyzeJohanBenzRepos() {
    console.log('🐙 Analyzing Johan Benz repositories...');
    ...
    console.log(`✅ Johan Benz repos analyzed: ${johanBenzData.length} repositories`);
  }

  async analyzeJohanBenzForks() {
    console.log('🔄 Analyzing Johan Benz forks and contributions...');
    ...
    console.log(`✅ Forks analyzed: ${forksData.length} community contributions`);
  }

  async analyzeHomeyForums() {
    console.log('💬 Analyzing Homey community forums with NLP...');
    ...
    console.log(`✅ Forum analysis: ${forumData.length} topics with NLP sentiment analysis`);
  }

  async analyzeGitHubDiscussions() {
    console.log('📝 Analyzing GitHub issues and PRs with NLP...');
    ...
    console.log(`✅ GitHub analysis: ${githubData.length} items with community sentiment`);
  }

  async harvestAdditionalSources() {
    console.log('🌐 Harvesting additional community sources...');
    ...
    console.log(`✅ Additional sources: ${additionalSources.length} platforms analyzed`);
  }

  async generateCommunityPatches() {
    console.log('🔧 Generating comprehensive community patches...');
    ...
    console.log(`✅ Community patches generated: ${patches.length} patches from forums and GitHub`);
  }

  async saveResults() {
    console.log('💾 Saving enhanced harvesting results...');
    ...
    console.log(`\n📊 Enhanced Harvesting Complete!`);
    console.log(`📱 Devices collected: ${summary.totalDevices}`);
    console.log(`💬 Community feedback items: ${summary.communityFeedbackItems}`);
    console.log(`🔧 Patches ready: ${summary.patchesReady}`);
