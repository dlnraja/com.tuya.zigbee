...
/**
 * @deprecated v5.9.24 - OBSOLETE: Not imported anywhere. Superseded by lib/battery/BatteryManager.js
...
class BatteryManagerV5 {
  ...
  async updateBattery(percentage, source) {
    ...
    if (this.device.hasCapability('measure_battery')) {
      await this.device.setCapabilityValue('measure_battery', parseFloat(smoothed)).catch((err) => {
