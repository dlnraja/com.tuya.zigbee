...
| Version | Changes |
|---------|---------|
| **v5.11.89** | Tuya Unified Zigbee app v5.11.89: Added 145 drivers and 4952 fingerprints. Fixed scan-forum tim... |
...
| **v5.11.84** | Tuya Unified Zigbee app v5.11.84: Updated drivers and fingerprints for better device compatibil... |
| **v5.11.83** | Tuya Unified Zigbee app v5.11.83: Improved authentication and updated drivers and fingerprints. |
| **v5.11.82** | Tuya Unified Zigbee app v5.11.82: Improved error logging and updated drivers. |
