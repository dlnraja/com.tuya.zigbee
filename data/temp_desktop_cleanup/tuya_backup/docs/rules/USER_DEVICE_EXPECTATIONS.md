...
[![Version](https://img.shields.io/badge/version-v5.11.89-blue)]()
...
> **v5.11.89** | **5,399+ fingerprints** | **145 drivers** | **1,829 flow cards** | Updated 2026-03-04
...
| Version | Changes |
|---------|---------|
| **v5.11.89** | Universal Tuya Zigbee app v5.11.89: Added 145 drivers and 4952 fingerprints. Fixed scan-forum tim... |
...
| **v5.11.84** | Universal Tuya Zigbee app v5.11.84: Updated drivers and fingerprints for better device compatibil... |
| **v5.11.83** | Universal Tuya Zigbee app v5.11.83: Improved authentication and updated drivers and fingerprints. |
| **v5.11.82** | Universal Tuya Zigbee app v5.11.82: Improved error logging and updated drivers. |
| **v5.11.81** | Fixed redirect handling and updated app metadata for v5.11.81. |
| **v5.11.80** | Updated app with 145 drivers and 3093 fingerprints supported. |
...
- **Total interviews recovered**: 121
- **Unique fingerprints**: 103
- **Sources**: {"github":90,"forum":31,"gmail":0,"forum-pm":0}
...
| **Flow cards not working** | Update app to v5.11.89, recreate flow, check driver flow cards |
...
*Auto-generated on 2026-03-04 from v5.11.89 — 5,399+ fingerprints across 145 drivers*
