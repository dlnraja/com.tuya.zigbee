...
class BaseZigBeeDriver extends ZigBeeDriver {
  ...
  /**
   * Safe Flow Card Getter (v7.0.13)
   * Resolves flow cards safely and silences invalid flow card errors/crashes.
   */
  _getFlowCard(id, type = 'trigger') {
    ...
    try {
      ...
      // Quietly return null to prevent startup crashes and silence invalid flow card warnings
      return null;
    }
  }
}
