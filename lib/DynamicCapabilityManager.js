    ...
    try {
      ...
      if (typeof cluster.readAttributes === 'function') {
        try {
          ...
          await this.device.setCapabilityValue(capabilityId, false).catch(() => {});
        }
      } else {
    ...
    try {
      ...
      if (typeof cluster.on === 'function') {
        cluster.on('attr.currentLevel', (value) => {
          ...
          this.device.setCapabilityValue(capabilityId, dim).catch(this.device.error);
        });
      }
    ...
    try {
      ...
      if (typeof cluster.on === 'function') {
        cluster.on(`attr.${attrName}`, (value) => {
          ...
          this.device.setCapabilityValue(capabilityId, processedValue).catch(this.device.error);
        });
      }
      ...
      if (typeof cluster.readAttributes === 'function') {
        try {
          ...
          await this.device.setCapabilityValue(capabilityId, 0).catch(() => {});
        }
      } else {
    ...
    try {
      ...
      if (typeof cluster.on === 'function') {
        cluster.on('attr.zoneStatus', (value) => {
          ...
          this.device.setCapabilityValue(capabilityId, alarm).catch(this.device.error);
        });
      }
