...
class DeviceDiagnostics {
  ...
  getDeviceInfo() {
    ...
    return {
      ...
      modelId: data.modelId || data.productId || settings.zb_model_id || 'Unknown',
  ...
  async checkDataFlow() {
    ...
    try {
      ...
      if (typeof this.device.dpMappings === 'object') {
        try { result.dpMappings = JSON.parse(JSON.stringify(this.device.dpMappings)); } catch(e) { /* dpMappings serialization failed */ }
      }
