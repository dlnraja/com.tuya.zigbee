  ...
  async fetch(url, opts = {}) {
    ...
    if (this.readerFallback) {
      try {
        ...
        if (this.cache) {this.cache.store(url, r.body, {});}
        ...
        return { body: r.body, fromCache: false, viaReader: r.via, statusCode: 200, attempts: this.maxRetries + 1, durationMs: Date.now() - t0 };
      } catch (readerErr) {
