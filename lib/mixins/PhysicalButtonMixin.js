...
const DEVICE_PROFILES = {
  ...
  // WHY(P2693): snappy 200ms + reject phantom gang + no LevelControl invent (canaux morts / lent).
  '_TZ3000_vsxvaj9i': {
    appCommandWindow: 1000, doubleClickWindow: 250, longPressThreshold: 600,
    protocol: 'hybrid', brand: 'Tuya', usesE000: true, productId: 'TS0043',
    buttonCount: 3, debounceMs: 200, crossPathDedupMs: 350,
    skip8004: true, writeSceneAttr: false, sceneSwitch: true,
    ...
    source: 'P2693_bastien_vsxvaj9i_ts0043',
  },
  '_TZ3000_nrfkrgf4': { 
    appCommandWindow: 1000, doubleClickWindow: 350, longPressThreshold: 600,
  ...
  // WHY(P2684 / Bastien): 1500ms debounce felt "aucune fonctionnalité" — snappy 400 like P2683
  '_TZ3000_axpdxqgu': {
    appCommandWindow: 1000, doubleClickWindow: 350, longPressThreshold: 600,
    ...
    collapsePhantomEndpoints: true, batteryEpOnly: 1, skipBatteryReporting: true,
    noEf00Tx: true, mapAllEndpointsToButton1: true,
    debounceMs: 400, crossPathDedupMs: 650, crossPathGangOnly: true,
    whiteLabel: ['Moes Star Ring', 'ZT-YK01-class'],
    source: 'P2684_bastien_ts0041_snappy_flow',
  },
  '_tz3000_axpdxqgu': {
    appCommandWindow: 1000, doubleClickWindow: 350, longPressThreshold: 600,
    protocol: 'zcl_0xfd', brand: 'Moes Star Ring', usesE000: false, productId: 'TS0041',
  ...
  // WHY(P2683): debounce 1200 felt "super lent" for lamp Flows — 400ms + crossPath 650
  '_TZ3000_dzwgk7e2': {
    appCommandWindow: 1000, doubleClickWindow: 250, longPressThreshold: 600,
    protocol: 'hybrid', brand: 'Tuya', usesE000: true, productId: 'TS0042',
    buttonCount: 2, debounceMs: 200, crossPathDedupMs: 350,
    skip8004: true, writeSceneAttr: false, sceneSwitch: true,
    collapsePhantomEndpoints: true, noEf00Tx: true, skipBatteryReporting: true,
    ...
    disableLevelControlComplement: true,
    source: 'P2693_bastien_dzwgk7e2_snappy',
  },
...
const PhysicalButtonMixin = (SuperClass) => {
  ...
  getDeviceProfile(overrides = null) {
    ...
    const ts004RemoteFallback = (productId, buttonCount, source) => {
      ...
      // WHY(P2681): TS0042/43/44 retransmit past TSN — keep modest floor (not 1200 — Bastien "super lent")
      const debounceMs = /^TS004[234]$/i.test(productId) ? 400 : /^TS004[1F]$/i.test(productId) ? 350 : 400;
      return {
