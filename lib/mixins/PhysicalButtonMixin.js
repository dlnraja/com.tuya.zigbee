...
const DEVICE_PROFILES = {
  ...
  '_TZ3000_dzwgk7e2': {
    appCommandWindow: 1000, doubleClickWindow: 400, longPressThreshold: 600,
    protocol: 'hybrid', brand: 'Tuya', usesE000: true, productId: 'TS0042',
    buttonCount: 2, debounceMs: 1200, crossPathDedupMs: 1200,
    skip8004: true, writeSceneAttr: false, sceneSwitch: true,
    source: 'P2681_bastien_8f0915fa_dzwgk7e2',
  },
...
const PhysicalButtonMixin = (SuperClass) => {
  ...
  getDeviceProfile(overrides = null) {
    ...
    const ts004RemoteFallback = (productId, buttonCount, source) => {
      ...
      // WHY(P2681): TS0042/43/44 retransmit past TSN — 200ms default → random double flows
      const debounceMs = /^TS004[234]$/i.test(productId) ? 1200 : /^TS004[1F]$/i.test(productId) ? 750 : 500;
      return {
