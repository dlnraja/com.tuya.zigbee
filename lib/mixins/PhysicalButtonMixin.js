...
const PhysicalButtonMixin = (SuperClass) => class extends SuperClass {
  ...
  _safeTriggerFlow(triggerId, tokens = {}, debug = {}) {
    try {
      ...
      this.error(`[PHYSICAL] _safeTriggerFlow('${triggerId}') exception: ${err.message}`);
      return Promise.resolve();
    }
  }
  ...
  _triggerPhysicalFlow(gang, pressType, tokens = {}) {
    ...
    // v9.8.0: DEFENSIVE - Use _safeTriggerFlow helper
    this._safeTriggerFlow(flowCardId, flowTokens, { pressType, gang });
