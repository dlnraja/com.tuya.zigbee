...
const DEVICE_PROFILES = {
  ...
  // WHY(P2440 / Peter #2230 diag 048cff91): after RX works, multi-path still
  // double-fires flows (0xFD + onOff + level) → light flicker; raise debounce.
  '_TZ3000_mrpevh8p': {
    appCommandWindow: 1000, doubleClickWindow: 350, longPressThreshold: 600,
    ...
    debounceMs: 1100, crossPathDedupMs: 1100, crossPathGangOnly: true,
    whiteLabel: ['SH-SC07', 'RSH-SC021'],
    source: 'P2285_z2m_hubitat_johan1120_forum2202_P2440',
  },
  '_TZ3000_5bpeda8u': {
    appCommandWindow: 1000, doubleClickWindow: 350, longPressThreshold: 600,
    protocol: 'hybrid', brand: 'Tuya/SH-SC07', usesE000: true, productId: 'TS0041',
