...
const DEVICE_PROFILES = {
  ...
  // v9.0.145: Cross-source regression fix for GH #333/#410/#412 and Johan #1407.
  // These TS0041 variants expose four endpoints despite being marketed as "single"
  // buttons, so they must use 4-gang virtual button flow routing.
  '_TZ3000_b4awzgct': {
    appCommandWindow: 1000, doubleClickWindow: 350, longPressThreshold: 600,
    protocol: 'hybrid', brand: 'Moes', usesE000: true, productId: 'TS0041', buttonCount: 4
  },
  ...
  '_TZ3000_qja6nq5z': {
    appCommandWindow: 1000, doubleClickWindow: 350, longPressThreshold: 600,
    protocol: 'hybrid', brand: 'Moes', usesE000: true, productId: 'TS004F', buttonCount: 1,
    smartKnob: true, levelControl: true
  },
  '_TZ3000_kfu8zapd': {
    appCommandWindow: 1000, doubleClickWindow: 350, longPressThreshold: 600,
