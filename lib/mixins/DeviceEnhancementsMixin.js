  ...
  triggers: [
    {
      ...
      titleFormatted: { en: 'Firmware version changed on [[device]]', fr: 'Version firmware changée sur [[device]]' }
    },
    {
      ...
      titleFormatted: { en: 'Standby power exceeded on [[device]]', fr: 'Puissance veille dépassée sur [[device]]' }
    },
    {
      ...
      args: [{ type: 'device', name: 'device' }],
      titleFormatted: { en: 'Signal quality changed on [[device]]', fr: 'Qualité du signal changée sur [[device]]' }
    },
    {
      ...
      titleFormatted: { en: 'Test completed on [[device]]', fr: 'Test terminé sur [[device]]' }
    }
  ],
  conditions: [
    {
      ...
      titleFormatted: { en: 'Power factor is below [[threshold]]', fr: 'Facteur de puissance inférieur à [[threshold]]' }
    }
  ],
  actions: [
    // Idea 20: Smoke/CO test mode
    {
      ...
      titleFormatted: { en: 'Run [[test_type]] self-test on [[device]]', fr: 'Lancer auto-test [[test_type]] sur [[device]]' }
    },
    // Idea 1: Flow card for calibration
    {
      ...
      titleFormatted: { en: 'Set temperature offset [[offset]] on [[device]]', fr: 'Régler décalage température [[offset]] sur [[device]]' }
    },
    // Idea 16: Generic number/slider entity
    {
      ...
      titleFormatted: { en: 'Set [[parameter]] to [[value]] on [[device]]', fr: 'Régler [[parameter]] à [[value]] sur [[device]]' }
    }
  ]
};
