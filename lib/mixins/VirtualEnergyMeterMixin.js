...
const VirtualEnergyMeterMixin = {
  ...
  async _initVirtualEnergy() {
    ...
    this._virtualEnergyTimer = this.homey.setInterval(() => { if (this._destroyed) return; this._updateVirtualEnergy().catch(this._boundError || ((e) => { try { this.error(e); } catch (_) {} })); }, 300000);
