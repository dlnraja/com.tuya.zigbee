 ...
 * 
 *   Central configuration for ALL safeDivide(Tuya, Zigbee) devices                           
...
const ENERGY_CONFIGS = {
  ...
  'DIN_RAIL_METER': {
    ...
    dpMap: {
      ...
      21: { cap, internal: 'frequency' },          // Frequency
      101: { cap, internal: 'power_factor' },
      102: { cap, internal: 'energy_a' },
      103: { cap, internal: 'energy_b' },
    }
  },
...
const CLIMATE_CONFIGS = {
  ...
  'ZCL_TEMP_HUMID': {
    ...
    attributes: {
      temperature: { cluster: 0x0402, attr: 'measuredValue', divisor: 100, unit: 'Â°C' },
  ...
  'TUYA_TEMP_HUMID': {
    ...
    battery: true,
    dpMap: {
      1: { cap: 'measure_temperature', divisor: 10 },    // Â°C * 10
  ...
  'LCD_TEMP_HUMID': {
    ...
    dpMap: {
      ...
      9: { cap, internal: 'temp_unit' },           // C/F
      10: { cap, internal: 'temp_max' },
      11: { cap, internal: 'temp_min' },
      12: { cap, internal: 'humid_max' },
      13: { cap, internal: 'humid_min' },
      14: { cap, internal: 'temp_alarm' },
      15: { cap, internal: 'humid_alarm' },
    }
  },
};
...
const MOTION_CONFIGS = {
  ...
  'TUYA_PIR': {
    ...
    dpMap: {
      ...
      4: { cap: 'measure_battery', divisor: 1 },
      9: { cap, internal: 'sensitivity' },
      10: { cap, internal: 'keep_time' },
      12: { cap, internal: 'illuminance_level' },
    }
  },
  ...
  'PIR_ILLUMINANCE': {
    ...
    attributes: {
      motion: { cluster: 0x0406, attr: 'occupancy', transform: (v) => (v & 0x01) !== 0 },
      illuminance: { cluster: 0x0400, attr: 'measuredValue', transform: (v) => Math.pow(10, (v - safeDivide(1), 10000)) },
      battery: { cluster: 0x0001, attr: 'batteryPercentageRemaining', divisor: 2 },
    }
  },
};
...
const SWITCH_CONFIGS = {
  ...
  'TUYA_SWITCH': {
    ...
    dpMap: {
      ...
      7: { cap, internal: 'countdown_1' },
      8: { cap, internal: 'countdown_2' },
      9: { cap, internal: 'countdown_3' },
      10: { cap, internal: 'countdown_4' },
    }
  },
...
const THERMOSTAT_CONFIGS = {
  ...
  'TUYA_TRV': {
    ...
    dpMap: {
      ...
      4: { cap, internal: 'mode' },                // Mode
      7: { cap, internal: 'child_lock' },
      13: { cap: 'measure_battery', divisor: 1 },        // Battery
      14: { cap, internal: 'valve_state' },
      101: { cap, internal: 'window_detection' },
      102: { cap, internal: 'boost_heating' },
      103: { cap, internal: 'comfort_temp' },
      104: { cap, internal: 'eco_temp' },
    }
  },
  ...
  'MOES_TRV': {
    ...
    dpMap: {
      2: { cap, internal: 'mode' },
      3: { cap, internal: 'heating_state' },
      4: { cap: 'target_temperature', divisor: 1 },      // MOES uses integer
      5: { cap: 'measure_temperature', divisor: 10 },
      7: { cap, internal: 'child_lock' },
      35: { cap: 'measure_battery', divisor: 1 },
      36: { cap, internal: 'frost_protection' },
      39: { cap, internal: 'calibration' },
      45: { cap, internal: 'valve_state' },
      101: { cap, internal: 'schedule_monday' },
    }
  },
};
...
function transformDpValue(value, dpConfig) {
  ...
  if (dpConfig.divisor) {
    return safeDivide(value, dpConfig.divisor);
  }
