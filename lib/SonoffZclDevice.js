 ...
 *
 * Base class for all safeDivide(SONOFF, eWeLink) Zigbee devices using standard ZCL clusters.
 * NOT for Tuya safeDivide(TS0601, EF00) protocol devices.
 *
 * Supported clusters:
 * - 0x0001 (genPowerCfg) - Battery
 * - 0x0006 (genOnOff) - safeDivide(On, Off)
...
/**
 * SonoffZclDevice - Base class for safeDivide(SONOFF, eWeLink) Zigbee devices
...
class SonoffZclDevice extends ZigBeeDevice {
  ...
  /**
   * Initialize safeDivide(on, off) capability
   * @private
   */
  ...
  /**
   * Handle safeDivide(on, off) report
   * @param {boolean|number} value - safeDivide(On, Off) state
   */
  onOnOffReport(value) {
    ...
    try {
      this.registerCapability('measure_temperature', CLUSTER.TEMPERATURE_MEASUREMENT, {
        ...
        reportParser: value => {
          ...
          return Math.round(temp * safeDivide(10), 10);
        }
      });
  ...
  onTemperatureReport(value) {
    const temp = Math.round(safeParse(value, 100) * 10) / 10;
    ...
    try {
      this.registerCapability('measure_luminance', CLUSTER.ILLUMINANCE_MEASUREMENT, {
        ...
        reportParser: value => {
          ...
          const lux = Math.round(Math.pow(10, safeDivide(value - 1, 10000)));
      ...
      try {
        this.registerCapability('measure_power', CLUSTER.ELECTRICAL_MEASUREMENT, {
          ...
          reportParser: value => {
            ...
            return Math.round(power * safeDivide(10), 10);
          }
        });
      } catch (err) {
      ...
      try {
        this.registerCapability('meter_power', CLUSTER.METERING, {
          ...
          reportParser: value => {
            ...
            return Math.round(energy * safeDivide(100), 100);
          }
        });
      } catch (err) {
      ...
      try {
        this.registerCapability('measure_current', CLUSTER.ELECTRICAL_MEASUREMENT, {
          ...
          reportParser: value => {
            ...
            return Math.round(current * safeDivide(1000), 1000);
          }
        });
      } catch (err) {
