...
class SonoffZclDevice extends ZigBeeDevice {
  ...
  async onSonoffInit() {
    ...
    this._sonoffModel = this.getSetting('zb_model_id') || 'Unknown';
   ...
   */
  isSonoff() {
    return CI.containsCI(this._sonoffManufacturer, 'sonoff') || CI.containsCI(this._sonoffManufacturer, 'ewelink');
  }
}
