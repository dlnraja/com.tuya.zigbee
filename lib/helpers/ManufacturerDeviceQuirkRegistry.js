...
const KNOWN_QUIRKS = [
  ...
  {
    id: 'hobeian_k4ej3ww2_ias_water',
    manufacturers: ['_TZ3000_k4ej3ww2'],
    modelIds: ['TS0207'],
    preferredDrivers: ['water_leak_sensor'],
    penalizedDrivers: ['water_leak_sensor_tuya', 'rain_sensor', 'zigbee_repeater', 'gas_sensor_switch', 'climate_sensor', 'contact_sensor'],
    boost: 80,
    candidateBoost: 32,
    penalty: 50,
    capabilities: ['alarm_water', 'measure_battery'],
    deviceTypes: ['sensor', 'water_leak'],
    powerSourceOverride: 'battery',
    evidence: ['ias_zone_sleepy', 'reports_on_wet_dry_only', 'never_ef00_water'],
    sourceRefs: ['z2m_17685', 'z2m_19308', 'forum_140352'],
  },
  {
    id: 'ts0207_repeater_not_water',
    manufacturers: ['_TZ3000_5k5vh43t', '_TZ3000_gszjt2xx', '_TZ3000_misw04hq', '_TZ3000_nkkl7uzv', '_TZ3000_nlsszmzl', '_TZ3000_ufttklsz', '_TZ3000_wlquqiiz', '_TZ3000_m0vaazab'],
    modelIds: ['TS0207'],
    preferredDrivers: ['zigbee_repeater'],
    penalizedDrivers: ['water_leak_sensor', 'rain_sensor', 'motion_sensor', 'water_leak_sensor_tuya'],
    boost: 78,
    candidateBoost: 30,
    penalty: 50,
    deviceTypes: ['repeater', 'router'],
    powerSourceOverride: 'mains',
    evidence: ['ts0207_repeater_no_ias', 'shared_pid_not_water'],
    sourceRefs: ['z2m_ts0207_repeater', 'P189'],
  },
  {
    id: 'bseed_m1cvyneb_ef00_dimmer',
    manufacturers: ['_TZE284_m1cvyneb', '_TZE204_m1cvyneb', '_TZE200_m1cvyneb'],
    modelIds: ['TS0601'],
    preferredDrivers: ['wall_dimmer_tuya'],
    penalizedDrivers: ['climate_sensor', 'soil_sensor', 'zigbee_universal', 'generic_tuya', 'ir_blaster'],
    boost: 84,
    candidateBoost: 34,
    penalty: 52,
    ...
    powerSourceOverride: 'mains',
    evidence: ['mcu_brightness_0_1000', 'sacred_couple_ts0601_only'],
    sourceRefs: ['z2m_32305', 'forum_140352', 'P2138'],
  },
  {
    id: 'kanbros_w5xztuy7_zcl_2gang',
    manufacturers: ['_TZ3000_w5xztuy7'],
    modelIds: ['TS0002'],
    preferredDrivers: ['switch_2gang'],
    penalizedDrivers: ['switch_2gang_metering', 'dimmer_2_gang_tuya', 'wall_dimmer_tuya', 'climate_sensor'],
    boost: 76,
    candidateBoost: 28,
    penalty: 46,
    capabilities: ['onoff'],
    deviceTypes: ['switch', 'wall_switch'],
    powerSourceOverride: 'mains',
    evidence: ['zcl_only', 'leftover_ef00_ignore'],
    sourceRefs: ['forum_140352_2130', 'P139'],
  },
  {
    id: 'switch_temp_tz3218_ts000f',
    manufacturers: ['_TZ3218_7fiyo3kv', '_TZ3218_ya5d6wth'],
    modelIds: ['TS000F'],
    preferredDrivers: ['switch_temp_sensor'],
    penalizedDrivers: ['switch_1gang', 'switch_1_gang', 'zigbee_universal', 'climate_sensor'],
    boost: 82,
    candidateBoost: 32,
    penalty: 50,
    capabilities: ['onoff', 'measure_temperature'],
    deviceTypes: ['switch', 'sensor'],
    powerSourceOverride: 'mains',
    evidence: ['hybrid_zcl_onoff_ef00_dp102', 'temp_divisor_10'],
    sourceRefs: ['z2m_herdsman', 'johan_1176', 'forum_pm_147692'],
  },
  {
    id: 'soil_nt4pquef_not_climate',
    manufacturers: ['_TZE284_nt4pquef'],
    modelIds: ['TS0601'],
    preferredDrivers: ['soil_sensor'],
    penalizedDrivers: ['climate_sensor', 'climate_sensor_zt08', 'air_purifier_soil', 'zigbee_universal'],
    boost: 80,
    candidateBoost: 30,
    penalty: 50,
    capabilities: ['measure_humidity.soil', 'measure_temperature', 'measure_battery'],
    deviceTypes: ['sensor', 'soil'],
    powerSourceOverride: 'battery',
    evidence: ['dp2_light_enum_not_moisture', 'dp3_soil', 'dp5_temp_div10', 'no_ed00_in_compose'],
    sourceRefs: ['z2m_herdsman_10315', 'zha_4707'],
  },
  {
    id: 'presence_clrdrnya_radar_relay',
    manufacturers: ['_TZE204_clrdrnya', '_TZE284_clrdrnya', '_TZE200_clrdrnya'],
    modelIds: ['TS0601'],
    preferredDrivers: ['presence_sensor_radar'],
    penalizedDrivers: ['motion_sensor', 'climate_sensor', 'sensor_illuminance_presence'],
    boost: 80,
    candidateBoost: 30,
    penalty: 48,
    capabilities: ['alarm_motion', 'measure_luminance'],
    deviceTypes: ['sensor', 'radar', 'presence'],
    powerSourceOverride: 'mains',
    evidence: ['mtg235_zb_rl_mmwave_relay', 'sbyx0lm6_family'],
    sourceRefs: ['z2m_18677', 'github_420'],
  },
  {
    id: 'okaz9tjs_ts011f_metering_plug',
    manufacturers: ['_TZ3000_okaz9tjs', '_TZ3210_fgwhjm9j'],
    modelIds: ['TS011F'],
    preferredDrivers: ['plug_energy_monitor'],
    penalizedDrivers: ['button_wireless_plug', 'button_wireless_2', 'climate_sensor', 'double_power_point_2'],
    boost: 74,
    candidateBoost: 28,
    penalty: 46,
    capabilities: ['onoff', 'measure_power', 'meter_power'],
    deviceTypes: ['plug', 'socket'],
    powerSourceOverride: 'mains',
    evidence: ['electrical_poll_fw_105', 'not_wireless_button'],
    sourceRefs: ['z2m_13191', 'homesuite_field'],
  },
];
