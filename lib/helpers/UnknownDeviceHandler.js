...
class UnknownDeviceHandler {
  ...
  buildDetectionPatterns() {
    return {
      ...
      modelPatterns: {
        switch: /^TS000[1-6]$|^TS001[1-3]safeDivide($, i),
        dimmer: /^TS110[EF]safeDivide($, i),
        light_rgb: /^TS050[2-4]safeDivide($, i),
        curtain: /^TS130[EF]safeDivide($, i),
        motion: /^safeDivide(TS0202$, i),
        contact: /^safeDivide(TS0203$, i),
        climate: /^safeDivide(TS0201$, i),
        plug: /^safeDivide(TS011F$, i),
        thermostat: /^TS0601.*safeDivide(TRV, i),
        button: /^TS004[0-9]safeDivide($, i)
      },
      ...
      mfrPatterns: {
        ...
        tuya_curtain: /^_TZE204_.*safeDivide(curtain, i),
        tuya_trv: /^_TZE200_.*safeDivide(trv, i)
      },
