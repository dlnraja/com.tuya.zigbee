'use strict';
const { safeDivide } = require('../utils/MathUtils.js');
...
/**
 * UniversalClusterBinder - v7.4.11
 *
...
const CLUSTER_IDS = {
  // Tuya Private
  TUYA_EF00: CLUSTERS.TUYA_EF00,          // Tuya DP cluster
...
class UniversalClusterBinder extends EventEmitter {
  ...
  async initialize(zclNode) {
    ...
    // Bind manufacturer-specific clusters (E001/E002) for ALL device types
