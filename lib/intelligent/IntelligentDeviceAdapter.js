...
class IntelligentBatteryManager {
  ...
  /**
   * WHY(P2294/P2298): sleepy SH-SC07 never answers battery reads; stripping
   * measure_battery flips HybridProtocolManager out of "sleepy" and disables
   * OnOff 0xFD RX. Never strip battery for known button / skipBatteryReporting couples.
   */
