...
class ClusterDPDatabase {
  ...
  static ZIGBEE_CLUSTERS = {
    ...
    TUYA_E000: { id: 0xE000, name: 'tuyaE000', decimal: 57344 },
    TUYA_E001: { id: 0xE001, name: 'tuyaE001', decimal: 57345 },
    TUYA_EF00: { id: 0xEF00, name: 'tuyaManufacturer', decimal: 61184 },
    XIAOMI: { id: 0xFCC0, name: 'xiaomiSpecific', decimal: 64704 }
  };
  ...
  static TUYA_DATAPOINTS = {
    ...
    DP103: { 
      ...
      types: ['string'],
      capabilities: ['time_sync'],
      description: 'Time synchronization (alternative)'
    },
