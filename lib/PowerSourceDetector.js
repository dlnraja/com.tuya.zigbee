  ...
  static getBatteryReportingConfig(deviceType) {
    const configs = {
      ...
      sensor: {
        ...
        maxInterval: 86400,  // 24h - report quotidien minimum
      ...
      contact: {
        ...
        maxInterval: 86400,  // 24h - report quotidien
      ...
      remote: {
        ...
        maxInterval: 86400,  // 24h - report quotidien suffit
      ...
      eco: {
        ...
        maxInterval: 86400,  // 24h - une fois par jour
