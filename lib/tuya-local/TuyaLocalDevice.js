...
class TuyaLocalDevice extends Homey.Device {
  ...
  async getDiagnostics() {
    return {
      deviceId: this._deviceId, ip: this._ip,
      protocol: this._protocolVersion,
      connected: !!(this._client && this._client.connected),
      reconnects: this._reconnectAttempts,
      lastDps: this._client ? this._client.lastDps : {},
      hasCloud: !!(this.homey.settings.get('tuya_cloud_access_id')),
    };
  }
