...
class TuyaLocalDevice extends Homey.Device {
  ...
  async _createDevice() {
    ...
    try {
      ...
      // P2619 / P2642 BOTH: live pacing + fire-and-forget from settings
      ...
      // P2641 BOTH: stale-data watchdog (andiwirz/com.tuyalocal) — HB alive / DPS dead
  ...
  async onSettings({ oldSettings, newSettings, changedKeys }) {
    ...
    for (const key of changedKeys) {
      ...
      // P2619 / P2642 BOTH: live apply — no reconnect
      ...
      // P2641 BOTH: live stale-data window
