...
class TuyaLocalDevice extends Homey.Device {
  ...
  async onSettings({ oldSettings, newSettings, changedKeys }) {
    ...
    for (const key of changedKeys) {
      ...
      // P2641: live stale-data window (0 = push-only, disable watchdog)
