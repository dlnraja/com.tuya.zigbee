...
const COVER_PROFILES = [
  ...
  // TS0601 Tuya DP Curtain (standard)
  {
    ...
    protocol: 'tuya_dp',
    dpMappings: {
      1: { capability, command: 'control', type: 'enum', values: { open: 0, stop: 1, close: 2 } },
      2: { capability: 'windowcoverings_set', type: 'value', divisor: 1 },
      3: { capability: 'windowcoverings_set', type: 'value', divisor: 1, readOnly: true },
      5: { capability, setting: 'direction', type: 'enum', values: { forward: 0, reverse: 1 } },
      7: { capability, setting: 'work_state', type: 'enum' }
    },
    capabilities: ['windowcoverings_set'],
  ...
  // TS0601 Curtain with tilt (blinds)
  {
    ...
    dpMappings: {
      ...
      2: { capability: 'windowcoverings_set', type: 'value', divisor: 1 },
      3: { capability: 'windowcoverings_set', type: 'value', divisor: 1, readOnly: true },
      5: { capability, setting: 'direction', type: 'enum' },
