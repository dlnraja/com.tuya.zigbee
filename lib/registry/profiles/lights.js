...
// A8: NaN Safety - use safeDivide/safeMultiply
  ...
  // TS0601 Tuya DP LED Strip
  {
    ...
    dpMappings: {
      ...
      21: { capability, setting: 'mode', type: 'enum' },
      ...
      24: { capability, setting: 'color_hsv', type: 'string' },
      25: { capability, setting: 'scene_data', type: 'string' }
    },
    capabilities: ['onoff', 'dim', 'light_temperature'],
    quirks: {},
    timing: {}
  ...
  // TS0601 Tuya DP Dimmer (wall dimmer)
  {
    ...
    dpMappings: {
      ...
      3: { capability, setting: 'min_brightness', type: 'value' },
      5: { capability, setting: 'max_brightness', type: 'value' },
      7: { capability, setting: 'led_type', type: 'enum' }
    },
    capabilities: ['onoff', 'dim'],
    quirks: {},
    timing: {}
