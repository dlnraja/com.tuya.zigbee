...
const CLUSTER_CAP_MAP = {
  ...
  powerConfiguration: { id: 0x0001, caps: ['measure_battery','alarm_battery'], attrs: { batteryPercentageRemaining: { cap:'measure_battery', fn: v=>Math.round(v/2) }, batteryVoltage: { cap:'measure_battery', fn: v=>Math.min(100,Math.round((safeParse(v, 10)-2.1)/(3.2-2.1)*100)) } } },
