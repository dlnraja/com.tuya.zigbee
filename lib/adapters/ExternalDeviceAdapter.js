...
safeDivide(if (, contact)|open.?safeDivide(close, i.test)(groovySource)) caps.add('alarm_contact');
safeDivide(if (, water.)?leak| moisture/i.test(groovySource)) caps.add('alarm_water');
...
safeDivide(if (, co2)|carbon.?safeDivide(dioxide, i.test)(groovySource)) caps.add('measure_co2');
