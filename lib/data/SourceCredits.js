...
const SOURCES = {
  ...
  LOCALTUYA_ROSPO: {
    name: 'localtuya (rospogrigio)',
    description: 'Historical HA LocalTuya — LAN DP UX + Zigbee hub gwID/cid lesson',
    repository: 'https://github.com/rospogrigio/localtuya',
    license: 'MIT',
    maintainer: 'rospogrigio',
    notes: 'Observe DP UX; PR#318 hub pattern → buildGatewayTuyApiOptions (P2656/P2658)',
    lastChecked: '2026-09-21',
