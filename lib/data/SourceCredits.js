...
const SOURCES = {
  ...
  TUYA_LOCAL_ANDIWIRZ: {
    ...
    homeyLive: '1.0.232',
    homeyTest: '1.0.237',
    notes: 'Complementary enrich only (P2520 UNION). See docs/architecture/TUYALOCAL_COMPLEMENTARY_CREDITS.md + COMPLEMENTARY_HOMEY_APPS.md',
  ...
  DRENSO_TUYA2: {
    name: 'Tuya (Drenso)',
    description: 'Homey Tuya app by Drenso — cloud/hybrid peer',
    website: 'https://homey.app/a/com.tuya2/',
    maintainer: 'Drenso V.O.F.',
    homeyAppId: 'com.tuya2',
    homeyLive: '1.5.8',
    notes: 'Observational contrast for local-first; do not copy cloud defaults',
    lastChecked: '2026-09-21',
  ...
  HA_TUYA_LOCAL: {
    ...
    description: 'HA custom integration — Tuya LAN DP layouts / EV configs',
    repository: 'https://github.com/make-all/tuya-local',
    license: 'MIT',
    maintainer: 'make-all',
    notes: 'YAML DP catalogs for WiFiDPRegistry / wifi_ev_charger complementary',
    lastChecked: '2026-09-21',
    updateInterval: 14 * 24 * 60 * 60 * 1000
  }
};
...
const COMMUNITY_CONTRIBUTORS = [
  ...
  { name: 'Johan Bendz', github: 'JohanBendz', role: 'Tuya Zigbee Homey app (MIT) — upstream Zigbee' },
