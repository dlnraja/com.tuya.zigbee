...
const SOURCES = {
  ...
  TUYA_LOCAL_ANDIWIRZ: {
    ...
    description: 'Local WiFi/LAN Tuya control for Homey — protocol detection, DP maps, LAN reliability',
    repository: 'https://github.com/andiwirz/com.tuyalocal',
    website: 'https://community.homey.app/t/app-pro-tuya-local/154077',
    license: 'MIT',
    maintainer: 'Andi Wirz (@andiwirz)',
    contributors: ['andiwirz', 'claude'],
    notes: 'Complementary enrich (P2520). Bastien: LAN stale-data BOTH only — no WiFi driver invent.',
