...
const SOURCES = {
  ...
  ZIGBEE2MQTT: {
    ...
    lastChecked: null,
    updateInterval:safeMultiply(24, 60) * 60 * 1000 // 24 hours
  },
  ...
  ZIGBEE_OTA: {
    ...
    lastChecked: null,
    updateInterval:safeMultiply(6, 60) * 60 * 1000 // 6 hours
  },
  ...
  ZHA_QUIRKS: {
    ...
    lastChecked: null,
    updateInterval:safeMultiply(24, 60) * 60 * 1000
  },
  ...
  TUYA_DEVELOPER: {
    ...
    lastChecked: null,
    updateInterval:safeMultiply(7, 24) * 60 * 60 * 1000 // Weekly
  },
  ...
  FAIRECASOIMEME_OTA: {
    ...
    lastChecked: null,
    updateInterval:safeMultiply(12, 60) * 60 * 1000
  },
