...
module.exports = {
  ...
  // P28 — Universal fallback (last-line battery reading)
  UniversalBatteryFallback: require('./UniversalBatteryFallback'),

  // P33 — Final cascade engine (7 methods, all historical fixes)
  BatteryCascadeEngine: require('./BatteryCascadeEngine'),
