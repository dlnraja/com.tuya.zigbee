...
module.exports = {
  ...
  // P209: multi-protocol % (ZCL / DP / WiFi / IAS / voltage / raw)
  MultiProtocolBatteryPercent: require('./MultiProtocolBatteryPercent'),
  ingestBatterySample: (...args) => require('./MultiProtocolBatteryPercent').ingestBatterySample(...args),
  normalizeBatteryPercent: (...args) => require('./MultiProtocolBatteryPercent').normalizeBatteryPercent(...args),

  // P2689: SOC/chemistry adaptive precision (no flood / no coin drain)
  SmartBatteryAdaptivePrecision: require('./SmartBatteryAdaptivePrecision'),
};
