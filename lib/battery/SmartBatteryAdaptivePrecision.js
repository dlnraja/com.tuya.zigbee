...
const RECHARGEABLE = new Set([
  'Li-ion', 'Li-polymer', 'LiPo', '18650', 'NiMH', 'NiMH_AA', 'NiMH_AAA', '2xNiMH', 'NiCd', 'LiFePO4', 'LiHV',
]);
...
function chemistryClass(chemistry) {
  ...
  if (RECHARGEABLE.has(c) || /li-?ion|lipo|18650|nimh|nicd|lifepo|lihv/i.test(c)) return 'rechargeable';
