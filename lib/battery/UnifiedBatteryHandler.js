...
class UnifiedBatteryHandler {
  ...
  static calculateFromVoltage(voltage, batteryType = 'CR2032', temperature = 20) {
    ...
    // tempCoeff est négatif pour toutes les chimies : l'ajouter abaisse la
    // tension compensée → estimation PLUS BASSE par temps froid.
    // (Avant: la soustraction inversait le signe et GONFLAIT l'estimation au froid.)
