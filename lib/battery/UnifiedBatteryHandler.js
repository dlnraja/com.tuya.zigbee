...
class UnifiedBatteryHandler {
   ...
   * ZCL standard: batteryPercentageRemaining is 0-200 (200 = 100%).
   * Some Tuya devices already report 0-100 directly.
   * v9.0.77: Fix — values 0-100 are already percentages, do NOT halve them.
   */
  static normalizeZigbeeValue(rawValue) {
    ...
    if (rawValue === 255) return null;  // 255 = unknown/invalid
    if (rawValue === 200) return null;  // 200 = "not available" sentinel (NOT 100%)
