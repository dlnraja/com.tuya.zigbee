...
// v9.0.412 (P92.120): negative cache for unsupported ZCL ops
...
class UnifiedBatteryHandler {
  ...
  static BATTERY_PROFILES = {
    ...
    '_TZ3000_b4awzgct':   { chemistry: 'CR2450', source: 'zcl', algorithm: 'cr2450_curve', zcl200IsPercent: true, notes: 'SH-SC07 TS0041 (Z2M whitelabel; CR2450)' },
    '_TZ3000_mrpevh8p':   { chemistry: 'CR2450', source: 'zcl', algorithm: 'cr2450_curve', zcl200IsPercent: true, notes: 'SH-SC07 / RSH-SC021 (Z2M#6225, Johan#1120, Peter #2230)' },
    '_TZ3000_5bpeda8u':   { chemistry: 'CR2450', source: 'zcl', algorithm: 'cr2450_curve', zcl200IsPercent: true, notes: 'SH-SC07 sibling' },
    // WHY(P2638): Moes Star Ring / Bastien axpdxqgu — SmartHomeScene + ZHA TuyaNoBindPower — CR2032, skip report storm
    '_TZ3000_adndolvx':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true, skipReporting: true, notes: 'HA T455202 Chinese TS0041 phantom EP' },
    '_TZ3000_itb0omhv':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true, skipReporting: true, notes: 'HA T455202 sibling' },
    '_TZ3000_x7mej5oc':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true, skipReporting: true, notes: 'ZHA#1557 phantom EP' },
    '_TZ3000_axpdxqgu':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'direct', zcl200IsPercent: true, skipReporting: true, notes: 'Moes Star Ring TS0041 (Z2M#25720/#8072, ZHA 0041TO)' },
    // WHY(P2706 / Bastien): black TS0042/43 — prefer ZCL % not CR2032 voltage (0–84% ceiling)
    '_TZ3000_dzwgk7e2':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'direct', zcl200IsPercent: true, skipReporting: true, notes: 'Bastien TS0042 sticky 2-btn' },
    '_TZ3000_vsxvaj9i':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'direct', zcl200IsPercent: true, skipReporting: true, notes: 'Bastien TS0043 sticky 3-btn (0–84% voltage false ceiling)' },
    '_TZ3000_yj6k7vfo':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true, notes: 'TS0041 four-endpoint scene button' },
    '_TZ3000_u3nv1jwk':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true, notes: 'TS0044/TS004F 4-button scene switch' },
    '_TZ3000_kfu8zapd':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true, notes: 'TS004F 4-button scene switch' },
    '_TZ3000_xabckq1v':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true, notes: 'TS004F 4-button scene switch' },
    '_TZ3000_czuyt8lz':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true, notes: 'TS004F 4-button scene switch' },
    '_TZ3000_b3mgfu0d':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true, notes: 'TS004F 4-button scene switch' },
    '_TZ3000_rco1yzb1':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true, notes: 'TS004F 4-button scene switch' },
    '_TZ3000_qja6nq5z':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true, notes: 'TS004F smart knob' },
    '_TZ3000_gwkzibhs':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true, notes: 'TS004F smart knob' },
    '_TZ3000_a7ouggvs':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true, notes: 'Zemismart ZB-L03C-H 3-button CR2032' },
    '_TZ3000_qzjcsmar':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true, notes: 'Zemismart 3-button wall remote' },
    '_TZ3000_bczr4e10':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true, notes: '3-button scene remote' },
    '_TZ3000_famkxci2':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true, notes: '3-button scene remote' },
    '_TZ3000_mjwg6a52':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true, notes: '3-button scene remote' },
    '_TZ3000_mutfmn4u':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true, notes: '3-button scene remote' },
    '_TZ3000_ngsph3oj':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true, notes: '3-button scene remote' },
    '_TZ3000_uyjmm0et':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true, notes: '3-button scene remote' },
    '_TZ3000_i5j6k7l8':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true, notes: '3-button scene remote' },
    '_TZ3000_1kmurvlx':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true, notes: '3-button scene remote' },
    '_TZ3000_tzvbimpq':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true, notes: 'TS0042 2-button wireless remote' },
    '_TZ3000_wkai4ga5':   { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true, notes: 'TS0044 4-button scene remote' },
  ...
  static lookupBatteryProfile(manufacturerName, productId) {
    if (manufacturerName) {
      const exact = UnifiedBatteryHandler.BATTERY_PROFILES[manufacturerName];
      if (exact) {
        return { source: 'manufacturer', ...exact };
      }
      let equalsIgnoreCase;
      try {
        ({ equalsIgnoreCase } = require('../utils/TuyaNormalizer'));
      } catch (_e) {
        equalsIgnoreCase = null;
      }
      if (equalsIgnoreCase) {
        for (const [key, profile] of Object.entries(UnifiedBatteryHandler.BATTERY_PROFILES)) {
          if (equalsIgnoreCase(key, manufacturerName)) {
            return { source: 'manufacturer', ...profile };
          }
        }
      }
    }
    ...
    if (productId) {
      ...
      const defaults = {
        ...
        'TS0041': { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true },
        'TS0042': { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true },
        'TS0043': { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true },
        'TS0044': { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true },
        'TS004F': { chemistry: 'CR2032', source: 'zcl', algorithm: 'cr2032_curve', zcl200IsPercent: true },
  ...
  static normalizeVoltage(rawVoltage) {
    try {
      const { normalizeVoltagePrecise } = require('./BatteryChemistryCurves');
      const v = normalizeVoltagePrecise(rawVoltage);
      if (v != null) return v;
    } catch (_e) { /* soft */ }
  ...
  static normalizeBatteryType(batteryType) {
    ...
    // P2710: chemistry aliases (NiMH, LiFePO4, Homey 1.5V_*, curve algos → specs)
    try {
      const { normalizeChemistryKey, EXTRA_SPECS } = require('./BatteryChemistryCurves');
      const n = normalizeChemistryKey(key);
      if (UnifiedBatteryHandler.BATTERY_SPECS[n] || EXTRA_SPECS[n]) return n;
    } catch (_e) { /* soft */ }
    const aliases = {
      cr2032: 'CR2032',
      '3v_2100': '3V_2100',
  ...
  /**
   * v5 + P2710: Calculate percentage from voltage — chemistry curves + température
   * @param {number} voltage - Tension en volts (ou raw — normalizeVoltagePrecise)
   * @param {string} batteryType - Type de batterie (CR2032, AA, Li-ion, LiFePO4, NiMH…)
  ...
  static calculateFromVoltage(voltage, batteryType = 'CR2032', temperature = 20) {
    ...
    let volts = Number(voltage);
    try {
      const { normalizeVoltagePrecise } = require('./BatteryChemistryCurves');
      const nv = normalizeVoltagePrecise(voltage);
      if (nv != null) volts = nv;
    } catch (_e) { /* soft */ }
    if (!Number.isFinite(volts)) return null;

    const specs = UnifiedBatteryHandler.BATTERY_SPECS[normalizedType]
      || UnifiedBatteryHandler.BATTERY_SPECS.CR2032;
    if (!specs?.curve) return null;

    let compensatedVoltage = volts;
    if (temperature < 20 && specs.tempCoeff) {
      compensatedVoltage = volts + (specs.tempCoeff * (20 - temperature));
    }
  ...
  /**
   * v5 + P2710: Convertir Tuya DP / algorithme profil → pourcentage
   */
  static calculateFromTuyaDP(dpValue, algorithm = 'direct', options = {}) {
    ...
    switch (algorithm) {
      ...
      case 'voltage_curve': {
        ...
        const chem = algorithm === 'alkaline_curve' ? (options.batteryType || '2xAAA')
          : algorithm === 'cr2450_curve' ? 'CR2450'
          : algorithm === 'lithium_flat' ? 'CR2032'
          : batteryType;
        return voltage === null ? null
          : UnifiedBatteryHandler.calculateFromVoltage(voltage, chem, options.temperature);
      }
      case 'direct':
  ...
  // v9.0.365: Manufacturers known to report battery on a 0-50 scale (50 = 100%).
  // Doubling is applied ONLY for these — never as a generic heuristic.
  static BATTERY_0_50_SCALE_MFRS = new Set(['_TZE284_vvmbj46n', '_TZE200_vvmbj46n']);
  ...
  static normalizeZigbeeValue(rawValue, options = {}) {
    ...
    // Some Tuya devices report 0-50 where 50 = 100%
    // v9.0.365: CURATED ONLY — a generic 0-50 doubling misreads genuinely
    // discharged devices (a real 40% report became 80%). Only manufacturers
    // known to use the 0-50 scale are doubled; everyone else passes through.
    if (rawValue > 0 && rawValue <= 50 && manufacturer) {
      const mfrLower = String(manufacturer).toLowerCase();
      let is050 = UnifiedBatteryHandler.BATTERY_0_50_SCALE_MFRS.has(manufacturer);
      if (!is050) {
        for (const known of UnifiedBatteryHandler.BATTERY_0_50_SCALE_MFRS) {
          if (String(known).toLowerCase() === mfrLower) { is050 = true; break; }
        }
      }
      if (is050) {
        return Math.min(100, Math.round(rawValue * 2));
      }
    }
  ...
  constructor(device) {
    ...
    // L14: all capability writes prefer safeSetCapabilityValue (SanityFilter + flow)
  ...
  /**
   * L14 commit gate — prefer safeSetCapabilityValue (SanityFilter + anti-flood + flows).
   * P209: measure_battery tagged with multi-protocol source when known.
   */
  async _safeSetCap(capability, value, meta = {}) {
    if (!this.device || value === undefined || value === null) return;
    if (typeof this.device.hasCapability === 'function' && !this.device.hasCapability(capability)) return;
    try {
      if (capability === 'measure_battery') {
        try {
          const { commitBatteryPercent } = require('./MultiProtocolBatteryPercent');
          const r = await commitBatteryPercent(this.device, value, {
            protocol: meta.source || this._lastBatterySource || 'zcl',
      ...
      if (typeof this.device.safeSetCapabilityValue === 'function') {
        await this.device.safeSetCapabilityValue(capability, value, {
          source: meta.source || (capability === 'measure_battery' ? 'zcl' : undefined),
        });
        return;
      }
  ...
  _safeSetCapFireAndForget(capability, value) {
    this._safeSetCap(capability, value).catch(() => {});
  }
  ...
  async initialize(zclNode) {
    ...
    // v5: Start active polling — sleepy remotes report on wake, never on a timer
    this._startPolling();
      ...
      if (stored !== null) {
        ...
        if (current === null || current === undefined) {
          ...
          if (this.device.hasCapability?.('measure_battery')) {
            await this._safeSetCap('measure_battery', stored);
          }
        }
      }
  ...
  _startPolling() {
    try {
      ...
      if (!shouldProactivePowerCfgRead(this.device)) {
        this.device.log('[BATTERY-UNIFIED] Sleepy remote — skip PowerCfg poll timer (listen on wake/report)');
        return;
      }
    } catch (_e) { /* policy optional in unit tests */ }

    const deviceType = this._detectDeviceType();
    const baseSec = UnifiedBatteryHandler.INTERVALS[deviceType] || UnifiedBatteryHandler.INTERVALS.default;
    let intervalMs = baseSec * 1000;
    // P2689 — adaptive poll cadence by SOC + chemistry (accus vs coin)
    try {
      const { resolvePollIntervalMs } = require('./SmartBatteryAdaptivePrecision');
      const adaptive = resolvePollIntervalMs({
        chemistry: this.batteryType || this._profile?.chemistry,
        percent: this.lastValue ?? this.device.getCapabilityValue?.('measure_battery'),
        baseIntervalSec: baseSec,
        deviceClass: deviceType,
        sleepy: false,
        skipProactive: false,
      });
      if (adaptive == null) {
        this.device.log('[BATTERY-UNIFIED] P2689 adaptive — no proactive poll for this chemistry/class');
        return;
      }
      intervalMs = adaptive;
    } catch (_e) { /* soft */ }
    this.device.log(`[BATTERY-UNIFIED] ⏱️ Polling interval: ${(intervalMs / 3600000).toFixed(2)}h (type: ${deviceType}, P2689)`);
  ...
  async _poll() {
    try {
      if (this.source?.includes('zcl')) {
        ...
        if (cluster) {
          // v9.0.412 (P92.120): smart read — genPowerCfg attrs the device
          // already rejected (UNSUPPORTED_ATTRIBUTE, classic on Tuya) are
          // skipped silently and the Tuya DP path takes over immediately.
          const requestDpFallback = async (device) => {
            if (device.tuyaEF00Manager) {
              for (const dp of UnifiedBatteryHandler.getTuyaBatteryDPs({ profile: this._profile })) {
                await device.tuyaEF00Manager.requestDP(dp).catch(() => {});
              }
            }
          };
          const attrs = await readAttributesSmart(this.device, cluster, 'genPowerCfg',
            ['batteryPercentageRemaining', 'batteryVoltage'], {
              onFallback: requestDpFallback,
              fallbackLabel: 'tuya-dp',
            });
  ...
  async _setupZclBattery(zclNode) {
    try {
      ...
      try {
        // v9.0.412 (P92.120): skip attrs already known unsupported on this
        // device (persisted negative cache) — kills the per-boot flood of
        // UNSUPPORTED_ATTRIBUTE on Tuya devices without genPowerCfg attrs.
        const attrs = await readAttributesSmart(this.device, cluster, 'genPowerCfg',
          ['batteryPercentageRemaining', 'batteryVoltage'], { fallbackLabel: 'tuya-dp' });
        if (attrs.batteryPercentageRemaining !== undefined) {
          const percent = UnifiedBatteryHandler.normalizeZigbeeValue(attrs.batteryPercentageRemaining, {
            batteryType: this.batteryType,
            treat200AsSentinel: this._profile?.zcl200IsPercent === false,
      ...
      try {
        // P2689 / Z2M-style: adaptive minChange by SOC — skip entirely for skipReporting profiles
        if (this._profile?.skipReporting || this._profile?.skipBatteryReporting) {
          this.device.log('[BATTERY-UNIFIED] P2689 skip configureReporting (profile skipReporting)');
        } else {
          const { buildAdaptiveReportingConfig } = require('./SmartBatteryAdaptivePrecision');
          const cfg = buildAdaptiveReportingConfig({
            chemistry: this.batteryType || this._profile?.chemistry,
            percent: this.lastValue ?? this.device.getCapabilityValue?.('measure_battery'),
          });
          ...
          this.device.log(`[BATTERY-UNIFIED] P2689 reporting band=${cfg.band} minChange=${cfg.minChange}`);
        }
  ...
  _setupTuyaBattery() {
    ...
    (this.device.homey?.setTimeout ? this.device.homey.setTimeout.bind(this.device.homey) : globalThis.setTimeout)(() => {
      if (this._destroyed) {return;}
  ...
  _handleTuyaBatteryDP(dp, value) {
    ...
    const percent = this._normalizeBatteryValue(value, dp);
  ...
  _updateBatteryAlarm(isLow) {
    if (this.device.hasCapability?.('alarm_battery')) {
      this._safeSetCapFireAndForget('alarm_battery', isLow);
    ...
    if (this.device.hasCapability?.('measure_battery')) {
      ...
      if (current === null || current === undefined) {
        ...
        if (storedPercent !== null) {
          ...
          this.device.log('[BATTERY-UNIFIED] Battery unknown — leaving unset until first report');
        }
      }
    }
  }
  ...
  _updateBattery(percent, force = false, meta = {}) {
    ...
    if (!force) {
      ...
      if (hasPrevious && change > 50 && percentValue > 0 && elapsed < 86400000) {
        // WHY: Card battery_anomaly_detected is NOT in app/flow compose — getDeviceTriggerCard
        // spams FLOW-GUARD Invalid Flow Card ID (ec514112 / 9.0.558). Log only.
        this.device.log(`[BATTERY-UNIFIED] ⚠️ Rejected abnormal battery fluctuation: ${prev}% -> ${percentValue}%`);
        return;
      }

      // P2689 — dynamic throttle by SOC band (1% when critical/low; coarser when high)
      try {
        const { shouldAcceptBatterySample } = require('./SmartBatteryAdaptivePrecision');
        const decision = shouldAcceptBatterySample({
          prev: previous,
          next: percentValue,
          lastTs: this._lastBattUpdate,
          now,
          force,
        });
    ...
    if (this.device.hasCapability?.('measure_battery')) {
      this._safeSetCap('measure_battery', parseFloat(smoothed)).catch(err => {
        this.device.error('[BATTERY-UNIFIED] Failed to set battery:', err.message);
      });
      try {
        const card = this.device.homey?.flow?.getDeviceTriggerCard?.('battery_percent_changed');
        if (card) {
          card.trigger(this.device, { percent: parseFloat(smoothed) }, {}).catch(() => {});
        }
      } catch (_e) { /* optional */ }
    }
    ...
    // v10.11.0: feed the PredictiveHealthEngine — it was instantiated and
    // its flow cards registered, but recordMetrics() was NEVER called
    // (predictions ran on empty history). Wire real battery samples in.
    try {
      const engine = this.device.safeApp?.predictiveHealthEngine
        || this.device.homey?.app?.predictiveHealthEngine;
      if (engine && typeof engine.recordMetrics === 'function') {
        engine.recordMetrics(this.device.getData().id, {
          batteryPercent: smoothed,
   ...
   * v10.7.0: symmetric for genuine COLLAPSES too — a fast CR2032 voltage
   * collapse (>20% drop between two reports) is real and must surface
   * immediately, not be smoothed for days. And lastSmoothedValue is
   * persisted so an app restart doesn't force-accept the next sample.
   */
  _applySmoothing(newPercentage, force = false) {
    // v10.7.0: restore persisted smoothed value after restart
    if (this.lastSmoothedValue === null && !this._smoothedRestored) {
      this._smoothedRestored = true;
      const stored = Number(this.device.getStoreValue?.('last_battery_percentage'));
      if (Number.isFinite(stored) && stored >= 0 && stored <= 100) {
        this.lastSmoothedValue = stored;
      }
    }
    ...
    // v10.7.0: large DROP > 20% = genuine cell collapse (coin cells fall off
    // a cliff at end of life) — accept immediately so low-battery alarms
    // fire on time. The 24h anti-flap in _updateBattery still guards noise.
    if (newPercentage < this.lastSmoothedValue - 20) {
      this.device.log(`[BATTERY-UNIFIED] 📉 Battery collapse detected: ${this.lastSmoothedValue}% → ${newPercentage}%`);
      this.lastSmoothedValue = newPercentage;
      return newPercentage;
    }
  ...
  _updateVoltage(voltage) {
    ...
    if (this.device.hasCapability?.('measure_voltage')) {
      this._safeSetCapFireAndForget('measure_voltage', parseFloat(voltage));
    }

    // v1.0: Feed voltage to health intelligence for voltage-level analysis
    this._updateVoltageHealthIntelligence(voltage);

    // P2710: chemistry curve % from voltage — always compute; fuse with ZCL % when present
    if (voltage > 0) {
      const fromV = UnifiedBatteryHandler.calculateFromVoltage(voltage, this.batteryType, this.temperature);
      if (fromV === null || fromV === undefined) return;
      try {
        const { fusePercentAndVoltage } = require('./SmartBatteryAdaptivePrecision');
        const fused = fusePercentAndVoltage({
          zclPercent: this.lastValue,
          voltagePercent: fromV,
          chemistry: this.batteryType || this._profile?.chemistry,
          preferVoltageOnFlatZcl: true,
        });
        if (fused.percent != null) {
          this._updateBattery(fused.percent, false, {
            source: fused.source === 'zcl' && this.lastValue != null ? 'voltage-confirm' : (fused.source || 'voltage-derived'),
            estimated: fused.source !== 'zcl',
      ...
      if (this.lastValue === null) {
        this._updateBattery(fromV, false, { source: 'voltage-derived', estimated: false });
      }
    }
  }
  ...
  _updateBatteryHealthIntelligence(percentage) {
    ...
    try {
      ...
      if (this.device.hasCapability?.('measure_battery_health')) {
        this._safeSetCapFireAndForget('measure_battery_health', report.healthScore);
      }

      if (this.device.hasCapability?.('measure_battery_cycles')) {
        this._safeSetCapFireAndForget('measure_battery_cycles', report.cycleCount);
      }

      if (this.device.hasCapability?.('text_battery_status')) {
        this._safeSetCapFireAndForget('text_battery_status', report.healthStatus);
      }

      if (this.device.hasCapability?.('measure_battery_internal_resistance') && report.internalResistanceEstimate !== null) {
        this._safeSetCapFireAndForget('measure_battery_internal_resistance', report.internalResistanceEstimate);
      }
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // v9.0.240 (P58): BatteryCore v2 bridge — chemistry-aware ops delegate here
  // These methods let consumers tap the BatteryCore library (curve interp,
  // exponential smoothing, Kalman, SOH, etc.) without rewriting call sites.
  // ═══════════════════════════════════════════════════════════════════════════
  static BatteryCore = null;
  static getCore() {
    if (!UnifiedBatteryHandler.BatteryCore) {
      try {
        UnifiedBatteryHandler.BatteryCore = require('./BatteryCore');
      } catch (_e) { UnifiedBatteryHandler.BatteryCore = null; }
    }
    return UnifiedBatteryHandler.BatteryCore;
  }
  /** Chemistry-aware voltage → percent (uses BatteryCore CHEMISTRY_PROFILES). */
  static voltageToPercentChemistry(voltage_mV, chemistry = 'Coin Cell', temperature_c = 20) {
    const core = UnifiedBatteryHandler.getCore();
    if (!core) {return null;}
    const profile = core.getProfile ? core.getProfile(chemistry) : null;
    if (!profile) {return null;}
    return core.voltageToPercentTempCompensated
      ? core.voltageToPercentTempCompensated(voltage_mV, profile.curve, temperature_c)
      : null;
  }
  /** Auto-detect chemistry from voltage + optional hints. */
  static autoDetectChemistry(voltage_mV, hints = {}) {
    const core = UnifiedBatteryHandler.getCore();
    return core && core.detectChemistry ? core.detectChemistry(voltage_mV, hints) : null;
  }
  /** Exponential smoothing (Holt-Winters-style) for noisy battery readings. */
  static smoothEma(currentValue, previousEma, alpha = 0.3) {
    const core = UnifiedBatteryHandler.getCore();
    return core && core.exponentialSmoothing
      ? core.exponentialSmoothing(currentValue, previousEma, alpha)
      : currentValue;
  }
  /** State-of-health: returns ratio (0..1) given cycles + chemistry. */
  static stateOfHealth(cycleCount, chemistry) {
    const core = UnifiedBatteryHandler.getCore();
    return core && core.stateOfHealth
      ? core.stateOfHealth(cycleCount, chemistry)
      : 1.0;
  }
  /** Anti-flood gate — should we commit this new battery value? */
  static shouldCommitBatteryValue(newValue, lastValue, options = {}) {
    const core = UnifiedBatteryHandler.getCore();
    return core && core.antiFloodCheck
      ? core.antiFloodCheck(newValue, lastValue, options)
      : true;
  }
  /** Normalize raw ZCL percent to 0..100, handling 0xFF/200/255 sentinels. */
  static normalizeZclPercentV2(rawValue) {
    const core = UnifiedBatteryHandler.getCore();
    return core && core.normalizeZclPercent
      ? core.normalizeZclPercent(rawValue)
      : UnifiedBatteryHandler.normalizeStoredBattery(rawValue);
  }
  /** Cascade fallback: try sources in priority order, return first valid. */
  static cascadeBatterySources(sources) {
    const core = UnifiedBatteryHandler.getCore();
    if (!core || !core.cascade) {return null;}
    // Normalize input: each source may be a value or a {name,value,confidence} object
    const normalized = (sources || [])
      .filter(s => s !== null && s !== undefined)
      .map((s, i) => {
        if (typeof s === 'object' && 'value' in s) {
          return { name: s.name || `src${i}`, value: s.value, confidence: s.confidence ?? 0.8 };
        }
        return { name: `src${i}`, value: s, confidence: 0.8 };
      });
    if (normalized.length === 0) {return null;}
    return core.cascade(normalized);
  }
}

module.exports = UnifiedBatteryHandler;

// P2710: merge LiFePO4 / NiMH / Li-SOCl2 / Homey 1.5V_* precision curves
try {
  const { EXTRA_SPECS } = require('./BatteryChemistryCurves');
  Object.assign(UnifiedBatteryHandler.BATTERY_SPECS, EXTRA_SPECS);
} catch (_e) { /* soft */ }
