...
class UnifiedBatteryHandler {
  ...
  static normalizeZigbeeValue(rawValue, options = {}) {
    ...
    if (rawValue > 0 && rawValue <= 50 && options.lastValue !== undefined) {
        // If previous value was also in 0-50 range, this is likely a 0-50 scale device
        if (options.lastValue !== null && options.lastValue <= 50) {
