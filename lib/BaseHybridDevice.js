...
class BaseHybridDevice extends ZigBeeDevice {
  ...
  async _runBackgroundInitialization() {
    try {
      ...
      // Step 3b: DYNAMIC CAPABILITY DISCOVERY (NEW!)
      this.log('[BACKGROUND] Step 3b/7: Dynamic capability discovery...');
      ...
      this.log('[BACKGROUND] Dynamic capabilities created');
      ...
      // Step 6: Setup monitoring and reporting
      this.log('[BACKGROUND] Step 4/7: Setting up monitoring...');
      await this.setupMonitoring();
      this.log('[BACKGROUND] Monitoring configured');
      
      // Step 7: CRITICAL - Force read ALL initial values (KPIs)
      this.log('[BACKGROUND] Step 5/7: Reading initial KPI values...');
