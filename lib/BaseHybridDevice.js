...
class BaseHybridDevice extends ZigBeeDevice {
  ...
  async _runBackgroundInitialization() {
    try {
      ...
      this.log('[BACKGROUND] Step 3c/6: Tuya EF00 initialization...');
      ...
      this.log('[BACKGROUND] Step 3d/6: Setting up command listeners...');
      ...
      this.log('[BACKGROUND] Step 4/6: Setting up monitoring...');
      await this.setupMonitoring();
      this.log('[BACKGROUND] Monitoring configured');
      
      // Step 7: CRITICAL - Force read ALL initial values (KPIs)
      this.log('[BACKGROUND] Step 5/6: Reading initial KPI values...');
