...
class DynamicFlowCardManager {
  ...
  async _registerFlowCardsForCapability(capabilityId) {
    // v5.5.17: CRITICAL - Skip if capability doesn't exist on device
    // Prevents "Invalid Capability" errors like alarm_generic
    if (!this.device.hasCapability(capabilityId)) {
      this.log(`⚠️ Skipping ${capabilityId} - not present on device`);
      return;
    }

    let capabilityOptions = {};
    try {
      capabilityOptions = this.device.getCapabilityOptions(capabilityId) || {};
    } catch (err) {
      this.log(`⚠️ Cannot get options for ${capabilityId}: ${err.message}`);
      return;
    }
  ...
  async _registerCondition(capabilityId, capabilityType) {
    ...
    try {
      const conditionCard = (() => { try { return (() => { try { return (() => { try { return (() => { try { return this.homey.flow.getDeviceConditionCard(conditionId); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })();
  ...
  async _registerAction(capabilityId, capabilityType) {
    ...
    try {
      const actionCard = (() => { try { return (() => { try { return (() => { try { return (() => { try { return this.homey.flow.getDeviceActionCard(actionId); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })();
  ...
  async _tryGenericTriggers(capabilityId, value) {
    ...
    if (typeof value === 'boolean') {
      ...
      try {
        const triggerCard = (() => { try { return (() => { try { return (() => { try { return (() => { try { return this.homey.flow.getDeviceTriggerCard(boolTriggerId); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })();
        if (triggerCard) {
    ...
    if (capabilityId.startsWith('alarm_')) {
      try {
        const alarmTrigger = (() => { try { return (() => { try { return (() => { try { return (() => { try { return this.homey.flow.getDeviceTriggerCard(`${this.driverId}_alarm_changed`); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })();
        if (alarmTrigger) {
    ...
    if (capabilityId.startsWith('measure_')) {
      try {
        const measureTrigger = (() => { try { return (() => { try { return (() => { try { return (() => { try { return this.homey.flow.getDeviceTriggerCard(`${this.driverId}_measure_changed`); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })();
        if (measureTrigger) {
