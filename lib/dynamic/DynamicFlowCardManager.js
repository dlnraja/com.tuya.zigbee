...
class DynamicFlowCardManager {
  ...
  async _registerAction(capabilityId, capabilityType) {
    ...
    try {
      const actionCard = (() => { try { return (() => { try { return (() => { try { return (() => { try { return this.homey.flow.getActionCard(actionId); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })();
  ...
  async _tryGenericTriggers(capabilityId, value) {
    ...
    if (typeof value === 'boolean') {
      ...
      try {
        const triggerCard = (() => { try { return (() => { try { return (() => { try { return (() => { try { return this.homey.flow.getTriggerCard(boolTriggerId); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })();
        if (triggerCard) {
    ...
    if (capabilityId.startsWith('alarm_')) {
      try {
        const alarmTrigger = (() => { try { return (() => { try { return (() => { try { return (() => { try { return this.homey.flow.getTriggerCard(`${this.driverId}_alarm_changed`); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })();
        if (alarmTrigger) {
    ...
    if (capabilityId.startsWith('measure_')) {
      try {
        const measureTrigger = (() => { try { return (() => { try { return (() => { try { return (() => { try { return this.homey.flow.getTriggerCard(`${this.driverId}_measure_changed`); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })();
        if (measureTrigger) {
