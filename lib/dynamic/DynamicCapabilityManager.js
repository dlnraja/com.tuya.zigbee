...
class DynamicCapabilityManager {
  ...
  /**
   * Athom-style capability audit stub (parity with lib/managers/DynamicCapabilityManager).
   * Must exist so BaseUnifiedDevice's delayed audit timer never throws
   * "auditCapabilities is not a function" after AutoAdaptive replaces the managers/DCM.
   * BOTH reliability — Gmail 2026-08-14/15 + Peter #2137 (5.12.70).
   */
