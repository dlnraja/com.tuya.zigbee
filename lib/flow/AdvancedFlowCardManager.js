...
class AdvancedFlowCardManager {
   ...
   * SDK v3 API: getDeviceTriggerCard, getDeviceActionCard, getDeviceConditionCard
  ...
  _safeGetCard(type, id) {
    try {
      switch (type) {
        ...
        case 'action': return this.homey.flow.getDeviceActionCard(id);
        case 'condition': return this.homey.flow.getDeviceConditionCard(id);
        default: return null;
      }
    } catch (err) {
