...
const DATAPOINT_REGISTRY = {
  ...
  SENSORS: {
    ...
    1: {
      ...
      writable: false,
      reportable: true,
      converter: 'boolean_inverted',
      sources: ['z2m', 'zha', 'blakadder', 'johan'],
      devices: ['contact_sensor', 'door_sensor', 'window_sensor'],
      notes: 'true=open, false=closed'
    },
    1: {
      name: 'smoke',
    ...
    1: {
      ...
      converter: 'boolean',
      sources: ['z2m', 'zha', 'blakadder'],
      devices: ['gas_detector', 'co_detector']
    },
    15: {
      name: 'water_leak',
