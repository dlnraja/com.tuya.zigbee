    ...
    try {
      ...
      while (offset < buffer.length - 4) {
        ...
        case 0x02: // VALUE (4-byte integer)
          value = len === 4 ? valueData.readInt32BE(0) : len === 2 ? valueData.readInt16BE(0) : valueData[0];
          break;
        case 0x03: // STRING
        ...
        case 0x04: // ENUM
          ...
          break;
        case 0x05: // BITMAP
          value = len === 4 ? valueData.readUInt32BE(0) : len === 2 ? valueData.readUInt16BE(0) : valueData[0];
          break;
        default:
          value = valueData;
        }
