  ...
  async init() {
    ...
    for (const cap of caps) {
      if (!this.device.hasCapability(cap)) {
        // ponytail: ADD_CAP_SAFE - capability may already exist; addCapability throws on duplicate
        try { await this.device.addCapability(cap); } catch { /* ponytail: already exists */ }
      }
    }
