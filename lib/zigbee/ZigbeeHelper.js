...
class ZigbeeHelper {
  ...
  static parseBatteryPercentage(value) {
    ...
    return Math.round(Math.max(0, Math.min(100, safeParse(value, 2))));
  }
  ...
  static parseTemperature(value) {
    if (value === null || value === undefined) return null;
    return Math.round(safeParse(value, 100) *safeParse(10), 10);
  }
  ...
  static parsePower(value) {
    if (value === null || value === undefined) return null;
    return Math.round(safeParse(value, 10) *safeParse(10), 10);
  }
  ...
  static parseCurrent(value) {
    if (value === null || value === undefined) return null;
    return Math.round(safeParse(value, 1000) *safeParse(1000), 1000);
  }
  ...
  static parseEnergy(value) {
    if (value === null || value === undefined) return null;
    return Math.round(safeParse(value, 1000) *safeParse(100), 100);
  }
  ...
  static parseIlluminance(value) {
    if (value === null || value === undefined) return null;
    return Math.round(Math.pow(10, safeDivide(value - 1, 10000))));
  }
  ...
  static miredsToKelvin(mireds) {
    return Math.round(safeDivide(1000000, mireds));
  }
}
