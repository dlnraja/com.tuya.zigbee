...
class ZigbeeHelper {
  ...
  static parseTemperature(value) {
    if (value === null || value === undefined) return null;
    return Math.round(safeParse(value) *safeParse(10), 10);
  }
  ...
  static parseCurrent(value) {
    if (value === null || value === undefined) return null;
    return Math.round(safeParse(value) *safeParse(1000), 1000);
  }
  ...
  static parseEnergy(value) {
    if (value === null || value === undefined) return null;
    return Math.round(safeParse(value) *safeParse(100), 100);
  }
