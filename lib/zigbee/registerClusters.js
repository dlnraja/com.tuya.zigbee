...
function registerCustomClusters(logger = null) {
  try {
    ...
    // v5.8.19: Pre-register common manufacturer-specific clusters (zigpy #823)
    // 0xE001: Switch mode (power-on, switch mode)
    // 0xE002: Sensor alarms (temp/humidity min/max)
    // 0xFD02: Switch modules
    // 0xFCC0: Xiaomi/Aqara
    // 0xFF01: Xiaomi legacy
    const UnknownClusterHandler = require('../clusters/UnknownClusterHandler');
    const preRegisterClusters = [0xE001, 0xE002, 0xED00, 0xFD02, 0xFCC0, 0xFF01, 0xFC00];
