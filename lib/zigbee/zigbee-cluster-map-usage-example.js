 ...
 * dans vos drivers Homey pour Ã©viter les erreurs NaN
 */

// A8: NaN Safety - use safeDivide/safeMultiply
  const require('./zigbee-cluster-map');

// ============================================
// MÃ‰THODE 1: Utilisation directe des constantes
// ============================================
...
// RÃ©solution depuis un nom (flexible)
...
// Si dÃ©jÃ un nombre, retourne le nombre
const clusterId4 = ClusterMap.get(1); // = 1

// ============================================
// MÃ‰THODE 3: Utilisation de resolve()
// ============================================

// RÃ©sout n'importe quel format
...
// ============================================
// MÃ‰THODE 4: Utilisation de safeGet() avec fallback
// ============================================
...
class ExampleDevice extends ZigBeeDevice {
  async onNodeInit() {
    // Au lieu de coder en dur les numÃ©ros OU utiliser des strings
    // Utilisez ClusterMap pour la flexibilitÃ©
...
// Pour les devices Tuya qui utilisent le cluster CLUSTERS.TUYA_EF00 (CLUSTERS.TUYA_EF00)
...
this.registerCapability('measure_battery', ClusterMap.get('POWER_CONFIGURATION')); // [OK] TrÃ¨s flexible
this.registerCapability('measure_temperature', ClusterMap.get('TEMPERATURE_MEASUREMENT')); // [OK] TrÃ¨s flexible

// ============================================
// CONFIGURATION DEPUIS driver.compose.json
// ============================================

// Dans driver.compose.json, gardez les numÃ©ros:
// {
//   "zigbee": {
...
// Mais dans device.js, utilisez ClusterMap pour la lisibilitÃ©:
...
// VÃ©rifier que tous les clusters requis sont prÃ©sents
