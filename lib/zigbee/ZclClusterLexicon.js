...
const CLUSTERS = Object.freeze({
  ...
  IAS_ACE: { id: 0x0501, names: ['iasAce', 'ssIasAce'] },
  // WHY P2466: Cleverio SA100 / TS0219 sirens expose IAS Warning Device (startWarning)
  IAS_WD: { id: 0x0502, names: ['iasWd', 'ssIasWd', 'iasWarningDevice'] },
  ...
  // WHY(P2655): eWeLink/Sonoff TH (CK-TLSR8656 / SNZB-02M) — climate_sensor compose 64529; calib attrs 0x2003/2004/2007
  EWELINK_FC11: { id: 0xFC11, names: ['ewelinkFc11', 'customClusterEwelink', 'sonoffClimateCalib', 'manuSpecificEwelink'] },
});
