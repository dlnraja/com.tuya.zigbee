  ...
  async registerBattery(options = {}) {
    ...
    try {
      ...
      powerCfg.on('attr.batteryPercentageRemaining', (value) => {
        ...
        this.device.setCapabilityValue('measure_battery', parseFloat(percent)).catch(this._boundError || ((e) => { try { this.error(e); } catch (_) {} }));
        this.device.setCapabilityValue('alarm_battery', percent < 20).catch(this._boundError || ((e) => { try { this.error(e); } catch (_) {} }));
      });
