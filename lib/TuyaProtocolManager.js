...
class TuyaProtocolManager extends EventEmitter {
  ...
  configureDPMappings() {
    ...
    // Standard Tuya DP mappings from official docs
    const standardMappings = {
      // Switches (DP1-4 for multi-gang)
      1: { capability: 'onoff', type: TuyaDPParser.DP_TYPE.BOOL, description: 'Main switch / Gang 1' },
      2: { capability: 'onoff.gang2', type: TuyaDPParser.DP_TYPE.BOOL, description: 'Gang 2' },
      3: { capability: 'onoff.gang3', type: TuyaDPParser.DP_TYPE.BOOL, description: 'Gang 3' },
      4: { capability: 'onoff.gang4', type: TuyaDPParser.DP_TYPE.BOOL, description: 'Gang 4' },
      
      // Countdown timers (DP7-10)
      7: { capability: 'countdown.gang1', type: TuyaDPParser.DP_TYPE.VALUE, description: 'Timer gang 1', scale: 1 },
      8: { capability: 'countdown.gang2', type: TuyaDPParser.DP_TYPE.VALUE, description: 'Timer gang 2', scale: 1 },
      9: { capability: 'countdown.gang3', type: TuyaDPParser.DP_TYPE.VALUE, description: 'Timer gang 3', scale: 1 },
      10: { capability: 'countdown.gang4', type: TuyaDPParser.DP_TYPE.VALUE, description: 'Timer gang 4', scale: 1 },
      
      // Power-on behavior
      14: { capability: 'power_on_behavior', type: TuyaDPParser.DP_TYPE.ENUM, description: 'Main power-on' },
      29: { capability: 'power_on_behavior.gang1', type: TuyaDPParser.DP_TYPE.ENUM, description: 'Gang 1 power-on' },
      30: { capability: 'power_on_behavior.gang2', type: TuyaDPParser.DP_TYPE.ENUM, description: 'Gang 2 power-on' },
      31: { capability: 'power_on_behavior.gang3', type: TuyaDPParser.DP_TYPE.ENUM, description: 'Gang 3 power-on' },
      32: { capability: 'power_on_behavior.gang4', type: TuyaDPParser.DP_TYPE.ENUM, description: 'Gang 4 power-on' },
      
      // LED & Backlight
      15: { capability: 'led_behavior', type: TuyaDPParser.DP_TYPE.ENUM, description: 'LED indicator' },
      16: { capability: 'backlight', type: TuyaDPParser.DP_TYPE.BOOL, description: 'Backlight' },
      
      // Inching/Pulse
      19: { capability: 'inching_mode', type: TuyaDPParser.DP_TYPE.RAW, description: 'Pulse mode' },
      
      // Environmental sensors
      1: { capability: 'measure_temperature', type: TuyaDPParser.DP_TYPE.VALUE, description: 'Temperature', scale: 10 },
      2: { capability: 'measure_humidity', type: TuyaDPParser.DP_TYPE.VALUE, description: 'Humidity', scale: 10 },
      3: { capability: 'measure_luminance', type: TuyaDPParser.DP_TYPE.VALUE, description: 'Illuminance', scale: 1 },
      4: { capability: 'measure_battery', type: TuyaDPParser.DP_TYPE.VALUE, description: 'Battery', scale: 1 },
      5: { capability: 'alarm_motion', type: TuyaDPParser.DP_TYPE.BOOL, description: 'Motion' },
      9: { capability: 'alarm_contact', type: TuyaDPParser.DP_TYPE.BOOL, description: 'Contact' },
      
      // Soil Moisture Sensor (HOBEIAN + others)
      1: { capability: 'measure_moisture', type: TuyaDPParser.DP_TYPE.VALUE, description: 'Soil moisture', scale: 1 },
      
      // Alternative temperature/humidity
      18: { capability: 'measure_temperature', type: TuyaDPParser.DP_TYPE.VALUE, description: 'Temperature (alt)', scale: 10 },
      19: { capability: 'measure_humidity', type: TuyaDPParser.DP_TYPE.VALUE, description: 'Humidity (alt)', scale: 10 },
      
      // Plug/Socket
      101: { capability: 'onoff', type: TuyaDPParser.DP_TYPE.BOOL, description: 'Socket main' },
      102: { capability: 'dim', type: TuyaDPParser.DP_TYPE.VALUE, description: 'Dimmer', scale: 1 },
      103: { capability: 'onoff.usb2', type: TuyaDPParser.DP_TYPE.BOOL, description: 'USB port 2' },
      
      // Energy monitoring
      16: { capability: 'measure_voltage', type: TuyaDPParser.DP_TYPE.VALUE, description: 'Voltage', scale: 10 },
      17: { capability: 'measure_current', type: TuyaDPParser.DP_TYPE.VALUE, description: 'Current (mA)', scale: 1000 },
      18: { capability: 'measure_power', type: TuyaDPParser.DP_TYPE.VALUE, description: 'Power', scale: 10 },
      19: { capability: 'meter_power', type: TuyaDPParser.DP_TYPE.VALUE, description: 'Energy (kWh)', scale: 100 }
    };

    // Apply mappings only for capabilities that exist on device
    let mappedCount = 0;
    for (const [dpStr, config] of Object.entries(standardMappings)) {
      const dp = parseInt(dpStr);
      if (this.device.hasCapability(config.capability)) {
        this.dpMapping.set(dp, config);
