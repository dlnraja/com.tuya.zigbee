...
class UnifiedSensorBase extends TuyaZigbeeDevice {
  ...
  _detectProtocol() {
    try {
      ...
      const isSONOFF = MfrHelper.equalsCI(mfr, 'SONOFF') || MfrHelper.equalsCI(mfr, 'eWeLink') || MfrHelper.startsWithCI(modelId, 'SNZB');
      const isStandardZCL = (MfrHelper.equalsCI(modelId, 'TS0201') || MfrHelper.startsWithCI(modelId, 'TS02') || isSONOFF) && !isTuyaDP;
