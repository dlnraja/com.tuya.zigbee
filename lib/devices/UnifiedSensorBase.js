...
class UnifiedSensorBase extends TuyaZigbeeDevice {
  ...
  _handleMotionWithHoldoff(motionDetected) {
    ...
    if (motionDetected) {
      ...
      this.safeSetCapabilityValue('alarm_motion', true);
      return;
    }
    if (holdoffMs <= 0) { this.safeSetCapabilityValue('alarm_motion', false); return; }
    ...
    this._motionHoldoffTimer = setTimeout(() => {
      this._motionHoldoffTimer = null;
      this.safeSetCapabilityValue('alarm_motion', false);
