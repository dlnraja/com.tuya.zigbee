...
class UnifiedSensorBase extends BaseUnifiedDevice {
  ...
  async _triggerPresenceFlows(detected) {
    try {
      ...
      this.log(`[SENSOR-BASE] ⚠️ Flow trigger skipped: ${err.message}`);
    }
  }
  ...
  async onNodeInit({ zclNode }) {
    ...
    try {
      ...
      this.log(`⚠️ RateLimiter init failed: ${e.message}`);
    }
  ...
  _setupRawFrameFallback() {
    ...
    this.log('🛡️ [TX/RX] Setup Universal Raw Frame Fallback (UnifiedSensorBase)');
