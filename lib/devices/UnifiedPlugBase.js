...
class UnifiedPlugBase extends TuyaZigbeeDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    // v5.12.59 (P92.126): virtual energy estimation when no hardware
    // metering path exists — on-time x configurable load per gang.
    try {
      ...
      this.log('[VIRTUAL-ENERGY] estimator init: ' + e.message);
    }
  ...
  async onDeleted() {
    ...
    // v5.12.59 (P92.126): Cleanup virtual energy estimator
