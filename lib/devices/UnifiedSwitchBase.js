    ...
    if (oldValue !== value) {
      ...
      if (capability.startsWith('onoff')) {
        try {
          ...
          // WHY(P2331/P2334): declared-only via CoreCapabilityMixin / _safeTriggerFlow.
          // Prefer `_1gang_turned_*` / `_Ngang_gangN_turned_*` / bare `_turned_*`
          // before legacy `_gangN_turned_*` (valid for switch_2gang only).
