    ...
    if (oldValue !== value) {
      ...
      if (capability.startsWith('onoff')) {
        try {
          ...
          // WHY(P2331): never invent `${driverId}_gangN_turned_*` — prefer declared
          // compose IDs via CoreCapabilityMixin / _safeTriggerFlow.
          if (typeof this._triggerGangFlows === 'function') {
            ...
            if (gangNum > 1) {
              candidates.splice(1, 0, `${driverId}_${gangNum}gang_gang${gangNum}_turned_${stateStr}`);
            }
