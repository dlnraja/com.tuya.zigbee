...
class UnifiedSwitchBase extends TuyaZigbeeDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    // The estimator existed but was dead code (TuyaDeviceMixin, its only
    // host, was never applied to any class).
    try {
  ...
  /**
   * v9.0.413 (P92.121): apply persisted on/off-cluster settings at boot.
