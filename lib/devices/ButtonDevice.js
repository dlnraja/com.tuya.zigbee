          ...
          if (typeof powerCluster.readAttributes === 'function') {
            ...
            if (data?.batteryPercentageRemaining !== undefined &&
              ...
              if (this.hasCapability('measure_battery')) {
                ...
                this.log('[BUTTON-BATTERY]  No measure_battery capability (removed by adapter?)') : null;
              }
              batteryRead = true;
              ...
              const battery =safeMultiply(this._voltageToPercentCurve(Math.round(voltage)));
