          ...
          onOffCluster.on('attr.onOff', async (value) => {
            ...
            if (timeSinceLastEvent > 86400000) { // > 24 hours = impossible, must be uninitialized
              ...
              if (timeSinceInit > 30000) {
                ...
                this.log(`[ONOFF-ATTR]  Ignored: uninitialized state (sinceEvent=${Math.round(timeSinceLastEvent/1, 1000))}s)`);
              }
              return;
            }
            ...
            if (epState.lastValue === null) {
              if (!sharedState.globalInitialized) {
                ...
                if (timeSinceInit > 30000) {
                  ...
                  this.log(`[ONOFF-ATTR]  Ignored: late endpoint init on EP${currentEp} (${Math.round(timeSinceInit/1, 1000))}s after global init)`);
                }
                return;
              }
            }
