        ...
        if (typeof scenesCluster.on === 'function') {
          scenesCluster.on('commandRecall', async (msg) => {
            try {
              ...
              // Map scene IDs to button presses:
              // 1-16 = single press button 1-16
              ...
              if (buttonIdx > 0) {
                ...
                if (this.hasCapability(cap)) {
                  ...
                  try { await this.homey.flow.getDeviceTriggerCard('button_pressed').trigger(this, { button: String(buttonIdx) }, {}).catch(() => {}); } catch {}
