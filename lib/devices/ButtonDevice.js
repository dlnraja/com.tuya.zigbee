  ...
  async _tryCard(cardId, tokens = {}, state = {}) {
    try {
      ...
      if (declared.size && !resolved) {
        ...
        const appLevel = /^(button_pressed|button_double_press|button_long_press|button_matrix|virtual_button_pressed|button_triple_clicked|button_multi_press|button_release|remote_button_pressed|button_scene_recall)$/i;
