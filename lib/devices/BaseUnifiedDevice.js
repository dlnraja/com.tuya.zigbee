      ...
      try {
        ...
        if (onOffCluster) {
          ...
          if (state?.onOff !== undefined) {
            await Promise.resolve(this.setCapabilityValue('onoff', state.onOff)).catch(err => this.error(err));
      ...
      try {
        ...
        if (occCluster) {
          ...
          if (occ?.occupancy !== undefined) {
            ...
            await Promise.resolve(this.setCapabilityValue('alarm_motion', occupied)).catch(err => this.error(err));
      ...
      try {
        ...
        if (iasCluster) {
          ...
          if (zone?.zoneStatus !== undefined) {
            ...
            await Promise.resolve(this.setCapabilityValue('alarm_contact', open)).catch(err => this.error(err));
    ...
    try {
      ...
      if (clusterName === 'onOff') {
        ...
        if (command === 'on' || command === 'off') {
          ...
          await Promise.resolve(this.setCapabilityValue(cap, state)).catch(err => this.error(err));
        ...
        if (command === 'toggle') {
          ...
          await Promise.resolve(this.setCapabilityValue(cap, !current)).catch(err => this.error(err));
          return;
        }
      }
