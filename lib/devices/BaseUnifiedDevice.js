...
letDataQuery, ZigbeeDataQuery;
try {
  const zigbeeQueryModule = require('../zigbee/ZigbeeDataQuery');
 DataQuery = zigbeeQueryModule.HybridDataQuery;
...
class BaseUnifiedDevice extends TuyaZigbeeDevice {
  ...
  async safeSetCapabilityValue(capabilityId, value, options = {}) {
    try {
      ...
      if (this._deleted || this._destroyed || this.destroyed || !this.homey) {
      ...
      if (!this.hasCapability(capabilityId)) {
        ...
        if (manifestCaps.includes(capabilityId)) {
          try {
            ...
            if (typeof this._invalidateCapabilityMap === 'function') {
      ...
      // v5.11.220: Fix infinite recursion by bypassing TuyaZigbeeDevice.setCapabilityValue.
        ...
        if (this.hasCapability('measure_temperature')) {
          ...
          if (tempCluster) {
            try {
              ...
              await this.safeSetCapabilityValue('measure_temperature', parseFloat(temp));
        ...
        if (this.hasCapability('measure_humidity')) {
          ...
          if (humidCluster) {
            try {
              ...
              await this.safeSetCapabilityValue('measure_humidity', parseFloat(humidity));
  ...
  async _initHybridDataQuery() {
    ...
    // Skip ifDataQuery not available
    if (!HybridDataQuery) {
    ...
    try {
      this.DataQuery = newDataQuery(this);
    ...
    try {
      ...
      try {
        ...
        if (batteryData) {
          ...
          if (this.hasCapability('measure_battery')) {
            await Promise.resolve(await this.safeSetCapabilityValue('measure_battery', batteryPercent)).catch(this.error);
      ...
      try {
        ...
        if (tempCluster) {
          ...
          if (temp?.measuredValue !== undefined) {
            ...
            await Promise.resolve(await this.safeSetCapabilityValue('measure_temperature', parseFloat(tempC))).catch(this.error);
      ...
      try {
        ...
        if (humCluster) {
          ...
          if (hum?.measuredValue !== undefined) {
            ...
            await Promise.resolve(await this.safeSetCapabilityValue('measure_humidity', parseFloat(humPercent))).catch(this.error);
      ...
      try {
        ...
        if (illumCluster) {
          ...
          if (illum?.measuredValue !== undefined) {
            ...
            await Promise.resolve(await this.safeSetCapabilityValue('measure_luminance', parseFloat(lux))).catch(this.error);
  ...
  async registerTemperatureCapability() {
    ...
    try {
      ...
      tempCluster.on('attr.measuredValue', async (value) => {
        ...
        if (this.hasCapability('measure_temperature')) {
          await this.safeSetCapabilityValue('measure_temperature', parseFloat(temp)).catch(this.error);
        }
      });
  ...
  async registerHumidityCapability() {
    ...
    try {
      ...
      humidCluster.on('attr.measuredValue', async (value) => {
        ...
        if (this.hasCapability('measure_humidity')) {
          await this.safeSetCapabilityValue('measure_humidity', parseFloat(humidity)).catch(this.error);
        }
      });
  ...
  async registerLuminanceCapability() {
    ...
    try {
      ...
      luxCluster.on('attr.measuredValue', async (value) => {
        ...
        if (this.hasCapability('measure_luminance')) {
          await this.safeSetCapabilityValue('measure_luminance', parseFloat(lux)).catch(this.error);
        }
      });
      ...
      try {
        ...
        if (this.hasCapability('measure_luminance')) {
          await this.safeSetCapabilityValue('measure_luminance', parseFloat(lux));
        }
      } catch (err) {
    ...
    try {
      ...
      if (powerCluster) {
        ...
        if (battery?.batteryPercentageRemaining !== undefined) {
          ...
          if (this.hasCapability('measure_battery')) {
            await this.safeSetCapabilityValue('measure_battery', parseFloat(level));
          }
  ...
  async handleEndpointCommand(endpointId, clusterName, command, payload = {}) {
    ...
    try {
      // v5.5.396/v5.11.220: Button devices should never become switches here.
      ...
      if (this.hasCapability('measure_battery') && endpoint.clusters?.powerConfiguration && !this.skipZclBatteryPolling && !this.usesTuyaDPBattery) {
        try {
          ...
          if (batteryData && batteryData.batteryPercentageRemaining != null) {
            ...
            if (this.hasCapability('measure_battery')) {
              await Promise.resolve(await this.safeSetCapabilityValue('measure_battery', parseFloat(battery))).catch(this.error);
            }
          } else {
            ...
            if (voltageData && voltageData.batteryVoltage) {
              ...
              if (this.hasCapability('measure_battery')) {
                await Promise.resolve(await this.safeSetCapabilityValue('measure_battery', parseFloat(percent))).catch(this.error);
              }
            }
          }
        } catch (err) {
      ...
      if (endpoint.clusters?.temperatureMeasurement || endpoint.clusters?.msTemperatureMeasurement) {
        try {
          ...
          if (tempData && tempData.measuredValue !== null && tempData.measuredValue !== undefined) {
            ...
            if (this.hasCapability('measure_temperature')) {
              await Promise.resolve(await this.safeSetCapabilityValue('measure_temperature', parseFloat(temp))).catch(this.error);
            }
          } else {
      ...
      if (endpoint.clusters?.relativeHumidity || endpoint.clusters?.msRelativeHumidity) {
        try {
          ...
          if (humidityData && humidityData.measuredValue !== null && humidityData.measuredValue !== undefined) {
            ...
            if (this.hasCapability('measure_humidity')) {
              await Promise.resolve(await this.safeSetCapabilityValue('measure_humidity', parseFloat(humidity))).catch(this.error);
            }
          } else {
      ...
      if (humCluster && this.hasCapability('measure_humidity')) {
        ...
        try {
          ...
          safeAddListener(humCluster, 'attr.measuredValue', async function (value) {
            ...
            await this.safeSetCapabilityValue('measure_humidity', parseFloat(hum)).catch(this.error);
            if (typeof this.setLastSeenAt === 'function') this.setLastSeenAt();
          }, 'relativeHumidity');
      ...
      if (powerCluster && this.hasCapability('measure_battery')) {
        ...
        try {
          ...
          safeAddListener(powerCluster, 'attr.batteryPercentageRemaining', async function (value) {
            ...
            if (this.hasCapability('measure_battery')) {
              await this.safeSetCapabilityValue('measure_battery', parseFloat(battery)).catch(this.error);
            }
            if (typeof this.setLastSeenAt === 'function') this.setLastSeenAt();
          }, 'powerConfiguration');
        ...
        try {
          ...
          if (this.hasCapability('measure_power')) {
            elecCluster.on('attr.activePower', async (value) => {
              ...
              await this.safeSetCapabilityValue('measure_power', parseFloat(power)).catch(this.error);
            });
          }
          ...
          if (this.hasCapability('measure_voltage')) {
            elecCluster.on('attr.rmsVoltage', async (value) => {
              ...
              await this.safeSetCapabilityValue('measure_voltage', parseFloat(voltage)).catch(this.error);
            });
          }
          ...
          if (this.hasCapability('measure_current')) {
            elecCluster.on('attr.rmsCurrent', async (value) => {
              ...
              await this.safeSetCapabilityValue('measure_current', parseFloat(current)).catch(this.error);
            });
          }
      ...
      if (meterCluster && this.hasCapability('meter_power')) {
        ...
        try {
          meterCluster.on('attr.currentSummationDelivered', async (value) => {
            ...
            await this.safeSetCapabilityValue('meter_power', parseFloat(energy)).catch(this.error);
          });
      ...
      if (onoffCluster && this.hasCapability('onoff') && !isButtonDevice) {
        ...
        try {
          onoffCluster.on('attr.onOff', async (value) => {
            ...
            await this.safeSetCapabilityValue('onoff', isOn).catch(this.error);
          });
  ...
  async retryBatteryRead(maxRetries = 3) {
    ...
    if (this.hasCapability('measure_battery')) {
      await this.safeSetCapabilityValue('measure_battery', 50).catch(() => { });
    }
          ...
          this._bgBatteryReadTimer = setTimeout(async () => {
            try {
              ...
              const battery = await endpoint.clusters.powerConfiguration.readAttributes(['batteryPercentageRemaining'])
                .catch(() => null);
              // v5.11.219: Filter ZCL sentinel 255=unknown. ZCL 200 means 100%.
      ...
      try {
                ...
                if (storedVoltage) {
                  ...
                  if (accuratePercent !== null) {
                    ...
                    if (this.hasCapability('alarm_battery')) {
                      ...
                      await this.safeSetCapabilityValue('alarm_battery', isLow).catch(err =>
        ...
        if (batteryAttrs) {
          ...
          if (finalPercent !== null && this.hasCapability('measure_battery')) {
            await this.safeSetCapabilityValue('measure_battery', parseFloat(finalPercent));
    ...
    if (this.hasCapability('measure_temperature') && endpoint.clusters?.temperatureMeasurement) {
      try {
        ...
        if (temp?.measuredValue != null) {
          ...
          await this.safeSetCapabilityValue('measure_temperature', parseFloat(temperature));
    ...
    if (this.hasCapability('measure_luminance') && endpoint.clusters?.illuminanceMeasurement) {
      try {
        ...
        if (lux?.measuredValue != null) {
          ...
          await this.safeSetCapabilityValue('measure_luminance', parseFloat(luminance));
    ...
    if (this.hasCapability('alarm_motion') && endpoint.clusters?.occupancySensing) {
      try {
        ...
        if (occ?.occupancy != null) {
          ...
          await this.safeSetCapabilityValue('alarm_motion', motion);
  ...
  async configureStandardBatteryReporting() {
    try {
      ...
      endpoint.clusters.powerConfiguration.on('attr.batteryPercentageRemaining', async value => {
        ...
        if (this.hasCapability('measure_battery')) {
          await this.safeSetCapabilityValue('measure_battery', parseFloat(percent)).catch(this.error);
        } else {
