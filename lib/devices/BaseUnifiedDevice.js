      ...
      try {
        ...
        if (powerCluster) {
          ...
          if (power?.activePower !== undefined) {
            ...
            await Promise.resolve(this.setCapabilityValue('measure_power', parseFloat(watts))).catch(err => this.error(err));
      ...
      try {
        ...
        if (powerCluster) {
          ...
          if (voltage?.rmsVoltage !== undefined) {
            ...
            await Promise.resolve(this.setCapabilityValue('measure_voltage', parseFloat(volts))).catch(err => this.error(err));
      ...
      try {
        ...
        if (powerCluster) {
          ...
          if (current?.rmsCurrent !== undefined) {
            ...
            await Promise.resolve(this.setCapabilityValue('measure_current', parseFloat(amps))).catch(err => this.error(err));
