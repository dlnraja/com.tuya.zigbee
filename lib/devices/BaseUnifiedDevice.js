        ...
        const triggerButton = async (pressType, count = 1) => {
          ...
          if (typeof this.triggerButtonPress === 'function') {
            ...
            try {
              ...
              if (flowTrigger) {
                await flowTrigger.trigger(this, { press_type: pressType }, { button: buttonIndex }).catch(() => { });
              }
            } catch (err) {
              this.log(`[CMD] Flow card button_${buttonIndex}_pressed unavailable:`, err.message);
            }
          }
