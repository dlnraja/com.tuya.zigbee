    ...
    try {
      ...
      try {
        ...
        if (batteryData) {
          ...
          if (this.hasCapability('measure_battery')) {
            await Promise.resolve(await this.setCapabilityValue('measure_battery', batteryPercent)).catch(this.error);
      ...
      try {
        ...
        if (tempCluster) {
          ...
          if (temp?.measuredValue !== undefined) {
            ...
            await Promise.resolve(await this.setCapabilityValue('measure_temperature', parseFloat(tempC))).catch(this.error);
      ...
      try {
        ...
        if (humCluster) {
          ...
          if (hum?.measuredValue !== undefined) {
            ...
            await Promise.resolve(await this.setCapabilityValue('measure_humidity', parseFloat(humPercent))).catch(this.error);
      ...
      try {
        ...
        if (illumCluster) {
          ...
          if (illum?.measuredValue !== undefined) {
            ...
            await Promise.resolve(await this.setCapabilityValue('measure_luminance', parseFloat(lux))).catch(this.error);
      ...
      if (this.hasCapability('measure_battery') && endpoint.clusters?.powerConfiguration && !this.skipZclBatteryPolling && !this.usesTuyaDPBattery) {
        try {
          ...
          if (batteryData && batteryData.batteryPercentageRemaining != null) {
            ...
            if (this.hasCapability('measure_battery')) {
              await Promise.resolve(await this.setCapabilityValue('measure_battery', parseFloat(battery))).catch(this.error);
            }
          } else {
            ...
            if (voltageData && voltageData.batteryVoltage) {
              ...
              if (this.hasCapability('measure_battery')) {
                await Promise.resolve(await this.setCapabilityValue('measure_battery', parseFloat(percent))).catch(this.error);
              }
            }
          }
        } catch (err) {
      ...
      if (endpoint.clusters?.temperatureMeasurement || endpoint.clusters?.msTemperatureMeasurement) {
        try {
          ...
          if (tempData && tempData.measuredValue !== null && tempData.measuredValue !== undefined) {
            ...
            if (this.hasCapability('measure_temperature')) {
              await Promise.resolve(await this.setCapabilityValue('measure_temperature', parseFloat(temp))).catch(this.error);
            }
          } else {
      ...
      if (endpoint.clusters?.relativeHumidity || endpoint.clusters?.msRelativeHumidity) {
        try {
          ...
          if (humidityData && humidityData.measuredValue !== null && humidityData.measuredValue !== undefined) {
            ...
            if (this.hasCapability('measure_humidity')) {
              await Promise.resolve(await this.setCapabilityValue('measure_humidity', parseFloat(humidity))).catch(this.error);
            }
          } else {
      ...
      if (humCluster && this.hasCapability('measure_humidity')) {
        ...
        try {
          ...
          safeAddListener(humCluster, 'attr.measuredValue', async function (value) {
            ...
            await this.setCapabilityValue('measure_humidity', parseFloat(hum)).catch(this.error);
            if (typeof this.setLastSeenAt === 'function') {this.setLastSeenAt();}
          }, 'relativeHumidity');
      ...
      if (powerCluster && this.hasCapability('measure_battery')) {
        ...
        try {
          ...
          safeAddListener(powerCluster, 'attr.batteryPercentageRemaining', async function (value) {
            ...
            if (this.hasCapability('measure_battery')) {
              await this.setCapabilityValue('measure_battery', parseFloat(battery)).catch(this.error);
            }
            if (typeof this.setLastSeenAt === 'function') {this.setLastSeenAt();}
          }, 'powerConfiguration');
        ...
        try {
          ...
          if (this.hasCapability('measure_power')) {
            elecCluster.on('attr.activePower', async (value) => {
              ...
              await this.setCapabilityValue('measure_power', parseFloat(power)).catch(this.error);
            });
          }
          ...
          if (this.hasCapability('measure_voltage')) {
            elecCluster.on('attr.rmsVoltage', async (value) => {
              ...
              await this.setCapabilityValue('measure_voltage', parseFloat(voltage)).catch(this.error);
            });
          }
          ...
          if (this.hasCapability('measure_current')) {
            elecCluster.on('attr.rmsCurrent', async (value) => {
              ...
              await this.setCapabilityValue('measure_current', parseFloat(current)).catch(this.error);
            });
          }
      ...
      if (meterCluster && this.hasCapability('meter_power')) {
        ...
        try {
          meterCluster.on('attr.currentSummationDelivered', async (value) => {
            ...
            await this.setCapabilityValue('meter_power', parseFloat(energy)).catch(this.error);
          });
    ...
    if (this.hasCapability('measure_temperature') && endpoint.clusters?.temperatureMeasurement) {
      try {
        ...
        if (temp?.measuredValue != null) {
          ...
          await this.setCapabilityValue('measure_temperature', parseFloat(temperature)).catch(err => this.error('[REGISTER] measure_temperature set failed:', err.message));
    ...
    if (this.hasCapability('measure_humidity') && humidityCluster) {
      try {
        ...
        if (humid?.measuredValue != null) {
          ...
          await this.setCapabilityValue('measure_humidity', parseFloat(humidity)).catch(err => this.error('[REGISTER] measure_humidity set failed:', err.message));
    ...
    if (this.hasCapability('measure_luminance') && endpoint.clusters?.illuminanceMeasurement) {
      try {
        ...
        if (lux?.measuredValue != null) {
          ...
          await this.setCapabilityValue('measure_luminance', parseFloat(luminance)).catch(err => this.error('[REGISTER] measure_luminance set failed:', err.message));
    ...
    if (this.hasCapability('alarm_motion') && endpoint.clusters?.occupancySensing) {
      try {
        ...
        if (occ?.occupancy != null) {
          ...
          await this.setCapabilityValue('alarm_motion', motion).catch(err => this.error('[REGISTER] alarm_motion set failed:', err.message));
    ...
    if (this.hasCapability('alarm_contact') && endpoint.clusters?.iasZone) {
      try {
        ...
        if (zone?.zoneStatus != null) {
          const open = (zone.zoneStatus & 1) === 1;
          await this.setCapabilityValue('alarm_contact', open).catch(err => this.error('[REGISTER] alarm_contact set failed:', err.message));
  ...
  async configureStandardBatteryReporting() {
    try {
      ...
      endpoint.clusters.powerConfiguration.on('attr.batteryPercentageRemaining', async value => {
        ...
        if (this.hasCapability('measure_battery')) {
          await this.setCapabilityValue('measure_battery', parseFloat(percent)).catch(this.error);
        } else {
