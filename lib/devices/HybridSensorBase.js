      ...
      try {
        if (typeof iasCluster.readAttributes === 'function') {
          ...
          if (isNullCie) {
            ...
            this.log('[IAS] 🔧 Attempting auto-enrollment workaround...');
            
            // v5.5.776: Use Homey's built-in IAS Zone enrollment
            // Send zoneEnrollResponse to trigger device to use Homey as CIE
            try {
            ...
            // v5.5.776: Store flag to show user notification
