...
class BaseHybridDevice extends TuyaZigbeeDevice {
  ...
  async monitorBatteryThresholds(batteryLevel) {
    ...
    if (previousLevel > lowThreshold && batteryLevel <= lowThreshold && enableNotifications) {
      ...
      if (this.hasCapability('measure_battery')) {
        try {
          (() => { try { return (() => { try { return this.homey.flow.getTriggerCard('low_battery_warning'); } catch(e) { return null; } })(); } catch(e) { return null; } })()?.trigger(this, { device_name: this.getName(), battery_level: batteryLevel })
    ...
    if (previousLevel > criticalThreshold && batteryLevel <= criticalThreshold && enableNotifications) {
      ...
      if (this.hasCapability('measure_battery')) {
        try {
          (() => { try { return (() => { try { return this.homey.flow.getTriggerCard('critical_battery_warning'); } catch(e) { return null; } })(); } catch(e) { return null; } })()?.trigger(this, { device_name: this.getName(), battery_level: batteryLevel })
  ...
  async onSettings({ oldSettings, newSettings, changedKeys }) {
    ...
    if (changedKeys.includes('power_source')) {
      ...
      try {
        (() => { try { return (() => { try { return this.homey.flow.getTriggerCard('power_source_changed'); } catch(e) { return null; } })(); } catch(e) { return null; } })()?.trigger(this, { power_source: this.powerType.toLowerCase() })
      ...
      if (clusterName === 'onOff') {
        ...
        if (isButtonDevice) {
          ...
          if (typeof this.triggerButtonPress === 'function') {
            ...
            const flowTrigger = (() => { try { return (() => { try { return (() => { try { return (() => { try { return this.homey.flow.getTriggerCard(`button_${buttonIndex}_pressed`); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })();
            if (flowTrigger) {
