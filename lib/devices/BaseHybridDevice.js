  ...
  async _setupUniversalHybridMode() {
    ...
    try {
      ...
      if (tempCluster && this.hasCapability('measure_temperature')) {
        ...
        try {
          // CRITICAL: Setup listeners FIRST (non-blocking)
          ...
          this.log('[HYBRID] ✅ Temperature listener registered');
      ...
      if (humCluster && this.hasCapability('measure_humidity')) {
        ...
        try {
          ...
          this.log('[HYBRID] ✅ Humidity listener registered');
      ...
      if (powerCluster && this.hasCapability('measure_battery')) {
        ...
        try {
          ...
          this.log('[HYBRID] ✅ Battery listeners registered');
