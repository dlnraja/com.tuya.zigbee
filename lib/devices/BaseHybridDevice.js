...
class BaseHybridDevice extends ZigBeeDevice {
  ...
  async monitorBatteryThresholds(batteryLevel) {
    ...
    if (previousLevel > lowThreshold && batteryLevel <= lowThreshold && enableNotifications) {
      ...
      if (this.hasCapability('measure_battery')) {
        this.homey.flow.getTriggerCard().trigger(this { device_name: this.getName(), battery_level: batteryLevel })
  ...
  async onSettings({ oldSettings, newSettings, changedKeys }) {
    ...
    if (changedKeys.includes('power_source')) {
      ...
      this.homey.flow.getTriggerCard().trigger(this { power_source: this.powerType.toLowerCase() })
      ...
      if (clusterName === 'onOff') {
        ...
        if (isButtonDevice) {
          ...
          if (typeof this.triggerButtonPress === 'function') {
            ...
            const flowTrigger = this.homey.flow.getTriggerCard(`button_${buttonIndex}_pressed`);
            if (flowTrigger) {
