...
const DriverMappingLoader = require('../utils/DriverMappingLoader');
 ...
 */
class BaseHybridDevice extends TuyaZigbeeDevice {
  ...
  constructor(...args) {
    ...
    // v5.13.1: TRACKERS for universal _safeSetCapability (moved from HybridSensorBase)
    // v5.13.1: TRACKERS for universal _safeSetCapability (moved from HybridSensorBase)
  ...
  /**
   * Safe helper to retrieve flow trigger cards without crashing
   * v7.0.22: Replaces redundant nested try-catch blocks
   */
  _getFlowCard(id, type = 'trigger') {
    try {
      ...
      this.error(`[FLOW-SAFE] Failed to load ${type} card ${id}:`, err.message);
    }
    return null;
  }
  ...
  async triggerCapabilityListener(capability, value, options = {}) {
    ...
    if (capability.startsWith('onoff')) {
      ...
      // Fallback for drivers that don't use HybridSwitchBase but have onoff.X
  ...
  async onNodeInit({ zclNode }) {
    ...
    try {
      ...
      // v7.0.21: Defensive property normalization (Fixes "is not a function" crashes)
      // Supports legacy _tuyaEF00Manager and case-insensitive tuyaEF00manager
      this._tuyaEF00Manager = this.tuyaEF00Manager;
      this.tuyaEF00manager = this.tuyaEF00Manager;
  ...
  getDpFromCapability(capability) {
    ...
    const MAP = {
      'onoff': 1,
      'onoff.gang1': 1, 'onoff.gang2': 2, 'onoff.gang3': 3, 'onoff.gang4': 4,
...
Object.assign(BaseHybridDevice.prototype, CapabilityManagerMixin);
Object.assign(BaseHybridDevice.prototype, CoreCapabilityMixin);
Object.assign(BaseHybridDevice.prototype, VirtualEnergyMeterMixin);
Object.assign(BaseHybridDevice.prototype, SmartFeatureEmulationMixin);
Object.assign(BaseHybridDevice.prototype, NaturalLightMixin);
Object.assign(BaseHybridDevice.prototype, ZigbeeHealthMixin);
Object.assign(BaseHybridDevice.prototype, MultiGangMixin({}).constructor.prototype); // Proper class-based mixin apply
