...
const SAFE_CLUSTERS = {
  ...
  0x0702: { cap: 'meter_power', attr: 'currentSummationDelivered', xform: v => v / 1000 }, // Metering
  0x0B04: { cap: 'measure_power', attr: 'activePower', xform: v => v / 10 }, // Electrical measurement
};
