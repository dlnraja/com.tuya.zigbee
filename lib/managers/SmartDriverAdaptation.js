...
class SmartDriverAdaptation {
  ...
  async analyzeClusters(deviceInfo) {
    ...
    const isUsbOutlet =
      (deviceInfo.modelId && usbOutletProductIds.some(id => containsCI(deviceInfo.modelId, id))) ||
      (deviceInfo.manufacturer && usbOutletManufacturers.some(id => containsCI(deviceInfo.manufacturer, id))) ||
