    ...
    if (value !== null && value !== undefined) {
      ...
      if (unreliable) {
        ...
        if (!distOk) {
          ...
          const luxOk = luxFresh && this.state.luxChangeRate > this.params.luxChangeRateThreshold;
          if (luxOk) {
            this.state.lastActivityTime = now;
            ...
            this.state.lastInferenceTime = now;
            if (this.device.log) {
              this.device.log('[INFERENCE] DP1 unreliable true corroborated by lux rate (P2595)');
            }
            return true;
          }
