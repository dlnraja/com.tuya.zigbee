'use strict';
/**
 * UniversalDPSender v5.7.29 - Audited & Improved
 * Types: bool, enum, bitmap(1-8bytes+BigInt), value(1-4bytes), string, raw
 */
...
class UniversalDPSender {
  ...
  _buildBuffer(v, t = 'value', o = {}) {
    ...
    const n = Number(v) || 0;
    const len = sz || (s ? (n >= -128 && n <= 127 ? 1 : n >= -32768 && n <= 32767 ? 2 : 4)
