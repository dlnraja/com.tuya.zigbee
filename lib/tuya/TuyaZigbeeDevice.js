...
class TuyaZigbeeDevice extends PhysicalButtonMixin(VirtualButtonMixin(ZigBeeDeviceWithDiagnostics)) {
  ...
  async onNodeInit({ zclNode } = {}) {
    ...
    // 🔘 v5.12.50 (backport P92.114): UNIVERSAL button.N UI listeners
   ...
   */
  /**
   * v5.12.50 (backport P92.114+115): UNIVERSAL button.N UI listeners +
   * bidirectional virtual/physical dedup (2s window).
   */
