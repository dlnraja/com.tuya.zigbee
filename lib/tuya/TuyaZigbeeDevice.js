...
class TuyaZigbeeDevice extends PhysicalButtonMixin(VirtualButtonMixin(ZigBeeDeviceWithDiagnostics)) {
  ...
  async initSmartManagers() {
    try {
      // WHY(P2673 Bastien-first): IntelligentEnergyAdapter BEFORE battery/energy managers —
      // every device class gets metered|approximate|battery|mains_sensor on this house box.
      try {
