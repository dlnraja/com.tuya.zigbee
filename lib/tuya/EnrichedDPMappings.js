...
const PRESENCE_SENSOR_DPS = {
  ...
  // v5.5.826: HOBEIAN ZG-204ZV Multi-sensor (PIR-based, NOT radar)
  // Source: Diagnostics Report 26-Jan-2026 + TS0601_EMERGENCY_FIX.js
  // Uses DIFFERENT DPs than radar sensors!
  ZG_204ZV: {
    ...
    4: { capability: 'measure_humidity', converter: 'raw', type: 'VALUE', name: 'humidity' },
    9: { capability: 'measure_luminance', converter: 'raw', type: 'VALUE', name: 'illuminance' },
...
const MANUFACTURER_DP_PROFILES = {
  ...
  // v5.5.826: HOBEIAN ZG-204ZV Multi-sensor (PIR + Temp/Humidity)
  // Source: Diagnostics Report 26-Jan-2026 - "no Temp and Humidity data"
  '_TZE200_3towulqd': { profile: PRESENCE_SENSOR_DPS.ZG_204ZV, type: 'pir_multi' },
