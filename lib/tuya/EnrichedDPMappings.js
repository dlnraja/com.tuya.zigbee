...
const PRESENCE_SENSOR_DPS = {
  ...
  // v5.5.920: HOBEIAN ZG-204ZL PIR-ONLY sensor (NO temp/humidity!)
  // Source: Z2M GitHub #12364, Blakadder - _TZE200_3towulqd is ZG-204ZL NOT ZG-204ZV
  // Peter_van_Werkhoven #1225: Device labeled ZG-204ZV but is actually ZG-204ZL
  ZG_204ZL: {
...
const MANUFACTURER_DP_PROFILES = {
  ...
  // v5.5.920: HOBEIAN ZG-204ZL PIR-ONLY sensor (NO temp/humidity!)
  // Source: Z2M GitHub #12364, Blakadder - _TZE200_3towulqd is ZG-204ZL NOT ZG-204ZV
  '_TZE200_3towulqd': { profile: PRESENCE_SENSOR_DPS.ZG_204ZL, type: 'pir_only' },
  '_tze200_3towulqd': { profile: PRESENCE_SENSOR_DPS.ZG_204ZL, type: 'pir_only' },
  '_TZE204_3towulqd': { profile: PRESENCE_SENSOR_DPS.ZG_204ZL, type: 'pir_only' },
  '_TZE200_1ibpyhdc': { profile: PRESENCE_SENSOR_DPS.ZG_204ZL, type: 'pir_only' },
  '_TZE200_bh3n6gk8': { profile: PRESENCE_SENSOR_DPS.ZG_204ZL, type: 'pir_only' },
