...
function mapDpToCapability(dpId, value, opts = {}) {
  ...
  try {
    ...
    case 6: // Voltage (V * 10)
      return { capability: 'measure_voltage', value:safeParse(Number(value), 10) };
      
    case 5: // Current (mA)
      return { capability: 'measure_current', value:safeParse(Number(value), 1000) };
      
    case 19: // Humidity (% * 10)
      return { capability: 'measure_humidity', value:safeParse(Number(value), 10) };
      
    case 18: // Temperature (Â°C * 10)
      return { capability: 'measure_temperature', value:safeParse(Number(value), 10) };
