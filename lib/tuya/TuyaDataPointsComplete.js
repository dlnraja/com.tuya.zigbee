 ...
 * - D:\Download\loic\* (LoÃ¯c's device data)
 * - Tuya Developer Platform documentation
 * - Community forum analysis (Peter, LoÃ¯c, etc.)
 * - Homey forum user devices
 * 
 * Clusters Tuya:
 * - CLUSTERS.TUYA_EF00 (CLUSTERS.TUYA_EF00): Tuya Manufacturer Cluster (standard)
...
class TuyaDataPointsComplete {
  ...
  static TUYA_CLUSTERS = {
    [CLUSTERS.TUYA_EF00]: {
      id: CLUSTERS.TUYA_EF00,
      hex: CLUSTERS.TUYA_EF00,
    ...
    0xE001: {
      ...
      discovered: 'LoÃ¯c BSEED data + ZHA',
      attributes: {
        0xD030: {
    ...
    0xED00: {
      ...
      discovered: 'LoÃ¯c curtain data + ZHA',
      attributes: {}
    },
    0x1888: {
      id: 6280,
