...
function mapTuyaDPToCapabilities(device, dp, value) {
  ...
  switch (dp) {
    ...
    // ══════════════════════════════════════════════════════════════════════════
    // DP 5: Alarm motor (curtains)
    // ══════════════════════════════════════════════════════════════════════════
    case 5:
      if (device.hasCapability('alarm_motor')) {
        device.setCapabilityValue('alarm_motor', !!value).catch(e => device.error('[DP-MAPPER] alarm_motor:', e.message));
      }
      break;
