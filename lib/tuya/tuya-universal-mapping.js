 ...
 *
 * Syst̬me ultra-complet de mapping entre:
 * - Tuya DataPoints (DPs)
...
const CLUSTER_CAPABILITY_MAP = {
  ...
  // Tuya Proprietary (CLUSTERS.TUYA_EF00)
  CLUSTERS.TUYA_EF00: {
    capability: 'dynamic', // D̩pend des DPs
    type: 'custom',
    writable: true,
...
/**
 * SOURCES REFERENCES
 * URLs et m̩thodologies pour chaque source
 */
const SOURCES = {
  'z2m': {
    name: 'Zigbee2MQTT',
    ...
    methodology: 'Converters Tuya avec DPs mapp̩s',
    priority: 1
  },
  'zha': {
  ...
  'blakadder': {
    ...
    methodology: 'Database devices avec specs compl̬tes',
    priority: 3
  },
  'johan': {
    name: 'Johan Bendz Tuya Zigbee',
    url: 'https://github.com/JohanBendz/com.tuya.zigbee',
    methodology: 'Homey App officielle, drivers valid̩s',
    priority: 4
  },
  'dlnraja': {
  ...
  'tuya': {
    ...
    methodology: 'Documentation officielle (limit̩e)',
    priority: 6
  },
  'homey-forum': {
  ...
  'zigbee-spec': {
    ...
    methodology: 'Sp̩cifications officielles clusters',
    priority: 8
  }
};
