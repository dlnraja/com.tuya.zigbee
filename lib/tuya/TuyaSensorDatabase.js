...
const SENSOR_CONFIGS = {
  ...
  'MTG075_ZB_RL_RELAY': {
    sensors: [
      '_TZE204_sbyx0lm6', '_TZE204_clrdrnya', '_TZE204_dtzziy1e', '_TZE204_iaeejhvf',
      '_TZE204_mtoaryre', '_TZE200_mp902om5', '_TZE204_pfayrzcw', '_TZE284_4qznlkbu',
    ...
    // WHY(P2575/#2247 diag 8d9d0199 @ 9.0.1021): trust DP1; soft-clear sticky bathroom
    // WHY(P2577): antiFalsePositive + sticky-DP1 ignore after soft-clear
    // WHY(P2579 / Z2M MTG075/MTG235): heal occupied; quantized distance
  ...
  'ZY_M100_CEILING_24G': {
    ...
    // WHY(P2597): DP101 find_switch OFF → lux OK / distance null (GH#550)
  ...
  // P2421: aligned with Z2M herdsman ZG-204ZM
  'HOBEIAN_ZG204ZM': {
    sensors: [
      'HOBEIAN',
      '_TZE200_2aaelwxk', '_TZE200_kb5noeto', '_TZE200_tyffvoij', '_TZE200_yflzeeqj',
    ],
    modelId: 'ZG-204ZM',
    battery: true,
    useZcl: true,
  ...
  'HOBEIAN_ZG302ZM': {
    ...
    dpMap: {
      ...
      102: { cap: null, setting: 'switch2' },
      103: { cap: null, setting: 'switch3' },
  ...
  'HOBEIAN_ZG302ZL': {
    ...
    dpMap: {
      ...
      2: { cap: null, setting: 'switch2' },
      3: { cap: null, setting: 'switch3' },
