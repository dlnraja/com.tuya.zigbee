...
class TuyaDPFlowCardManager {
  ...
  _triggerThresholdCard(dp, value, threshold) {
    try {
      const card = (() => { try { return this.homey.flow.getTriggerCard('tuya_dp_threshold_crossed'); } catch(e) { return null; } })();
      if (card) {
        card.trigger(this.device, {
  ...
  _registerConditionCards() {
    const conditionCard = (() => { try { return this.homey.flow.getConditionCard('tuya_dp_value_is'); } catch(e) { return null; } })();
  ...
  _registerActionCards() {
    const actionCard = (() => { try { return this.homey.flow.getActionCard('tuya_dp_set'); } catch(e) { return null; } })();
