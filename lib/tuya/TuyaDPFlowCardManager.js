...
class TuyaDPFlowCardManager {
  ...
  _triggerGenericDPCard(dp, value, dataType, enumMapping) {
    ...
    try {
      const card = (() => { try { return (() => { try { return (() => { try { return (() => { try { return this.homey.flow.getDeviceTriggerCard(cardId); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })(); } catch (e) { this.error('[FLOW-SAFE] Failed to load card:', e.message); return null; } })();
      if (card) {
  ...
  _triggerThresholdCard(dp, value, threshold) {
    try {
      const card = (() => { try { return this.homey.flow.getDeviceTriggerCard('tuya_dp_threshold_crossed'); } catch(e) { return null; } })();
      if (card) {
        card.trigger(this.device, {
  ...
  _registerConditionCards() {
      const conditionCard = (() => { try { return this.homey.flow.getDeviceConditionCard('tuya_dp_value_is'); } catch(e) { return null; } })();
  ...
  _registerActionCards() {
      const actionCard = (() => { try { return this.homey.flow.getDeviceActionCard('tuya_dp_set'); } catch(e) { return null; } })();
