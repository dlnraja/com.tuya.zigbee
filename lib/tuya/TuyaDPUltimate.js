  ...
  static DEVICE_PROFILES = {
    ...
    'presence_radar': {
      ...
      dps: {
        ...
        6: { capability: 'measure_luminance.distance', type: 'value', scale: 100, unit: 'm', name: 'target_distance' },
    ...
    'presence_mmwave': {
      ...
      dps: {
        ...
        6: { capability: 'measure_luminance.distance', type: 'value', scale: 100, name: 'detected_distance' },
    ...
    'thermostat_trv': {
      ...
      dps: {
        ...
        101: { capability: 'dim.valve', type: 'value', min: 0, max: 100, name: 'valve' },
    ...
    'vibration_sensor': {
      ...
      dps: {
        1: { capability: 'alarm_generic.vibration', type: 'bool', name: 'vibration' },
