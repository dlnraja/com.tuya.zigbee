...
// v5.5.383: COMPREHENSIVE Time format constants - ALL POSSIBLE FORMATS
const TIME_FORMATS = {
  // === EPOCH-BASED FORMATS (4-8 bytes) ===
  ...
  TUYA_MCU: 'tuya_mcu',                 // 9 bytes: [Type, Len, YY, MM, DD, HH, MM, SS, Weekday]
  ...
  TUYA_UTC_STRING: 'tuya_utc_string',   // 7 bytes: UTC time [YY, MM, DD, HH, MM, SS, Weekday]

  // === SPECIAL FORMATS ===
  TUYA_GATEWAY: 'tuya_gateway',         // 12 bytes: Gateway format with full year
