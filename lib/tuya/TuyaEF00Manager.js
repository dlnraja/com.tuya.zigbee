      ...
      if (TuyaBoundCluster) {
        try {
          ...
          if (endpoint) {
            ...
            // Try multiple cluster names - Athom uses string cluster names
            // 'tuyaSpecific' is the NAME from our TuyaSpecificCluster.js
            const clusterNames = ['tuyaSpecific', 'manuSpecificTuya', 'tuya', 'tuyaManufacturer', 61184, 0xEF00];
            let bound = false;
