...
class TuyaEF00Manager extends EventEmitter {
   ...
   * P102: canonical name; alias queryAllDatapoints ≡ requestAllDPs
   */
  async requestAllDPs(options = {}) {
    try {
      ...
      if (!sent) {
        ...
        return this.requestDP(1, options);
      }
  ...
  /** @deprecated Prefer requestAllDPs — kept for TuyaZigbeeDevice callers */
