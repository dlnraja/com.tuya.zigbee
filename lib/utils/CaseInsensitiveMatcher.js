...
module.exports = {
  ...
  generateCaseVariants: TU.generateCaseVariants,
  pairingCaseVariants: TU.pairingCaseVariants,
  pairingProductIdVariants: TU.pairingProductIdVariants,
  brandAthomForms: TU.brandAthomForms,
  mergeManufacturerCaseVariants: TU.mergeManufacturerCaseVariants,
  hasPairingCaseCoverage: TU.hasPairingCaseCoverage,
};
