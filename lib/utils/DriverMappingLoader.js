...
class DriverMappingLoader {
  ...
  loadDatabase() {
    try {
      ...
      rawData = null; // Explicitly free string buffer memory immediately (GC micro-optimization)
      ...
      this._log('[DRIVER-MAPPING] ✅ Database loaded successfully');
      ...
      this._error('[DRIVER-MAPPING] ❌ Failed to load database:', err.message);
      this.database = { devices: {}, parsers: {}, driver_rules: {} };
    }
  }
