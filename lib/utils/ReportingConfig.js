...
class ReportingConfig {
  ...
  static getConfig(capabilityId) {
    const ATTRS = {
      ...
      'alarm_motion': {
        minInterval: 5,        //  CRITICAL: Min 5s prevents flooding
      ...
      'measure_temperature': {
        ...
        minChange: 50          // 0.5Â°C (Zigbee: 0.01Â°C units)
      },
