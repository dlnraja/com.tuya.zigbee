...
class ClusterDPDatabase {
  ...
  static ZIGBEE_CLUSTERS = {
    ...
    TUYA_EF00: { id: CLUSTERS.TUYA_EF00, name: 'tuyaManufacturer', decimal: CLUSTERS.TUYA_EF00, description: 'Tuya Manufacturer Cluster (standard DP tunnel)' },
  ...
  static TUYA_DATAPOINTS = {
    ...
    DP101: {
      ...
      description: 'Temperature (Â°C * 10)'
    },
    DP102: {
      id: 102,
      name: 'humidity',
    ...
    DP201: {
      ...
      description: 'Target temperature (Â°C * 10)'
    },
    DP202: {
      id: 202,
