...
async function safeReadCluster(cluster, attrs = [], timeoutMs = 5000) {
  try {
    ...
    const timeoutPromise = new Promise((_, reject) => {
      (this && this.homey && typeof this.homey.setTimeout === 'function' ? this.homey : globalThis).setTimeout(() => { if (this._destroyed) {return;} reject(new Error('Timeout: Expected Response')); }, timeoutMs);
    });
