...
/**
 * P2306 / P2351 / P2373 / P2480 — Soft-fail ManagerDrivers.getDriver for foreign driver IDs.
 *
...
function shouldSoftFail(driverId, err) {
  ...
  return (
    ...
    || /^LLC\d/i.test(id)
    || /^SML\d/i.test(id)
    // WHY(P2373/P2480): Homey class name used as driver ID
