...
// v2026-07-12: Import from extracted module to break circular dep with lib/helpers/device_helpers.js
const { isTuyaDP } = require('./tuya-dp-detector');
...
async function safeAutoMigrate(device, recommendedDriverId, confidence = 0, reason = '') {
  ...
  const deviceInfo = {
    modelId: data.modelId || data.zb_model_id || data.productId || '',
