...
// console.warn(`[TUYA-DP] Unknown datatype: ${datatype}`);
      ...
      // --- v5.12.0: Smart Adaptation & Anomaly Heuristics ---
      // 1. Battery Anomaly (Some Tuya devices report 1000 for 100%)
      if ((dp === 14 || dp === 15 || dp === 4) && typeof value === 'number' && value > 100 && value <= 1000) {
        value = Math.floor(value / 10);
      }
      // 2. Temperature Anomaly (Negative temps wrapped as unsigned ints)
      // If temperature is reported as > 60000, it is usually a wrapped 16-bit negative number
      if ((dp === 3 || dp === 1) && typeof value === 'number' && value > 4000) {
        if (value > 60000) value = value - 65536; 
        else if (value > 4000000000) value = value - 4294967296; 
      }
