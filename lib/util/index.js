...
function debounce(fn, interval, immediate = false) {
  ...
  return function debounced(...args) {
    ...
    timeout = (this && this.homey && typeof this.homey.setTimeout === 'function' ? this.homey : globalThis).setTimeout(later, interval);
...
async function wait(timeout) {
  ...
  return new Promise(resolve => (this && this.homey && typeof this.homey.setTimeout === 'function' ? this.homey : globalThis).setTimeout(resolve, timeout));
}
