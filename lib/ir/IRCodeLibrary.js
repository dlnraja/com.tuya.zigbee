...
// P2487: Pronto / Broadlink live in IRFormatConverter (SSOT)
const {
  prontoToZosungBase64: prontoToBase64,
  broadlinkToZosungBase64: broadlinkToBase64,
  normalizeCode: normalizeIRCode,
  detectFormat: detectIRFormat,
...
class IRCodeLibrary{
  ...
  // Public exposure of converters (P2487 → IRFormatConverter)
  convertProntoToBase64(pronto) { return prontoToBase64(pronto); }
  convertBroadlinkToBase64(bl) { return broadlinkToBase64(bl); }
  normalizeCode(input, opts) { return normalizeIRCode(input, opts); }
  detectFormat(input) { return detectIRFormat(input); }
}
