...
const SETTING_ATTR_MAP = Object.freeze({
  ...
  motion_detection_distance: { attr: ATTR.motionDistance, attrName: 'motionDetectionDistance', coerce: (v) => clampInt(v, 0, 600) },
  led_indicator: { attr: ATTR.ledIndicator, attrName: 'ledIndicator', coerce: (v) => (v ? 1 : 0) },
