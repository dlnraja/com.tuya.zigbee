...
class SmartDeviceDiscovery {
  ...
  buildPatterns() {
    return {
      ...
      manufacturerPatterns: {
        ...
        climate: /_TZE200_.*temp|_TZE200_.*humid/i,
        curtain: /_TZE200_.*curtain|_TZE200_.*blind/i,
        dimmer: /_TZ3210_.*dim/i,
  ...
  async identifyDevice(discoveryData) {
    ...
    const identification = {
      ...
      type: 'unknown',
      model: discoveryData?.modelId || 'unknown',
      suggestedDriver: 'generic_zigbee_device',
      capabilities: [],
      clusters: [],
      gangs: 1
    };
