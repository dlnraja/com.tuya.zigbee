...
class SmartCoordinator extends EventEmitter {
  ...
  start() {
    ...
    this._presenceTimer = (this.homey && typeof this.homey.setInterval === 'function' ? this.homey : globalThis).setInterval(() => { if (this._destroyed) {return;} this.presenceEngine.update(); }, 60000);
