...
function findBestDriver(device, drivers) {
  ...
  for (const driver of drivers) {
    const supportedMfrs = driver.zigbee?.manufacturerName || [] : null;
    const supportedProducts = driver.zigbee?.productId || [] : null;
