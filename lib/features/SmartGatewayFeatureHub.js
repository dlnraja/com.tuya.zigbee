...
/**
 * SmartGatewayFeatureHub (P2563–P2566) — branding-free gateway smart features.
...
class SmartGatewayFeatureHub {
  ...
  enableSoftFeature(vectorId, ctx) {
    this._ensure();
    return this.recipes?.enable?.(vectorId, ctx) || { ok: false, reason: 'no_runner' };
  }
