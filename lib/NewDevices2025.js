...
const NEW_TUYA_2025 = {
  ...
  climate: {
    ...
    '_TZE200_vvmbj46n': { model: 'ZTH08', type: 'temp_humidity_soil', driver: 'climate_sensor_soil' },
  ...
  // Soil Sensors
  soil: {
    '_TZE200_vvmbj46n': { model: 'TS0601_soil', type: 'soil', driver: 'climate_sensor_soil' },
    '_TZE200_myd45weu': { model: 'ZY-GS01', type: 'soil', driver: 'climate_sensor_soil' },
    '_TZE200_ga1maeof': { model: 'TS0601_soil_v2', type: 'soil', driver: 'climate_sensor_soil' },
    '_TZE284_hjxqcglr': { model: 'ZY-GS02', type: 'soil_2025', driver: 'climate_sensor_soil' }
  },
  ...
  plugs: {
    '_TZE200_3p5ydos3': { model: 'TS011F_plug', type: 'plug_energy', driver: 'socket_plug_1gang' },
  ...
  for (const [brand, manufacturers] of Object.entries(NEW_OTHER_2025)) {
    for (const [mfr, models] of Object.entries(manufacturers)) {
      for (const [model, device] of Object.entries(models)) {
        if (model === modelId || device.model === modelId) {
