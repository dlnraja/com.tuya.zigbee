...
const FINGERPRINT_DB = {
  ...
  '_TZ3000_jjdkhueq|TS0002': { driver: 'switch_2gang', protocol: 'zcl', powerSource: 'mains', endpoints: [1, 2], notes: 'NovaDigital/Zemismart 2-gang; keep off 1-gang' },
  '_TZ3000_lwthnp7j|TS0004': { driver: 'switch_4gang', protocol: 'zcl', powerSource: 'mains', endpoints: [1, 2, 3, 4], notes: 'Zemismart/NovaDigital 4-gang ZCL; not EF00 TS0601' },
  ...
  '_TZ3000_ok0ggpk7|TS0003': { driver: 'switch_3gang', protocol: 'zcl', powerSource: 'mains', endpoints: [1, 2, 3], notes: 'NovaDigital NFZB-03 sibling of fawk5xjv; not 1-gang' },
  '_TZ3000_f09j9qjb|TS0003': { driver: 'switch_3gang', protocol: 'zcl', powerSource: 'mains', endpoints: [1, 2, 3], notes: '3-gang ZCL; not 2-gang or climate' },
  '_TZ3000_vjhcenzo|TS0003': { driver: 'switch_3gang', protocol: 'zcl', powerSource: 'mains', endpoints: [1, 2, 3], notes: '3-gang ZCL; not climate' },
