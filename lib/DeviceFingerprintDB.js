...
const FINGERPRINT_DB = {
  '_TZE200_aqnazj70|TS0601': { driver: 'switch_4gang', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'onoff.1', 2: 'onoff.2', 3: 'onoff.3', 4: 'onoff.4' }, notes: 'Tuya TS0601 4-gang switch module' },
  '_tze200_aqnazj70|TS0601': { driver: 'switch_4gang', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'onoff.1', 2: 'onoff.2', 3: 'onoff.3', 4: 'onoff.4' }, notes: 'Tuya TS0601 4-gang switch module' },
  '_TZE200_AQNAZJ70|TS0601': { driver: 'switch_4gang', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'onoff.1', 2: 'onoff.2', 3: 'onoff.3', 4: 'onoff.4' }, notes: 'Tuya TS0601 4-gang switch module' },
  '_TZE200_dfxkcots|TS0601': { driver: 'wall_dimmer_tuya', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'onoff', 2: 'dim/1000' }, notes: 'Tuya TS0601 rotary smart dimmer' },
  '_tze200_dfxkcots|TS0601': { driver: 'wall_dimmer_tuya', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'onoff', 2: 'dim/1000' }, notes: 'Tuya TS0601 rotary smart dimmer' },
  '_TZE200_DFXKCOTS|TS0601': { driver: 'wall_dimmer_tuya', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'onoff', 2: 'dim/1000' }, notes: 'Tuya TS0601 rotary smart dimmer' },
  '_TZE200_fjjbhx9d|TS0601': { driver: 'dimmer_2_gang_tuya', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'onoff.1', 2: 'dim.1/1000', 7: 'onoff.2', 8: 'dim.2/1000' }, notes: 'Tuya TS0601 2-gang smart dimmer switch' },
  '_tze200_fjjbhx9d|TS0601': { driver: 'dimmer_2_gang_tuya', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'onoff.1', 2: 'dim.1/1000', 7: 'onoff.2', 8: 'dim.2/1000' }, notes: 'Tuya TS0601 2-gang smart dimmer switch' },
  '_TZE200_FJJBHX9D|TS0601': { driver: 'dimmer_2_gang_tuya', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'onoff.1', 2: 'dim.1/1000', 7: 'onoff.2', 8: 'dim.2/1000' }, notes: 'Tuya TS0601 2-gang smart dimmer switch' },
  '_TZE200_mexisfik|TS0601': { driver: 'switch_4gang', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'onoff.1', 2: 'onoff.2', 3: 'onoff.3', 4: 'onoff.4' }, notes: 'Tuya TS0601 4-gang wall switch' },
  '_tze200_mexisfik|TS0601': { driver: 'switch_4gang', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'onoff.1', 2: 'onoff.2', 3: 'onoff.3', 4: 'onoff.4' }, notes: 'Tuya TS0601 4-gang wall switch' },
  '_TZE200_MEXISFIK|TS0601': { driver: 'switch_4gang', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'onoff.1', 2: 'onoff.2', 3: 'onoff.3', 4: 'onoff.4' }, notes: 'Tuya TS0601 4-gang wall switch' },
  '_TZE200_p0gzbqct|TS0601': { driver: 'wall_dimmer_tuya', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'onoff', 2: 'dim/1000' }, notes: 'Forum Henk de Boom #671 Rotary smart knob dimmer TS0601' },
  '_tze200_p0gzbqct|TS0601': { driver: 'wall_dimmer_tuya', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'onoff', 2: 'dim/1000' }, notes: 'Forum Henk de Boom #671 Rotary smart knob dimmer TS0601' },
  '_TZE200_P0GZBQCT|TS0601': { driver: 'wall_dimmer_tuya', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'onoff', 2: 'dim/1000' }, notes: 'Forum Henk de Boom #671 Rotary smart knob dimmer TS0601' },
  '_TYZB01_qeqvmvti|TS0011': { driver: 'switch_1gang', protocol: 'zcl', powerSource: 'mains', notes: 'Tuya TS0011 1-gang light switch' },
  '_tyzb01_qeqvmvti|TS0011': { driver: 'switch_1gang', protocol: 'zcl', powerSource: 'mains', notes: 'Tuya TS0011 1-gang light switch' },
  '_TYZB01_QEQVMVTI|TS0011': { driver: 'switch_1gang', protocol: 'zcl', powerSource: 'mains', notes: 'Tuya TS0011 1-gang light switch' },
  '_TZ3000_mmkbptmx|TS0004': { driver: 'switch_4gang', protocol: 'zcl', powerSource: 'mains', notes: 'Forum Melectro #646 4-gang wall switch TS0004' },
  '_tz3000_mmkbptmx|TS0004': { driver: 'switch_4gang', protocol: 'zcl', powerSource: 'mains', notes: 'Forum Melectro #646 4-gang wall switch TS0004' },
  '_TZ3000_MMKBPTMX|TS0004': { driver: 'switch_4gang', protocol: 'zcl', powerSource: 'mains', notes: 'Forum Melectro #646 4-gang wall switch TS0004' },
  '_TZ3000_ruxexjfz|TS0002': { driver: 'switch_2gang', protocol: 'zcl', powerSource: 'mains', notes: 'Forum Melectro #647 2-gang wall switch TS0002' },
  '_tz3000_ruxexjfz|TS0002': { driver: 'switch_2gang', protocol: 'zcl', powerSource: 'mains', notes: 'Forum Melectro #647 2-gang wall switch TS0002' },
  '_TZ3000_RUXEXJFZ|TS0002': { driver: 'switch_2gang', protocol: 'zcl', powerSource: 'mains', notes: 'Forum Melectro #647 2-gang wall switch TS0002' },
  '_TZE200_2ekuz3dz|TS0601': { driver: 'wall_thermostat', protocol: 'tuya_dp', powerSource: 'mains', dp: { 16: 'target_temperature/10', 24: 'measure_temperature/10' }, notes: 'Forum Melectro #650 Beok/Moes X5H-GB-B smart thermostat' },
  '_tze200_2ekuz3dz|TS0601': { driver: 'wall_thermostat', protocol: 'tuya_dp', powerSource: 'mains', dp: { 16: 'target_temperature/10', 24: 'measure_temperature/10' }, notes: 'Forum Melectro #650 Beok/Moes X5H-GB-B smart thermostat' },
  '_TZE200_2EKUZ3DZ|TS0601': { driver: 'wall_thermostat', protocol: 'tuya_dp', powerSource: 'mains', dp: { 16: 'target_temperature/10', 24: 'measure_temperature/10' }, notes: 'Forum Melectro #650 Beok/Moes X5H-GB-B smart thermostat' },
  '_TZ3000_3dfewsk1|TS0207': { driver: 'water_leak_sensor', protocol: 'zcl', powerSource: 'battery', notes: 'Forum Roy1 #649 Water flood sensor TS0207' },
  '_tz3000_3dfewsk1|TS0207': { driver: 'water_leak_sensor', protocol: 'zcl', powerSource: 'battery', notes: 'Forum Roy1 #649 Water flood sensor TS0207' },
  '_TZ3000_3DFEWSK1|TS0207': { driver: 'water_leak_sensor', protocol: 'zcl', powerSource: 'battery', notes: 'Forum Roy1 #649 Water flood sensor TS0207' },
  '_TZ3000_wkai4ga5|TS0042': { driver: 'button_wireless_2', protocol: 'zcl', powerSource: 'battery', notes: 'Forum Rob_G #653 2-gang wireless button/scene switch TS0042' },
  '_tz3000_wkai4ga5|TS0042': { driver: 'button_wireless_2', protocol: 'zcl', powerSource: 'battery', notes: 'Forum Rob_G #653 2-gang wireless button/scene switch TS0042' },
  '_TZ3000_WKAI4GA5|TS0042': { driver: 'button_wireless_2', protocol: 'zcl', powerSource: 'battery', notes: 'Forum Rob_G #653 2-gang wireless button/scene switch TS0042' },
  '_TZE204_qasjif9e|TS0601': { driver: 'presence_sensor_radar', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'alarm_motion', 104: 'measure_luminance' }, notes: 'Forum G4nd41f #654 ZY-M100 mmWave radar presence' },
  '_tze204_qasjif9e|TS0601': { driver: 'presence_sensor_radar', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'alarm_motion', 104: 'measure_luminance' }, notes: 'Forum G4nd41f #654 ZY-M100 mmWave radar presence' },
  '_TZE204_QASJIF9E|TS0601': { driver: 'presence_sensor_radar', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'alarm_motion', 104: 'measure_luminance' }, notes: 'Forum G4nd41f #654 ZY-M100 mmWave radar presence' },
  '_TZE204_sxm7l9xa|TS0601': { driver: 'presence_sensor_radar', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'alarm_motion', 104: 'measure_luminance' }, notes: 'Forum G4nd41f ZY-M100-S mmWave radar presence' },
  '_tze204_sxm7l9xa|TS0601': { driver: 'presence_sensor_radar', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'alarm_motion', 104: 'measure_luminance' }, notes: 'Forum G4nd41f ZY-M100-S mmWave radar presence' },
  '_TZE204_SXM7L9XA|TS0601': { driver: 'presence_sensor_radar', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'alarm_motion', 104: 'measure_luminance' }, notes: 'Forum G4nd41f ZY-M100-S mmWave radar presence' },
  '_TZE200_3p5ydos3|TS0601': { driver: 'wall_dimmer_tuya', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'onoff', 2: 'dim/1000' }, notes: 'Forum Ferenc_Szasz #660 BSEED smart dimmer switch' },
  '_tze200_3p5ydos3|TS0601': { driver: 'wall_dimmer_tuya', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'onoff', 2: 'dim/1000' }, notes: 'Forum Ferenc_Szasz #660 BSEED smart dimmer switch' },
  '_TZE200_3P5YDOS3|TS0601': { driver: 'wall_dimmer_tuya', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'onoff', 2: 'dim/1000' }, notes: 'Forum Ferenc_Szasz #660 BSEED smart dimmer switch' },
  '_TZE204_zenj4lxv|TS0601': { driver: 'dimmer_2_gang_tuya', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'onoff.1', 2: 'dim.1/1000', 7: 'onoff.2', 8: 'dim.2/1000' }, notes: 'Forum Anders_Lim #661 Moes Star Ring 2-gang dimmer ZS-SR-EUD-2' },
  '_tze204_zenj4lxv|TS0601': { driver: 'dimmer_2_gang_tuya', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'onoff.1', 2: 'dim.1/1000', 7: 'onoff.2', 8: 'dim.2/1000' }, notes: 'Forum Anders_Lim #661 Moes Star Ring 2-gang dimmer ZS-SR-EUD-2' },
  '_TZE204_ZENJ4LXV|TS0601': { driver: 'dimmer_2_gang_tuya', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'onoff.1', 2: 'dim.1/1000', 7: 'onoff.2', 8: 'dim.2/1000' }, notes: 'Forum Anders_Lim #661 Moes Star Ring 2-gang dimmer ZS-SR-EUD-2' },
  '_TZB210_rkgngb5o|TS0502B': { driver: 'bulb_tunable_white', protocol: 'zcl', powerSource: 'mains', notes: 'Forum radiothieves #662 CCT tunable white bulb TS0502B' },
  '_tzb210_rkgngb5o|TS0502B': { driver: 'bulb_tunable_white', protocol: 'zcl', powerSource: 'mains', notes: 'Forum radiothieves #662 CCT tunable white bulb TS0502B' },
  '_TZB210_RKGNGb5O|TS0502B': { driver: 'bulb_tunable_white', protocol: 'zcl', powerSource: 'mains', notes: 'Forum radiothieves #662 CCT tunable white bulb TS0502B' },
  '_TZB210_rkgngb5o|TS0501B': { driver: 'led_controller_dimmable', protocol: 'zcl', powerSource: 'mains', notes: 'Forum radiothieves #662 Dimmable bulb TS0501B' },
  '_tzb210_rkgngb5o|TS0501B': { driver: 'led_controller_dimmable', protocol: 'zcl', powerSource: 'mains', notes: 'Forum radiothieves #662 Dimmable bulb TS0501B' },
  '_TZB210_RKGNGb5O|TS0501B': { driver: 'led_controller_dimmable', protocol: 'zcl', powerSource: 'mains', notes: 'Forum radiothieves #662 Dimmable bulb TS0501B' },
  '_TZE200_3towulqd|TS0601': { driver: 'presence_sensor_radar', protocol: 'tuya_dp', powerSource: 'battery', dp: { 1: 'alarm_motion', 104: 'measure_luminance' }, notes: 'Forum Janderek #663 ZG-204ZL motion & lux radar/PIR' },
  '_tze200_3towulqd|TS0601': { driver: 'presence_sensor_radar', protocol: 'tuya_dp', powerSource: 'battery', dp: { 1: 'alarm_motion', 104: 'measure_luminance' }, notes: 'Forum Janderek #663 ZG-204ZL motion & lux radar/PIR' },
  '_TZE200_3TOWULQD|TS0601': { driver: 'presence_sensor_radar', protocol: 'tuya_dp', powerSource: 'battery', dp: { 1: 'alarm_motion', 104: 'measure_luminance' }, notes: 'Forum Janderek #663 ZG-204ZL motion & lux radar/PIR' },
  '_TYZB01_6g8b7at8|TS0012': { driver: 'switch_2gang', protocol: 'zcl', powerSource: 'mains', notes: 'Forum Johan_Rossouw #665 2-gang switch TS0012' },
  '_tyzb01_6g8b7at8|TS0012': { driver: 'switch_2gang', protocol: 'zcl', powerSource: 'mains', notes: 'Forum Johan_Rossouw #665 2-gang switch TS0012' },
  '_TYZB01_6G8B7AT8|TS0012': { driver: 'switch_2gang', protocol: 'zcl', powerSource: 'mains', notes: 'Forum Johan_Rossouw #665 2-gang switch TS0012' },
  '_TZ3210_0zabbfax|TS0503B': { driver: 'light_bulb_rgb', protocol: 'zcl', powerSource: 'mains', notes: 'Forum RezaRose #666 USB RGB LED strip controller TS0503B' },
  '_tz3210_0zabbfax|TS0503B': { driver: 'light_bulb_rgb', protocol: 'zcl', powerSource: 'mains', notes: 'Forum RezaRose #666 USB RGB LED strip controller TS0503B' },
  '_TZ3210_0ZABBFAX|TS0503B': { driver: 'light_bulb_rgb', protocol: 'zcl', powerSource: 'mains', notes: 'Forum RezaRose #666 USB RGB LED strip controller TS0503B' },
  '_TZE204_ex3rcdha|TS0601': { driver: 'presence_sensor_radar', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'alarm_motion', 104: 'measure_luminance' }, notes: 'Forum #1379 / #31079 / Riccardo_Baro #5460 Human presence radar + luminance' },
  '_tze204_ex3rcdha|TS0601': { driver: 'presence_sensor_radar', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'alarm_motion', 104: 'measure_luminance' }, notes: 'Forum #1379 / #31079 / Riccardo_Baro #5460 Human presence radar + luminance' },
  '_TZE204_EX3RCDHA|TS0601': { driver: 'presence_sensor_radar', protocol: 'tuya_dp', powerSource: 'mains', dp: { 1: 'alarm_motion', 104: 'measure_luminance' }, notes: 'Forum #1379 / #31079 / Riccardo_Baro #5460 Human presence radar + luminance' },
  '_TZE200_yjjdcqsq|TS0601': { driver: 'climate_sensor', protocol: 'tuya_dp', powerSource: 'battery', dp: { 1: 'measure_temperature/10', 2: 'measure_humidity' }, notes: 'Forum #1379 / #31079 Temperature & humidity sensor TS0601' },
  '_tze200_yjjdcqsq|TS0601': { driver: 'climate_sensor', protocol: 'tuya_dp', powerSource: 'battery', dp: { 1: 'measure_temperature/10', 2: 'measure_humidity' }, notes: 'Forum #1379 / #31079 Temperature & humidity sensor TS0601' },
  '_TZE200_YJJDCQSQ|TS0601': { driver: 'climate_sensor', protocol: 'tuya_dp', powerSource: 'battery', dp: { 1: 'measure_temperature/10', 2: 'measure_humidity' }, notes: 'Forum #1379 / #31079 Temperature & humidity sensor TS0601' },
  '_TZE200_mja3fuja|TS0601': { driver: 'air_quality_comprehensive', protocol: 'tuya_dp', powerSource: 'mains', dp: { 2: 'measure_pm25', 18: 'measure_temperature/10', 19: 'measure_humidity', 21: 'measure_voc', 22: 'measure_co2' }, notes: 'Forum #1379 / #31079 Smart Air House Keeper' },
  '_tze200_mja3fuja|TS0601': { driver: 'air_quality_comprehensive', protocol: 'tuya_dp', powerSource: 'mains', dp: { 2: 'measure_pm25', 18: 'measure_temperature/10', 19: 'measure_humidity', 21: 'measure_voc', 22: 'measure_co2' }, notes: 'Forum #1379 / #31079 Smart Air House Keeper' },
  '_TZE200_MJA3FUJA|TS0601': { driver: 'air_quality_comprehensive', protocol: 'tuya_dp', powerSource: 'mains', dp: { 2: 'measure_pm25', 18: 'measure_temperature/10', 19: 'measure_humidity', 21: 'measure_voc', 22: 'measure_co2' }, notes: 'Forum #1379 / #31079 Smart Air House Keeper' },
  ...
  '_tze284_libht6ua|ts0601': { driver: 'curtain_motor', protocol: 'tuya_dp', powerSource: 'battery', dp: { 1: 'windowcoverings_state', 2: 'windowcoverings_set/100', 3: 'windowcoverings_set/100', 5: 'reverse_direction', 13: 'measure_battery' }, notes: 'Roller blind motor sibling to fodv6bkr' },
  '_TZE284_LIBHT6UA|ts0601': { driver: 'curtain_motor', protocol: 'tuya_dp', powerSource: 'battery', dp: { 1: 'windowcoverings_state', 2: 'windowcoverings_set/100', 3: 'windowcoverings_set/100', 5: 'reverse_direction', 13: 'measure_battery' }, notes: 'Roller blind motor sibling to fodv6bkr' },
  // WHY(P2462): same interview footprint as ysdv91bk — metering switch_1gang rejects pair → wall_1gang
  '_TZ3000_blhvsaqf|TS0001': { driver: 'wall_switch_1gang_1way', protocol: 'zcl', powerSource: 'mains', notes: 'P2462 GH#540 BSEED 1G ZCL — not metering switch_1gang' },
  '_tz3000_blhvsaqf|TS0001': { driver: 'wall_switch_1gang_1way', protocol: 'zcl', powerSource: 'mains', notes: 'P2462 GH#540' },
  '_TZ3000_BLHVSAQF|TS0001': { driver: 'wall_switch_1gang_1way', protocol: 'zcl', powerSource: 'mains', notes: 'P2462 GH#540' },
  '_tz3000_blhvsaqf|ts0001': { driver: 'wall_switch_1gang_1way', protocol: 'zcl', powerSource: 'mains', notes: 'P2462 GH#540' },
  '_TZ3000_BLHVSAQF|ts0001': { driver: 'wall_switch_1gang_1way', protocol: 'zcl', powerSource: 'mains', notes: 'P2462 GH#540' },
  '_tz3000_BLHVSAQF|TS0001': { driver: 'wall_switch_1gang_1way', protocol: 'zcl', powerSource: 'mains', notes: 'P2462 GH#540' },
  '_tz3000_BLHVSAQF|ts0001': { driver: 'wall_switch_1gang_1way', protocol: 'zcl', powerSource: 'mains', notes: 'P2462 GH#540' },
  // P2435 — GH #541–#544 endpoint pairing + sacred couples
  '_TZ3000_enmfaave|TS0004': { driver: 'switch_4gang', protocol: 'zcl', powerSource: 'mains', notes: 'P2435 GH#541 ZCL 4-gang; no EF00 required on compose' },
  '_tz3000_enmfaave|TS0004': { driver: 'switch_4gang', protocol: 'zcl', powerSource: 'mains', notes: 'P2435 GH#541 ZCL 4-gang; no EF00 required on compose' },
  '_tz3000_enmfaave|ts0004': { driver: 'switch_4gang', protocol: 'zcl', powerSource: 'mains', notes: 'P2435 GH#541 ZCL 4-gang; no EF00 required on compose' },
  '_TZ3000_xk5udnd6|TS0012': { driver: 'wall_switch_2gang_1way', protocol: 'zcl', powerSource: 'mains', notes: 'P2435/P2463 GH#542 — relay onoff only; never invent button.N / water_leak' },
  '_tz3000_xk5udnd6|TS0012': { driver: 'wall_switch_2gang_1way', protocol: 'zcl', powerSource: 'mains', notes: 'P2463 GH#542' },
  '_tz3000_xk5udnd6|ts0012': { driver: 'wall_switch_2gang_1way', protocol: 'zcl', powerSource: 'mains', notes: 'P2463 GH#542' },
  // WHY(P2463): Johan #468 / Z2M SPM01 energy monitor — was wrongly on curtain_motor
  '_TZE200_bcusnqt8|TS0601': { driver: 'power_clamp_meter', protocol: 'tuya_dp', powerSource: 'mains', notes: 'P2463 SPM01 smart energy monitor — never curtain' },
  '_tze200_bcusnqt8|TS0601': { driver: 'power_clamp_meter', protocol: 'tuya_dp', powerSource: 'mains', notes: 'P2463 SPM01' },
  '_tze200_bcusnqt8|ts0601': { driver: 'power_clamp_meter', protocol: 'tuya_dp', powerSource: 'mains', notes: 'P2463 SPM01' },
  '_TZE200_BCUSNQT8|TS0601': { driver: 'power_clamp_meter', protocol: 'tuya_dp', powerSource: 'mains', notes: 'P2463 SPM01' },
  '_TZ3000_ptjcjise|TS0002': { driver: 'wall_switch_2gang_1way', protocol: 'zcl', powerSource: 'mains', notes: 'P2456 GH#543 Moes wired EP1/EP2 — not switch_2gang button clutter' },
  '_tz3000_ptjcjise|TS0002': { driver: 'wall_switch_2gang_1way', protocol: 'zcl', powerSource: 'mains', notes: 'P2456 GH#543 Moes wired EP1/EP2 — not switch_2gang button clutter' },
  '_tz3000_ptjcjise|ts0002': { driver: 'wall_switch_2gang_1way', protocol: 'zcl', powerSource: 'mains', notes: 'P2456 GH#543 Moes wired EP1/EP2 — not switch_2gang button clutter' },
  '_TZ3000_l9brjwau|TS0002': { driver: 'wall_switch_2gang_1way', protocol: 'zcl', powerSource: 'mains', notes: 'P2455 GH#544 BSEED wired EP1/EP2 — not switch_2gang button clutter' },
  '_tz3000_l9brjwau|TS0002': { driver: 'wall_switch_2gang_1way', protocol: 'zcl', powerSource: 'mains', notes: 'P2455 GH#544 BSEED wired EP1/EP2 — not switch_2gang button clutter' },
  '_tz3000_l9brjwau|ts0002': { driver: 'wall_switch_2gang_1way', protocol: 'zcl', powerSource: 'mains', notes: 'P2455 GH#544 BSEED wired EP1/EP2 — not switch_2gang button clutter' },
  // VicHY #2224/#2227 MTG075 220V AC ceiling mmWave presence radar
  '_TZE204_clrdrnya|TS0601': { driver: 'presence_sensor_radar', protocol: 'tuya_dp', powerSource: 'mains', notes: 'VicHY #2224/#2227 MTG075 mmWave radar 220V' },
  '_tze204_clrdrnya|TS0601': { driver: 'presence_sensor_radar', protocol: 'tuya_dp', powerSource: 'mains', notes: 'VicHY #2224/#2227 MTG075 mmWave radar 220V' },
  '_TZE204_CLRDRNYA|TS0601': { driver: 'presence_sensor_radar', protocol: 'tuya_dp', powerSource: 'mains', notes: 'VicHY #2224/#2227 MTG075 mmWave radar 220V' },
  '_tze204_clrdrnya|ts0601': { driver: 'presence_sensor_radar', protocol: 'tuya_dp', powerSource: 'mains', notes: 'VicHY #2224/#2227 MTG075 mmWave radar 220V' },
  '_TZE200_clrdrnya|TS0601': { driver: 'presence_sensor_radar', protocol: 'tuya_dp', powerSource: 'mains', notes: 'VicHY #2224/#2227 MTG075 mmWave radar 220V' },
  '_tze200_clrdrnya|TS0601': { driver: 'presence_sensor_radar', protocol: 'tuya_dp', powerSource: 'mains', notes: 'VicHY #2224/#2227 MTG075 mmWave radar 220V' },
  '_TZE284_clrdrnya|TS0601': { driver: 'presence_sensor_radar', protocol: 'tuya_dp', powerSource: 'mains', notes: 'VicHY #2224/#2227 MTG075 mmWave radar 220V' },
  '_tze284_clrdrnya|TS0601': { driver: 'presence_sensor_radar', protocol: 'tuya_dp', powerSource: 'mains', notes: 'VicHY #2224/#2227 MTG075 mmWave radar 220V' },
  // Gmail diagnostic reports missing FPs (typo / truncated variants)
  '_TZ3000_dpo1ysaak|TS011F': { driver: 'plug', protocol: 'zcl', powerSource: 'mains', notes: 'Gmail diag typo for dpo1ysak' },
  '_tz3000_dpo1ysaak|ts011f': { driver: 'plug', protocol: 'zcl', powerSource: 'mains', notes: 'Gmail diag typo for dpo1ysak' },
  '_TZ3000_fa9mlvjaa|TS0041': { driver: 'remote_button_wireless', protocol: 'zcl', powerSource: 'battery', notes: 'Gmail diag typo for fa9mlvja' },
  '_tz3000_fa9mlvjaa|ts0041': { driver: 'remote_button_wireless', protocol: 'zcl', powerSource: 'battery', notes: 'Gmail diag typo for fa9mlvja' },
  '_TZ3210_ngqk6jiaa|TS110E': { driver: 'wall_dimmer_tuya', protocol: 'zcl', powerSource: 'mains', notes: 'Gmail diag typo for ngqk6jia' },
  '_tz3210_ngqk6jiaa|ts110e': { driver: 'wall_dimmer_tuya', protocol: 'zcl', powerSource: 'mains', notes: 'Gmail diag typo for ngqk6jia' },
  '_TZ3210_w0qqde|TS011F': { driver: 'plug_energy_monitor', protocol: 'zcl', powerSource: 'mains', notes: 'Gmail diag prefix for w0qqde0g' },
  '_tz3210_w0qqde|ts011f': { driver: 'plug_energy_monitor', protocol: 'zcl', powerSource: 'mains', notes: 'Gmail diag prefix for w0qqde0g' },
  '_TZ321C_fkziha|TS0225': { driver: 'presence_sensor_radar', protocol: 'hybrid', powerSource: 'mains', notes: 'Gmail diag prefix for fkzihaxe8' },
  '_tz321c_fkziha|ts0225': { driver: 'presence_sensor_radar', protocol: 'hybrid', powerSource: 'mains', notes: 'Gmail diag prefix for fkzihaxe8' },
  ...
  // WHY(P2452 / GH#545): verified couple is TS0001 on switch_1gang — do not invent TS0002→wall_switch_2gang.
  '_TZ3000_ysdv91bk|TS0001': { driver: 'wall_switch_1gang_1way', protocol: 'zcl', powerSource: 'mains', notes: 'P2460 GH#545 BSEED 1G ZCL Identify+E000/E001 — not metering switch_1gang' },
  '_tz3000_ysdv91bk|TS0001': { driver: 'wall_switch_1gang_1way', protocol: 'zcl', powerSource: 'mains', notes: 'P2460 GH#545' },
  '_tz3000_ysdv91bk|ts0001': { driver: 'wall_switch_1gang_1way', protocol: 'zcl', powerSource: 'mains', notes: 'P2460 GH#545' },
  '_TZ3000_YSDV91BK|TS0001': { driver: 'wall_switch_1gang_1way', protocol: 'zcl', powerSource: 'mains', notes: 'P2460 GH#545' },
  ...
  '_TZE200_hewlydpz|TS0601': { driver: 'wall_switch_4_gang_tuya', protocol: 'tuya_dp', dpProfile: 'SIMPLE_4GANG_BL7', powerSource: 'mains', notes: 'P2485 Z2M Homeetec 4-gang DP1-4 + backlight DP7' },
  '_TZE204_hewlydpz|TS0601': { driver: 'wall_switch_4_gang_tuya', protocol: 'tuya_dp', dpProfile: 'COLORED_4GANG', powerSource: 'mains', notes: 'P2485 Z2M TS0601_4gang_7ytnacie sibling' },
  '_TZE204_7ytnacie|TS0601': { driver: 'wall_switch_4_gang_tuya', protocol: 'tuya_dp', dpProfile: 'COLORED_4GANG', powerSource: 'mains', notes: 'P2485 colored backlight 4-gang' },
  '_TZE204_rkbxtclc|TS0601': { driver: 'switch_3gang', protocol: 'tuya_dp', dpProfile: 'COLORED_3GANG', powerSource: 'mains', notes: 'P2485 Z2M TS0601_3gang_rkbxtclc' },
  ...
  '_TZE284_xnbkhhdr|TS0601': { driver: 'wall_thermostat', protocol: 'tuya_dp', notes: 'P2463 Johan#1345 / Z2M ZWT198 wall thermostat — not TRV' },
  '_tze284_xnbkhhdr|TS0601': { driver: 'wall_thermostat', protocol: 'tuya_dp', notes: 'P2463 ZWT198' },
  '_tze284_xnbkhhdr|ts0601': { driver: 'wall_thermostat', protocol: 'tuya_dp', notes: 'P2463 ZWT198' },
  '_TZE204_xnbkhhdr|TS0601': { driver: 'wall_thermostat', protocol: 'tuya_dp', notes: 'P2463 ZWT198 sibling' },
  '_tze204_xnbkhhdr|TS0601': { driver: 'wall_thermostat', protocol: 'tuya_dp', notes: 'P2463 ZWT198 sibling' },
  '_TZE204_gkfbdvyx|TS0601': { driver: 'presence_sensor_radar', protocol: 'tuya_dp', powerSource: 'mains', notes: 'P2463 Johan#1322 Wenzhi 24GHz mmWave' },
  '_tze204_gkfbdvyx|TS0601': { driver: 'presence_sensor_radar', protocol: 'tuya_dp', powerSource: 'mains', notes: 'P2463' },
  '_tze204_gkfbdvyx|ts0601': { driver: 'presence_sensor_radar', protocol: 'tuya_dp', powerSource: 'mains', notes: 'P2463' },
  '_TZE200_gkfbdvyx|TS0601': { driver: 'presence_sensor_radar', protocol: 'tuya_dp', powerSource: 'mains', notes: 'P2463 TZE200 sibling' },
  '_tze200_gkfbdvyx|TS0601': { driver: 'presence_sensor_radar', protocol: 'tuya_dp', powerSource: 'mains', notes: 'P2463' },
  ...
  // P2671 HOBEIAN fleet locks (Z2M sync)
  ...
  '_TZ3000_vdfwjopk|TS0219': { driver: 'siren', protocol: 'zcl', powerSource: 'mains', notes: 'P2466 Johan#1455 Cleverio SA100 IAS WD — not handheld_remote' },
  '_tz3000_vdfwjopk|TS0219': { driver: 'siren', protocol: 'zcl', powerSource: 'mains', notes: 'P2466 Johan#1455' },
  '_tz3000_vdfwjopk|ts0219': { driver: 'siren', protocol: 'zcl', powerSource: 'mains', notes: 'P2466 Johan#1455' },
  ...
  '_TZ3000_402vrq2i|TS004F': { driver: 'smart_knob', protocol: 'zcl', powerSource: 'battery', dpProfile: null, notes: 'P2448 ZHA#5261 rotary — command/dimmer 0x8004; not 4-gang metering' },
  
  // P2453 Gmail/GH couple locks
  '_TZ3000_ja5osu5g|TS004F': { driver: 'smart_knob', protocol: 'zcl', dpProfile: null, notes: 'P2453 ZHA/Z2M 1-btn TS004F scene sibling of kaflzta4' },
  '_tz3000_ja5osu5g|TS004F': { driver: 'smart_knob', protocol: 'zcl', dpProfile: null, notes: 'P2453 ZHA/Z2M 1-btn TS004F scene sibling of kaflzta4' },
  '_TZ3000_an5rjiwd|TS0041': { driver: 'button_wireless_1', protocol: 'zcl', dpProfile: null, notes: 'P2453 Johan #1128 / ZHA TS0041 1-btn — not button_wireless_4' },
  '_tz3000_an5rjiwd|TS0041': { driver: 'button_wireless_1', protocol: 'zcl', dpProfile: null, notes: 'P2453 Johan #1128 / ZHA TS0041 1-btn — not button_wireless_4' },
  '_TZ3000_5tqxpine|TS0044': { driver: 'scene_switch_4', protocol: 'zcl', dpProfile: null, notes: 'P2453 Z2M iHseno 4-btn wall TS0044 — not button_wireless_4' },
  '_tz3000_5tqxpine|TS0044': { driver: 'scene_switch_4', protocol: 'zcl', dpProfile: null, notes: 'P2453 Z2M iHseno 4-btn wall TS0044 — not button_wireless_4' },
  '_TZ3000_wkai4ga5|TS0044': { driver: 'scene_switch_4', protocol: 'zcl', dpProfile: null, notes: 'P2328/P2453 Moes/SunBeech TS0044 scene' },
  '_TZ3000_kaflzta4|TS004F': { driver: 'smart_knob', protocol: 'zcl', dpProfile: null, notes: 'P2439 Johan #1365 / diag a342c411 — 1-endpoint TS004F scene button; force event 0x8004 (not rotary knob)' },
  '_TZ3000_qja6nq5z|TS004F': { driver: 'smart_knob_rotary', protocol: 'zcl', dpProfile: null, notes: 'P2448 ERS-10 rotary; command/dimmer + levelControl; never scene-force' },
  ...
  '_TZ3000_gwkzibhs|TS004F': { driver: 'smart_knob_rotary', protocol: 'zcl', dpProfile: null, notes: 'P2448 ERS-10 rotary; command/dimmer + levelControl' },
  '_TZ3000_ugi8ky6u|TS004F': { driver: 'smart_knob_rotary', protocol: 'zcl', dpProfile: null, notes: 'P2448 TS004F rotary knob variant; command/dimmer' },
  '_TZ3000_csflgqj2|TS004F': { driver: 'smart_knob_rotary', protocol: 'zcl', powerSource: 'battery', notes: 'P2448 rotary; command/dimmer' },
  '_TZ3000_pzui3skt|TS004F': { driver: 'smart_knob_rotary', protocol: 'zcl', powerSource: 'battery', notes: 'P2448 rotary; command/dimmer' },
  '_TZ3000_pcqjmcud|TS004F': { driver: 'smart_knob_rotary', protocol: 'zcl', powerSource: 'battery', notes: 'P2448 rotary; command/dimmer' },
  '_TZ3000_uri7ber7|TS004F': { driver: 'smart_knob_switch', protocol: 'zcl', powerSource: 'battery', notes: 'P2448 smart_knob_switch; command/dimmer default' },
  ...
  '_TZ3000_adndolvx|TS0041': { driver: 'button_wireless_1', protocol: 'zcl_0xfd', powerSource: 'battery', notes: 'P2639 HA T455202 phantom 4-EP → button_wireless_1' },
  '_TZ3000_itb0omhv|TS0041': { driver: 'button_wireless_1', protocol: 'zcl_0xfd', powerSource: 'battery', notes: 'P2639 HA T455202 sibling phantom 4-EP' },
  '_TZ3000_x7mej5oc|TS0041': { driver: 'button_wireless_1', protocol: 'zcl_0xfd', powerSource: 'battery', notes: 'P2639 ZHA#1557 phantom 4-EP' },
  '_TZ3000_axpdxqgu|TS0041': { driver: 'button_wireless_1', protocol: 'zcl_0xfd', powerSource: 'battery', notes: 'P2638 Moes Star Ring / Bastien — Z2M#25720 ZHA 0041TO CR2032 no E000' },
  '_tz3000_axpdxqgu|TS0041': { driver: 'button_wireless_1', protocol: 'zcl_0xfd', powerSource: 'battery', notes: 'P2638 case twin' },
  ...
  // WHY(P2464): FrankEver FK-BV05 / FK_V02 family — never thermostat (was mis-locked on 1n2zev06)
  '_TZE200_1n2zev06|TS0601': { driver: 'water_valve_smart', protocol: 'tuya_dp', powerSource: 'mains', notes: 'FrankEver smart water valve (ZHA#2633); forbid thermostat_tuya_dp' },
  '_TZE200_nbqnmkee|TS0601': { driver: 'water_valve_smart', protocol: 'tuya_dp', powerSource: 'mains', notes: 'FrankEver FK-BV05 flow+temp valve (Z2M)' },

  '_TZE200_zo0cfekv|TS0601': { driver: 'wall_switch_3gang_1way', protocol: 'tuya_dp', powerSource: 'mains', dp: { 24: 'onoff', 25: 'onoff.gang2', 26: 'onoff.gang3' }, notes: 'Moes Star Feather SFL02-Z-3 EU (Johan#1457 / Z2M); forbid climate_sensor' },
  '_TZE200_tzyy0rtq|TS0601': { driver: 'wall_switch_3gang_1way', protocol: 'tuya_dp', powerSource: 'mains', dp: { 24: 'onoff', 25: 'onoff.gang2', 26: 'onoff.gang3' }, notes: 'Moes Star Feather SFL02-Z-3 US sibling' },
  '_TZE200_rd8cdssd|TS0601': { driver: 'wall_switch_3gang_1way', protocol: 'tuya_dp', powerSource: 'mains', dp: { 24: 'onoff', 25: 'onoff.gang2', 26: 'onoff.gang3' }, notes: 'Nova Digital / Moes Star Feather 3-gang whiteLabel' },
  '_TZE200_wt9agwf3|TS0601': { driver: 'water_valve_smart', protocol: 'tuya_dp', powerSource: 'mains', notes: 'FrankEver FK-V02 (Johan#1458); forbid valve_irrigation 4-way' },
  '_TZE200_5uodvhgc|TS0601': { driver: 'water_valve_smart', protocol: 'tuya_dp', powerSource: 'mains', notes: 'FrankEver FK-V02 sibling' },
  ...
  '_TZ3000_g9g2xnch|TS004F': { driver: 'smart_knob', protocol: 'zcl', powerSource: 'battery', notes: 'P2448 ZG-101ZD / YSR-MINI-Z rotary; command/dimmer — not mains 1-gang' },
  ...
  '_TZ3000_uri7ongn|TS004F': { driver: 'smart_knob', protocol: 'zcl', powerSource: 'battery', notes: 'P2448 ERS-10TZBVK-AA / ZG-101ZD rotary; command/dimmer 0x8004; never power_meter' },
  '_TZ3000_ixla93vd|TS004F': { driver: 'smart_knob', protocol: 'zcl', powerSource: 'battery', notes: 'P2448 ERS-10 sibling; command/dimmer' },
