...
const FINGERPRINT_DB = {
  ...
  '_TZ3000_mrduubod|TS0014': { driver: 'wall_switch_4gang_1way', type: 'switch', protocol: 'zcl', dpProfile: null, powerSource: 'mains', endpoints: [1, 2, 3, 4], notes: 'Moes/BSEED 4G TS0014, Homey forum #2099: Basic reports battery but device is mains wall switch' },
  ...
  // ─────────────────────────────────────────────────────────────────────────
  '_TZ3210_jlf1nepw|TS011F': { driver: 'plug_energy_monitor', type: 'plug', protocol: 'zcl', powerSource: 'mains', notes: 'Johan #1408 power-monitoring plug: keep live metering on plug_energy_monitor' },
  '_TZE28C1000000_81yrt3lo|TS0601': { driver: 'power_clamp_meter', type: 'energy_meter', protocol: 'tuya_dp', dpProfile: 'PJ1203A_2CH', powerSource: 'mains', notes: 'Johan #1424 PJ-1203A dual-channel electricity monitor variant' },
  ...
  'Wing|TS0201': { driver: 'climate_sensor', protocol: 'zcl', dpProfile: null, powerSource: 'battery', notes: 'Johan #1422 ZTH13-3.0 ZCL temp/humidity/display sensor' },
  'Zbeacon|TH01': { driver: 'climate_sensor', protocol: 'zcl', dpProfile: null, powerSource: 'battery', notes: 'Johan #1423 Z3-P3-L_G7 ZCL temp/humidity sensor' },
  ...
  // SOIL SENSORS
  // ─────────────────────────────────────────────────────────────────────────
  '_TZE200_myd45weu|TS0601': { driver: 'soil_sensor', protocol: 'tuya_dp', dpProfile: 'SOIL_STANDARD', dp: { 3: 'measure_humidity.soil', 5: 'measure_temperature/10', 15: 'measure_battery' }, notes: 'Soil temperature/moisture sensor, Zigbee2MQTT #27346' },
  ...
  '_TZE284_myd45weu|TS0601': { driver: 'soil_sensor', protocol: 'tuya_dp', dpProfile: 'SOIL_STANDARD', dp: { 3: 'measure_humidity.soil', 5: 'measure_temperature/10', 15: 'measure_battery' }, notes: 'Homey forum #2097, Zigbee2MQTT #27346' },
  '_TZE284_aao3yzhs|TS0601': { driver: 'soil_sensor', protocol: 'tuya_dp', dpProfile: 'SOIL_STANDARD', dp: { 3: 'measure_humidity.soil', 5: 'measure_temperature/10', 15: 'measure_battery' }, notes: 'GitHub #1341' },
  ...
  '_TZE200_xtrnjaoz|TS0601': { driver: 'curtain_motor', type: 'cover', protocol: 'tuya_dp', dpProfile: 'COVER_STANDARD', powerSource: 'mains', notes: 'xtrnjaoz tubular motor family; keep away from climate_sensor' },
  '_TZE204_xtrnjaoz|TS0601': { driver: 'curtain_motor', type: 'cover', protocol: 'tuya_dp', dpProfile: 'COVER_STANDARD', powerSource: 'mains', notes: 'Johan #1425 GM25TEQ-TYZ tubular motor; not climate_sensor' },
