...
const FINGERPRINT_DB = {
  ...
  '_TZE200_pay2byax|TS0601': { driver: 'contact_sensor_zigbee', protocol: 'tuya_dp', powerSource: 'battery', notes: 'P2201 P126-safe; TS0601 not on contact_sensor' },
  '_TZE204_pay2byax|TS0601': { driver: 'contact_sensor_zigbee', protocol: 'tuya_dp', powerSource: 'battery', notes: 'TZE204 sibling P2201' },
  ...
  // WHY(P2285): SH-SC07 1-button — never button_wireless_4_ts0041 (phantom EP interview)
  '_TZ3000_mrpevh8p|TS0041': { driver: 'button_wireless_1', protocol: 'zcl', powerSource: 'battery', notes: 'P2285 Z2M SH-SC07/Johan#1120' },
  '_TZ3000_5bpeda8u|TS0041': { driver: 'button_wireless_1', protocol: 'zcl', powerSource: 'battery', notes: 'P2285 SH-SC07 sibling' },
  '_TZ3000_b4awzgct|TS0041': { driver: 'button_wireless_1', protocol: 'zcl', powerSource: 'battery', notes: 'P2285 was 4_ts0041 misroute' },
  ...
  '_TZ3000_18ejxno0|TS0042': { driver: 'scene_switch_wall', protocol: 'zcl', powerSource: 'battery' },
  '_TZ3000_18ejxno0|TS0043': { driver: 'scene_switch_wall', protocol: 'zcl', powerSource: 'battery' },
  ...
  '_TZ3000_kfu8zapd|TS0044': { driver: 'button_wireless_4', protocol: 'zcl', dpProfile: null, endpoints: [1, 2, 3, 4], notes: 'Moes TS0044 4-button scene remote, OnOff 0xFD action path' },
  '_TZ3000_xffhmvhv|TS004F': { driver: 'button_wireless_4', protocol: 'zcl', dpProfile: null, endpoints: [1, 2, 3, 4], notes: 'Nobø SWS-IZ — skip 0x8004; OnOff 0xFD path' },
  '_TZ3000_4upl1fcj|TS0041': { driver: 'button_wireless_1', protocol: 'zcl', powerSource: 'battery', notes: 'SunBeech — TS0041 remote NOT switch_1gang' },
  '_TZ3000_zgyzgdua|TS0044': { driver: 'scene_switch_4', protocol: 'zcl', dpProfile: null, endpoints: [1, 2, 3, 4], notes: 'meter91 Moes XH-SY-04Z genOnOff 0xFD; skip 0x8004' },
  ...
  '_TZ3000_k6fvknrr|TS011F': { driver: 'double_power_point_2', protocol: 'zcl', dpProfile: null, notes: '2-endpoint on/off TS011F; not switch_1gang' },
  ...
  '_TZE204_wfxuhoea|TS0601': { driver: 'garage_door', protocol: 'tuya_dp', dpProfile: 'GARAGE' },
  'Wing|TS0203': { driver: 'contact_sensor', protocol: 'zcl', dpProfile: null, notes: 'Wing TS0203 door/window; not water leak' },
  'Wing|ZTH11-3.0': { driver: 'climate_sensor', protocol: 'zcl', dpProfile: null },
  'Wing|ZTH13-3.0': { driver: 'climate_sensor', protocol: 'zcl', dpProfile: null },
  'HOBEIAN|ZG-305Z': { driver: 'switch_2gang', protocol: 'zcl', dpProfile: null, notes: 'MHCOZY/HOBEIAN 2ch USB switch' },
  ...
  '_TZE284_m1cvyneb|TS0601': { driver: 'wall_dimmer_tuya', protocol: 'tuya_dp', dpProfile: 'DIMMER', powerSource: 'mains', dp: { 1: 'onoff', 2: 'dim/1000' }, notes: 'BSEED Click 1-gang EF00 dimmer; not climate/soil' },
  ...
  '_TZ3000_k4ej3ww2|TS0207': { driver: 'water_leak_sensor', protocol: 'ias_zone', powerSource: 'battery', notes: 'HOBEIAN/Aubess IH-K665 IAS Zone sleepy; never EF00 water/rain/repeater' },
  '_TZ3000_5k5vh43t|TS0207': { driver: 'zigbee_repeater', protocol: 'zcl', powerSource: 'mains', notes: 'TS0207 repeater couple; not water leak from pid alone' },
  '_TZ3000_okaz9tjs|TS011F': { driver: 'plug_energy_monitor', protocol: 'zcl', powerSource: 'mains', notes: 'Energy plug fw 1.0.5+ electrical poll' },
  '_TZE284_nt4pquef|TS0601': { driver: 'soil_sensor', protocol: 'tuya_dp', dpProfile: 'SOIL', powerSource: 'battery', dp: { 2: 'light_enum', 3: 'measure_humidity.soil', 5: 'measure_temperature/10', 9: 'temperature_unit', 15: 'measure_battery' }, notes: 'SGS02Z retail; DP2 illuminance enum not moisture' },
  '_TZ3000_qeuvnohg|TS011F': { driver: 'din_rail_switch', protocol: 'zcl', powerSource: 'mains' },
  '_TZE284_6ocnqlhn|TS0601': { driver: 'din_rail_meter', protocol: 'tuya_dp', powerSource: 'mains', notes: 'Tongou TO-Q-SYS-JZT; forbid smart_rcbo; re-pair after update' },
...
const PRODUCT_ID_DEFAULTS = {
  ...
  'TS011F': { driver: null, type: 'plug', notes: 'Requires manufacturerName — plug vs DIN vs strip; never invent couple' },
  ...
  'ZG-305Z': { driver: 'switch_2gang', type: 'switch', notes: 'HOBEIAN/MHCOZY 2-channel USB switch' },
  'SNZB-03': { driver: 'motion_sensor', type: 'sensor' },
  'TS0205': { driver: 'smoke_sensor', type: 'sensor' },
  'TS0207': { driver: null, type: 'sensor', notes: 'Requires manufacturerName — water leak vs repeater vs rain; never invent couple' },
