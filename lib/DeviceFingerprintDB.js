...
const FINGERPRINT_DB = {
  ...
  '_TZE284_hodyryli|TS0601': { driver: 'climate_sensor', protocol: 'tuya_dp', dpProfile: 'CLIMATE_ZT08', powerSource: 'battery', dp: { 1: 'measure_temperature/10', 2: 'measure_humidity', 3: 'measure_battery', 38: 'measure_temperature.probe/10' }, notes: 'GH #513 ZT08: DP3 battery_state 0/1/2, DP38 probe ×10' },
  '_TZE284_hodyryli|TS0201': { driver: 'climate_sensor', protocol: 'zcl', powerSource: 'battery', notes: 'GitHub #513 ZCL fallback for hodyryli variant' },
...
class DeviceFingerprintDB {
  ...
  static _heuristicLookup(manufacturerName, productId) {
    ...
    const match = FingerprintMatcher.matchFingerprint(manufacturerName, null, candidates);
    if (!match) {return null;}

    const compoundKey = match.entry;
    return {
