...
const FINGERPRINT_DB = {
  ...
  '_TZ3000_BLHVSAQF|TS0001': { driver: 'wall_switch_1gang_1way', protocol: 'zcl', powerSource: 'mains', notes: 'P2462 GH#540' },
  '_tz3000_blhvsaqf|ts0001': { driver: 'wall_switch_1gang_1way', protocol: 'zcl', powerSource: 'mains', notes: 'P2462 GH#540' },
  '_tz3000_blhvsaqf|ts0001': { driver: 'switch_1gang', protocol: 'zcl', powerSource: 'mains', notes: 'Issue #540 / P2435 BSEED 1-gang ZCL' },
  '_TZ3000_BLHVSAQF|ts0001': { driver: 'switch_1gang', protocol: 'zcl', powerSource: 'mains', notes: 'Issue #540 / P2435 BSEED 1-gang ZCL' },
  ...
  '_tz3000_enmfaave|TS0004': { driver: 'switch_4gang', protocol: 'zcl', powerSource: 'mains', notes: 'P2435 GH#541 ZCL 4-gang; no EF00 required on compose' },
  '_tz3000_enmfaave|ts0004': { driver: 'switch_4gang', protocol: 'zcl', powerSource: 'mains', notes: 'P2435 GH#541 ZCL 4-gang; no EF00 required on compose' },
  '_TZ3000_xk5udnd6|TS0012': { driver: 'wall_switch_2gang_1way', protocol: 'zcl', powerSource: 'mains', notes: 'P2435 GH#542 — never water_leak_sensor' },
  '_tz3000_xk5udnd6|TS0012': { driver: 'wall_switch_2gang_1way', protocol: 'zcl', powerSource: 'mains', notes: 'P2435 GH#542 — never water_leak_sensor' },
  '_tz3000_xk5udnd6|ts0012': { driver: 'wall_switch_2gang_1way', protocol: 'zcl', powerSource: 'mains', notes: 'P2435 GH#542 — never water_leak_sensor' },
  ...
  '_tz3000_ja5osu5g|TS004F': { driver: 'smart_knob', protocol: 'zcl', dpProfile: null, notes: 'P2453 ZHA/Z2M 1-btn TS004F scene sibling of kaflzta4' },
  '_TZ3000_an5rjiwd|TS0041': { driver: 'button_wireless_1', protocol: 'zcl', dpProfile: null, notes: 'P2453 Johan #1128 / ZHA TS0041 1-btn' },
  '_tz3000_an5rjiwd|TS0041': { driver: 'button_wireless_1', protocol: 'zcl', dpProfile: null, notes: 'P2453 Johan #1128 / ZHA TS0041 1-btn' },
  '_TZ3000_5tqxpine|TS0044': { driver: 'scene_switch_4', protocol: 'zcl', dpProfile: null, notes: 'P2453 Z2M iHseno 4-btn wall TS0044' },
  '_tz3000_5tqxpine|TS0044': { driver: 'scene_switch_4', protocol: 'zcl', dpProfile: null, notes: 'P2453 Z2M iHseno 4-btn wall TS0044' },
