...
/**
 * Pre-Pairing Compatibility Check - UX #90 / P2498
 *
 * Soft advisories only. Homey owns Zigbee radio pairing — we cannot swap
 * drivers mid-pair. Identity = manufacturerName + productId (see
 * config/architecture/pairing-discovery-ssot.json + identity-fields-ssot).
 *
 * Checks device compatibility signals before/after interview:
 * - Sacred-couple recognition (mfr+pid)
 * - Firmware / protocol hints
 * - Required cluster support
 * - Network capacity hints
