...
class DPFragmentationHardening extends EventEmitter {
   ...
   */
  _startCleanup() {
    this._cleanupTimer = (this.homey && typeof this.homey.setInterval === 'function' ? this.homey : globalThis).setInterval(() => { if (this._destroyed) {return;} this._cleanup(); }, this.cleanupIntervalMs);
  }
