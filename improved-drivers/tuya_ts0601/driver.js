...
class TuyaTs0601Driver extends Homey.Driver {
   ...
   */
  onUninit() {
    this.log('TuyaTs0601Driver is unloading...');
  }
  ...
  _registerFlowCards() {
    // Action cards
    this.flowActionTurnOn = this.homey.flow.getActionCard('tuya_ts0601_turn_on');
    this.flowActionTurnOn.registerRun(this._actionTurnOn.bind(this));
    
    this.flowActionTurnOff = this.homey.flow.getActionCard('tuya_ts0601_turn_off');
    this.flowActionTurnOff.registerRun(this._actionTurnOff.bind(this));
    
    this.flowActionToggle = this.homey.flow.getActionCard('tuya_ts0601_toggle');
    this.flowActionToggle.registerRun(this._actionToggle.bind(this));
    
    // Condition cards
    this.flowConditionIsOn = this.homey.flow.getConditionCard('tuya_ts0601_is_on');
    ...
    return [
      {
        name: 'Tuya TS0601',
        data: {
          id: '1195254e-398b-45c3-9117-c92f3090b163'
        },
        store: {
          // Add store data here
        },
