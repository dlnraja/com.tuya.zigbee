 ...
 * Vibration Sensor
 * 
 * @class TuyaTs0219Device
 * @extends {ZigbeeDevice}
 */
class TuyaTs0219Device extends ZigbeeDevice {
  /**
   * onInit is called when the device is initialized.
   */
  async onNodeInit() {
    this.log('TuyaTs0219Device has been initialized');
   ...
   */
  async onAdded() {
    this.log('TuyaTs0219Device has been added');
  }
  ...
  async onSettings({ oldSettings, newSettings, changedKeys }) {
    this.log('TuyaTs0219Device settings were changed:', changedKeys);
  ...
  async onRenamed(name) {
    this.log('TuyaTs0219Device was renamed to', name);
  }
   ...
   */
  async onDeleted() {
    this.log('TuyaTs0219Device has been deleted');
...
module.exports = TuyaTs0219Device;