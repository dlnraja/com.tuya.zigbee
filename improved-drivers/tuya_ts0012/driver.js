...
class TuyaTs0012Driver extends Homey.Driver {
   ...
   */
  onUninit() {
    this.log('TuyaTs0012Driver is unloading...');
  }
  ...
  _registerFlowCards() {
    // Action cards
    this.flowActionTurnOn = this.homey.flow.getActionCard('tuya_ts0012_turn_on');
    this.flowActionTurnOn.registerRun(this._actionTurnOn.bind(this));
    
    this.flowActionTurnOff = this.homey.flow.getActionCard('tuya_ts0012_turn_off');
    this.flowActionTurnOff.registerRun(this._actionTurnOff.bind(this));
    
    this.flowActionToggle = this.homey.flow.getActionCard('tuya_ts0012_toggle');
    this.flowActionToggle.registerRun(this._actionToggle.bind(this));
    
    // Condition cards
    this.flowConditionIsOn = this.homey.flow.getConditionCard('tuya_ts0012_is_on');
    ...
    return [
      {
        name: 'Tuya TS0012',
        data: {
          id: 'bb903cd9-0980-4f5a-b4da-b1f68fc7a534'
        },
        store: {
          // Add store data here
        },
