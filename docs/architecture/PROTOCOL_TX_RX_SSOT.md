...
- Sleepy IAS: skip leftover EF00 TX (`shouldSkipIasOnlyEf00Tx`)
- Brightness MCU 0–1000 via `TuyaBrightnessScale`

See also: [COMM_PATHFINDING.md](./COMM_PATHFINDING.md), [LAYERS_CAPABILITY_PROTOCOL.md](./LAYERS_CAPABILITY_PROTOCOL.md).
