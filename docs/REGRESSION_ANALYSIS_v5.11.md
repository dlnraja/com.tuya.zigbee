...
- **Root causes**: (1) No same-value dedup  00 always processed, (2) Change calc `currentLux > 0 ? ... : 100` returns 100% when both are 0, (3) Static mapping logged on every DP, (4) Per-event Tuya listener log
