...
[![Version](https://img.shields.io/badge/version-v5.11.101-blue)]()
[![Drivers](https://img.shields.io/badge/drivers-145-brightgreen)]()
[![Fingerprints](https://img.shields.io/badge/fingerprints-5,423+-green)]()
[![Users Tracked](https://img.shields.io/badge/users%20tracked-33+-purple)]()
[![Last Updated](https://img.shields.io/badge/updated-2026-03-09-lightgrey)]()

> **v5.11.101** | **5,423+ fingerprints** | **145 drivers** | **1,857 flow cards** | Updated 2026-03-09

---

## Fingerprint Verification

**Verified**: 81 fingerprints from user reports found in drivers
**Missing** (2): `_TZ3210_jic09i9a`, `_TZ3210_ogx8u9it`
...
| Version | Changes |
|---------|---------|
| **v5.11.101** | Universal Tuya Zigbee app v5.11.101 adds new device variants and updates 145 drivers with 5423 fi... |
...
| **v5.11.92** | Universal Tuya Zigbee app v5.11.92 adds new drivers and fingerprints, improving device compatibil... |
...
- **Total interviews recovered**: 126
- **Unique fingerprints**: 107
- **Sources**: {"github":95,"forum":31,"gmail":0,"forum-pm":0}
...
- **Topics monitored**: 5
- **Recent replies**: 2
- **Last reply**: 2026-03-08T21:03:42.303Z
...
| **Flow cards not working** | Update app to v5.11.101, recreate flow, check driver flow cards |
...
*Auto-generated on 2026-03-09 from v5.11.101 — 5,423+ fingerprints across 145 drivers*
