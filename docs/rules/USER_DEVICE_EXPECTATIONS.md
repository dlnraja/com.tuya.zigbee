...
[![Version](https://img.shields.io/badge/version-v5.11.138-blue)]()
...
[![Last Updated](https://img.shields.io/badge/updated-2026-03-23-lightgrey)]()

> **v5.11.138** | **4,732+ fingerprints** | **188 drivers** | **1,874 flow cards** | Updated 2026-03-23

---

## Fingerprint Verification

**Verified**: 85 fingerprints from user reports found in drivers
**Missing** (1): `_TZ3000_kxaow5ki`
...
| Version | Changes |
|---------|---------|
| **v5.11.138** | v5.11.132: Implemented batch close/respond state update for improved device management., No new f... |
| **v5.11.137** | v5.11.132: Implemented batch close/respond state update for improved device management., No new f... |
| **v5.11.136** | v5.11.132: Implemented batch close/respond state update for improved device management., No new f... |
| **v5.11.135** | v5.11.132: Implemented batch close/respond state update for improved device management., No new f... |
| **v5.11.134** | v5.11.132: Implemented batch close/respond state update for improved device management., No new f... |
| **v5.11.133** | v5.11.132: Implemented batch close/respond state update for improved device management., No new f... |
| **v5.11.132** | Updated Universal Tuya Zigbee app with batch state update feature. |
| **v5.11.131** | Universal Tuya Zigbee app v5.11.131 adds new device fingerprints and enhances multi-protocol bug ... |
| **v5.11.130** | Universal Tuya Zigbee app v5.11.130: Added new device fingerprints, fixed critical SDK compatibil... |
| **v5.11.129** | Universal Tuya Zigbee app v5.11.129 adds new device support and critical fixes for improved compa... |
...
- **False Battery Alert / Missing Battery** (27 reports, high priority): Set `get mainsPowered() { return true; }` and remove measure_battery in onNodeInit
- **Pairing Failure** (7 reports, high priority): Check driver.compose.json fingerprints, verify manufacturerName + productId
...
- **Device Not Responding** (4 reports, medium priority): Check Zigbee mesh, device routing, and cluster bindings
...
- **Total interviews recovered**: 153
- **Unique fingerprints**: 123
- **Sources**: {"github":121,"forum":32,"gmail":0,"forum-pm":0}
...
- **Topics monitored**: 5
- **Recent replies**: 7
- **Last reply**: 2026-03-15T21:13:05.180Z
...
| **Flow cards not working** | Update app to v5.11.138, recreate flow, check driver flow cards |
...
*Auto-generated on 2026-03-23 from v5.11.138 — 4,732+ fingerprints across 188 drivers*
