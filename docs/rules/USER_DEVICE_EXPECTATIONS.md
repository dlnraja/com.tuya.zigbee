...
[![Last Updated](https://img.shields.io/badge/updated-2026-03-25-lightgrey)]()

> **v5.11.138** | **4,732+ fingerprints** | **188 drivers** | **1,874 flow cards** | Updated 2026-03-25

---

## Fingerprint Verification

**Verified**: 87 fingerprints from user reports found in drivers
...
- **False Battery Alert / Missing Battery** (29 reports, high priority): Set `get mainsPowered() { return true; }` and remove measure_battery in onNodeInit
...
- **Total interviews recovered**: 156
- **Unique fingerprints**: 124
- **Sources**: {"github":123,"forum":33,"gmail":0,"forum-pm":0}
...
*Auto-generated on 2026-03-25 from v5.11.138 — 4,732+ fingerprints across 188 drivers*
