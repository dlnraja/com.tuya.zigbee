...
[![Version](https://img.shields.io/badge/version-v5.11.57-blue)]()
[![Drivers](https://img.shields.io/badge/drivers-145-brightgreen)]()
[![Fingerprints](https://img.shields.io/badge/fingerprints-5,406+-green)]()
[![Users Tracked](https://img.shields.io/badge/users%20tracked-33+-purple)]()
[![Last Updated](https://img.shields.io/badge/updated-2026-03-03-lightgrey)]()

> **v5.11.57** | **5,406+ fingerprints** | **145 drivers** | **1,829 flow cards** | Updated 2026-03-03

---

## Fingerprint Verification

**Verified**: 77 fingerprints from user reports found in drivers
...
| Version | Changes |
|---------|---------|
| **v5.11.57** | Universal Tuya Zigbee app v5.11.57 adds a new remote dimmer driver and fixes vibration sensor tri... |
| **v5.11.56** | Universal Tuya Zigbee app v5.11.56: Added remote dimmer driver, fixed vibration sensor triggers, ... |
| **v5.11.55** | Universal Tuya Zigbee app v5.11.55 adds a new remote dimmer driver and improves vibration sensor ... |
| **v5.11.54** | Universal Tuya Zigbee app v5.11.54: Added remote dimmer driver, fixed vibration sensor triggers, ... |
| **v5.11.53** | Universal Tuya Zigbee app v5.11.53 adds a new remote dimmer driver and improves Gmail token manag... |
| **v5.11.52** | Universal Tuya Zigbee app v5.11.52: Added remote dimmer driver, fixed vibration sensor triggers, ... |
| **v5.11.51** | Fixes for vibration sensor triggers and adds remote dimmer driver. 145 drivers, 4959 fingerprints. |
| **v5.11.50** | Universal Tuya Zigbee app v5.11.50 adds a new remote dimmer driver and improves Gmail diagnostics. |
| **v5.11.49** | Universal Tuya Zigbee app v5.11.49 adds a new remote dimmer driver and a GitHub Deep Search engin... |
| **v5.11.48** | Added remote dimmer driver for Lidl HG06323 TS1001 and GitHub Deep Search engine for Zigbee proje... |
...
- **Total interviews recovered**: 117
- **Unique fingerprints**: 102
- **Sources**: {"github":90,"forum":27,"gmail":0,"forum-pm":0}
...
| **Flow cards not working** | Update app to v5.11.57, recreate flow, check driver flow cards |
...
*Auto-generated on 2026-03-03 from v5.11.57 — 5,406+ fingerprints across 145 drivers*
