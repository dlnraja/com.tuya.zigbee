...
[![Last Updated](https://img.shields.io/badge/updated-2026-03-26-lightgrey)]()

> **v5.11.138** | **4,732+ fingerprints** | **188 drivers** | **1,874 flow cards** | Updated 2026-03-26

---

## Fingerprint Verification

**Verified**: 88 fingerprints from user reports found in drivers
...
- **False Battery Alert / Missing Battery** (30 reports, high priority): Set `get mainsPowered() { return true; }` and remove measure_battery in onNodeInit
- **Pairing Failure** (8 reports, high priority): Check driver.compose.json fingerprints, verify manufacturerName + productId
...
- **Total interviews recovered**: 157
- **Unique fingerprints**: 125
- **Sources**: {"github":124,"forum":33,"gmail":0,"forum-pm":0}
...
- **Topics monitored**: 5
- **Recent replies**: 9
- **Last reply**: 2026-03-24T21:20:07.135Z
...
*Auto-generated on 2026-03-26 from v5.11.138 — 4,732+ fingerprints across 188 drivers*
