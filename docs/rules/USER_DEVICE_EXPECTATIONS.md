...
[![Version](https://img.shields.io/badge/version-v5.11.154-blue)]()
[![Drivers](https://img.shields.io/badge/drivers-191-brightgreen)]()
[![Fingerprints](https://img.shields.io/badge/fingerprints-4,323+-green)]()
[![Users Tracked](https://img.shields.io/badge/users%20tracked-33+-purple)]()
[![Last Updated](https://img.shields.io/badge/updated-2026-04-03-lightgrey)]()

> **v5.11.154** | **4,323+ fingerprints** | **191 drivers** | **2,238 flow cards** | Updated 2026-04-03

---

## Fingerprint Verification

**Verified**: 96 fingerprints from user reports found in drivers
...
| Version | Changes |
|---------|---------|
| **v5.11.154** | Universal Tuya Zigbee app v5.11.154 adds 4323 fingerprints across 191 drivers, enhancing device c... |
| **v5.11.152** | Universal Tuya Zigbee app v5.11.152 adds new device support and fixes several bugs for improved p... |
...
- **Pairing Failure** (12 reports, high priority): Check driver.compose.json fingerprints, verify manufacturerName + productId
...
- **Total interviews recovered**: 169
- **Unique fingerprints**: 130
- **Sources**: {"github":132,"forum":37,"gmail":0,"forum-pm":0}
...
| **Flow cards not working** | Update app to v5.11.154, recreate flow, check driver flow cards |
...
*Auto-generated on 2026-04-03 from v5.11.154 — 4,323+ fingerprints across 191 drivers*
