...
[![Version](https://img.shields.io/badge/version-v5.11.125-blue)]()
[![Drivers](https://img.shields.io/badge/drivers-188-brightgreen)]()
[![Fingerprints](https://img.shields.io/badge/fingerprints-4,731+-green)]()
[![Users Tracked](https://img.shields.io/badge/users%20tracked-33+-purple)]()
[![Last Updated](https://img.shields.io/badge/updated-2026-03-16-lightgrey)]()

> **v5.11.125** | **4,731+ fingerprints** | **188 drivers** | **1,872 flow cards** | Updated 2026-03-16
...
| Version | Changes |
|---------|---------|
| **v5.11.125** | Universal Tuya Zigbee app v5.11.125 adds , fixing IR blaster protocol issues. |
...
| **v5.11.121** | Universal Tuya Zigbee app v5.11.121 adds new device variants and fixes issues with LEAPMW DP109/1... |
| **v5.11.120** | Universal Tuya Zigbee app v5.11.120 adds new device variants and fixes distance drop issue for ra... |
...
| **v5.11.117** | Universal Tuya Zigbee app v5.11.117: Restored forum integration and updated drivers and fingerpri... |
| **v5.11.116** | Universal Tuya Zigbee app v5.11.116 includes a batch state update feature for improved device man... |
...
| **Flow cards not working** | Update app to v5.11.125, recreate flow, check driver flow cards |
...
*Auto-generated on 2026-03-16 from v5.11.125 — 4,731+ fingerprints across 188 drivers*
