...
[![Version](https://img.shields.io/badge/version-v5.11.132-blue)]()
[![Drivers](https://img.shields.io/badge/drivers-188-brightgreen)]()
[![Fingerprints](https://img.shields.io/badge/fingerprints-4,733+-green)]()
[![Users Tracked](https://img.shields.io/badge/users%20tracked-33+-purple)]()
[![Last Updated](https://img.shields.io/badge/updated-2026-03-18-lightgrey)]()

> **v5.11.132** | **4,733+ fingerprints** | **188 drivers** | **1,872 flow cards** | Updated 2026-03-18
...
| Version | Changes |
|---------|---------|
| **v5.11.132** | Updated  for Universal Tuya Zigbee app v5.11.132. |
...
| **v5.11.128** | Universal Tuya Zigbee app v5.11.128 adds new device support and critical fixes for SDK compatibil... |
| **v5.11.127** | Universal Tuya Zigbee app v5.11.127: Fixed SDK v2 flow card issues, improved device setup, and up... |
| **v5.11.126** | Universal Tuya Zigbee app v5.11.126: Fixed critical DP setup issue, updated device fingerprints, ... |
| **v5.11.125** | Fixed radar sensor classification and added new device fingerprints for Tuya Zigbee. |
| **v5.11.124** | Universal Tuya Zigbee app v5.11.124 fixes IR blaster learning issues and updates driver and finge... |
| **v5.11.123** | Universal Tuya Zigbee app v5.11.123: Fixed IR blaster sequence mismatch and adjusted TZE lux clam... |
...
- **False Battery Alert / Missing Battery** (25 reports, high priority): Set `get mainsPowered() { return true; }` and remove measure_battery in onNodeInit
...
- **Total interviews recovered**: 141
- **Unique fingerprints**: 114
- **Sources**: {"github":109,"forum":32,"gmail":0,"forum-pm":0}
...
| **Flow cards not working** | Update app to v5.11.132, recreate flow, check driver flow cards |
...
*Auto-generated on 2026-03-18 from v5.11.132 — 4,733+ fingerprints across 188 drivers*
