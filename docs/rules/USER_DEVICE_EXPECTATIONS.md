...
[![Version](https://img.shields.io/badge/version-v5.11.152-blue)]()
[![Drivers](https://img.shields.io/badge/drivers-191-brightgreen)]()
[![Fingerprints](https://img.shields.io/badge/fingerprints-4,314+-green)]()
[![Users Tracked](https://img.shields.io/badge/users%20tracked-33+-purple)]()
[![Last Updated](https://img.shields.io/badge/updated-2026-03-31-lightgrey)]()

> **v5.11.152** | **4,314+ fingerprints** | **191 drivers** | **2,238 flow cards** | Updated 2026-03-31
...
| Version | Changes |
|---------|---------|
| **v5.11.152** | Universal Tuya Zigbee app v5.11.152 fixes rain sensor pairing and resolves critical SyntaxError c... |
| **v5.11.151** | Universal Tuya Zigbee app v5.11.151: Critical fix for SyntaxError crashes and updated drivers. |
| **v5.11.150** | Universal Tuya Zigbee app v5.11.150 adds new drivers and fingerprints, enhancing device compatibi... |
| **v5.11.149** | Universal Tuya Zigbee app v5.11.149 adds new drivers and fingerprints, enhancing device compatibi... |
| **v5.11.148** | Universal Tuya Zigbee app v5.11.148 adds new device fingerprints and fixes bugs for improved comp... |
| **v5.11.147** | Universal Tuya Zigbee app v5.11.147 adds new device fingerprints and fixes issues for better perf... |
...
| **v5.11.144** | Universal Tuya Zigbee app v5.11.144 adds new device fingerprints and fixes issues with existing d... |
| **v5.11.143** | Universal Tuya Zigbee app v5.11.143 adds new drivers and capabilities, enhancing device compatibi... |
...
- **Total interviews recovered**: 163
- **Unique fingerprints**: 128
- **Sources**: {"github":128,"forum":35,"gmail":0,"forum-pm":0}
...
| **Flow cards not working** | Update app to v5.11.152, recreate flow, check driver flow cards |
...
*Auto-generated on 2026-03-31 from v5.11.152 — 4,314+ fingerprints across 191 drivers*
