...
[![Version](https://img.shields.io/badge/version-v5.11.87-blue)]()
[![Drivers](https://img.shields.io/badge/drivers-145-brightgreen)]()
[![Fingerprints](https://img.shields.io/badge/fingerprints-5,399+-green)]()
[![Users Tracked](https://img.shields.io/badge/users%20tracked-33+-purple)]()
[![Last Updated](https://img.shields.io/badge/updated-2026-03-04-lightgrey)]()

> **v5.11.87** | **5,399+ fingerprints** | **145 drivers** | **1,829 flow cards** | Updated 2026-03-04

---

## Fingerprint Verification

**Verified**: 76 fingerprints from user reports found in drivers
**Missing** (1): `_TZE200_vvmbj46n`
...
| Version | Changes |
|---------|---------|
| **v5.11.87** | Updated Gmail keepalive functionality for improved token management. |
...
| **v5.11.84** | Universal Tuya Zigbee app v5.11.84 adds delegation token step for API auth and updates drivers an... |
| **v5.11.83** | Universal Tuya Zigbee app v5.11.83 adds client_secret for OAuth token exchange and updates driver... |
| **v5.11.82** | Universal Tuya Zigbee app v5.11.82: Added support for multiple token endpoints and improved error... |
| **v5.11.81** | Fixed OAuth redirect handling and updated app metadata for v5.11.81. |
| **v5.11.80** | Updated OAuth flow to use session token for authorization. 145 drivers and 3093 fingerprints supp... |
| **v5.11.79** | Universal Tuya Zigbee app v5.11.79 adds headless OAuth support and updates drivers and fingerprints. |
| **v5.11.78** | Universal Tuya Zigbee app v5.11.78: Fixed session API v2 and updated auto-publish process. |
...
- **Total interviews recovered**: 120
- **Unique fingerprints**: 103
- **Sources**: {"github":90,"forum":30,"gmail":0,"forum-pm":0}
...
| **Flow cards not working** | Update app to v5.11.87, recreate flow, check driver flow cards |
...
*Auto-generated on 2026-03-04 from v5.11.87 — 5,399+ fingerprints across 145 drivers*
