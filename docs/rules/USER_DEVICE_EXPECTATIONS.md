...
[![Version](https://img.shields.io/badge/version-v7.5.14-blue)]()
[![Drivers](https://img.shields.io/badge/drivers-225-brightgreen)]()
[![Fingerprints](https://img.shields.io/badge/fingerprints-10,911+-green)]()
...
> **v7.5.14** | **10,911+ fingerprints** | **225 drivers** | **2,490 flow cards** | Updated 2026-05-11

---

## Fingerprint Verification

**Verified**: 127 fingerprints from user reports found in drivers
**Missing** (6): `_TZ3000_an5jiwd`, `_TZ3000_qxqcxxs`, `_TZ3000_j6kfv0r`, `_TZ68_4h8bgm`, `_TZE284_aaeasoll`, `_TYST11_jeaxp72v`
...
| **v5.11.211** | Universal Tuya Zigbee v5.11.211: Fixed DeviceIdentificationDatabase crash on startup (ReferenceEr... |
| **v5.11.210** | Universal Tuya Zigbee v5.11.210: Stability release - verified syntax integrity on all lib/ files,... |
...
- **Total interviews recovered**: 211
- **Unique fingerprints**: 157
- **Sources**: {"github":173,"forum":38,"gmail":0,"forum-pm":0}
...
| **Flow cards not working** | Update app to v7.5.14, recreate flow, check driver flow cards |
...
*Auto-generated on 2026-05-11 from v7.5.14 — 10,911+ fingerprints across 225 drivers*
