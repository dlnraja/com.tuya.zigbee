...
It lists external references, state trackers, and new integrations for Tuya Unified Zigbee.
...
- **Conclusion for our Homey App**: The Homey Tuya Unified Zigbee App acts as the supreme, stable equivalent of Z2M for the Homey ecosystem. No local keys needed.
