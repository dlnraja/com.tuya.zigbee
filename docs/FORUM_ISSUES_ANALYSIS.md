...
- **Topic 140352 #1689** @FrankP: `_TZ3000_tzvbimpq` (openrouter)
- **Topic 140352 #1701** @Adri1: `_TZ3000_bgsigers` (openrouter)
- **Topic 140352 #1703** @Adri1: `example`, `test` (deepseek)
- **Topic 140352 #1722** @Meruem: `_TZE284_bquwrqh1`, `_TZE`, `dlnraja`, `lumi`, `test` (deepseek)
- **Topic 140352 #1724** @Fantuz: `_TZE284_9ern5sfh`, `_TZE` (deepseek)
- **Topic 140352 #1725** @Wojciech_Ciarkowski: `example` (deepseek)
- **Topic 140352 #1728** @ManuelKugler: `_TZE284_oitavov2`, `_TZE284_hdml1aav`, `_TZE284_aao3yzhs`, `_TZE200_npj9bug3`, `A89G12C`, `HOBEIAN`, `_TZE` (deepseek)
- **Topic 140352 #1731** @Clement_Loridan: no FPs (deepseek)
- **Topic 140352 #1744** @Peter_van_Werkhoven: `example` (deepseek)
- **Topic 140352 #1745** @FrankP: `_TZ3000_tzvbimpq`, `_TZ3290_7v1k4vufotpowp9z`, `_TZ3290_7v1k4vuf` (deepseek)
- **Topic 140352 #1747** @Ronald_Bok: `_TZE284_oitavov2`, `_TZE` (deepseek)
- **Topic 140352 #1751** @JJ10: `test` (deepseek)
- **Topic 140352 #1757** @Clement_Loridan: `dlnraja`, `tuya` (deepseek)
- **Topic 140352 #1759** @Fantuz: no FPs (deepseek)
- **Topic 140352 #1760** @Clement_Loridan: no FPs (deepseek)
- **Topic 140352 #1763** @Rikjes: `tuya` (deepseek)
- **Topic 140352 #1765** @Mitch_Vallinga: no FPs (deepseek)
- **Topic 140352 #1766** @Clement_Loridan: `dlnraja` (deepseek)
- **Topic 140352 #1770** @tlink: `dlnraja` (deepseek)
- **Topic 140352 #1776** @Mahom: `dlnraja` (deepseek)
- **Topic 140352 #1778** @Mahom: no FPs (deepseek)
- **Topic 140352 #1787** @Mahom: `dlnraja` (deepseek)
- **Topic 140352 #1792** @xerot: `test` (deepseek)
- **Topic 140352 #1793** @Peter_van_Werkhoven: no FPs (deepseek)
- **Topic 140352 #1795** @Mahom: `matter`, `test` (deepseek)
- **Topic 140352 #1801** @Lachee: `test` (deepseek)
- **Topic 140352 #1811** @Mahom: `dlnraja` (deepseek)
- **Topic 140352 #1812** @Julien_31: `bseed` (deepseek)
- **Topic 140352 #1813** @Roger_Gorissen: `test` (deepseek)
- **Topic 140352 #1817** @Mahom: `dlnraja`, `test` (deepseek)
- **Topic 140352 #1818** @Sem: `_TZE204_clrdrnya`, `_TZE`, `dlnraja`, `router`, `vision` (deepseek)
- **Topic 140352 #1827** @Meruem: `dlnraja`, `tuya` (deepseek)
- **Topic 140352 #1830** @Mahom: `_TZ3000_l9brjwau`, `dlnraja`, `router`, `vision` (deepseek)
- **Topic 140352 #1833** @punkportaldan: `_TZ3000_ja5osu5g`, `thread`, `vision`, `MOES` (deepseek)
- **Topic 140352 #1839** @FrankP: `test`, `_TZ3000_an5jiwd`, `_TZ3000_fa9mlvja`, `_TZ3000_qxqcxxs`, `_TZ3000_j6kfv0r`, `_TZ3000_tk3Styg`, `_TZ3000_tzvbimpq` (deepseek)
- **Topic 140352 #1840** @Roger_Gorissen: `test` (deepseek)
- **Topic 140352 #1842** @Joep_Vullings: `_TZE284_fhvpaltk`, `_TZE` (deepseek)
- **Topic 140352 #1848** @Roger_Gorissen: `vision`, `test` (deepseek)
- **Topic 140352 #1857** @Roger_Gorissen: `test` (deepseek)
- **Topic 140352 #1858** @robertklep: `test` (deepseek)
- **Topic 140352 #1861** @emos: `_TZE200_ka8l86iu`, `_TZE`, `vision` (deepseek)
- **Topic 140352 #1862** @Roger_Gorissen: `dlnraja`, `test` (deepseek)
- **Topic 140352 #1864** @robertklep: `dlnraja`, `test` (deepseek)
- **Topic 140352 #1870** @Roger_Gorissen: `test` (deepseek)
- **Topic 140352 #1871** @robertklep: `dlnraja`, `test` (template)
- **Topic 140352 #1873** @Roger_Gorissen: `test` (template)
- **Topic 140352 #1874** @robertklep: `thread`, `test` (template)
- **Topic 140352 #1875** @FrankP: `development`, `test` (deepseek)
- **Topic 140352 #1877** @Roger_Gorissen: `trust` (deepseek)
- **Topic 140352 #1878** @Roger_Gorissen: `dlnraja`, `test` (deepseek)
- **Topic 140352 #1881** @Mahom: `dlnraja` (deepseek)
- **Topic 140352 #1886** @Mahom: `_TZ3000_l9brjwau`, `router`, `vision` (deepseek)
- **Topic 140352 #1887** @Mahom: `bseed` (deepseek)
- **Topic 140352 #1892** @Mahom: `test` (deepseek)
- **Topic 140352 #1893** @vikino: `test` (deepseek)
- **Topic 140352 #1894** @Hartmut_Dunker: `_TZ3002_pzao9ls1` (deepseek)
- **Topic 140352 #1896** @robertklep: `dlnraja`, `test` (deepseek)
- **Topic 140352 #1897** @smarthomesven: `dlnraja`, `test` (deepseek)
- **Topic 140352 #1899** @Roger_Gorissen: `test` (deepseek)
- **Topic 140352 #1902** @SunBeech: `MOES`, `tuya` (deepseek)
- **Topic 140352 #1904** @Jocke_Wallen: `dlnraja`, `tuya`, `test` (template)
- **Topic 140352 #1906** @Roger_Gorissen: `dlnraja`, `tuya`, `debug`, `test` (deepseek)
- **Topic 140352 #1912** @Roger_Gorissen: `test`, `dome`, `DOME` (deepseek)
- **Topic 140352 #1914** @Roger_Gorissen: `debug` (deepseek)
- **Topic 140352 #1921** @Roger_Gorissen: `matter` (deepseek)
- **Topic 140352 #1926** @ManuelKugler: `dlnraja`, `tuya`, `test` (deepseek)
- **Topic 140352 #1929** @Roger_Gorissen: `dlnraja`, `debug` (deepseek)
- **Topic 140352 #1932** @Joep_Vullings: `test` (deepseek)
- **Topic 140352 #1934** @Roger_Gorissen: `test` (deepseek)
- **Topic 140352 #1941** @Peter_van_Werkhoven: `test` (deepseek)
- **Topic 140352 #1951** @Peter_van_Werkhoven: `test` (deepseek)
- **Topic 140352 #1952** @xfiler: `thread`, `tuya`, `test` (deepseek)
- **Topic 140352 #1956** @Joep_Vullings: `test` (deepseek)
- **Topic 140352 #1957** @robertklep: `test` (deepseek)
- **Topic 140352 #1958** @Joep_Vullings: `dlnraja` (template)
- **Topic 140352 #1960** @4x4_Pete: `dlnraja`, `thread` (deepseek)
- **Topic 140352 #1967** @Meruem: `dlnraja`, `test` (deepseek)
- **Topic 140352 #1968** @robertklep: `thread` (deepseek)
- **Topic 140352 #1969** @smarthomesven: `HOBEIAN`, `SONOFF`, `_TZE`, `dlnraja`, `vision`, `OWON`, `lumi`, `tuya`, `NIKO` (deepseek)
- **Topic 140352 #1976** @Jocke_Wallen: `dlnraja` (deepseek)
- **Topic 140352 #1977** @ManuelKugler: `test` (deepseek)
- **Topic 140352 #1980** @SunBeech: `dlnraja`, `test` (deepseek)
- **Topic 140352 #1985** @SunBeech: `dlnraja`, `tuya`, `test` (deepseek)
- **Topic 140352 #1987** @SunBeech: `development`, `dlnraja`, `tuya` (deepseek)
- **Topic 140352 #1991** @ManuelKugler: `test` (deepseek)
- **Topic 140352 #1992** @Peter_van_Werkhoven: `test` (deepseek)
- **Topic 140352 #1999** @Nicolas: `dlnraja` (deepseek)
- **Topic 140352 #2000** @Mahom: no FPs (deepseek)
- **Topic 140352 #2001** @Roger_Gorissen: `popp` (template)
- **Topic 140352 #2002** @Roger_Gorissen: `development`, `test` (deepseek)
- **Topic 140352 #2003** @late4marshmellow: `thread`, `popp` (template)
- **Topic 140352 #2007** @ManuelKugler: `_TZE200_kb5noeto`, `_TZE`, `example`, `thread`, `test` (deepseek)
- **Topic 140352 #2008** @Peter_van_Werkhoven: `development` (deepseek)
- **Topic 140352 #2011** @Peter_van_Werkhoven: `dlnraja` (deepseek)
- **Topic 140352 #2012** @late4marshmellow: `dlnraja` (deepseek)
- **Topic 140352 #2013** @Roger_Gorissen: `dlnraja`, `test` (deepseek)
- **Topic 140352 #2014** @robertklep: `dlnraja`, `tuya` (deepseek)
- **Topic 140352 #2015** @Roger_Gorissen: `dlnraja` (deepseek)
- **Topic 140352 #2017** @DutchDuke: `_TZ3000_akqdg6g7` (openrouter)
- **Topic 140352 #2018** @Roger_Gorissen: `dlnraja` (openrouter)
- **Topic 140352 #2021** @Roger_Gorissen: `dlnraja`, `tuya` (deepseek)
- **Topic 140352 #2022** @blutch32: `dlnraja`, `example`, `test` (deepseek)
- **Topic 140352 #2024** @Joep_Vullings: `_TZE284_fhvpaltk`, `_TZE`, `vision` (deepseek)
- **Topic 140352 #2025** @xerot: `custom`, `thread` (template)
- **Topic 140352 #2026** @Ronald_Bok: `_TZE284_oitavov2`, `_TZE`, `_TZ68_4h8bgm` (deepseek)
- **Topic 140352 #2029** @Yannick_Eeckelaert: `dlnraja`, `test` (deepseek)
- **Topic 140352 #2031** @DutchDuke: `dlnraja` (deepseek)
