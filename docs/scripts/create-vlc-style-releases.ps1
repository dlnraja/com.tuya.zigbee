...
Write-Host "🚀 VLC Style Releases Creation - Tuya Zigbee Project" -ForegroundColor Green
...
Write-Host "📦 Création des releases ZIP style VLC..." -ForegroundColor Cyan
...
$releaseReport | ConvertTo-Json -Depth 3 | Set-Content "docs/vlc-releases-report.json"

Write-Host ""
Write-Host "📊 Résultats des releases VLC:" -ForegroundColor Cyan
...
Write-Host "   📄 Rapport sauvegardé: docs/vlc-releases-report.json" -ForegroundColor Yellow
Write-Host "🚀 Releases VLC créées avec succès!" -ForegroundColor Green