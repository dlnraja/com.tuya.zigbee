...
**Status:** ⚠️ **Network/Hardware Issue**
...
**Status:** ⚠️ **Device Variant Issue**
- Logs show: `[DATA-RECOVERY] ⚠️ Still missing after recovery: measure_distance`
