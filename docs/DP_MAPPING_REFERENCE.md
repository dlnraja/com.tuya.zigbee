...
## MCU Time Sync DP Mappings (Detailed)

### Time-Related DPs (Extended)
| DP | Function | Type | Notes |
|----|----------|------|-------|
...
| DP110 | UTC time (extended) | Value | Seconds since epoch |
| DP111 | Local time (extended) | Value | Seconds since epoch (local TZ) |
...
### 23 Time Sync Format Categories
| Category | Formats | Typical Device |
|----------|---------|----------------|
| Epoch-Based | ZIGBEE_2000, ZIGBEE_2000_LOCAL, ZIGBEE_2000_LE, UNIX_1970, UNIX_1970_LOCAL, UNIX_1970_LE, UNIX_1970_MS | ZCL sensors |
| Dual Timestamp | TUYA_DUAL_2000, TUYA_DUAL_1970, Z2M_DUAL_1970, Z2M_DUAL_2000 | LCD climate sensors |
| MCU UART | TUYA_MCU, TUYA_MCU_HDR_10, TUYA_MCU_HDR_8 | MCU-bridged devices |
| Sequence-Echo | TUYA_SEQ_10, TUYA_SEQ_10_E2K | v3.3+ firmware |
| Minimal/Date | ZCL_5, TUYA_STANDARD, TUYA_UTC, TUYA_EXTENDED_TZ, TUYA_FULL_TZ, TUYA_GATEWAY | Various |
| Commit-Trigger | ZT08_DP17_COMMIT | Weather stations |
...
*Updated: MCU Time Sync DP Mappings, 23 Time Sync Format Categories*
