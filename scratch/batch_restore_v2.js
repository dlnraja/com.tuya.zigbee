...
const files = [
    'drivers/device_plug_energy/driver.js',
    'drivers/dimmer_air_purifier/device.js',
    'drivers/diy_custom_zigbee/device.js'
];

const templates = {
    'drivers/device_plug_energy/driver.js': `'use strict';
...
module.exports = PlugEnergyDriver;`,
    ...
    'drivers/dimmer_air_purifier/device.js': `'use strict';
