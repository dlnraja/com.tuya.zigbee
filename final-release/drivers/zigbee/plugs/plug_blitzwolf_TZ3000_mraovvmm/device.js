...
// Device Type: zigbee
// Category: plugs
// Subcategory: plug_blitzwolf_TZ3000_mraovvmm
// Enrichment Date: 2025-08-07T17:53:56.295Z
...
class Plugblitzwolftz3000mraovvmm extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Plugblitzwolftz3000mraovvmm SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Plugblitzwolftz3000mraovvmm Enhanced deleted');
  }
