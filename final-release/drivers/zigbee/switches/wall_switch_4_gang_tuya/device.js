...
// Device Type: zigbee
// Category: switches
// Subcategory: wall_switch_4_gang_tuya
// Enrichment Date: 2025-08-07T17:53:57.310Z
...
class Wallswitch4gangtuya extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Wallswitch4gangtuya SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Wallswitch4gangtuya Enhanced deleted');
  }
