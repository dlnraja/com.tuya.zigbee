...
// Device Type: zigbee
// Category: onoff
// Subcategory: double_power_point_2
// Enrichment Date: 2025-08-07T17:53:55.965Z
...
class Doublepowerpoint2 extends ZigBeeDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('Doublepowerpoint2 SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Doublepowerpoint2 Enhanced deleted');
  }
