...
// Device Type: zigbee
// Category: onoff
// Subcategory: water_detector
// Enrichment Date: 2025-08-07T17:53:56.211Z
...
class Waterdetector extends ZigBeeDevice {
  ...
  async onNodeInit({ zclNode }) {
    ...
    this.log('Waterdetector SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Waterdetector Enhanced deleted');
  }
