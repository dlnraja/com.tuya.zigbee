...
// Device Type: zigbee
// Category: sensors
// Subcategory: smart_door_window_sensor
// Enrichment Date: 2025-08-07T17:53:56.808Z
...
class Smartdoorwindowsensor extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Smartdoorwindowsensor SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Smartdoorwindowsensor Enhanced deleted');
  }
...
module.exports = Smartdoorwindowsensor;
