...
// Device Type: zigbee
// Category: sensors
// Subcategory: smoke_sensor3
// Enrichment Date: 2025-08-07T17:53:56.856Z
...
class Smokesensor3 extends ZigBeeDevice {
  
  async onNodeInit({ zclNode }) {
    // SDK3 compatibility - Homey Mini/Bridge/Pro
    await super.onNodeInit({ zclNode });
    
    this.log('Smokesensor3 SDK3 Enhanced initialized');
  ...
  async onDeleted() {
    ...
    this.log('Smokesensor3 Enhanced deleted');
  }
