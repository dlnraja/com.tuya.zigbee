...
// Enrichment Date: 2025-08-07T17:53:54.680Z

'use strict';

const { ZigBeeDriver } = require('homey-meshdriver');

class AutomationDriver extends ZigBeeDriver {
    ...
    this.printNode();
        ...
        this.log('🚀 automation Driver - Initialisation MEGA enrichie...');
        ...
        this.log('✅ automation Driver - Initialisation MEGA terminée');
    }
...
module.exports = AutomationDriver;