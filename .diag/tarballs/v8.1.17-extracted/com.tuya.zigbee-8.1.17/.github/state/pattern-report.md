...
| Device Not Responding | 8 | **high** | `test` (5x), `TS0601` (5x), `vision` (4x) |
...
**Most affected:** `vision` (27x), `TS0601` (18x), `_TZE` (16x), `router` (6x), `test` (5x), `example` (3x), `TS0202` (3x), `generic` (3x), `_TZ3000_b4awzgct` (3x), `TS0041` (3x)
