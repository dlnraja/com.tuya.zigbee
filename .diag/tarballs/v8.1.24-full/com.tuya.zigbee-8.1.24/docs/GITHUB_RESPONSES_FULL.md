...
## Nightly Auto-Responses (2026-03-15 v5.11.119)
- **JohanBendz/com.tuya.zigbee#1351** @cristianoisaac: `_TZE284_bquwrqh1`, `smartthings`, `vision`, `lumi`, `tuya` (gh-gpt-4o-mini)


## Nightly Auto-Responses (2026-03-16 v5.11.125)
- **dlnraja/com.tuya.zigbee#160** @github-actions[bot]: `SONOFF`, `danfoss`, `eWeLink`, `legrand`, `sonoff`, `xiaomi`, `test`, `bosch`, `ikea`, `tuya` (gh-gpt-4o-mini)
...
- **JohanBendz/com.tuya.zigbee#1393** @macmonty: `_TZE204_81yrt3lo`, `_TZE`, `example`, `router`, `vision`, `zigbee2mqtt` (openrouter)
- **JohanBendz/com.tuya.zigbee#1392** @4576ggv4536: `_TZ3040_o4mkahkc`, `example`, `vision` (openrouter)
- **JohanBendz/com.tuya.zigbee#1391** @4576ggv4536: `_TZ3000_996rpfy6`, `example`, `vision` (openrouter)
- **JohanBendz/com.tuya.zigbee#1390** @4576ggv4536: `example`, `router`, `vision` (openrouter)
- **JohanBendz/com.tuya.zigbee#1389** @migueleap: `_TZ3000_qja6nq5z`, `custom`, `example` (deepseek)
- **JohanBendz/com.tuya.zigbee#1388** @migueleap: `_TZ3210_5ct6e7ye`, `example`, `router` (deepseek)
- **JohanBendz/com.tuya.zigbee#1387** @vikinos: `_TZE284_rqcuwlsa`, `_TZE`, `vision` (deepseek)
- **JohanBendz/com.tuya.zigbee#1386** @KasvanD: `ZG-106Z` (deepseek)
- **JohanBendz/com.tuya.zigbee#1385** @PDominikPL: `_TZE608_c75zqghm`, `_TZE`, `example`, `router`, `vision` (deepseek)
- **JohanBendz/com.tuya.zigbee#1384** @tjoepatjoep: `_TZE284_fhvpaltk`, `_TZE`, `test` (deepseek)
- **JohanBendz/com.tuya.zigbee#1383** @johbiraus: `_TZ3290_yyax9ajf`, `example`, `vision`, `tuya`, `test` (deepseek)
- **JohanBendz/com.tuya.zigbee#1382** @dzsandzsee: `_TZE200_crq3r3la`, `_TZE`, `example`, `router`, `vision`, `lumi`, `tuya` (deepseek)
- **JohanBendz/com.tuya.zigbee#1381** @gangstigen-glitch: `_TZE204_xalsoe3m`, `_TZE`, `example`, `router`, `vision`, `moes` (deepseek)
- **JohanBendz/com.tuya.zigbee#1380** @pixelwiese: `_TZ3000_baeiitad`, `example`, `vision` (deepseek)
- **JohanBendz/com.tuya.zigbee#1379** @TobiasB295: `_TZE284_aaeasoll`, `_TZE`, `example`, `vision`, `tuya` (deepseek)
- **JohanBendz/com.tuya.zigbee#1378** @migueleap: `test` (deepseek)
- **JohanBendz/com.tuya.zigbee#1377** @migueleap: `_TZ3000_gjrubzje`, `_TZ3000_g`, `router`, `test` (deepseek)
- **JohanBendz/com.tuya.zigbee#1376** @migueleap: `_TZ3000_aetquff4`, `example`, `vision` (deepseek)
- **JohanBendz/com.tuya.zigbee#1375** @migueleap: `_TZ3000_qkixdnon`, `example`, `router` (openrouter)
- **JohanBendz/com.tuya.zigbee#1374** @bogdan296: `_TZE204_r0jdjrvi`, `_TZE200_r0jdjrvi`, `_TZE`, `example`, `router` (deepseek)
- **JohanBendz/com.tuya.zigbee#1373** @davidgeresdi-cyber: `_TYST11_jeaxp72v`, `_TYST`, `vision` (deepseek)
- **JohanBendz/com.tuya.zigbee#1371** @migueleap: `_TZ3000_wpueorev`, `router`, `vision` (deepseek)
- **JohanBendz/com.tuya.zigbee#1370** @migueleap: `_TZ3000_hafsqare`, `router`, `vision` (deepseek)
...
## FORUM: JJ10  Presence sensor v5.8.66v5.8.77
> v5.8.66: Found correctly, motion 1sec only, lux/distance not updating, battery '?'. Diag 17c03ea7.
> v5.8.77: Motion/lux/distance WORKING. Temp/hum show but don't change  likely device doesn't support them or ghost caps. No action needed unless user reports again.
