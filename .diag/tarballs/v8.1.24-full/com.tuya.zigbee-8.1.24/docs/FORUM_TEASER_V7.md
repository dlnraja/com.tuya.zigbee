...
Ive been reading through all your recent feedbackthe "Unknown Device" reports, the multi-gang switch glitches, and the WiFi disconnects. Behind the scenes, I have been working on a massive architectural rewrite of the app. 

I am excited to share a sneak peek of what Im currently implementing for the upcoming **v7.0 (Codename: MAX Local Pro)**. We are moving from a simple driver approach to an industrial-grade, SDK 3-compliant hybrid engine. 
...
####  4. The BVB Engine (Bizarre Value Blocking)
...
####  5. CI/CD Auto-DevOps (For the 13,000+ Fingerprints)
With so many Tuya variants, manual updates are impossible. Ive overhauled the GitHub CI/CD pipeline. 
...
Let me know what you guys think of this new architecture! 
